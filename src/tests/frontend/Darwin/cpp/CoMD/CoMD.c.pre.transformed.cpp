...
{init_chimes(); new_stack((void *)(&main), 2, 2, (size_t)(0UL), (size_t)(13807915916850228111UL), "main|argc|0", &____must_checkpoint_main_argc_0, "i32", (void *)(&argc), (size_t)4, 0, 0, 0, "main|argv|0", (int *)0x0, "i8**", (void *)(&argv), (size_t)8, 1, 0, 0); if (____chimes_replaying) { goto lbl_0; }
...
# 98 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/CoMD.c"
 lbl_0: Command cmd; if (____must_checkpoint_main_cmd_0 != 0) { register_stack_var("main|cmd|0", &____must_checkpoint_main_cmd_0, "%struct.CommandSt = type { [1024 x i8], [1024 x i8], [1024 x i8], i32, i32, i32, i32, i32, i32, i32, i32, i32, double, double, double, double }", (void *)(&cmd), (size_t)3144, 0, 1, 0); } if (____chimes_replaying) { goto lbl_1; } call_lbl_9: calling((void*)&parseCommandLine, 9, 0UL, 3, (size_t)(13807915916850227994UL), (size_t)(0UL), (size_t)(13807915916850228111UL)); cmd = Command(parseCommandLine(argc, argv)) ;
...
# 102 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/CoMD.c"
 lbl_1: SimFlat *sim; if (____must_checkpoint_main_sim_0 != 0) { register_stack_var("main|sim|0", &____must_checkpoint_main_sim_0, "%struct.SimFlatSt*", (void *)(&sim), (size_t)8, 1, 0, 0); } if (____chimes_replaying) { goto lbl_2; } call_lbl_11: calling((void*)&initSimulation, 11, 13807915916850228054UL, 1, (size_t)(13807915916850227996UL)); sim = (initSimulation(cmd)) ;
...
{new_stack((void *)(&initSpecies), 1, 0, (size_t)(13807915916850229296UL)); if (____chimes_replaying) { switch(get_next_call()) { case(2): { goto call_lbl_2; } default: { chimes_error(); } } }
...
# 279 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/CoMD.c"
 call_lbl_2: calling((void*)&strcpy, 2, 13807915916850229281UL, 2, (size_t)(13807915916850229272UL), (size_t)(13807915916850229296UL)); strcpy(species->name, pot->name);
...
# 357 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/CoMD.c"
 lbl_0: int nEval; if (____must_checkpoint_printThings_nEval_0 != 0) { register_stack_var("printThings|nEval|0", &____must_checkpoint_printThings_nEval_0, "i32", (void *)(&nEval), (size_t)4, 0, 0, 0); } if (____chimes_replaying) { switch(get_next_call()) { case(2): { goto call_lbl_2; } case(6): { goto call_lbl_6; } default: { chimes_error(); } } } nEval = (iStep - iStepPrev) ;
...
# 369 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/CoMD.c"
 call_lbl_6: calling((void*)&fflush, 6, 0UL, 1, (size_t)(13807915916850228886UL)); fflush(__stdoutp);
...
{new_stack((void *)(&printSimulationDataYaml), 2, 2, (size_t)(13807915916850228659UL), (size_t)(13807915916850228660UL), "printSimulationDataYaml|file|0", (int *)0x0, "%struct.__sFILE*", (void *)(&file), (size_t)8, 1, 0, 0, "printSimulationDataYaml|s|0", (int *)0x0, "%struct.SimFlatSt*", (void *)(&s), (size_t)8, 1, 0, 0); if (____chimes_replaying) { goto lbl_0; }
...
# 389 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/CoMD.c"
 alias_group_changed(2, (size_t)(13807915916850228322UL), (size_t)(13807915916850228323UL)); lbl_0: int maxOcc; register_stack_var("printSimulationDataYaml|maxOcc|0", (int *)0x0, "i32", (void *)(&maxOcc), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_1; } call_lbl_2: calling((void*)&maxOccupancy, 2, 0UL, 1, (size_t)(13807915916850228340UL)); maxOcc = (maxOccupancy(s->boxes)) ;
...
# 439 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/CoMD.c"
 call_lbl_27: calling((void*)&fflush, 27, 0UL, 1, (size_t)(13807915916850228659UL)); fflush(file);
