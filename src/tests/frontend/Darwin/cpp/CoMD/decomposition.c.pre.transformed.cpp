...
static int module_init() {
    init_module(13672999005525477744UL, 5, 1, 13672999005525477744UL + 245UL, 13672999005525477744UL + 326UL, 13672999005525477744UL + 244UL, 13672999005525477744UL + 326UL, 13672999005525477744UL + 5UL, 13672999005525477744UL + 34UL, 13672999005525477744UL + 4UL, 13672999005525477744UL + 230UL, 13672999005525477744UL + 240UL, 13672999005525477744UL + 326UL, "DomainSt", 8, (int)__builtin_offsetof(struct DomainSt, procGrid), (int)__builtin_offsetof(struct DomainSt, procCoord), (int)__builtin_offsetof(struct DomainSt, globalMin), (int)__builtin_offsetof(struct DomainSt, globalMax), (int)__builtin_offsetof(struct DomainSt, globalExtent), (int)__builtin_offsetof(struct DomainSt, localMin), (int)__builtin_offsetof(struct DomainSt, localMax), (int)__builtin_offsetof(struct DomainSt, localExtent));
    return 0;
}
