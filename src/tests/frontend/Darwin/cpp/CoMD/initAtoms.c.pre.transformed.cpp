...
{const int ____chimes_disable0 = new_stack((void *)(&initAtoms), "initAtoms", &____must_manage_initAtoms, 1, 0, (size_t)(13592833164869970745UL)) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
...
# 49 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/initAtoms.c"
 rm_stack(true, 13592833164869970623UL, "initAtoms", &____must_manage_initAtoms, ____alias_loc_id_14, ____chimes_disable0); return atoms;
...
{const int ____chimes_disable1 = new_stack((void *)(&destroyAtoms), "destroyAtoms", &____must_manage_destroyAtoms, 1, 0, (size_t)(13592833164869970854UL)) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
...
rm_stack(false, 0UL, "destroyAtoms", &____must_manage_destroyAtoms, ____alias_loc_id_16, ____chimes_disable1); }
...
{const int ____chimes_disable2 = new_stack((void *)(&createFccLattice), "createFccLattice", &____must_manage_createFccLattice, 5, 5, (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(13592833164869971117UL), "createFccLattice|nx|0", &____must_checkpoint_createFccLattice_nx_0, "i32", (void *)(&nx), (size_t)4, 0, 0, 0, "createFccLattice|ny|0", &____must_checkpoint_createFccLattice_ny_0, "i32", (void *)(&ny), (size_t)4, 0, 0, 0, "createFccLattice|nz|0", &____must_checkpoint_createFccLattice_nz_0, "i32", (void *)(&nz), (size_t)4, 0, 0, 0, "createFccLattice|lat|0", &____must_checkpoint_createFccLattice_lat_0, "double", (void *)(&lat), (size_t)8, 0, 0, 0, "createFccLattice|s|0", &____must_checkpoint_createFccLattice_s_0, "%struct.SimFlatSt*", (void *)(&s), (size_t)8, 1, 0, 0) ; int id;
real_t rz;
real_t ry;
real_t rx;
int ib;
...
# 116 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/initAtoms.c"
 do { alias_group_changed(____alias_loc_id_1); ({ call_lbl_5: enum TimerHandle ____chimes_arg13; if (!____chimes_replaying) { ____chimes_arg13 = (commReduceTimer); } calling((void*)profileStart, 5, 0UL, 1, (size_t)(0UL)); (profileStart)(____chimes_arg13); }) ; } while(0);
# 117 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/initAtoms.c"
 ({ call_lbl_6: int * ____chimes_arg14; int * ____chimes_arg15; int ____chimes_arg16; if (!____chimes_replaying) { ____chimes_arg14 = (&s->atoms->nLocal); ____chimes_arg15 = (&s->atoms->nGlobal); ____chimes_arg16 = (1); } calling((void*)addIntParallel, 6, 0UL, 3, (size_t)(13592833164869971119UL), (size_t)(13592833164869971119UL), (size_t)(0UL)); (addIntParallel)(____chimes_arg14, ____chimes_arg15, ____chimes_arg16); }) ;
# 118 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/initAtoms.c"
 do { ({ call_lbl_7: enum TimerHandle ____chimes_arg17; if (!____chimes_replaying) { ____chimes_arg17 = (commReduceTimer); } calling((void*)profileStop, 7, 0UL, 1, (size_t)(0UL)); (profileStop)(____chimes_arg17); }) ; } while(0);
...
rm_stack(false, 0UL, "createFccLattice", &____must_manage_createFccLattice, 0, ____chimes_disable2); }
...
real_t oldVcm[3];
 if (____must_checkpoint_setVcm_oldVcm_0) { register_stack_vars(1, "setVcm|oldVcm|0", &____must_checkpoint_setVcm_oldVcm_0, "[3 x double]", (void *)(oldVcm), (size_t)24, 0, 0, 0); } if (____chimes_replaying) { switch(get_next_call()) { case(2): { goto call_lbl_2; } default: { chimes_error(); } } } ; ;
...
# 128 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/initAtoms.c"
 alias_group_changed(____alias_loc_id_2); ({ call_lbl_2: SimFlat * ____chimes_arg18; real_t * ____chimes_arg19; if (!____chimes_replaying) { ____chimes_arg18 = (s); ____chimes_arg19 = (oldVcm); } calling((void*)computeVcm, 2, 0UL, 2, (size_t)(13592833164869971340UL), (size_t)(13592833164869971187UL)); (computeVcm)(____chimes_arg18, ____chimes_arg19); }) ;
...
rm_stack(false, 0UL, "setVcm", &____must_manage_setVcm, ____alias_loc_id_17, ____chimes_disable3); }
...
# 170 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/initAtoms.c"
 alias_group_changed(____alias_loc_id_6); s->atoms->p[iOff][0] = mass * sigma * ({ call_lbl_5: uint64_t * ____chimes_arg22; if (!____chimes_replaying) { ____chimes_arg22 = (&seed); } calling((void*)gasdev, 5, 0UL, 1, (size_t)(13592833164869971514UL)); (gasdev)(____chimes_arg22); }) ;
# 171 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/initAtoms.c"
 alias_group_changed(____alias_loc_id_7); s->atoms->p[iOff][1] = mass * sigma * ({ call_lbl_7: uint64_t * ____chimes_arg23; if (!____chimes_replaying) { ____chimes_arg23 = (&seed); } calling((void*)gasdev, 7, 0UL, 1, (size_t)(13592833164869971514UL)); (gasdev)(____chimes_arg23); }) ;
# 172 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/initAtoms.c"
 alias_group_changed(____alias_loc_id_8); s->atoms->p[iOff][2] = mass * sigma * ({ call_lbl_9: uint64_t * ____chimes_arg24; if (!____chimes_replaying) { ____chimes_arg24 = (&seed); } calling((void*)gasdev, 9, 0UL, 1, (size_t)(13592833164869971514UL)); (gasdev)(____chimes_arg24); }) ;
...
# 177 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/initAtoms.c"
 if (temperature == 0.) {rm_stack(false, 0UL, "setTemperature", &____must_manage_setTemperature, ____alias_loc_id_19, ____chimes_disable4); return;; };
...
# 179 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/initAtoms.c"
 alias_group_changed(____alias_loc_id_5); ({ call_lbl_12: SimFlat * ____chimes_arg25; real_t * ____chimes_arg26; if (!____chimes_replaying) { ____chimes_arg25 = (s); ____chimes_arg26 = (vZero); } calling((void*)setVcm, 12, 0UL, 2, (size_t)(13592833164869971784UL), (size_t)(13592833164869971515UL)); (setVcm)(____chimes_arg25, ____chimes_arg26); }) ;
# 180 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/initAtoms.c"
 ({ call_lbl_13: SimFlat * ____chimes_arg27; if (!____chimes_replaying) { ____chimes_arg27 = (s); } calling((void*)kineticEnergy, 13, 0UL, 1, (size_t)(13592833164869971784UL)); (kineticEnergy)(____chimes_arg27); }) ;
...
# 193 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/initAtoms.c"
 alias_group_changed(____alias_loc_id_9); ({ call_lbl_16: SimFlat * ____chimes_arg28; if (!____chimes_replaying) { ____chimes_arg28 = (s); } calling((void*)kineticEnergy, 16, 0UL, 1, (size_t)(13592833164869971784UL)); (kineticEnergy)(____chimes_arg28); }) ;
...
rm_stack(false, 0UL, "setTemperature", &____must_manage_setTemperature, ____alias_loc_id_19, ____chimes_disable4); }
...
# 208 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/initAtoms.c"
 alias_group_changed(____alias_loc_id_11); s->atoms->r[iOff][0] += (2.0* ({ call_lbl_4: uint64_t * ____chimes_arg31; if (!____chimes_replaying) { ____chimes_arg31 = (&seed); } calling((void*)lcg61, 4, 0UL, 1, (size_t)(13592833164869971801UL)); (lcg61)(____chimes_arg31); }) -1.0) * delta;
# 209 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/initAtoms.c"
 alias_group_changed(____alias_loc_id_12); s->atoms->r[iOff][1] += (2.0* ({ call_lbl_6: uint64_t * ____chimes_arg32; if (!____chimes_replaying) { ____chimes_arg32 = (&seed); } calling((void*)lcg61, 6, 0UL, 1, (size_t)(13592833164869971801UL)); (lcg61)(____chimes_arg32); }) -1.0) * delta;
# 210 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/initAtoms.c"
 alias_group_changed(____alias_loc_id_13); s->atoms->r[iOff][2] += (2.0* ({ call_lbl_8: uint64_t * ____chimes_arg33; if (!____chimes_replaying) { ____chimes_arg33 = (&seed); } calling((void*)lcg61, 8, 0UL, 1, (size_t)(13592833164869971801UL)); (lcg61)(____chimes_arg33); }) -1.0) * delta;
...
rm_stack(false, 0UL, "randomDisplacements", &____must_manage_randomDisplacements, ____alias_loc_id_20, ____chimes_disable5); }
...
{const int ____chimes_disable6 = new_stack((void *)(&computeVcm), "computeVcm", &____must_manage_computeVcm, 2, 1, (size_t)(13592833164869971504UL), (size_t)(13592833164869971486UL), "computeVcm|vcm|0", &____must_checkpoint_computeVcm_vcm_0, "double*", (void *)(&vcm), (size_t)8, 1, 0, 0) ; real_t vcmSum[4] = { 0., 0., 0., 0. };
real_t vcmLocal[4] = { 0., 0., 0., 0. };
 if (____must_checkpoint_computeVcm_vcmSum_0 || ____must_checkpoint_computeVcm_vcmLocal_0) { register_stack_vars(2, "computeVcm|vcmSum|0", &____must_checkpoint_computeVcm_vcmSum_0, "[4 x double]", (void *)(vcmSum), (size_t)32, 0, 0, 0, "computeVcm|vcmLocal|0", &____must_checkpoint_computeVcm_vcmLocal_0, "[4 x double]", (void *)(vcmLocal), (size_t)32, 0, 0, 0); } if (____chimes_replaying) { switch(get_next_call()) { case(2): { goto call_lbl_2; } case(3): { goto call_lbl_3; } case(4): { goto call_lbl_4; } default: { chimes_error(); } } } ; ;
...
# 235 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/initAtoms.c"
 do { alias_group_changed(____alias_loc_id_3); ({ call_lbl_2: enum TimerHandle ____chimes_arg34; if (!____chimes_replaying) { ____chimes_arg34 = (commReduceTimer); } calling((void*)profileStart, 2, 0UL, 1, (size_t)(0UL)); (profileStart)(____chimes_arg34); }) ; } while(0);
# 236 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/initAtoms.c"
 ({ call_lbl_3: real_t * ____chimes_arg35; real_t * ____chimes_arg36; int ____chimes_arg37; if (!____chimes_replaying) { ____chimes_arg35 = (vcmLocal); ____chimes_arg36 = (vcmSum); ____chimes_arg37 = (4); } calling((void*)addRealParallel, 3, 0UL, 3, (size_t)(13592833164869971344UL), (size_t)(13592833164869971345UL), (size_t)(0UL)); (addRealParallel)(____chimes_arg35, ____chimes_arg36, ____chimes_arg37); }) ;
...
rm_stack(false, 0UL, "computeVcm", &____must_manage_computeVcm, ____alias_loc_id_18, ____chimes_disable6); }
...
static int module_init() {
    ...
    register_functions(8, "initAtoms.c.pre.register.cpp", "initAtoms", &initAtoms, "zeroReal3", &zeroReal3, "destroyAtoms", &destroyAtoms, "createFccLattice", &createFccLattice, "setVcm", &setVcm, "computeVcm", &computeVcm, "setTemperature", &setTemperature, "randomDisplacements", &randomDisplacements);
    return 0;
}
