...
# 105 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 alias_group_changed(3, (size_t)(14970133447157970233UL), (size_t)(14970133447157970234UL), (size_t)(14970133447157970257UL)); rm_stack(false, 0UL); return;
...
alias_group_changed(3, (size_t)(14970133447157970798UL), (size_t)(14970133447157970799UL), (size_t)(14970133447157970800UL)); rm_stack(false, 0UL); }
...
{new_stack((void *)(&ljForce), 1, 1, (size_t)(14970133447157970504UL), "ljForce|s|0", &____must_checkpoint_ljForce_s_0, "%struct.SimFlatSt*", (void *)(&s), (size_t)8, 1, 0, 0); if (____chimes_replaying) { goto lbl_0; }
...
# 147 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 lbl_0: real_t epsilon; register_stack_var("ljForce|epsilon|0", &____must_checkpoint_ljForce_epsilon_0, "double", (void *)(&epsilon), (size_t)8, 0, 0, 0); if (____chimes_replaying) { goto lbl_1; } epsilon = (pot->epsilon) ;
...
# 149 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 lbl_1: real_t rCut2; register_stack_var("ljForce|rCut2|0", &____must_checkpoint_ljForce_rCut2_0, "double", (void *)(&rCut2), (size_t)8, 0, 0, 0); if (____chimes_replaying) { goto lbl_2; } rCut2 = (rCut * rCut) ;
...
# 152 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 lbl_2: real_t ePot; register_stack_var("ljForce|ePot|0", &____must_checkpoint_ljForce_ePot_0, "double", (void *)(&ePot), (size_t)8, 0, 0, 0); if (____chimes_replaying) { goto lbl_3; } ePot = (0.) ;
...
# 155 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 { lbl_3: int ii; register_stack_var("ljForce|ii|0", &____must_checkpoint_ljForce_ii_0, "i32", (void *)(&ii), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_4; } for ( ii = (0) ; ii<fSize; ++ii)
...
# 161 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 lbl_4: real_t s6; register_stack_var("ljForce|s6|0", &____must_checkpoint_ljForce_s6_0, "double", (void *)(&s6), (size_t)8, 0, 0, 0); if (____chimes_replaying) { goto lbl_5; } s6 = (sigma * sigma * sigma * sigma * sigma * sigma) ;
...
# 164 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 lbl_5: real_t eShift; register_stack_var("ljForce|eShift|0", &____must_checkpoint_ljForce_eShift_0, "double", (void *)(&eShift), (size_t)8, 0, 0, 0); if (____chimes_replaying) { goto lbl_6; } eShift = (1. * rCut6 * (rCut6 - 1.)) ;
...
# 166 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 lbl_6: int nbrBoxes[27]; register_stack_var("ljForce|nbrBoxes|0", &____must_checkpoint_ljForce_nbrBoxes_0, "[27 x i32]", (void *)(nbrBoxes), (size_t)108, 0, 0, 0); if (____chimes_replaying) { goto lbl_7; } ;
...
# 168 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 { lbl_7: int iBox; register_stack_var("ljForce|iBox|0", &____must_checkpoint_ljForce_iBox_0, "i32", (void *)(&iBox), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_8; } for ( iBox = (0) ; iBox<s->boxes->nLocalBoxes; iBox++)
...
# 170 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 lbl_8: int nIBox; register_stack_var("ljForce|nIBox|0", &____must_checkpoint_ljForce_nIBox_0, "i32", (void *)(&nIBox), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_9; } nIBox = (s->boxes->nAtoms[iBox]) ;
...
# 174 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 { lbl_10: int jTmp; register_stack_var("ljForce|jTmp|0", &____must_checkpoint_ljForce_jTmp_0, "i32", (void *)(&jTmp), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_11; } for ( jTmp = (0) ; jTmp<nNbrBoxes; jTmp++)
...
# 176 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 lbl_11: int jBox; register_stack_var("ljForce|jBox|0", &____must_checkpoint_ljForce_jBox_0, "i32", (void *)(&jBox), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_12; } jBox = (nbrBoxes[jTmp]) ;
...
# 180 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 lbl_12: int nJBox; register_stack_var("ljForce|nJBox|0", &____must_checkpoint_ljForce_nJBox_0, "i32", (void *)(&nJBox), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_13; } nJBox = (s->boxes->nAtoms[jBox]) ;
...
# 184 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 { lbl_13: int iOff; register_stack_var("ljForce|iOff|0", &____must_checkpoint_ljForce_iOff_0, "i32", (void *)(&iOff), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_14; } int ii; for ( iOff = (iBox * 64) , ii = (0) ; ii<nIBox; ii++,iOff++)
...
# 186 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 lbl_14: int iId; register_stack_var("ljForce|iId|0", &____must_checkpoint_ljForce_iId_0, "i32", (void *)(&iId), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_15; } iId = (s->atoms->gid[iOff]) ;
...
# 188 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 { lbl_15: int jOff; register_stack_var("ljForce|jOff|0", &____must_checkpoint_ljForce_jOff_0, "i32", (void *)(&jOff), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_16; } lbl_16: int ij; register_stack_var("ljForce|ij|0", &____must_checkpoint_ljForce_ij_0, "i32", (void *)(&ij), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_17; } for ( jOff = (64 * jBox) , ij = (0) ; ij<nJBox; ij++,jOff++)
...
# 190 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 lbl_17: real_t dr[3]; register_stack_var("ljForce|dr|0", &____must_checkpoint_ljForce_dr_0, "[3 x double]", (void *)(dr), (size_t)24, 0, 0, 0); if (____chimes_replaying) { goto lbl_18; } ;
# 191 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 lbl_18: int jId; register_stack_var("ljForce|jId|0", &____must_checkpoint_ljForce_jId_0, "i32", (void *)(&jId), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_19; } jId = (s->atoms->gid[jOff]) ;
...
# 194 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 lbl_19: real_t r2; register_stack_var("ljForce|r2|0", &____must_checkpoint_ljForce_r2_0, "double", (void *)(&r2), (size_t)8, 0, 0, 0); if (____chimes_replaying) { goto lbl_20; } r2 = (0.) ;
# 195 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 { lbl_20: int m; register_stack_var("ljForce|m|0", &____must_checkpoint_ljForce_m_0, "i32", (void *)(&m), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_21; } for ( m = (0) ; m<3; m++)
...
# 206 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 lbl_21: real_t r6; register_stack_var("ljForce|r6|0", &____must_checkpoint_ljForce_r6_0, "double", (void *)(&r6), (size_t)8, 0, 0, 0); if (____chimes_replaying) { goto lbl_22; } r6 = (s6 * (r2 * r2 * r2)) ;
# 207 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 lbl_22: real_t eLocal; register_stack_var("ljForce|eLocal|0", &____must_checkpoint_ljForce_eLocal_0, "double", (void *)(&eLocal), (size_t)8, 0, 0, 0); if (____chimes_replaying) { goto lbl_23; } eLocal = (r6 * (r6 - 1.) - eShift) ;
...
# 219 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 lbl_23: real_t fr; register_stack_var("ljForce|fr|0", &____must_checkpoint_ljForce_fr_0, "double", (void *)(&fr), (size_t)8, 0, 0, 0); if (____chimes_replaying) { goto lbl_24; } fr = (-4. * epsilon * r6 * r2 * (12. * r6 - 6.)) ;
# 220 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 { lbl_24: int m; register_stack_var("ljForce|m|1", &____must_checkpoint_ljForce_m_1, "i32", (void *)(&m), (size_t)4, 0, 0, 0); if (____chimes_replaying) { switch(get_next_call()) { case(1): { goto call_lbl_1; } case(3): { goto call_lbl_3; } default: { chimes_error(); } } } for ( m = (0) ; m<3; m++)
