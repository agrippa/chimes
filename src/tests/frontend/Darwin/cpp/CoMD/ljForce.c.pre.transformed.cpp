...
# 155 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 { lbl_3: int ii; if (____must_checkpoint_ljForce_ii_0 != 0) { register_stack_var("ljForce|ii|0", &____must_checkpoint_ljForce_ii_0, "i32", (void *)(&ii), (size_t)4, 0, 0, 0); } if (____chimes_replaying) { goto lbl_4; } for ( ii = (0) ; ii<fSize; ++ii)
...
# 161 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 lbl_4: real_t s6; if (____must_checkpoint_ljForce_s6_0 != 0) { register_stack_var("ljForce|s6|0", &____must_checkpoint_ljForce_s6_0, "double", (void *)(&s6), (size_t)8, 0, 0, 0); } if (____chimes_replaying) { goto lbl_5; } s6 = (sigma * sigma * sigma * sigma * sigma * sigma) ;
...
# 164 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 lbl_5: real_t eShift; if (____must_checkpoint_ljForce_eShift_0 != 0) { register_stack_var("ljForce|eShift|0", &____must_checkpoint_ljForce_eShift_0, "double", (void *)(&eShift), (size_t)8, 0, 0, 0); } if (____chimes_replaying) { goto lbl_6; } eShift = (1. * rCut6 * (rCut6 - 1.)) ;
...
# 166 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 lbl_6: int nbrBoxes[27]; if (____must_checkpoint_ljForce_nbrBoxes_0 != 0) { register_stack_var("ljForce|nbrBoxes|0", &____must_checkpoint_ljForce_nbrBoxes_0, "[27 x i32]", (void *)(nbrBoxes), (size_t)108, 0, 0, 0); } if (____chimes_replaying) { goto lbl_7; } ;
...
# 168 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 { lbl_7: int iBox; if (____must_checkpoint_ljForce_iBox_0 != 0) { register_stack_var("ljForce|iBox|0", &____must_checkpoint_ljForce_iBox_0, "i32", (void *)(&iBox), (size_t)4, 0, 0, 0); } if (____chimes_replaying) { goto lbl_8; } for ( iBox = (0) ; iBox<s->boxes->nLocalBoxes; iBox++)
...
# 170 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 lbl_8: int nIBox; if (____must_checkpoint_ljForce_nIBox_0 != 0) { register_stack_var("ljForce|nIBox|0", &____must_checkpoint_ljForce_nIBox_0, "i32", (void *)(&nIBox), (size_t)4, 0, 0, 0); } if (____chimes_replaying) { goto lbl_9; } nIBox = (s->boxes->nAtoms[iBox]) ;
...
# 174 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 { lbl_10: int jTmp; if (____must_checkpoint_ljForce_jTmp_0 != 0) { register_stack_var("ljForce|jTmp|0", &____must_checkpoint_ljForce_jTmp_0, "i32", (void *)(&jTmp), (size_t)4, 0, 0, 0); } if (____chimes_replaying) { goto lbl_11; } for ( jTmp = (0) ; jTmp<nNbrBoxes; jTmp++)
...
# 176 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 lbl_11: int jBox; if (____must_checkpoint_ljForce_jBox_0 != 0) { register_stack_var("ljForce|jBox|0", &____must_checkpoint_ljForce_jBox_0, "i32", (void *)(&jBox), (size_t)4, 0, 0, 0); } if (____chimes_replaying) { goto lbl_12; } jBox = (nbrBoxes[jTmp]) ;
...
# 180 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 lbl_12: int nJBox; if (____must_checkpoint_ljForce_nJBox_0 != 0) { register_stack_var("ljForce|nJBox|0", &____must_checkpoint_ljForce_nJBox_0, "i32", (void *)(&nJBox), (size_t)4, 0, 0, 0); } if (____chimes_replaying) { goto lbl_13; } nJBox = (s->boxes->nAtoms[jBox]) ;
...
# 184 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/ljForce.c"
 { lbl_13: int iOff; if (____must_checkpoint_ljForce_iOff_0 != 0) { register_stack_var("ljForce|iOff|0", &____must_checkpoint_ljForce_iOff_0, "i32", (void *)(&iOff), (size_t)4, 0, 0, 0); } if (____chimes_replaying) { goto lbl_14; } int ii; for ( iOff = (iBox * 64) , ii = (0) ; ii<nIBox; ii++,iOff++)
