...
{new_stack((void *)(&printPerformanceResultsYaml), 1, 1, (size_t)(17287627617634550259UL), "printPerformanceResultsYaml|file|0", "%struct.__sFILE*", (void *)(&file), (size_t)8, 1, 0, 0); if (____chimes_replaying) { goto lbl_0; }
...
# 245 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/performanceTimers.c"
 lbl_0: struct timeval ptime; register_stack_var("getTime|ptime|0", "%struct.timeval = type { i64, i32 }", (void *)(&ptime), (size_t)16, 0, 1, 0); if (____chimes_replaying) { switch(get_next_call()) { case(1): { goto call_lbl_1; } default: { chimes_error(); } } } ;
