...
static int ____must_manage_timestep = 2;
...
# 12 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/timestep.c"
...
{new_stack((void *)(&timestep), "timestep", &____must_manage_timestep, 3, 3, (size_t)(8093288458141874007UL), (size_t)(0UL), (size_t)(0UL), "timestep|s|0", &____must_checkpoint_timestep_s_0, "%struct.SimFlatSt*", (void *)(&s), (size_t)8, 1, 0, 0, "timestep|nSteps|0", &____must_checkpoint_timestep_nSteps_0, "i32", (void *)(&nSteps), (size_t)4, 0, 0, 0, "timestep|dt|0", &____must_checkpoint_timestep_dt_0, "double", (void *)(&dt), (size_t)8, 0, 0, 0); if (____chimes_replaying) { goto lbl_0; }
# 33 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/timestep.c"
 { lbl_0: int ii; if (____must_checkpoint_timestep_ii_0 != 0) { register_stack_var("timestep|ii|0", &____must_checkpoint_timestep_ii_0, "i32", (void *)(&ii), (size_t)4, 0, 0, 0); } if (____chimes_replaying) { switch(get_next_call()) { case(2): { goto call_lbl_2; } case(3): { goto call_lbl_3; } case(4): { goto call_lbl_4; } case(5): { goto call_lbl_5; } case(6): { goto call_lbl_6; } case(7): { goto call_lbl_7; } case(8): { goto call_lbl_8; } case(9): { goto call_lbl_9; } case(10): { goto call_lbl_10; } case(11): { goto call_lbl_11; } case(12): { goto call_lbl_12; } case(13): { goto call_lbl_13; } case(14): { goto call_lbl_14; } case(15): { goto call_lbl_15; } case(16): { goto call_lbl_16; } case(18): { goto call_lbl_18; } default: { chimes_error(); } } } for ( ii = (0) ; ii<nSteps; ++ii)
...
# 36 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/timestep.c"
 call_lbl_3: calling((void*)&advanceVelocity, 3, 0UL, 3, (size_t)(8093288458141874007UL), (size_t)(0UL), (size_t)(0UL)); advanceVelocity(s, s->boxes->nLocalBoxes, 0.5*dt);
...
# 40 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/timestep.c"
 call_lbl_6: calling((void*)&advancePosition, 6, 0UL, 3, (size_t)(8093288458141874007UL), (size_t)(0UL), (size_t)(0UL)); advancePosition(s, s->boxes->nLocalBoxes, dt);
...
# 48 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/timestep.c"
 call_lbl_12: calling((void*)&computeForce, 12, 0UL, 1, (size_t)(8093288458141874007UL)); computeForce(s);
...
# 52 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/timestep.c"
 call_lbl_15: calling((void*)&advanceVelocity, 15, 0UL, 3, (size_t)(8093288458141874007UL), (size_t)(0UL), (size_t)(0UL)); advanceVelocity(s, s->boxes->nLocalBoxes, 0.5*dt);
...
# 56 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/timestep.c"
 alias_group_changed(____alias_loc_id_1); call_lbl_18: calling((void*)&kineticEnergy, 18, 0UL, 1, (size_t)(8093288458141874007UL)); kineticEnergy(s);
...
# 58 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/timestep.c"
 rm_stack(false, 0UL, "timestep", &____must_manage_timestep, 0); return s->ePotential;
...
{new_stack((void *)(&computeForce), "computeForce", (int *)0x0, 1, 0, (size_t)(8093288458141874426UL)); if (____chimes_replaying) { switch(get_next_call()) { case(2): { goto call_lbl_2; } default: { chimes_error(); } } }
# 63 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/timestep.c"
 alias_group_changed(____alias_loc_id_4); call_lbl_2: calling((void*)s->pot->force, 2, 0UL, 1, (size_t)(8093288458141874426UL)); s->pot->force(s);
# 64 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/timestep.c"
rm_stack(false, 0UL, "computeForce", (int *)0x0, 0); }
...
{new_stack((void *)(&advanceVelocity), "advanceVelocity", &____must_manage_advanceVelocity, 3, 0, (size_t)(8093288458141874205UL), (size_t)(0UL), (size_t)(0UL)); if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } }
...
rm_stack(false, 0UL, "advanceVelocity", &____must_manage_advanceVelocity, ____alias_loc_id_6); }
...
{new_stack((void *)(&advancePosition), "advancePosition", &____must_manage_advancePosition, 3, 0, (size_t)(8093288458141874363UL), (size_t)(0UL), (size_t)(0UL)); if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } }
...
rm_stack(false, 0UL, "advancePosition", &____must_manage_advancePosition, ____alias_loc_id_7); }
...
{new_stack((void *)(&kineticEnergy), "kineticEnergy", &____must_manage_kineticEnergy, 1, 1, (size_t)(8093288458141874593UL), "kineticEnergy|s|0", &____must_checkpoint_kineticEnergy_s_0, "%struct.SimFlatSt*", (void *)(&s), (size_t)8, 1, 0, 0); if (____chimes_replaying) { goto lbl_0; }
# 99 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/timestep.c"
 lbl_0: real_t eLocal[2]; if (____must_checkpoint_kineticEnergy_eLocal_0 != 0) { register_stack_var("kineticEnergy|eLocal|0", &____must_checkpoint_kineticEnergy_eLocal_0, "[2 x double]", (void *)(eLocal), (size_t)16, 0, 0, 0); } if (____chimes_replaying) { goto lbl_1; } ;
...
# 114 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/timestep.c"
 lbl_1: real_t eSum[2]; if (____chimes_replaying) { switch(get_next_call()) { case(2): { goto call_lbl_2; } case(3): { goto call_lbl_3; } case(4): { goto call_lbl_4; } default: { chimes_error(); } } } ;
...
# 116 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/timestep.c"
 call_lbl_3: calling((void*)&addRealParallel, 3, 0UL, 3, (size_t)(8093288458141874428UL), (size_t)(8093288458141874434UL), (size_t)(0UL)); addRealParallel(eLocal, eSum, 2);
...
rm_stack(false, 0UL, "kineticEnergy", &____must_manage_kineticEnergy, ____alias_loc_id_9); }
...
{new_stack((void *)(&redistributeAtoms), "redistributeAtoms", &____must_manage_redistributeAtoms, 1, 1, (size_t)(8093288458141874380UL), "redistributeAtoms|sim|0", &____must_checkpoint_redistributeAtoms_sim_0, "%struct.SimFlatSt*", (void *)(&sim), (size_t)8, 1, 0, 0); if (____chimes_replaying) { goto lbl_0; }
# 138 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/timestep.c"
 alias_group_changed(____alias_loc_id_2); call_lbl_2: calling((void*)&updateLinkCells, 2, 0UL, 2, (size_t)(8093288458141874382UL), (size_t)(8093288458141874382UL)); updateLinkCells(sim->boxes, sim->atoms);
...
# 141 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/timestep.c"
 call_lbl_4: calling((void*)&haloExchange, 4, 0UL, 2, (size_t)(8093288458141874382UL), (size_t)(8093288458141874380UL)); haloExchange(sim->atomExchange, sim);
...
# 144 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/timestep.c"
 { lbl_0: int ii; if (____must_checkpoint_redistributeAtoms_ii_0 != 0) { register_stack_var("redistributeAtoms|ii|0", &____must_checkpoint_redistributeAtoms_ii_0, "i32", (void *)(&ii), (size_t)4, 0, 0, 0); } if (____chimes_replaying) { switch(get_next_call()) { case(2): { goto call_lbl_2; } case(3): { goto call_lbl_3; } case(4): { goto call_lbl_4; } case(5): { goto call_lbl_5; } case(7): { goto call_lbl_7; } default: { chimes_error(); } } } for ( ii = (0) ;ii < sim->boxes->nTotalBoxes; ++ii) { alias_group_changed(____alias_loc_id_3); call_lbl_7: calling((void*)&sortAtomsInCell, 7, 0UL, 3, (size_t)(8093288458141874382UL), (size_t)(8093288458141874382UL), (size_t)(0UL)); sortAtomsInCell(sim->atoms, sim->boxes, ii); } };
# 146 "/Users/jmg3/num-debug/src/examples/cpp/CoMD/src-mpi/timestep.c"
rm_stack(false, 0UL, "redistributeAtoms", &____must_manage_redistributeAtoms, ____alias_loc_id_8); }


static int module_init() {
    init_module(8093288458141873986UL, 16, 6, 8, 6, 11, 8093288458141873986UL + 380UL, 8093288458141873986UL + 394UL, 8093288458141873986UL + 607UL, 8093288458141873986UL + 494UL, 8093288458141873986UL + 268UL, 8093288458141873986UL + 270UL, 8093288458141873986UL + 21UL, 8093288458141873986UL + 24UL, 8093288458141873986UL + 429UL, 8093288458141873986UL + 440UL, 8093288458141873986UL + 95UL, 8093288458141873986UL + 219UL, 8093288458141873986UL + 441UL, 8093288458141873986UL + 607UL, 8093288458141873986UL + 440UL, 8093288458141873986UL + 434UL, 8093288458141873986UL + 219UL, 8093288458141873986UL + 138UL, 8093288458141873986UL + 1UL, 8093288458141873986UL + 21UL, 8093288458141873986UL + 394UL, 8093288458141873986UL + 396UL, 8093288458141873986UL + 494UL, 8093288458141873986UL + 496UL, 8093288458141873986UL + 434UL, 8093288458141873986UL + 436UL, 8093288458141873986UL + 138UL, 8093288458141873986UL + 140UL, 8093288458141873986UL + 223UL, 8093288458141873986UL + 377UL, 8093288458141873986UL + 377UL, 8093288458141873986UL + 268UL, "AtomsSt", 8, "int", (int)__builtin_offsetof(struct AtomsSt, nLocal), "int", (int)__builtin_offsetof(struct AtomsSt, nGlobal), "int*", (int)__builtin_offsetof(struct AtomsSt, gid), "int*", (int)__builtin_offsetof(struct AtomsSt, iSpecies), "[ 3 x double ]*", (int)__builtin_offsetof(struct AtomsSt, r), "[ 3 x double ]*", (int)__builtin_offsetof(struct AtomsSt, p), "[ 3 x double ]*", (int)__builtin_offsetof(struct AtomsSt, f), "double*", (int)__builtin_offsetof(struct AtomsSt, U), "BasePotentialSt", 9, "double", (int)__builtin_offsetof(struct BasePotentialSt, cutoff), "double", (int)__builtin_offsetof(struct BasePotentialSt, mass), "double", (int)__builtin_offsetof(struct BasePotentialSt, lat), "[ 8 x char ]", (int)__builtin_offsetof(struct BasePotentialSt, latticeType), "[ 3 x char ]", (int)__builtin_offsetof(struct BasePotentialSt, name), "int", (int)__builtin_offsetof(struct BasePotentialSt, atomicNo), "*", (int)__builtin_offsetof(struct BasePotentialSt, force), "*", (int)__builtin_offsetof(struct BasePotentialSt, print), "*", (int)__builtin_offsetof(struct BasePotentialSt, destroy), "DomainSt", 8, "[ 3 x int ]", (int)__builtin_offsetof(struct DomainSt, procGrid), "[ 3 x int ]", (int)__builtin_offsetof(struct DomainSt, procCoord), "[ 3 x double ]", (int)__builtin_offsetof(struct DomainSt, globalMin), "[ 3 x double ]", (int)__builtin_offsetof(struct DomainSt, globalMax), "[ 3 x double ]", (int)__builtin_offsetof(struct DomainSt, globalExtent), "[ 3 x double ]", (int)__builtin_offsetof(struct DomainSt, localMin), "[ 3 x double ]", (int)__builtin_offsetof(struct DomainSt, localMax), "[ 3 x double ]", (int)__builtin_offsetof(struct DomainSt, localExtent), "HaloExchangeSt", 5, "[ 6 x int ]", (int)__builtin_offsetof(struct HaloExchangeSt, nbrRank), "int", (int)__builtin_offsetof(struct HaloExchangeSt, bufCapacity), "*", (int)__builtin_offsetof(struct HaloExchangeSt, loadBuffer), "*", (int)__builtin_offsetof(struct HaloExchangeSt, unloadBuffer), "*", (int)__builtin_offsetof(struct HaloExchangeSt, destroy), "LinkCellSt", 9, "[ 3 x int ]", (int)__builtin_offsetof(struct LinkCellSt, gridSize), "int", (int)__builtin_offsetof(struct LinkCellSt, nLocalBoxes), "int", (int)__builtin_offsetof(struct LinkCellSt, nHaloBoxes), "int", (int)__builtin_offsetof(struct LinkCellSt, nTotalBoxes), "[ 3 x double ]", (int)__builtin_offsetof(struct LinkCellSt, localMin), "[ 3 x double ]", (int)__builtin_offsetof(struct LinkCellSt, localMax), "[ 3 x double ]", (int)__builtin_offsetof(struct LinkCellSt, boxSize), "[ 3 x double ]", (int)__builtin_offsetof(struct LinkCellSt, invBoxSize), "int*", (int)__builtin_offsetof(struct LinkCellSt, nAtoms), "SimFlatSt", 11, "int", (int)__builtin_offsetof(struct SimFlatSt, nSteps), "int", (int)__builtin_offsetof(struct SimFlatSt, printRate), "double", (int)__builtin_offsetof(struct SimFlatSt, dt), "%struct.DomainSt*", (int)__builtin_offsetof(struct SimFlatSt, domain), "%struct.LinkCellSt*", (int)__builtin_offsetof(struct SimFlatSt, boxes), "%struct.AtomsSt*", (int)__builtin_offsetof(struct SimFlatSt, atoms), "%struct.SpeciesDataSt*", (int)__builtin_offsetof(struct SimFlatSt, species), "double", (int)__builtin_offsetof(struct SimFlatSt, ePotential), "double", (int)__builtin_offsetof(struct SimFlatSt, eKinetic), "%struct.BasePotentialSt*", (int)__builtin_offsetof(struct SimFlatSt, pot), "%struct.HaloExchangeSt*", (int)__builtin_offsetof(struct SimFlatSt, atomExchange), "SpeciesDataSt", 3, "[ 3 x char ]", (int)__builtin_offsetof(struct SpeciesDataSt, name), "int", (int)__builtin_offsetof(struct SpeciesDataSt, atomicNo), "double", (int)__builtin_offsetof(struct SpeciesDataSt, mass), "TimerHandle", 0, "__sFILE", 19, "unsigned char*", (int)__builtin_offsetof(struct __sFILE, _p), "int", (int)__builtin_offsetof(struct __sFILE, _r), "int", (int)__builtin_offsetof(struct __sFILE, _w), "short", (int)__builtin_offsetof(struct __sFILE, _flags), "short", (int)__builtin_offsetof(struct __sFILE, _file), "%struct.__sbuf", (int)__builtin_offsetof(struct __sFILE, _bf), "int", (int)__builtin_offsetof(struct __sFILE, _lbfsize), "*", (int)__builtin_offsetof(struct __sFILE, _close), "*", (int)__builtin_offsetof(struct __sFILE, _read), "*", (int)__builtin_offsetof(struct __sFILE, _seek), "*", (int)__builtin_offsetof(struct __sFILE, _write), "%struct.__sbuf", (int)__builtin_offsetof(struct __sFILE, _ub), "%struct.__sFILEX*", (int)__builtin_offsetof(struct __sFILE, _extra), "int", (int)__builtin_offsetof(struct __sFILE, _ur), "[ 3 x unsigned char ]", (int)__builtin_offsetof(struct __sFILE, _ubuf), "[ 1 x unsigned char ]", (int)__builtin_offsetof(struct __sFILE, _nbuf), "%struct.__sbuf", (int)__builtin_offsetof(struct __sFILE, _lb), "int", (int)__builtin_offsetof(struct __sFILE, _blksize), "long long int", (int)__builtin_offsetof(struct __sFILE, _offset), "__sFILEX", 0, "__sbuf", 2, "unsigned char*", (int)__builtin_offsetof(struct __sbuf, _base), "int", (int)__builtin_offsetof(struct __sbuf, _size), "timestep", 7, "advancePosition", "advanceVelocity", "computeForce", "kineticEnergy", "profileStart", "profileStop", "redistributeAtoms", "advancePosition", 0, "kineticEnergy", 3, "addRealParallel", "profileStart", "profileStop", "computeForce", 0, "redistributeAtoms", 5, "haloExchange", "profileStart", "profileStop", "sortAtomsInCell", "updateLinkCells", "advanceVelocity", 0, "timestep|s|0", 5, "redistributeAtoms", "profileStop", "profileStart", "kineticEnergy", "computeForce", "timestep|nSteps|0", 5, "redistributeAtoms", "profileStop", "profileStart", "kineticEnergy", "computeForce", "timestep|dt|0", 5, "redistributeAtoms", "profileStop", "profileStart", "kineticEnergy", "computeForce", "timestep|ii|0", 5, "redistributeAtoms", "profileStop", "profileStart", "kineticEnergy", "computeForce", "redistributeAtoms|sim|0", 5, "updateLinkCells", "sortAtomsInCell", "profileStop", "profileStart", "haloExchange", "redistributeAtoms|ii|0", 1, "sortAtomsInCell", "kineticEnergy|s|0", 3, "profileStop", "profileStart", "addRealParallel", "kineticEnergy|eLocal|0", 1, "kineticEnergy", &____alias_loc_id_0, (unsigned)4, 8093288458141873986UL + 1UL, 8093288458141873986UL + 2UL, 8093288458141873986UL + 3UL, 8093288458141873986UL + 4UL, &____alias_loc_id_1, (unsigned)4, 8093288458141873986UL + 1UL, 8093288458141873986UL + 2UL, 8093288458141873986UL + 3UL, 8093288458141873986UL + 4UL, &____alias_loc_id_2, (unsigned)1, 8093288458141873986UL + 380UL, &____alias_loc_id_3, (unsigned)1, 8093288458141873986UL + 381UL, &____alias_loc_id_4, (unsigned)1, 8093288458141873986UL + 429UL, &____alias_loc_id_5, (unsigned)7, 8093288458141873986UL + 441UL, 8093288458141873986UL + 442UL, 8093288458141873986UL + 443UL, 8093288458141873986UL + 444UL, 8093288458141873986UL + 445UL, 8093288458141873986UL + 446UL, 8093288458141873986UL + 447UL, &____alias_loc_id_6, (unsigned)7, 8093288458141873986UL + 95UL, 8093288458141873986UL + 96UL, 8093288458141873986UL + 97UL, 8093288458141873986UL + 98UL, 8093288458141873986UL + 99UL, 8093288458141873986UL + 100UL, 8093288458141873986UL + 140UL, &____alias_loc_id_7, (unsigned)9, 8093288458141873986UL + 223UL, 8093288458141873986UL + 224UL, 8093288458141873986UL + 225UL, 8093288458141873986UL + 226UL, 8093288458141873986UL + 227UL, 8093288458141873986UL + 228UL, 8093288458141873986UL + 229UL, 8093288458141873986UL + 230UL, 8093288458141873986UL + 270UL, &____alias_loc_id_8, (unsigned)1, 8093288458141873986UL + 381UL, &____alias_loc_id_9, (unsigned)1, 8093288458141873986UL + 607UL);
    return 0;
}
