...
# 1334 "/Users/jmg3/num-debug/src/examples/cpp/lulesh/LULESH.cc"
 lbl_6: Real_t *z8n; register_stack_var("CalcHourglassControlForElems|z8n|0", "double*", (void *)(&z8n), (size_t)8, 1, 0, 0); if (____chimes_replaying) { switch(get_next_call()) { case(7): { goto call_lbl_7; } case(8): { goto call_lbl_8; } case(12): { goto call_lbl_12; } default: { chimes_error(); } } } z8n = ((Real_t *)malloc_wrapper(sizeof(Real_t) * numElem8, 16832839476487313797UL, 0, 0)) ;
...
# 1387 "/Users/jmg3/num-debug/src/examples/cpp/lulesh/LULESH.cc"
 lbl_3: Real_t *determ; register_stack_var("CalcVolumeForceForElems|determ|0", "double*", (void *)(&determ), (size_t)8, 1, 0, 0); if (____chimes_replaying) { switch(get_next_call()) { case(5): { goto call_lbl_5; } case(6): { goto call_lbl_6; } case(10): { goto call_lbl_10; } default: { chimes_error(); } } } determ = ((Real_t *)malloc_wrapper(sizeof(Real_t) * numElem, 16832839476487313437UL, 0, 0)) ;
...
# 1399 "/Users/jmg3/num-debug/src/examples/cpp/lulesh/LULESH.cc"
 alias_group_changed(7, (size_t)(16832839476487313373UL), (size_t)(16832839476487313374UL), (size_t)(16832839476487313375UL), (size_t)(16832839476487313376UL), (size_t)(16832839476487313377UL), (size_t)(16832839476487313378UL), (size_t)(16832839476487313379UL)); exit(VolumeError) ;
...
# 1403 "/Users/jmg3/num-debug/src/examples/cpp/lulesh/LULESH.cc"
 alias_group_changed(7, (size_t)(16832839476487313373UL), (size_t)(16832839476487313374UL), (size_t)(16832839476487313375UL), (size_t)(16832839476487313376UL), (size_t)(16832839476487313377UL), (size_t)(16832839476487313378UL), (size_t)(16832839476487313379UL)); call_lbl_10: calling((void*)&CalcHourglassControlForElems, 10, 0UL, 2, (size_t)(16832839476487313437UL), (size_t)(0UL)); CalcHourglassControlForElems(determ, hgcoef) ;
...
alias_group_changed(1, (size_t)(16832839476487313373UL)); rm_stack(false, 0UL); }
...
# 1822 "/Users/jmg3/num-debug/src/examples/cpp/lulesh/LULESH.cc"
 lbl_3: Real_t vdovthird; register_stack_var("CalcLagrangeElements|vdovthird|0", "double", (void *)(&vdovthird), (size_t)8, 0, 0, 0); if (____chimes_replaying) { switch(get_next_call()) { case(2): { goto call_lbl_2; } default: { chimes_error(); } } } vdovthird = (vdov / Real_t(3.)) ;
...
# 1833 "/Users/jmg3/num-debug/src/examples/cpp/lulesh/LULESH.cc"
 alias_group_changed(4, (size_t)(16832839476487307545UL), (size_t)(16832839476487307546UL), (size_t)(16832839476487307547UL), (size_t)(16832839476487307662UL)); exit(VolumeError) ;
...
# 2182 "/Users/jmg3/num-debug/src/examples/cpp/lulesh/LULESH.cc"
 alias_group_changed(2, (size_t)(16832839476487307638UL), (size_t)(16832839476487307639UL)); exit(QStopError) ;
...
# 2485 "/Users/jmg3/num-debug/src/examples/cpp/lulesh/LULESH.cc"
 lbl_0: Real_t *vnewc; register_stack_var("ApplyMaterialPropertiesForElems|vnewc|0", "double*", (void *)(&vnewc), (size_t)8, 1, 0, 0); if (____chimes_replaying) { switch(get_next_call()) { case(5): { goto call_lbl_5; } default: { chimes_error(); } } } vnewc = ((Real_t *)malloc_wrapper(sizeof(Real_t) * length, 16832839476487307734UL, 0, 0)) ;
...
# 2522 "/Users/jmg3/num-debug/src/examples/cpp/lulesh/LULESH.cc"
 alias_group_changed(12, (size_t)(16832839476487307683UL), (size_t)(16832839476487307684UL), (size_t)(16832839476487307685UL), (size_t)(16832839476487307686UL), (size_t)(16832839476487307687UL), (size_t)(16832839476487307688UL), (size_t)(16832839476487307689UL), (size_t)(16832839476487307690UL), (size_t)(16832839476487307691UL), (size_t)(16832839476487307692UL), (size_t)(16832839476487307693UL), (size_t)(16832839476487307734UL)); call_lbl_5: calling((void*)&EvalEOSForElems, 5, 0UL, 2, (size_t)(16832839476487307734UL), (size_t)(0UL)); EvalEOSForElems(vnewc, length);
...
alias_group_changed(1, (size_t)(16832839476487307683UL)); rm_stack(false, 0UL); }
...
# 2878 "/Users/jmg3/num-debug/src/examples/cpp/lulesh/LULESH.cc"
 call_lbl_12: calling((void*)&TimeIncrement, 12, 0UL, 0); TimeIncrement() ;
# 2879 "/Users/jmg3/num-debug/src/examples/cpp/lulesh/LULESH.cc"
 call_lbl_13: calling((void*)&LagrangeLeapFrog, 13, 0UL, 0); LagrangeLeapFrog() ;
...
# 2909 "/Users/jmg3/num-debug/src/examples/cpp/lulesh/LULESH.cc"
 alias_group_changed(9, (size_t)(16832839476487306171UL), (size_t)(16832839476487306172UL), (size_t)(16832839476487306173UL), (size_t)(16832839476487306174UL), (size_t)(16832839476487306175UL), (size_t)(16832839476487306176UL), (size_t)(16832839476487306177UL), (size_t)(16832839476487306178UL), (size_t)(16832839476487306179UL)); lbl_47: Real_t AbsDiff; register_stack_var("main|AbsDiff|0", "double", (void *)(&AbsDiff), (size_t)8, 0, 0, 0); if (____chimes_replaying) { goto lbl_48; } call_lbl_22: calling((void*)&FABS, 22, 0UL, 1, (size_t)(0UL)); AbsDiff = (FABS(mesh.e[j * edgeElems + k] - mesh.e[k * edgeElems + j])) ;
...
# 2914 "/Users/jmg3/num-debug/src/examples/cpp/lulesh/LULESH.cc"
 lbl_48: Real_t RelDiff; register_stack_var("main|RelDiff|0", "double", (void *)(&RelDiff), (size_t)8, 0, 0, 0); if (____chimes_replaying) { switch(get_next_call()) { case(5): { goto call_lbl_5; } case(6): { goto call_lbl_6; } case(7): { goto call_lbl_7; } case(8): { goto call_lbl_8; } case(9): { goto call_lbl_9; } case(11): { goto call_lbl_11; } case(12): { goto call_lbl_12; } case(13): { goto call_lbl_13; } case(14): { goto call_lbl_14; } case(15): { goto call_lbl_15; } case(22): { goto call_lbl_22; } default: { chimes_error(); } } } RelDiff = (AbsDiff / mesh.e[k * edgeElems + j]) ;
