...
int foo_quick(int *a, int s) {const int ____chimes_did_disable0 = new_stack((void *)(&foo), "foo", &____must_manage_foo, 2, 0, (size_t)(11947780893324068249UL), (size_t)(0UL)) ; ; ;
# 5 "/Users/jmg3/num-debug/src/examples/cpp/call_passed_directly_to_call.cpp"
    *a = s;
# 6 "/Users/jmg3/num-debug/src/examples/cpp/call_passed_directly_to_call.cpp"
rm_stack(false, 0UL, "foo", &____must_manage_foo, ____alias_loc_id_1, ____chimes_did_disable0); }
...
static int module_init() {
    init_module(11947780893324068234UL, 2, 3, 1, 2, 2, 0, 2, 2, 0, 0,
                           &____alias_loc_id_0, (unsigned)4, (unsigned)1, (11947780893324068234UL + 20UL), (11947780893324068234UL + 21UL), (11947780893324068234UL + 22UL), (11947780893324068234UL + 24UL), "foo", (unsigned)1, (11947780893324068234UL + 23UL),
                           &____alias_loc_id_1, (unsigned)3, (unsigned)0, (11947780893324068234UL + 2UL), (11947780893324068234UL + 3UL), (11947780893324068234UL + 15UL),
                            "foo", (void *)(&foo_npm), (void *)__null, 0, 2, (11947780893324068234UL + 15UL), 0UL, 0UL, 0,
                            "bar", (void *)(&bar_npm), (void *)__null, 0, 0, 0UL, 0,
                           "foo", &(____chimes_does_checkpoint_foo_npm),
                           "bar", &(____chimes_does_checkpoint_bar_npm),
                             (11947780893324068234UL + 2UL), (11947780893324068234UL + 15UL),
                             (11947780893324068234UL + 22UL), (11947780893324068234UL + 50UL),
                             "main", "main", 3, "bar", "foo", "checkpoint",
                             "foo", "_Z3fooPii", 0,
                             "bar", "_Z3barv", 0,
                        "main|b|0", 1, "main",
        "bar", 0UL, (int)0,
        "foo", 0UL, (int)2, 11947780893324068257UL, 0UL);
    return 0;
}
