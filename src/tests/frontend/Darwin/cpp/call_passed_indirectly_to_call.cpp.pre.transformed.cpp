...
# 15 "/Users/jmg3/num-debug/src/examples/cpp/call_passed_indirectly_to_call.cpp"
 int ____chimes_unroll_var_0; ____chimes_unroll_var_0 = (({ calling_npm(0, 0); bar_npm(); })) ; ({ calling_npm(1, 0, 15092453942527021228UL, 15092453942527021220UL); foo_npm(&b, ____chimes_unroll_var_0 + 9); });
