...
int main(int argc, char **argv) {init_chimes(); new_stack(2, 2, (size_t)(0UL), (size_t)(26UL), "main|argc|0", "i32", (void *)(&argc), (size_t)4, 0, 0, 0, "main|argv|0", "i8**", (void *)(&argv), (size_t)8, 1, 0, 0); if (____chimes_replaying) { goto lbl_0; }
# 4 "/Users/jmg3/num-debug/src/examples/cpp/calloc.cpp"
 lbl_0: int *alloc; register_stack_var("main|alloc|0", "i32*", (void *)(&alloc), (size_t)8, 1, 0, 0); if (____chimes_replaying) { switch(get_next_call()) { case(0): { goto call_lbl_0; } default: { exit(42); } } } alloc = ((int *)calloc_wrapper(10, sizeof(int), 11UL, 0, 0));
...
# 11 "/Users/jmg3/num-debug/src/examples/cpp/calloc.cpp"
 alias_group_changed(1, (size_t)(11UL)); rm_stack(false, 0UL); return alloc[1];
# 12 "/Users/jmg3/num-debug/src/examples/cpp/calloc.cpp"
}


static int module_init() {
    init_module(2173952053329873801UL, 2, 0, 3UL, 26UL, 4UL, 11UL);
    return 0;
}
