...
# 47 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
 lbl_2: int i; register_stack_var("seconds|i|0", "i32", (void *)(&i), (size_t)4, 0, 0, 0); if (____chimes_replaying) { switch(get_next_call()) { case(1): { goto call_lbl_1; } default: { chimes_error(); } } } call_lbl_1: calling((void*)&gettimeofday, 1, 0UL, 2, (size_t)(7724169104006700303UL), (size_t)(7724169104006700304UL)); i = (gettimeofday(&tp, &tzp)) ;
...
void ricker_wavelet(float *source, int nsteps, float dt, float freq) {new_stack((void *)(&ricker_wavelet), 4, 4, (size_t)(7724169104006700394UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), "ricker_wavelet|source|0", "float*", (void *)(&source), (size_t)8, 1, 0, 0, "ricker_wavelet|nsteps|0", "i32", (void *)(&nsteps), (size_t)4, 0, 0, 0, "ricker_wavelet|dt|0", "float", (void *)(&dt), (size_t)4, 0, 0, 0, "ricker_wavelet|freq|0", "float", (void *)(&freq), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_0; }
...
void parse_source(char *optarg, source *out) {new_stack((void *)(&parse_source), 2, 2, (size_t)(7724169104006700488UL), (size_t)(7724169104006700489UL), "parse_source|optarg|0", "i8*", (void *)(&optarg), (size_t)8, 1, 0, 0, "parse_source|out|0", "%struct._source*", (void *)(&out), (size_t)8, 1, 0, 0); if (____chimes_replaying) { goto lbl_0; }
...
# 64 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
 alias_group_changed(3, (size_t)(7724169104006700399UL), (size_t)(7724169104006700400UL), (size_t)(7724169104006700401UL)); lbl_1: char *first_comma; register_stack_var("parse_source|first_comma|0", "i8*", (void *)(&first_comma), (size_t)8, 1, 0, 0); if (____chimes_replaying) { goto lbl_2; } first_comma = (strchr(x_str, ',')) ;
...
# 68 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
 alias_group_changed(2, (size_t)(7724169104006700402UL), (size_t)(7724169104006700403UL)); exit(1);
...
# 71 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
 alias_group_changed(2, (size_t)(7724169104006700402UL), (size_t)(7724169104006700403UL)); lbl_3: char *second_comma; register_stack_var("parse_source|second_comma|0", "i8*", (void *)(&second_comma), (size_t)8, 1, 0, 0); if (____chimes_replaying) { goto lbl_4; } second_comma = (strchr(y_str, ',')) ;
...
# 75 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
 alias_group_changed(2, (size_t)(7724169104006700404UL), (size_t)(7724169104006700405UL)); exit(1);
...
# 78 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
 alias_group_changed(2, (size_t)(7724169104006700404UL), (size_t)(7724169104006700405UL)); lbl_5: char *third_comma; register_stack_var("parse_source|third_comma|0", "i8*", (void *)(&third_comma), (size_t)8, 1, 0, 0); if (____chimes_replaying) { goto lbl_6; } third_comma = (strchr(freq_str, ',')) ;
...
# 82 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
 alias_group_changed(5, (size_t)(7724169104006700406UL), (size_t)(7724169104006700407UL), (size_t)(7724169104006700417UL), (size_t)(7724169104006700457UL), (size_t)(7724169104006700476UL)); exit(1);
...
float **sample_sources(source *srcs, int nsrcs, int nsteps, float dt) {new_stack((void *)(&sample_sources), 4, 4, (size_t)(7724169104006700702UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), "sample_sources|srcs|0", "%struct._source*", (void *)(&srcs), (size_t)8, 1, 0, 0, "sample_sources|nsrcs|0", "i32", (void *)(&nsrcs), (size_t)4, 0, 0, 0, "sample_sources|nsteps|0", "i32", (void *)(&nsteps), (size_t)4, 0, 0, 0, "sample_sources|dt|0", "float", (void *)(&dt), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_0; }
# 128 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
 lbl_0: float **src_samples; register_stack_var("sample_sources|src_samples|0", "float**", (void *)(&src_samples), (size_t)8, 1, 0, 0); if (____chimes_replaying) { goto lbl_1; } src_samples = ((float **)malloc_wrapper(nsrcs * sizeof(float *), 7724169104006700643UL, 1, 0)) ;
...
# 131 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
 alias_group_changed(7, (size_t)(7724169104006700625UL), (size_t)(7724169104006700626UL), (size_t)(7724169104006700627UL), (size_t)(7724169104006700628UL), (size_t)(7724169104006700629UL), (size_t)(7724169104006700630UL), (size_t)(7724169104006700643UL)); exit(1);
...
# 140 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
 alias_group_changed(7, (size_t)(7724169104006700625UL), (size_t)(7724169104006700626UL), (size_t)(7724169104006700627UL), (size_t)(7724169104006700628UL), (size_t)(7724169104006700629UL), (size_t)(7724169104006700630UL), (size_t)(7724169104006700643UL)); call_lbl_10: calling((void*)&ricker_wavelet, 10, 0UL, 4, (size_t)(7724169104006700663UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)); ricker_wavelet(src_samples[i], nsteps, dt, srcs[i].freq);
# 141 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
 } }
# 142 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
 alias_group_changed(6, (size_t)(7724169104006700625UL), (size_t)(7724169104006700626UL), (size_t)(7724169104006700627UL), (size_t)(7724169104006700628UL), (size_t)(7724169104006700629UL), (size_t)(7724169104006700630UL)); rm_stack(true, 7724169104006700643UL); return src_samples;
...
# 149 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
 alias_group_changed(5, (size_t)(7724169104006700706UL), (size_t)(7724169104006700707UL), (size_t)(7724169104006700708UL), (size_t)(7724169104006700914UL), (size_t)(7724169104006700917UL)); exit(1);
...
# 188 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
 alias_group_changed(3, (size_t)(7724169104006700804UL), (size_t)(7724169104006700806UL), (size_t)(7724169104006700807UL)); exit(1);
