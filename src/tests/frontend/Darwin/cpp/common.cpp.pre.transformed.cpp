...
void parse_source_resumable(char *optarg, source *out) {const int ____chimes_did_disable2 = new_stack((void *)(&parse_source), "parse_source", &____must_manage_parse_source, 2, 0, (size_t)(7724169104006700488UL), (size_t)(7724169104006700489UL)) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
...
void config_sources_resumable(source **srcs, int *nsrcs, int nx, int ny, int nsteps) {const int ____chimes_did_disable3 = new_stack((void *)(&config_sources), "config_sources", &____must_manage_config_sources, 5, 0, (size_t)(7724169104006700619UL), (size_t)(7724169104006700620UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
# 96 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
    if (*nsrcs == 0) {
# 97 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
        *srcs = (source *)malloc_wrapper(sizeof(source), 7724169104006700563UL, 0, 1, (int)sizeof(struct _source), 0);
...
float **sample_sources_resumable(source *srcs, int nsrcs, int nsteps, float dt) {const int ____chimes_did_disable4 = new_stack((void *)(&sample_sources), "sample_sources", &____must_manage_sample_sources, 4, 0, (size_t)(7724169104006700702UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
...
# 135 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
        src_samples[i] = (float *)malloc_wrapper(nsteps * sizeof(float), 7724169104006700663UL, 0, 0);
...
# 142 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
    rm_stack(true, 7724169104006700643UL, "sample_sources", &____must_manage_sample_sources, ____alias_loc_id_4, ____chimes_did_disable4); return src_samples;
...
# 162 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
    (__builtin_expect(!(progress_buffer != __null), 0) ? __assert_rtn(__func__, "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp", 162, "progress_buffer != NULL") : (void)0);
...
void ricker_wavelet_quick(float *source, int nsteps, float dt, float freq) {const int ____chimes_did_disable1 = new_stack((void *)(&ricker_wavelet), "ricker_wavelet", &____must_manage_ricker_wavelet, 4, 0, (size_t)(7724169104006700394UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)) ; ; ;
# 52 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
     float shift; shift = (-1.55939996F / freq) ;
# 53 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
# 54 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
...
void parse_source_quick(char *optarg, source *out) {const int ____chimes_did_disable2 = new_stack((void *)(&parse_source), "parse_source", &____must_manage_parse_source, 2, 0, (size_t)(7724169104006700488UL), (size_t)(7724169104006700489UL)) ; ; ;
# 63 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
     char *x_str; x_str = (optarg) ;
# 64 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
     char *first_comma; first_comma = (strchr(x_str, ',')) ;
...
void config_sources_quick(source **srcs, int *nsrcs, int nx, int ny, int nsteps) {const int ____chimes_did_disable3 = new_stack((void *)(&config_sources), "config_sources", &____must_manage_config_sources, 5, 0, (size_t)(7724169104006700619UL), (size_t)(7724169104006700620UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)) ; ; ;
# 96 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
    if (*nsrcs == 0) {
# 97 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
        *srcs = (source *)malloc_wrapper(sizeof(source), 7724169104006700563UL, 0, 1, (int)sizeof(struct _source), 0);
...
float **sample_sources_quick(source *srcs, int nsrcs, int nsteps, float dt) {const int ____chimes_did_disable4 = new_stack((void *)(&sample_sources), "sample_sources", &____must_manage_sample_sources, 4, 0, (size_t)(7724169104006700702UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)) ; ; ;
# 128 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
     float **src_samples; src_samples = ((float **)malloc_wrapper(nsrcs * sizeof(float *), 7724169104006700643UL, 1, 0)) ;
# 129 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
    if (src_samples == __null) {
...
float **sample_sources_npm(source *srcs, int nsrcs, int nsteps, float dt) {
# 128 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
    float **src_samples = (float **)malloc_wrapper(nsrcs * sizeof(float *), 7724169104006700643UL, 1, 0);
# 129 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
    if (src_samples == __null) {
# 130 "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp"
        fprintf(__stderrp, "Allocation failed\n");
...
static int module_init() {
    init_module(7724169104006700302UL, 19, 8, 1, 7, 8, 0, 8, 2, 0, 3,
                           &____alias_loc_id_0, (unsigned)2, (unsigned)0, (7724169104006700302UL + 1UL), (7724169104006700302UL + 3UL),
                           &____alias_loc_id_1, (unsigned)10, (unsigned)0, (7724169104006700302UL + 23UL), (7724169104006700302UL + 24UL), (7724169104006700302UL + 25UL), (7724169104006700302UL + 26UL), (7724169104006700302UL + 27UL), (7724169104006700302UL + 28UL), (7724169104006700302UL + 29UL), (7724169104006700302UL + 30UL), (7724169104006700302UL + 31UL), (7724169104006700302UL + 92UL),
                           &____alias_loc_id_2, (unsigned)13, (unsigned)0, (7724169104006700302UL + 97UL), (7724169104006700302UL + 98UL), (7724169104006700302UL + 99UL), (7724169104006700302UL + 100UL), (7724169104006700302UL + 101UL), (7724169104006700302UL + 102UL), (7724169104006700302UL + 103UL), (7724169104006700302UL + 104UL), (7724169104006700302UL + 105UL), (7724169104006700302UL + 115UL), (7724169104006700302UL + 155UL), (7724169104006700302UL + 174UL), (7724169104006700302UL + 187UL),
                           &____alias_loc_id_3, (unsigned)10, (unsigned)0, (7724169104006700302UL + 195UL), (7724169104006700302UL + 196UL), (7724169104006700302UL + 197UL), (7724169104006700302UL + 198UL), (7724169104006700302UL + 199UL), (7724169104006700302UL + 200UL), (7724169104006700302UL + 201UL), (7724169104006700302UL + 261UL), (7724169104006700302UL + 317UL), (7724169104006700302UL + 318UL),
                           &____alias_loc_id_4, (unsigned)7, (unsigned)1, (7724169104006700302UL + 323UL), (7724169104006700302UL + 324UL), (7724169104006700302UL + 325UL), (7724169104006700302UL + 326UL), (7724169104006700302UL + 327UL), (7724169104006700302UL + 328UL), (7724169104006700302UL + 341UL), "ricker_wavelet", (unsigned)1, (7724169104006700302UL + 361UL),
                           &____alias_loc_id_5, (unsigned)7, (unsigned)0, (7724169104006700302UL + 404UL), (7724169104006700302UL + 405UL), (7724169104006700302UL + 406UL), (7724169104006700302UL + 407UL), (7724169104006700302UL + 457UL), (7724169104006700302UL + 612UL), (7724169104006700302UL + 615UL),
                           &____alias_loc_id_6, (unsigned)6, (unsigned)0, (7724169104006700302UL + 457UL), (7724169104006700302UL + 502UL), (7724169104006700302UL + 503UL), (7724169104006700302UL + 504UL), (7724169104006700302UL + 505UL), (7724169104006700302UL + 615UL),
                            "seconds", (void *)(&seconds_npm), (void *)__null, 0, 0, 0UL, 1, "gettimeofday", 2, (7724169104006700302UL + 1UL), (7724169104006700302UL + 2UL), 0UL,
                            "ricker_wavelet", (void *)(&ricker_wavelet_npm), (void *)__null, 0, 4, (7724169104006700302UL + 92UL), 0UL, 0UL, 0UL, 0UL, 1, "exp", 1, 0UL, 0UL,
                            "parse_source", (void *)(&parse_source_npm), (void *)__null, 0, 2, (7724169104006700302UL + 186UL), (7724169104006700302UL + 187UL), 0UL, 13, "strchr", 2, (7724169104006700302UL + 186UL), 0UL, (7724169104006700302UL + 115UL), "fprintf", 2, (7724169104006700302UL + 120UL), (7724169104006700302UL + 607UL), 0UL, "exit", 1, 0UL, 0UL, "strchr", 2, (7724169104006700302UL + 115UL), 0UL, (7724169104006700302UL + 174UL), "fprintf", 2, (7724169104006700302UL + 120UL), (7724169104006700302UL + 607UL), 0UL, "exit", 1, 0UL, 0UL, "strchr", 2, (7724169104006700302UL + 174UL), 0UL, (7724169104006700302UL + 155UL), "fprintf", 2, (7724169104006700302UL + 120UL), (7724169104006700302UL + 607UL), 0UL, "exit", 1, 0UL, 0UL, "atoi", 1, (7724169104006700302UL + 186UL), 0UL, "atoi", 1, (7724169104006700302UL + 115UL), 0UL, "atof", 1, (7724169104006700302UL + 174UL), 0UL, "atoi", 1, (7724169104006700302UL + 155UL), 0UL,
                            "config_sources", (void *)(&config_sources_npm), (void *)__null, 0, 5, (7724169104006700302UL + 317UL), (7724169104006700302UL + 318UL), 0UL, 0UL, 0UL, 0UL, 9, "malloc", 1, 0UL, (7724169104006700302UL + 261UL), "fprintf", 2, (7724169104006700302UL + 120UL), (7724169104006700302UL + 608UL), 0UL, "exit", 1, 0UL, 0UL, "fprintf", 2, (7724169104006700302UL + 120UL), (7724169104006700302UL + 609UL), 0UL, "exit", 1, 0UL, 0UL, "fprintf", 2, (7724169104006700302UL + 120UL), (7724169104006700302UL + 609UL), 0UL, "exit", 1, 0UL, 0UL, "fprintf", 2, (7724169104006700302UL + 120UL), (7724169104006700302UL + 609UL), 0UL, "exit", 1, 0UL, 0UL,
                            "sample_sources", (void *)(&sample_sources_npm), (void *)__null, 0, 4, (7724169104006700302UL + 400UL), 0UL, 0UL, 0UL, (7724169104006700302UL + 341UL), 7, "malloc", 1, 0UL, (7724169104006700302UL + 341UL), "fprintf", 2, (7724169104006700302UL + 120UL), (7724169104006700302UL + 608UL), 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (7724169104006700302UL + 361UL), "fprintf", 2, (7724169104006700302UL + 120UL), (7724169104006700302UL + 608UL), 0UL, "exit", 1, 0UL, 0UL, "ricker_wavelet", 4, (7724169104006700302UL + 361UL), 0UL, 0UL, 0UL, 0UL,
                            "init_progress", (void *)(&init_progress_npm), (void *)__null, 0, 3, 0UL, 0UL, 0UL, 0UL, 7, "fprintf", 2, (7724169104006700302UL + 120UL), (7724169104006700302UL + 613UL), 0UL, "exit", 1, 0UL, 0UL, "fprintf", 2, (7724169104006700302UL + 120UL), (7724169104006700302UL + 614UL), 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (7724169104006700302UL + 457UL), "__assert_rtn", 4, (7724169104006700302UL + 616UL), (7724169104006700302UL + 607UL), 0UL, (7724169104006700302UL + 618UL), 0UL, "fprintf", 3, (7724169104006700302UL + 120UL), (7724169104006700302UL + 622UL), (7724169104006700302UL + 457UL), 0UL,
                            "update_progress", (void *)(&update_progress_npm), (void *)__null, 0, 1, 0UL, 0UL, 6, "fprintf", 2, (7724169104006700302UL + 120UL), (7724169104006700302UL + 623UL), 0UL, "exit", 1, 0UL, 0UL, "fprintf", 2, (7724169104006700302UL + 120UL), (7724169104006700302UL + 624UL), 0UL, "exit", 1, 0UL, 0UL, "fprintf", 2, (7724169104006700302UL + 120UL), (7724169104006700302UL + 625UL), 0UL, "fprintf", 3, (7724169104006700302UL + 120UL), (7724169104006700302UL + 622UL), (7724169104006700302UL + 457UL), 0UL,
                            "finish_progress", (void *)(&finish_progress_npm), (void *)__null, 0, 0, 0UL, 3, "update_progress", 1, 0UL, 0UL, "fprintf", 2, (7724169104006700302UL + 120UL), (7724169104006700302UL + 625UL), 0UL, "free", 1, (7724169104006700302UL + 457UL), 0UL,
                           ...
                           "finish_progress", &(____chimes_does_checkpoint_finish_progress_npm),
                             (7724169104006700302UL + 201UL), (7724169104006700302UL + 261UL),
                             (7724169104006700302UL + 323UL), (7724169104006700302UL + 400UL),
                             (7724169104006700302UL + 606UL), (7724169104006700302UL + 120UL),
                             (7724169104006700302UL + 612UL), (7724169104006700302UL + 457UL),
                             (7724169104006700302UL + 23UL), (7724169104006700302UL + 92UL),
                             (7724169104006700302UL + 195UL), (7724169104006700302UL + 317UL),
                             (7724169104006700302UL + 196UL), (7724169104006700302UL + 318UL),
                             (7724169104006700302UL + 317UL), (7724169104006700302UL + 261UL),
                             (7724169104006700302UL + 99UL), (7724169104006700302UL + 186UL),
                             (7724169104006700302UL + 98UL), (7724169104006700302UL + 187UL),
                             (7724169104006700302UL + 327UL), (7724169104006700302UL + 341UL),
                             (7724169104006700302UL + 104UL), (7724169104006700302UL + 155UL),
                             (7724169104006700302UL + 102UL), (7724169104006700302UL + 174UL),
                             (7724169104006700302UL + 103UL), (7724169104006700302UL + 174UL),
                             (7724169104006700302UL + 100UL), (7724169104006700302UL + 115UL),
                             (7724169104006700302UL + 101UL), (7724169104006700302UL + 115UL),
                             (7724169104006700302UL + 341UL), (7724169104006700302UL + 361UL),
                             (7724169104006700302UL + 97UL), (7724169104006700302UL + 186UL),
                             (7724169104006700302UL + 105UL), (7724169104006700302UL + 155UL),
        ...
        "ricker_wavelet", 0UL, (int)4, 7724169104006700663UL, 0UL, 0UL, 0UL,
