...
# 8 "/Users/jmg3/num-debug/src/examples/cpp/lib/common3d.cpp"
 const int ny, const int nx, const char *filename, int radius) {new_stack((void *)(&save_layer_text), 8, 0, (size_t)(8205091211441270712UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(8205091211441270718UL), (size_t)(0UL)); if (____chimes_replaying) { switch(get_next_call()) { case(6): { goto call_lbl_6; } default: { chimes_error(); } } }
...
# 23 "/Users/jmg3/num-debug/src/examples/cpp/lib/common3d.cpp"
 call_lbl_6: calling((void*)&fclose, 6, 0UL, 1, (size_t)(8205091211441270647UL)); fclose(fp);
