...
void usage(char **argv) {new_stack((void *)(&usage), 1, 1, (size_t)(8205091211441270883UL), "usage|argv|0", "i8**", (void *)(&argv), (size_t)8, 1, 0, 0); if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } }
...
# 101 "/Users/jmg3/num-debug/src/examples/cpp/lib/common3d.cpp"
 (conf->nsrcs + 1), 8205091211441270984UL);
