...
void *foo() {const int ____chimes_disable0 = new_stack((void *)(&foo), "foo", &____must_manage_foo, 0, 0) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
...
# 9 "/Users/jmg3/num-debug/src/examples/cpp/cond_ptr_return.cpp"
 rm_stack(true, 8715185705475396353UL, "foo", &____must_manage_foo, ____alias_loc_id_1, ____chimes_disable0); return A;
...
# 12 "/Users/jmg3/num-debug/src/examples/cpp/cond_ptr_return.cpp"
 rm_stack(true, 8715185705475396353UL, "foo", &____must_manage_foo, ____alias_loc_id_1, ____chimes_disable0); return __null;
...
int main(int argc, char **argv) {init_chimes(); const int ____chimes_disable1 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(8715185705475396352UL)) ; if (____chimes_replaying) { switch(get_next_call()) { case(3): { goto call_lbl_3; } default: { chimes_error(); } } } ; ;
# 16 "/Users/jmg3/num-debug/src/examples/cpp/cond_ptr_return.cpp"
 void *tmp; tmp = ( ({ if (!____chimes_replaying) { } calling((void*)foo, -1, 8715185705475396347UL, 0); (foo)(); }) ) ;
