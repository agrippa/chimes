...
static int module_init() {
    init_module(8715185705475396311UL, 4, 0, 8715185705475396311UL + 1UL, 8715185705475396311UL + 42UL, 8715185705475396311UL + 2UL, 8715185705475396311UL + 42UL, 8715185705475396311UL + 28UL, 8715185705475396311UL + 41UL, 8715185705475396311UL + 29UL, 8715185705475396311UL + 36UL);
    return 0;
}
