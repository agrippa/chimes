...
int main_resumable(int argc, char **argv) {const int ____chimes_did_disable1 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(7761431396069166529UL)) ; int b;
...
int main_quick(int argc, char **argv) {const int ____chimes_did_disable1 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(7761431396069166529UL)) ; int b;
...
static int module_init() {
    init_module(7761431396069166501UL, 2, 2, 0, 3, 1, 0, 1, 0, 0, 0,
                           &____alias_loc_id_0, (unsigned)4, (unsigned)0, (7761431396069166501UL + 10UL), (7761431396069166501UL + 11UL), (7761431396069166501UL + 12UL), (7761431396069166501UL + 29UL),
                           &____alias_loc_id_1, (unsigned)1, (unsigned)0, (7761431396069166501UL + 13UL),
                           &____alias_loc_id_2, (unsigned)1, (unsigned)0, (7761431396069166501UL + 1UL),
                            "foo", (void *)(&foo_npm), (void *)(foo), 0, 1, 0UL, 0UL, 0,
                           "foo", &(____chimes_does_checkpoint_foo_npm),
                             (7761431396069166501UL + 12UL), (7761431396069166501UL + 28UL),
                             (7761431396069166501UL + 29UL), (7761431396069166501UL + 30UL),
