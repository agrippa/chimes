...
void *haha_this_sux_part_deux() {const int ____chimes_disable0 = new_stack((void *)(&haha_this_sux_part_deux), "haha_this_sux_part_deux", &____must_manage_haha_this_sux_part_deux, 0, 0) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
...
# 6 "/Users/jmg3/num-debug/src/examples/cpp/func_with_one_ptr_return.cpp"
 rm_stack(true, 651168722096376618UL, "haha_this_sux_part_deux", &____must_manage_haha_this_sux_part_deux, ____alias_loc_id_1, ____chimes_disable0); return A;
...
int main(int argc, char **argv) {init_chimes(); const int ____chimes_disable1 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(651168722096376646UL)) ; void *tmp;
...
# 10 "/Users/jmg3/num-debug/src/examples/cpp/func_with_one_ptr_return.cpp"
 tmp = ( ({ if (!____chimes_replaying) { } calling((void*)haha_this_sux_part_deux, -1, 651168722096376637UL, 0); (haha_this_sux_part_deux)(); }) ) ;
...
static int module_init() {
    ...
    register_functions(2, "func_with_one_ptr_return.cpp.pre.register.cpp", "haha_this_sux_part_deux", &haha_this_sux_part_deux, "main", &main);
    return 0;
}
