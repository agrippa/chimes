...
void *haha_this_sux() {const int ____chimes_disable0 = new_stack((void *)(&haha_this_sux), "haha_this_sux", &____must_manage_haha_this_sux, 0, 0) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
# 4 "/Users/jmg3/num-debug/src/examples/cpp/func_with_only_return.cpp"
 rm_stack(true, 2786831167442144618UL, "haha_this_sux", &____must_manage_haha_this_sux, 0, ____chimes_disable0); return __null;
...
int main(int argc, char **argv) {init_chimes(); const int ____chimes_disable1 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(2786831167442144615UL)) ; if (____chimes_replaying) { switch(get_next_call()) { case(2): { goto call_lbl_2; } default: { chimes_error(); } } } ; ;
