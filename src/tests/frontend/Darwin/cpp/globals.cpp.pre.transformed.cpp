...
int main(int argc, char **argv) {init_chimes(); const int ____chimes_disable0 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(9397157703034130362UL)) ; if (____chimes_replaying) { switch(get_next_call()) { case(5): { goto call_lbl_5; } default: { chimes_error(); } } } ; ;
...
static int module_init() {
    ...
    register_functions(1, "globals.cpp.pre.register.cpp", "main", &main);
    return 0;
}
