...
int main( int argc, char *argv[] ) {init_chimes(); const int ____chimes_did_disable1 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(636351199311517481UL)) ; float point_rate;
double elapsed_s;
float *tmp;
int src_offset;
int src;
