...
# 5 "<command line>" 2
# 1 "<built-in>" 2
# 1 "/Users/jmg3/num-debug/src/examples/cpp/multi_line_decl.cpp" 2
...
int foo(int a, int b) {new_stack(2, 0, (size_t)(0UL), (size_t)(0UL)); if (____chimes_replaying) { switch(get_next_call()) { default: { exit(42); } } }
# 4 "/Users/jmg3/num-debug/src/examples/cpp/multi_line_decl.cpp"
 alias_group_changed(2, (size_t)(1UL), (size_t)(2UL)); rm_stack(false, 0UL); return a + b;
...
int main(int argc, char **argv) {init_chimes(); new_stack(2, 2, (size_t)(0UL), (size_t)(42UL), "main|argc|0", "i32", (void *)(&argc), (size_t)4, 0, 0, 0, "main|argv|0", "i8**", (void *)(&argv), (size_t)8, 1, 0, 0); if (____chimes_replaying) { goto lbl_0; }
...
# 11 "/Users/jmg3/num-debug/src/examples/cpp/multi_line_decl.cpp"
 lbl_1: int *ptr; register_stack_var("main|ptr|0", "i32*", (void *)(&ptr), (size_t)8, 1, 0, 0); if (____chimes_replaying) { switch(get_next_call()) { case(0): { goto call_lbl_0; } case(1): { goto call_lbl_1; } default: { exit(42); } } } ptr = ((int *)malloc_wrapper(100, 28UL, 0, 0));
...
# 14 "/Users/jmg3/num-debug/src/examples/cpp/multi_line_decl.cpp"
 alias_group_changed(6, (size_t)(15UL), (size_t)(16UL), (size_t)(17UL), (size_t)(18UL), (size_t)(19UL), (size_t)(28UL)); call_lbl_0: calling(0, 0UL, 0); checkpoint();
# 15 "/Users/jmg3/num-debug/src/examples/cpp/multi_line_decl.cpp"
# 16 "/Users/jmg3/num-debug/src/examples/cpp/multi_line_decl.cpp"
 rm_stack(false, 0UL); call_lbl_1: calling(1, 0UL, 2, (size_t)(0UL), (size_t)(0UL)); return foo(ptr[0], a);
# 17 "/Users/jmg3/num-debug/src/examples/cpp/multi_line_decl.cpp"
}


static int module_init() {
    init_module(1300474033434903672UL, 2, 0, 19UL, 28UL, 17UL, 42UL);
    return 0;
}
