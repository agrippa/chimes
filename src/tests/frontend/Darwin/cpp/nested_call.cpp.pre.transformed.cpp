...
# 3 "<command line>" 2
# 1 "<built-in>" 2
# 1 "nested_call.cpp.pre.transformed.cpp" 2
...
# 3 "<command line>" 2
# 1 "<built-in>" 2
# 1 "/Users/jmg3/num-debug/src/examples/cpp/nested_call.cpp" 2
...
# 14 "/Users/jmg3/num-debug/src/examples/cpp/nested_call.cpp"
 int ____chimes_unroll_var_0; ____chimes_unroll_var_0 = (({ calling_npm(0, 0); bar_npm(a); })) ; a = ({ calling_npm(0, 0); foo_npm(____chimes_unroll_var_0); });
...
static int module_init() {
    init_module(8178581968770421985UL, 1, 3, 0, 1, 2, 0, 0, 8178581968770421985UL + 19UL, 8178581968770421985UL + 40UL, "main", 3, "bar", "foo", "checkpoint", "foo", 0, "bar", 0, &____alias_loc_id_0, (unsigned)5, 8178581968770421985UL + 17UL, 8178581968770421985UL + 18UL, 8178581968770421985UL + 19UL, 8178581968770421985UL + 20UL, 8178581968770421985UL + 21UL, &____alias_loc_id_1, (unsigned)1, 8178581968770421985UL + 1UL, &____alias_loc_id_2, (unsigned)1, 8178581968770421985UL + 10UL, "foo_npm", foo_npm, "bar_npm", bar_npm);
    register_functions(3, "nested_call.cpp.pre.extern_ptrs.cpp", "foo", &foo, "bar", &bar, "main", &main);
    return 0;
}
