...
# 14 "/Users/jmg3/num-debug/src/examples/cpp/nested_call_complex.cpp"
 int ____chimes_unroll_var_0; ____chimes_unroll_var_0 = (({ calling_npm(0, 0); bar_npm(a); })) ; int ____chimes_unroll_var_1; ____chimes_unroll_var_1 = (({ calling_npm(0, 0); bar_npm(____chimes_unroll_var_0); })) ; a = ({ calling_npm(0, 0); foo_npm(5 + ____chimes_unroll_var_1); });
...
static int module_init() {
    init_module(12499450248527248196UL, 1, 3, 0, 1, 2, 0, 0, 12499450248527248196UL + 19UL, 12499450248527248196UL + 46UL, "main", 4, "bar", "bar", "foo", "checkpoint", "foo", 0, "bar", 0, &____alias_loc_id_0, (unsigned)6, 12499450248527248196UL + 17UL, 12499450248527248196UL + 18UL, 12499450248527248196UL + 19UL, 12499450248527248196UL + 20UL, 12499450248527248196UL + 21UL, 12499450248527248196UL + 22UL, &____alias_loc_id_1, (unsigned)1, 12499450248527248196UL + 1UL, &____alias_loc_id_2, (unsigned)1, 12499450248527248196UL + 10UL, "foo_npm", foo_npm, "bar_npm", bar_npm);
    register_functions(3, "nested_call_complex.cpp.pre.extern_ptrs.cpp", "foo", &foo, "bar", &bar, "main", &main);
    return 0;
}
