...
# 14 "/Users/jmg3/num-debug/src/examples/cpp/nested_indirect_call.cpp"
 int ____chimes_unroll_var_0; ____chimes_unroll_var_0 = (({ calling_npm(0, 0); bar_npm(a); })) ; a = ({ calling_npm(0, 0); foo_npm(3 + ____chimes_unroll_var_0); });
...
static int module_init() {
    init_module(4133033703235126322UL, 1, 3, 0, 1, 2, 0, 0, 4133033703235126322UL + 19UL, 4133033703235126322UL + 41UL, "main", 3, "bar", "foo", "checkpoint", "foo", 0, "bar", 0, &____alias_loc_id_0, (unsigned)5, 4133033703235126322UL + 17UL, 4133033703235126322UL + 18UL, 4133033703235126322UL + 19UL, 4133033703235126322UL + 20UL, 4133033703235126322UL + 21UL, &____alias_loc_id_1, (unsigned)1, 4133033703235126322UL + 1UL, &____alias_loc_id_2, (unsigned)1, 4133033703235126322UL + 10UL, "foo_npm", foo_npm, "bar_npm", bar_npm);
    register_functions(3, "nested_indirect_call.cpp.pre.extern_ptrs.cpp", "foo", &foo, "bar", &bar, "main", &main);
    return 0;
}
