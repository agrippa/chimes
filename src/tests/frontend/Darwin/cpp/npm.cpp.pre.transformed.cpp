...
# 3 "<command line>" 2
# 1 "<built-in>" 2
# 1 "npm.cpp.pre.transformed.cpp" 2
...
# 3 "<command line>" 2
# 1 "<built-in>" 2
# 1 "/Users/jmg3/num-debug/src/examples/cpp/npm.cpp" 2
...
# 8 "/Users/jmg3/num-debug/src/examples/cpp/npm.cpp"
 rm_stack(false, 0UL, "foo", &____must_manage_foo, ____alias_loc_id_2, ____chimes_did_disable1); return ({ calling_npm(0, 0); bar_npm(a); }) + 5;
