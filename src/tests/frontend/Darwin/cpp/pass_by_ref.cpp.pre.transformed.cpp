...
# 10 "/Users/jmg3/num-debug/src/examples/cpp/pass_by_ref.cpp"
     call_lbl_1: (____chimes_does_checkpoint_foo_npm ? ( ({ calling((void*)foo, 1, ____alias_loc_id_0, 0UL, 1, (size_t)(12387876047547725260UL)); (foo)(&b); }) ) : (({ calling_npm("foo", ____alias_loc_id_0); (*____chimes_extern_func_foo)(&b); })));
...
static int module_init() {
    init_module(12387876047547725256UL, 1, 1, 1, 1, 0, 1, 1, 0, 1, 0,
                           &____alias_loc_id_0, (unsigned)3, (unsigned)1, (12387876047547725256UL + 1UL), (12387876047547725256UL + 2UL), (12387876047547725256UL + 3UL), "foo", (unsigned)1, (12387876047547725256UL + 4UL),
                               "foo", (void **)&(____chimes_extern_func_foo),
                           "foo", &(____chimes_does_checkpoint_foo_npm),
                             (12387876047547725256UL + 3UL), (12387876047547725256UL + 16UL),
                             "main", "main", 2, "foo", "checkpoint",
                        "main|b|0", 1, "main",
        "foo", 0UL, (int)1, 12387876047547725260UL);
    return 0;
}
