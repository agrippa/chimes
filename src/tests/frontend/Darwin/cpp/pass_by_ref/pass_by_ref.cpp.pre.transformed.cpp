...
# 1 "/Users/jmg3/chimes/src/examples/cpp/./pass_by_ref.cpp"
...
# 2 "/Users/jmg3/chimes/src/examples/cpp/./pass_by_ref.cpp" 2
...
# 3 "/Users/jmg3/chimes/src/examples/cpp/./pass_by_ref.cpp" 2
# 3 "/Users/jmg3/chimes/src/examples/cpp/./pass_by_ref.cpp"
...
extern void register_custom_init_handler(const char *obj_name,
        void (*fp)(void *));
# 5 "/Users/jmg3/chimes/src/examples/cpp/./pass_by_ref.cpp" 2
# 5 "/Users/jmg3/chimes/src/examples/cpp/./pass_by_ref.cpp"
# 6 "/Users/jmg3/chimes/src/examples/cpp/./pass_by_ref.cpp"
extern void foo(int *A);
# 7 "/Users/jmg3/chimes/src/examples/cpp/./pass_by_ref.cpp"
# 8 "/Users/jmg3/chimes/src/examples/cpp/./pass_by_ref.cpp"
static void (*____chimes_extern_func_foo)(int *) = foo;
int main_quick(int argc, char **argv); int main(int argc, char **argv);
int main_resumable(int argc, char **argv) {const int ____chimes_did_disable0 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(788550027250460217UL)) ; int b;
...
# 9 "/Users/jmg3/chimes/src/examples/cpp/./pass_by_ref.cpp"
     ;
# 10 "/Users/jmg3/chimes/src/examples/cpp/./pass_by_ref.cpp"
     call_lbl_1: (____chimes_does_checkpoint_foo_npm ? ( ({ calling((void*)foo, 1, ____alias_loc_id_0, 0UL, 1, (size_t)(788550027250460205UL)); (foo)(&b); }) ) : (({ calling_npm("foo", ____alias_loc_id_0); (*____chimes_extern_func_foo)(&b); })));
# 11 "/Users/jmg3/chimes/src/examples/cpp/./pass_by_ref.cpp"
     call_lbl_2: checkpoint_transformed(2, 0);
# 12 "/Users/jmg3/chimes/src/examples/cpp/./pass_by_ref.cpp"
    rm_stack(false, 0UL, "main", (int *)0x0, 0, ____chimes_did_disable0); return b;
# 13 "/Users/jmg3/chimes/src/examples/cpp/./pass_by_ref.cpp"
}
int main_quick(int argc, char **argv) {const int ____chimes_did_disable0 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(788550027250460217UL)) ; int b;
...
static int module_init() {
    init_module(788550027250460201UL, 1, 1, 1, 1, 0, 1, 1, 0, 1, 0,
                           &____alias_loc_id_0, (unsigned)3, (unsigned)1, (788550027250460201UL + 1UL), (788550027250460201UL + 2UL), (788550027250460201UL + 3UL), "foo", (unsigned)1, (788550027250460201UL + 4UL),
                               "foo", (void **)&(____chimes_extern_func_foo),
                           "foo", &(____chimes_does_checkpoint_foo_npm),
                             (788550027250460201UL + 3UL), (788550027250460201UL + 16UL),
                             "main", "main", 2, "foo", "checkpoint",
                        "main|b|0", 1, "main",
        "foo", 0UL, (int)1, 788550027250460205UL);
    return 0;
}
