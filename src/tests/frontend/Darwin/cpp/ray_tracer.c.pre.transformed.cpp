...
# 69 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 alias_group_changed(2, (size_t)(519228149530227528UL), (size_t)(519228149530227529UL)); lbl_0: double y; if (____must_checkpoint_rot_x_y_0 != 0) { register_stack_var("rot_x|y|0", &____must_checkpoint_rot_x_y_0, "double", (void *)(&y), (size_t)8, 0, 0, 0); } if (____chimes_replaying) { switch(get_next_call()) { case(2): { goto call_lbl_2; } case(3): { goto call_lbl_3; } case(5): { goto call_lbl_5; } case(6): { goto call_lbl_6; } default: { chimes_error(); } } } call_lbl_2: calling((void*)&cos, 2, 0UL, 1, (size_t)(0UL)); call_lbl_3: calling((void*)&sin, 3, 0UL, 1, (size_t)(0UL)); y = (self->cy * cos(angle) - self->cz * sin(angle)) ;
...
# 76 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 alias_group_changed(2, (size_t)(519228149530227579UL), (size_t)(519228149530227580UL)); lbl_0: double x; if (____must_checkpoint_rot_y_x_0 != 0) { register_stack_var("rot_y|x|0", &____must_checkpoint_rot_y_x_0, "double", (void *)(&x), (size_t)8, 0, 0, 0); } if (____chimes_replaying) { switch(get_next_call()) { case(2): { goto call_lbl_2; } case(3): { goto call_lbl_3; } case(5): { goto call_lbl_5; } case(6): { goto call_lbl_6; } default: { chimes_error(); } } } call_lbl_2: calling((void*)&cos, 2, 0UL, 1, (size_t)(0UL)); call_lbl_3: calling((void*)&sin, 3, 0UL, 1, (size_t)(0UL)); x = (self->cx * cos(angle) - self->cz * sin(angle)) ;
...
# 105 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 alias_group_changed(8, (size_t)(519228149530227806UL), (size_t)(519228149530227807UL), (size_t)(519228149530227808UL), (size_t)(519228149530227809UL), (size_t)(519228149530227810UL), (size_t)(519228149530227811UL), (size_t)(519228149530227812UL), (size_t)(519228149530227813UL)); rm_stack(false, 0UL); return (v1x * v2x + v1y * v2y + v1z * v2z) / (a * b);
...
# 144 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 alias_group_changed(6, (size_t)(519228149530227946UL), (size_t)(519228149530227947UL), (size_t)(519228149530227948UL), (size_t)(519228149530227949UL), (size_t)(519228149530228171UL), (size_t)(519228149530228726UL)); while ((c = getopt(argc, argv, "s:x:y:p:l:d:v:t:h")) != -1) {
...
# 170 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 alias_group_changed(2, (size_t)(519228149530227949UL), (size_t)(519228149530227950UL)); lbl_2: char *first_comma; if (____must_checkpoint_parse_config_first_comma_0 != 0) { register_stack_var("parse_config|first_comma|0", &____must_checkpoint_parse_config_first_comma_0, "i8*", (void *)(&first_comma), (size_t)8, 1, 0, 0); } if (____chimes_replaying) { goto lbl_3; } first_comma = (strchr(sphere_def, ',')) ;
...
# 174 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 alias_group_changed(1, (size_t)(519228149530227952UL)); lbl_4: char *third_comma; if (____must_checkpoint_parse_config_third_comma_0 != 0) { register_stack_var("parse_config|third_comma|0", &____must_checkpoint_parse_config_third_comma_0, "i8*", (void *)(&third_comma), (size_t)8, 1, 0, 0); } if (____chimes_replaying) { goto lbl_5; } third_comma = (strchr(second_comma + 1, ',')) ;
...
# 176 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 alias_group_changed(1, (size_t)(519228149530227953UL)); lbl_5: char *fourth_comma; if (____must_checkpoint_parse_config_fourth_comma_0 != 0) { register_stack_var("parse_config|fourth_comma|0", &____must_checkpoint_parse_config_fourth_comma_0, "i8*", (void *)(&fourth_comma), (size_t)8, 1, 0, 0); } if (____chimes_replaying) { goto lbl_6; } fourth_comma = (strchr(third_comma + 1, ',')) ;
...
# 178 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 alias_group_changed(1, (size_t)(519228149530227954UL)); lbl_6: char *fifth_comma; if (____must_checkpoint_parse_config_fifth_comma_0 != 0) { register_stack_var("parse_config|fifth_comma|0", &____must_checkpoint_parse_config_fifth_comma_0, "i8*", (void *)(&fifth_comma), (size_t)8, 1, 0, 0); } if (____chimes_replaying) { goto lbl_7; } fifth_comma = (strchr(fourth_comma + 1, ',')) ;
...
# 203 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 call_lbl_52: calling((void*)&usage, 52, 0UL, 1, (size_t)(519228149530228232UL)); default:
...
# 227 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 lbl_11: double mod_v; register_stack_var("main|mod_v|0", (int *)0x0, "double", (void *)(&mod_v), (size_t)8, 0, 0, 0); if (____chimes_replaying) { goto lbl_12; } call_lbl_7: calling((void*)&modv, 7, 0UL, 3, (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)); mod_v = (modv(vx, vy, vz)) ;
...
# 236 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 lbl_16: double taux; register_stack_var("main|taux|0", (int *)0x0, "double", (void *)(&taux), (size_t)8, 0, 0, 0); if (____chimes_replaying) { goto lbl_17; } call_lbl_8: calling((void*)&get_sphere_intersec, 8, 0UL, 10, (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)); taux = (get_sphere_intersec(sphn->cx, sphn->cy, sphn->cz, sphn->radius, conf.px, conf.py, conf.pz, vx, vy, vz)) ;
...
# 268 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 lbl_25: double cost; register_stack_var("main|cost|0", (int *)0x0, "double", (void *)(&cost), (size_t)8, 0, 0, 0); if (____chimes_replaying) { goto lbl_26; } call_lbl_11: calling((void*)&get_cos_angle_v1v2, 11, 0UL, 6, (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)); cost = (get_cos_angle_v1v2(conf.dx, conf.dy, conf.dz, itx - spherehit->cx, ity - spherehit->cy, itz - spherehit->cz)) ;
...
# 284 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 { lbl_27: int i; register_stack_var("main|i|1", (int *)0x0, "i32", (void *)(&i), (size_t)4, 0, 0, 0); if (____chimes_replaying) { switch(get_next_call()) { case(3): { goto call_lbl_3; } case(5): { goto call_lbl_5; } case(6): { goto call_lbl_6; } case(7): { goto call_lbl_7; } case(8): { goto call_lbl_8; } case(9): { goto call_lbl_9; } case(10): { goto call_lbl_10; } case(11): { goto call_lbl_11; } case(12): { goto call_lbl_12; } case(14): { goto call_lbl_14; } default: { chimes_error(); } } } for ( i = (0) ; i < conf.nspheres; i++) {
# 285 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 call_lbl_12: calling((void*)&move, 12, 0UL, 4, (size_t)(519228149530228525UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)); move(conf.spheres + i, conf.svx, conf.svy, conf.svz);
...
# 289 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 alias_group_changed(28, (size_t)(519228149530228244UL), (size_t)(519228149530228245UL), (size_t)(519228149530228246UL), (size_t)(519228149530228247UL), (size_t)(519228149530228248UL), (size_t)(519228149530228249UL), (size_t)(519228149530228250UL), (size_t)(519228149530228251UL), (size_t)(519228149530228252UL), (size_t)(519228149530228253UL), (size_t)(519228149530228254UL), (size_t)(519228149530228255UL), (size_t)(519228149530228256UL), (size_t)(519228149530228257UL), (size_t)(519228149530228258UL), (size_t)(519228149530228259UL), (size_t)(519228149530228260UL), (size_t)(519228149530228261UL), (size_t)(519228149530228262UL), (size_t)(519228149530228263UL), (size_t)(519228149530228264UL), (size_t)(519228149530228265UL), (size_t)(519228149530228266UL), (size_t)(519228149530228267UL), (size_t)(519228149530228268UL), (size_t)(519228149530228269UL), (size_t)(519228149530228270UL), (size_t)(519228149530228289UL)); call_lbl_14: calling((void*)&checkpoint, 14, 0UL, 0); checkpoint();
