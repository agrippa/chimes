...
# 156 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 ({ calling((void*)parse_three_doubles, -1, 0UL, 0, 4, (size_t)(519228149530228194UL), (size_t)(519228149530228171UL), (size_t)(519228149530228171UL), (size_t)(519228149530228171UL)); (parse_three_doubles)(optarg, &conf->svx, &conf->svy, &conf->svz); }) ;
...
# 159 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 ({ calling((void*)parse_three_doubles, -1, 0UL, 0, 4, (size_t)(519228149530228194UL), (size_t)(519228149530228171UL), (size_t)(519228149530228171UL), (size_t)(519228149530228171UL)); (parse_three_doubles)(optarg, &conf->px, &conf->py, &conf->pz); }) ;
...
# 162 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 ({ calling((void*)parse_three_doubles, -1, 0UL, 0, 4, (size_t)(519228149530228194UL), (size_t)(519228149530228171UL), (size_t)(519228149530228171UL), (size_t)(519228149530228171UL)); (parse_three_doubles)(optarg, &conf->lx, &conf->ly, &conf->lz); }) ;
...
# 165 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 ({ calling((void*)parse_three_doubles, -1, 0UL, 0, 4, (size_t)(519228149530228194UL), (size_t)(519228149530228171UL), (size_t)(519228149530228171UL), (size_t)(519228149530228171UL)); (parse_three_doubles)(optarg, &conf->dx, &conf->dy, &conf->dz); }) ;
...
# 192 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 ({ calling((void*)init, -1, 0UL, 0, 8, (size_t)(519228149530228525UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)); (init)(conf->spheres + conf->nspheres, atof(sphere_def), atof(first_comma + 1), atof(second_comma + 1), atof(third_comma + 1), atof(fourth_comma + 1), atof(fifth_comma + 1), atof(sixth_comma + 1)); }) ;
...
# 204 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 ({ calling((void*)usage, -1, 0UL, 0, 1, (size_t)(519228149530228232UL)); (usage)(argv); }) ;
...
# 211 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 ({ calling((void*)parse_config, -1, 0UL, 0, 3, (size_t)(0UL), (size_t)(519228149530228714UL), (size_t)(519228149530228243UL)); (parse_config)(argc, argv, &conf); }) ;
...
# 220 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 x = ( ({ calling((void*)get_coord, -1, 0UL, 0, 5, (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)); (get_coord)(0., conf.nx, -f_max, f_max, i / conf.ny); }) ) ;
# 221 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 y = ( ({ calling((void*)get_coord, -1, 0UL, 0, 5, (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)); (get_coord)(0., conf.ny, -f_max, f_max, i % conf.ny); }) ) ;
...
# 227 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 mod_v = ( ({ calling((void*)modv, -1, 0UL, 0, 3, (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)); (modv)(vx, vy, vz); }) ) ;
...
# 236 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 taux = ( ({ calling((void*)get_sphere_intersec, -1, 0UL, 0, 10, (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)); (get_sphere_intersec)(sphn->cx, sphn->cy, sphn->cz, sphn->radius, conf.px, conf.py, conf.pz, vx, vy, vz); }) ) ;
...
# 251 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 tauxla = ( ({ calling((void*)get_sphere_intersec, -1, 0UL, 0, 10, (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)); (get_sphere_intersec)(spherehit->cx, spherehit->cy, spherehit->cz, spherehit->radius, conf.lx, conf.ly, conf.lz, itx - conf.lx, ity - conf.ly, itz - conf.lz); }) ) ;
...
# 258 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 tauxlb = ( ({ calling((void*)get_sphere_intersec, -1, 0UL, 0, 10, (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)); (get_sphere_intersec)(sphnb->cx, sphnb->cy, sphnb->cz, sphnb->radius, conf.lx, conf.ly, conf.lz, itx - conf.lx, ity - conf.ly, itz - conf.lz); }) ) ;
...
# 268 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 cost = ( ({ calling((void*)get_cos_angle_v1v2, -1, 0UL, 0, 6, (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)); (get_cos_angle_v1v2)(conf.dx, conf.dy, conf.dz, itx - spherehit->cx, ity - spherehit->cy, itz - spherehit->cz); }) ) ;
...
# 284 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 { lbl_5: int i; register_stack_var("main|i|1", (int *)0x0, "i32", (void *)(&i), (size_t)4, 0, 0, 0); if (____chimes_replaying) { switch(get_next_call()) { case(3): { goto call_lbl_3; } default: { chimes_error(); } } } for ( i = (0) ; i < conf.nspheres; i++) {
# 285 "/Users/jmg3/num-debug/src/examples/cpp/ray_tracer.c"
 ({ calling((void*)move, -1, 0UL, 0, 4, (size_t)(519228149530228525UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)); (move)(conf.spheres + i, conf.svx, conf.svy, conf.svz); }) ;
