...
int main_resumable(int argc, char **argv) {const int ____chimes_did_disable0 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(7654350934130983469UL)) ; int *tmp;
int *next;
int *curr;
int niters;
int N;
