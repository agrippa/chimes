...
# 112 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(1, (size_t)(766405423403602247UL)); call_lbl_3: calling((void*)&impl_abort, 3, 0UL, 1, (size_t)(0UL)); impl_abort(1);
# 113 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
rm_stack(false, 0UL, "uts_error", &____must_manage_uts_error); }
...
# 136 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 rm_stack(false, 0UL, "uts_wctime", &____must_manage_uts_wctime); return (tv.tv_sec + 1E-6 * tv.tv_usec);
...
# 146 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(1, (size_t)(766405423403602273UL)); rm_stack(false, 0UL, "rng_toProb", &____must_manage_rng_toProb); return ((n<0)? 0.0 : ((double) n)/2147483648.0);
...
# 154 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(3, (size_t)(766405423403602293UL), (size_t)(766405423403602294UL), (size_t)(766405423403602324UL)); call_lbl_2: calling((void*)&rng_init, 2, 0UL, 2, (size_t)(766405423403602324UL), (size_t)(0UL)); rng_init(root->state.state, rootId);
...
rm_stack(false, 0UL, "uts_initRoot", &____must_manage_uts_initRoot); }
...
# 163 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(1, (size_t)(766405423403602328UL)); int v; call_lbl_2: calling((void*)&rng_rand, 2, 0UL, 1, (size_t)(766405423403602353UL)); v = (rng_rand(parent->state.state)) ;
...
# 166 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(2, (size_t)(766405423403602329UL), (size_t)(766405423403602330UL)); rm_stack(false, 0UL, "uts_numChildren_bin", &____must_manage_uts_numChildren_bin); return (d < nonLeafProb) ? nonLeafBF : 0;
...
# 191 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(4, (size_t)(766405423403602355UL), (size_t)(766405423403602356UL), (size_t)(766405423403602357UL), (size_t)(766405423403602360UL)); call_lbl_6: calling((void*)&sin, 6, 0UL, 1, (size_t)(0UL)); b_i = pow(b_0,
...
# 213 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(4, (size_t)(766405423403602355UL), (size_t)(766405423403602356UL), (size_t)(766405423403602357UL), (size_t)(766405423403602360UL)); call_lbl_8: calling((void*)&rng_rand, 8, 0UL, 1, (size_t)(766405423403602460UL)); h = rng_rand(parent->state.state);
...
# 220 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(3, (size_t)(766405423403602358UL), (size_t)(766405423403602359UL), (size_t)(766405423403602361UL)); rm_stack(false, 0UL, "uts_numChildren_geo", &____must_manage_uts_numChildren_geo); return numChildren;
...
# 230 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 if (parent->height == 0) {numChildren = (int)floor(b_0); } else {alias_group_changed(2, (size_t)(766405423403602466UL), (size_t)(766405423403602467UL)); call_lbl_3: calling((void*)&uts_numChildren_bin, 3, 0UL, 1, (size_t)(766405423403602551UL)); numChildren = uts_numChildren_bin(parent); } ;
...
# 237 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(2, (size_t)(766405423403602466UL), (size_t)(766405423403602467UL)); call_lbl_5: calling((void*)&uts_numChildren_geo, 5, 0UL, 1, (size_t)(766405423403602551UL)); numChildren = uts_numChildren_geo(parent);
...
# 241 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 if (parent->height < shiftDepth * gen_mx) {alias_group_changed(2, (size_t)(766405423403602466UL), (size_t)(766405423403602467UL)); call_lbl_7: calling((void*)&uts_numChildren_geo, 7, 0UL, 1, (size_t)(766405423403602551UL)); numChildren = uts_numChildren_geo(parent); } else {alias_group_changed(2, (size_t)(766405423403602466UL), (size_t)(766405423403602467UL)); call_lbl_9: calling((void*)&uts_numChildren_bin, 9, 0UL, 1, (size_t)(766405423403602551UL)); numChildren = uts_numChildren_bin(parent); } ;
# 245 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 break;
# 246 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(2, (size_t)(766405423403602466UL), (size_t)(766405423403602467UL)); call_lbl_11: calling((void*)&uts_error, 11, 0UL, 1, (size_t)(766405423403603154UL)); default:
...
# 268 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(3, (size_t)(766405423403602466UL), (size_t)(766405423403602467UL), (size_t)(766405423403602468UL)); rm_stack(false, 0UL, "uts_numChildren", &____must_manage_uts_numChildren); return numChildren;
...
int uts_childType(Node *parent) {new_stack((void *)(&uts_childType), "uts_childType", &____must_manage_uts_childType, 1, 0, (size_t)(766405423403602582UL)); if (____chimes_replaying) { switch(get_next_call()) { case(10): { goto call_lbl_10; } default: { chimes_error(); } } }
...
# 275 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(2, (size_t)(766405423403602553UL), (size_t)(766405423403602554UL)); rm_stack(false, 0UL, "uts_childType", &____must_manage_uts_childType); return BIN;
# 276 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 case GEO:
# 277 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(2, (size_t)(766405423403602553UL), (size_t)(766405423403602554UL)); rm_stack(false, 0UL, "uts_childType", &____must_manage_uts_childType); return GEO;
# 278 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 case HYBRID:
# 279 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 if (parent->height < shiftDepth * gen_mx) {alias_group_changed(2, (size_t)(766405423403602553UL), (size_t)(766405423403602554UL)); rm_stack(false, 0UL, "uts_childType", &____must_manage_uts_childType); return GEO;; } else {alias_group_changed(2, (size_t)(766405423403602553UL), (size_t)(766405423403602554UL)); rm_stack(false, 0UL, "uts_childType", &____must_manage_uts_childType); return BIN;; } ;
# 283 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(1, (size_t)(766405423403602554UL)); call_lbl_10: calling((void*)&uts_error, 10, 0UL, 1, (size_t)(766405423403603157UL)); default:
...
# 285 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(2, (size_t)(766405423403602553UL), (size_t)(766405423403602554UL)); rm_stack(false, 0UL, "uts_childType", &____must_manage_uts_childType); return -1;
...
# 322 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(4, (size_t)(766405423403602584UL), (size_t)(766405423403602585UL), (size_t)(766405423403602586UL), (size_t)(766405423403602587UL)); call_lbl_13: calling((void*)&rng_showtype, 13, 0UL, 2, (size_t)(766405423403602730UL), (size_t)(0UL)); ind = rng_showtype(strBuf, ind);
...
# 325 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(1, (size_t)(766405423403602584UL)); rm_stack(false, 0UL, "uts_paramsToStr", &____must_manage_uts_paramsToStr); return ind;
...
# 335 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(2, (size_t)(766405423403602736UL), (size_t)(766405423403602737UL)); call_lbl_2: calling((void*)&uts_paramsToStr, 2, 0UL, 2, (size_t)(766405423403602736UL), (size_t)(0UL)); ind = uts_paramsToStr(strBuf, ind);
# 336 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(1, (size_t)(766405423403602737UL)); call_lbl_4: calling((void*)&impl_paramsToStr, 4, 0UL, 2, (size_t)(766405423403602736UL), (size_t)(0UL)); ind = impl_paramsToStr(strBuf, ind);
...
alias_group_changed(2, (size_t)(766405423403602736UL), (size_t)(766405423403602737UL)); rm_stack(false, 0UL, "uts_printParams", &____must_manage_uts_printParams); }
...
# 345 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 if (argv[i][0] == '-' && argv[i][1] == 'h') {{ alias_group_changed(6, (size_t)(766405423403602760UL), (size_t)(766405423403602761UL), (size_t)(766405423403602762UL), (size_t)(766405423403602763UL), (size_t)(766405423403603140UL), (size_t)(766405423403603141UL)); call_lbl_2: calling((void*)&uts_helpMessage, 2, 0UL, 0); uts_helpMessage(); call_lbl_3: calling((void*)&impl_abort, 3, 0UL, 1, (size_t)(0UL)); impl_abort(0); }; } else if (argv[i][0] != '-' || strlen(argv[i]) != 2 || argc <= i + 1) { err = i; break; }
...
# 355 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(6, (size_t)(766405423403602760UL), (size_t)(766405423403602761UL), (size_t)(766405423403602762UL), (size_t)(766405423403602763UL), (size_t)(766405423403603140UL), (size_t)(766405423403603141UL)); call_lbl_6: calling((void*)&impl_parseParam, 6, 0UL, 2, (size_t)(766405423403603006UL), (size_t)(766405423403603006UL)); if (!impl_parseParam(argv[i], argv[i+1])) {
...
# 400 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(6, (size_t)(766405423403602760UL), (size_t)(766405423403602761UL), (size_t)(766405423403602762UL), (size_t)(766405423403602763UL), (size_t)(766405423403603140UL), (size_t)(766405423403603141UL)); call_lbl_22: calling((void*)&impl_abort, 22, 0UL, 1, (size_t)(0UL)); impl_abort(4);
# 401 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 }
# 402 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
alias_group_changed(6, (size_t)(766405423403602760UL), (size_t)(766405423403602761UL), (size_t)(766405423403602762UL), (size_t)(766405423403602763UL), (size_t)(766405423403603140UL), (size_t)(766405423403603141UL)); rm_stack(false, 0UL, "uts_parseParams", &____must_manage_uts_parseParams); }
...
rm_stack(false, 0UL, "uts_helpMessage", &____must_manage_uts_helpMessage); }
