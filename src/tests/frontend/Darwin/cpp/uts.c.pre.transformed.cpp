...
# 112 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(____alias_loc_id_0); ({ call_lbl_3: calling((void*)impl_abort, 3, 0UL, 1, (size_t)(0UL)); (impl_abort)(1); }) ;
...
# 154 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(____alias_loc_id_1); ({ call_lbl_2: uint8 * ____chimes_arg1; if (!____chimes_replaying) { ____chimes_arg1 = (root->state.state); } calling((void*)rng_init, 2, 0UL, 2, (size_t)(766405423403602324UL), (size_t)(0UL)); (rng_init)(____chimes_arg1, rootId); }) ;
...
# 164 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 double d; d = ( ({ calling((void*)rng_toProb, -1, 0UL, 1, (size_t)(0UL)); (rng_toProb)(v); }) ) ;
...
# 214 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 u = ({ calling((void*)rng_toProb, -1, 0UL, 1, (size_t)(0UL)); (rng_toProb)(h); }) ;
...
# 230 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 if (parent->height == 0) {numChildren = (int)floor(b_0); } else {alias_group_changed(____alias_loc_id_6); numChildren = ({ call_lbl_3: calling((void*)uts_numChildren_bin, 3, 0UL, 1, (size_t)(766405423403602551UL)); (uts_numChildren_bin)(parent); }) ; } ;
...
# 237 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(____alias_loc_id_7); numChildren = ({ call_lbl_5: calling((void*)uts_numChildren_geo, 5, 0UL, 1, (size_t)(766405423403602551UL)); (uts_numChildren_geo)(parent); }) ;
...
# 241 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 if (parent->height < shiftDepth * gen_mx) {alias_group_changed(____alias_loc_id_8); numChildren = ({ call_lbl_7: calling((void*)uts_numChildren_geo, 7, 0UL, 1, (size_t)(766405423403602551UL)); (uts_numChildren_geo)(parent); }) ; } else {alias_group_changed(____alias_loc_id_9); numChildren = ({ call_lbl_9: calling((void*)uts_numChildren_bin, 9, 0UL, 1, (size_t)(766405423403602551UL)); (uts_numChildren_bin)(parent); }) ; } ;
...
# 322 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(____alias_loc_id_12); ind = ({ call_lbl_12: calling((void*)rng_showtype, 12, 0UL, 2, (size_t)(766405423403602730UL), (size_t)(0UL)); (rng_showtype)(strBuf, ind); }) ;
...
# 335 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(____alias_loc_id_13); ind = ({ call_lbl_2: calling((void*)uts_paramsToStr, 2, 0UL, 2, (size_t)(766405423403602736UL), (size_t)(0UL)); (uts_paramsToStr)(strBuf, ind); }) ;
# 336 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(____alias_loc_id_14); ind = ({ call_lbl_4: calling((void*)impl_paramsToStr, 4, 0UL, 2, (size_t)(766405423403602736UL), (size_t)(0UL)); (impl_paramsToStr)(strBuf, ind); }) ;
...
# 345 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 if (argv[i][0] == '-' && argv[i][1] == 'h') {{ alias_group_changed(____alias_loc_id_15); ({ call_lbl_2: calling((void*)uts_helpMessage, 2, 0UL, 0); (uts_helpMessage)(); }) ; ({ call_lbl_3: calling((void*)impl_abort, 3, 0UL, 1, (size_t)(0UL)); (impl_abort)(0); }) ; }; } else if (argv[i][0] != '-' || strlen(argv[i]) != 2 || argc <= i + 1) { err = i; break; }
...
# 400 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(____alias_loc_id_16); ({ call_lbl_22: calling((void*)impl_abort, 22, 0UL, 1, (size_t)(0UL)); (impl_abort)(4); }) ;
...
# 424 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 ({ call_lbl_18: calling((void*)impl_helpMessage, 18, 0UL, 0); (impl_helpMessage)(); }) ;
