...
# 110 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
void uts_error(char *str) {new_stack((void *)(&uts_error), 1, 1, (size_t)(766405423403602254UL), "uts_error|str|0", "i8*", (void *)(&str), (size_t)8, 1, 0, 0); if (____chimes_replaying) { switch(get_next_call()) { case(3): { goto call_lbl_3; } default: { chimes_error(); } } }
...
# 146 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(1, (size_t)(766405423403602273UL)); rm_stack(false, 0UL); return ((n<0)? 0.0 : ((double) n)/2147483648.0);
...
int uts_numChildren_bin(Node * parent) {new_stack((void *)(&uts_numChildren_bin), 1, 1, (size_t)(766405423403602353UL), "uts_numChildren_bin|parent|0", "%struct.node_t*", (void *)(&parent), (size_t)8, 1, 0, 0); if (____chimes_replaying) { goto lbl_0; }
# 162 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
# 163 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(1, (size_t)(766405423403602328UL)); lbl_0: int v; register_stack_var("uts_numChildren_bin|v|0", "i32", (void *)(&v), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_1; } call_lbl_2: calling((void*)&rng_rand, 2, 0UL, 1, (size_t)(766405423403602353UL)); v = (rng_rand(parent->state.state)) ;
# 164 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(1, (size_t)(766405423403602329UL)); lbl_1: double d; register_stack_var("uts_numChildren_bin|d|0", "double", (void *)(&d), (size_t)8, 0, 0, 0); if (____chimes_replaying) { switch(get_next_call()) { case(2): { goto call_lbl_2; } case(4): { goto call_lbl_4; } default: { chimes_error(); } } } call_lbl_4: calling((void*)&rng_toProb, 4, 0UL, 1, (size_t)(0UL)); d = (rng_toProb(v)) ;
# 165 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
# 166 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(1, (size_t)(766405423403602330UL)); rm_stack(false, 0UL); return (d < nonLeafProb) ? nonLeafBF : 0;
...
# 182 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(4, (size_t)(766405423403602355UL), (size_t)(766405423403602356UL), (size_t)(766405423403602357UL), (size_t)(766405423403602360UL)); call_lbl_3: calling((void*)&log, 3, 0UL, 1, (size_t)(0UL)); call_lbl_4: calling((void*)&log, 4, 0UL, 1, (size_t)(0UL)); b_i = b_0 * pow((double) depth, -log(b_0)/log((double) gen_mx));
...
# 191 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(4, (size_t)(766405423403602355UL), (size_t)(766405423403602356UL), (size_t)(766405423403602357UL), (size_t)(766405423403602360UL)); call_lbl_7: calling((void*)&sin, 7, 0UL, 1, (size_t)(0UL)); b_i = pow(b_0,
...
# 213 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(4, (size_t)(766405423403602355UL), (size_t)(766405423403602356UL), (size_t)(766405423403602357UL), (size_t)(766405423403602360UL)); call_lbl_9: calling((void*)&rng_rand, 9, 0UL, 1, (size_t)(766405423403602460UL)); h = rng_rand(parent->state.state);
# 214 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(1, (size_t)(766405423403602359UL)); call_lbl_11: calling((void*)&rng_toProb, 11, 0UL, 1, (size_t)(0UL)); u = rng_toProb(h);
...
# 218 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(1, (size_t)(766405423403602361UL)); call_lbl_13: calling((void*)&floor, 13, 0UL, 1, (size_t)(0UL)); call_lbl_14: calling((void*)&log, 14, 0UL, 1, (size_t)(0UL)); call_lbl_15: calling((void*)&log, 15, 0UL, 1, (size_t)(0UL)); numChildren = floor(log(1 - u) / log(1 - p));
# 219 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
# 220 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(1, (size_t)(766405423403602358UL)); rm_stack(false, 0UL); return numChildren;
...
# 230 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 if (parent->height == 0) {alias_group_changed(2, (size_t)(766405423403602466UL), (size_t)(766405423403602467UL)); call_lbl_2: calling((void*)&floor, 2, 0UL, 1, (size_t)(0UL)); numChildren = (int)floor(b_0); } else {alias_group_changed(2, (size_t)(766405423403602466UL), (size_t)(766405423403602467UL)); call_lbl_4: calling((void*)&uts_numChildren_bin, 4, 0UL, 1, (size_t)(766405423403602551UL)); numChildren = uts_numChildren_bin(parent); } ;
...
# 237 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(2, (size_t)(766405423403602466UL), (size_t)(766405423403602467UL)); call_lbl_6: calling((void*)&uts_numChildren_geo, 6, 0UL, 1, (size_t)(766405423403602551UL)); numChildren = uts_numChildren_geo(parent);
...
# 241 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 if (parent->height < shiftDepth * gen_mx) {alias_group_changed(2, (size_t)(766405423403602466UL), (size_t)(766405423403602467UL)); call_lbl_8: calling((void*)&uts_numChildren_geo, 8, 0UL, 1, (size_t)(766405423403602551UL)); numChildren = uts_numChildren_geo(parent); } else {alias_group_changed(2, (size_t)(766405423403602466UL), (size_t)(766405423403602467UL)); call_lbl_10: calling((void*)&uts_numChildren_bin, 10, 0UL, 1, (size_t)(766405423403602551UL)); numChildren = uts_numChildren_bin(parent); } ;
# 245 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 break;
# 246 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(2, (size_t)(766405423403602466UL), (size_t)(766405423403602467UL)); call_lbl_12: calling((void*)&uts_error, 12, 0UL, 1, (size_t)(766405423403603154UL)); default:
...
# 268 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(2, (size_t)(766405423403602467UL), (size_t)(766405423403602468UL)); rm_stack(false, 0UL); return numChildren;
...
int uts_childType(Node *parent) {new_stack((void *)(&uts_childType), 1, 1, (size_t)(766405423403602582UL), "uts_childType|parent|0", "%struct.node_t*", (void *)(&parent), (size_t)8, 1, 0, 0); if (____chimes_replaying) { switch(get_next_call()) { case(10): { goto call_lbl_10; } default: { chimes_error(); } } }
...
# 275 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(2, (size_t)(766405423403602553UL), (size_t)(766405423403602554UL)); rm_stack(false, 0UL); return BIN;
# 276 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 case GEO:
# 277 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(2, (size_t)(766405423403602553UL), (size_t)(766405423403602554UL)); rm_stack(false, 0UL); return GEO;
# 278 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 case HYBRID:
# 279 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 if (parent->height < shiftDepth * gen_mx) {alias_group_changed(2, (size_t)(766405423403602553UL), (size_t)(766405423403602554UL)); rm_stack(false, 0UL); return GEO;; } else {alias_group_changed(2, (size_t)(766405423403602553UL), (size_t)(766405423403602554UL)); rm_stack(false, 0UL); return BIN;; } ;
...
# 285 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(2, (size_t)(766405423403602553UL), (size_t)(766405423403602554UL)); rm_stack(false, 0UL); return -1;
# 286 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 }
# 287 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
alias_group_changed(2, (size_t)(766405423403602553UL), (size_t)(766405423403602554UL)); rm_stack(false, 0UL); }
...
# 296 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(1, (size_t)(766405423403602584UL)); ind += sprintf(strBuf+ind, "Tree type:  %d (%s)\n", type, uts_trees_str[type]);
...
# 299 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(1, (size_t)(766405423403602584UL)); ind += sprintf(strBuf+ind, "Tree shape parameters:\n");
# 300 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(1, (size_t)(766405423403602584UL)); ind += sprintf(strBuf+ind, "  root branching factor b_0 = %.1f, root seed = %d\n", b_0, rootId);
...
# 303 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(4, (size_t)(766405423403602584UL), (size_t)(766405423403602585UL), (size_t)(766405423403602586UL), (size_t)(766405423403602587UL)); ind += sprintf(strBuf+ind, "  GEO parameters: gen_mx = %d, shape function = %d (%s)\n",
...
# 311 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(4, (size_t)(766405423403602584UL), (size_t)(766405423403602585UL), (size_t)(766405423403602586UL), (size_t)(766405423403602587UL)); ind += sprintf(strBuf+ind, "  BIN parameters:  q = %f, m = %d, E(n) = %f, E(s) = %.2f\n",
...
# 316 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(4, (size_t)(766405423403602584UL), (size_t)(766405423403602585UL), (size_t)(766405423403602586UL), (size_t)(766405423403602587UL)); call_lbl_16: calling((void*)&ceil, 16, 0UL, 1, (size_t)(0UL)); ind += sprintf(strBuf+ind, "  HYBRID:  GEO from root to depth %d, then BIN\n",
...
# 321 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(4, (size_t)(766405423403602584UL), (size_t)(766405423403602585UL), (size_t)(766405423403602586UL), (size_t)(766405423403602587UL)); ind += sprintf(strBuf+ind, "Random number generator: ");
# 322 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(1, (size_t)(766405423403602584UL)); call_lbl_20: calling((void*)&rng_showtype, 20, 0UL, 2, (size_t)(766405423403602730UL), (size_t)(0UL)); ind = rng_showtype(strBuf, ind);
# 323 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(1, (size_t)(766405423403602584UL)); ind += sprintf(strBuf+ind, "\nCompute granularity: %d\n", computeGranularity);
# 324 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
# 325 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(1, (size_t)(766405423403602584UL)); rm_stack(false, 0UL); return ind;
...
# 345 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(6, (size_t)(766405423403602760UL), (size_t)(766405423403602761UL), (size_t)(766405423403602762UL), (size_t)(766405423403602763UL), (size_t)(766405423403603140UL), (size_t)(766405423403603141UL)); call_lbl_5: calling((void*)&strlen, 5, 0UL, 1, (size_t)(766405423403603006UL)); if (argv[i][0] == '-' && argv[i][1] == 'h') {{ alias_group_changed(6, (size_t)(766405423403602760UL), (size_t)(766405423403602761UL), (size_t)(766405423403602762UL), (size_t)(766405423403602763UL), (size_t)(766405423403603140UL), (size_t)(766405423403603141UL)); call_lbl_3: calling((void*)&uts_helpMessage, 3, 0UL, 0); uts_helpMessage(); call_lbl_4: calling((void*)&impl_abort, 4, 0UL, 1, (size_t)(0UL)); impl_abort(0); }; } else if (argv[i][0] != '-' || strlen(argv[i]) != 2 || argc <= i + 1) { err = i; break; }
...
# 355 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 call_lbl_6: calling((void*)&impl_parseParam, 6, 0UL, 2, (size_t)(766405423403603006UL), (size_t)(766405423403603006UL)); if (!impl_parseParam(argv[i], argv[i+1])) {
...
alias_group_changed(6, (size_t)(766405423403602760UL), (size_t)(766405423403602761UL), (size_t)(766405423403602762UL), (size_t)(766405423403602763UL), (size_t)(766405423403603140UL), (size_t)(766405423403603141UL)); rm_stack(false, 0UL); }
...
alias_group_changed(6, (size_t)(766405423403603054UL), (size_t)(766405423403603055UL), (size_t)(766405423403603056UL), (size_t)(766405423403603057UL), (size_t)(766405423403603058UL), (size_t)(766405423403603059UL)); rm_stack(false, 0UL); }
