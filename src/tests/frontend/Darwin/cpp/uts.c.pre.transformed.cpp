...
# 110 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
void uts_error(char *str) {new_stack((void *)(&uts_error), 1, 0, (size_t)(766405423403602254UL)); if (____chimes_replaying) { switch(get_next_call()) { case(3): { goto call_lbl_3; } default: { chimes_error(); } } }
...
int uts_numChildren_bin(Node * parent) {new_stack((void *)(&uts_numChildren_bin), 1, 0, (size_t)(766405423403602353UL)); if (____chimes_replaying) { switch(get_next_call()) { case(2): { goto call_lbl_2; } case(3): { goto call_lbl_3; } default: { chimes_error(); } } }
...
# 166 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(2, (size_t)(766405423403602329UL), (size_t)(766405423403602330UL)); rm_stack(false, 0UL); return (d < nonLeafProb) ? nonLeafBF : 0;
...
# 220 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(3, (size_t)(766405423403602358UL), (size_t)(766405423403602359UL), (size_t)(766405423403602361UL)); rm_stack(false, 0UL); return numChildren;
...
# 230 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 if (parent->height == 0) { call_lbl_1: calling((void*)&floor, 1, 0UL, 1, (size_t)(0UL)); numChildren = (int)floor(b_0); } else {alias_group_changed(2, (size_t)(766405423403602466UL), (size_t)(766405423403602467UL)); call_lbl_3: calling((void*)&uts_numChildren_bin, 3, 0UL, 1, (size_t)(766405423403602551UL)); numChildren = uts_numChildren_bin(parent); } ;
...
# 268 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
 alias_group_changed(3, (size_t)(766405423403602466UL), (size_t)(766405423403602467UL), (size_t)(766405423403602468UL)); rm_stack(false, 0UL); return numChildren;
...
int uts_childType(Node *parent) {new_stack((void *)(&uts_childType), 1, 0, (size_t)(766405423403602582UL)); if (____chimes_replaying) { switch(get_next_call()) { case(10): { goto call_lbl_10; } default: { chimes_error(); } } }
