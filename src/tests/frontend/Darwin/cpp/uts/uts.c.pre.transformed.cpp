...
# 346 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
         call_lbl_1: ({ calling((void*)uts_helpMessage, 1, ____alias_loc_id_14, 0UL, 0); (uts_helpMessage)(); }) ;
# 347 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
         call_lbl_2: ({ calling((void*)impl_abort, 2, 0, 0UL, 1, (size_t)(0UL)); (impl_abort)(0); }) ;
# 348 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
# 349 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
    }; } else if (argv[i][0] != '-' || strlen(argv[i]) != 2 || argc <= i+1) {
# 350 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
      err = i; break;
# 351 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts.c"
    }
