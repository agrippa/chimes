...
# 1359 "/Users/jmg3/num-debug/src/examples/cpp/uts/uts_shm.c"
 lbl_0: Node root; if (____must_checkpoint_main_root_0 != 0) { register_stack_var("main|root|0", &____must_checkpoint_main_root_0, "%struct.node_t = type { i32, i32, i32, %struct.state_t }", (void *)(&root), (size_t)32, 0, 1, 0); } if (____chimes_replaying) { goto lbl_1; } ;
