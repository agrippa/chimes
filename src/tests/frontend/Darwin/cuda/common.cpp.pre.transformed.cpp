...
void parse_source(char *optarg, source *out) {const int ____chimes_disable2 = new_stack((void *)(&parse_source), "parse_source", &____must_manage_parse_source, 2, 0, (size_t)(10806494385137637759UL), (size_t)(10806494385137637760UL)) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
...
float **sample_sources(source *srcs, int nsrcs, int nsteps, float dt) {const int ____chimes_disable4 = new_stack((void *)(&sample_sources), "sample_sources", &____must_manage_sample_sources, 4, 0, (size_t)(10806494385137637973UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
...
# 142 "/Users/jmg3/num-debug/src/examples/cuda/../cpp/lib/common.cpp"
 rm_stack(true, 10806494385137637914UL, "sample_sources", &____must_manage_sample_sources, ____alias_loc_id_4, ____chimes_disable4); return src_samples;
