...
void parse_source(char *optarg, source *out) {const int ____chimes_did_disable2 = new_stack((void *)(&parse_source), "parse_source", &____must_manage_parse_source, 2, 0, (size_t)(10806494385137637759UL), (size_t)(10806494385137637760UL)) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
...
static int module_init() {
    ...
    register_functions(8, "common.cpp.pre.register.cpp", "seconds", &seconds, "ricker_wavelet", &ricker_wavelet, "parse_source", &parse_source, "config_sources", &config_sources, "sample_sources", &sample_sources, "init_progress", &init_progress, "update_progress", &update_progress, "finish_progress", &finish_progress);
    return 0;
}
