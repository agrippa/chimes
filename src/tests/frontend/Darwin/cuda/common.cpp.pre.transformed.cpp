...
void init_progress(int length, int goal, int disabled) {new_stack(3, 3, (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), "init_progress|length|0", "i32", (void *)(&length), (size_t)4, 0, 0, 0, "init_progress|goal|0", "i32", (void *)(&goal), (size_t)4, 0, 0, 0, "init_progress|disabled|0", "i32", (void *)(&disabled), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_0; }
    ...
    alias_group_changed(5, (size_t)(404UL), (size_t)(405UL), (size_t)(406UL), (size_t)(612UL), (size_t)(615UL)); call_lbl_0: calling(0, 0UL, 2, (size_t)(0UL), (size_t)(0UL)); call_lbl_1: calling(1, 0UL, 4, (size_t)(616UL), (size_t)(617UL), (size_t)(0UL), (size_t)(618UL)); (__builtin_expect(!(progress_buffer != __null), 0) ? __assert_rtn(__func__, "/Users/jmg3/num-debug/src/examples/cuda/../cpp/lib/common.cpp", 162, "progress_buffer != NULL") : (void)0);
