...
# 5 "/Users/jmg3/num-debug/src/examples/cuda/../cpp/include/common2d.h" 2
...
# 8 "/Users/jmg3/num-debug/src/examples/cuda/../cpp/lib/common2d.cpp"
 const int ny, const int nx, const char *filename, int radius) {new_stack((void *)(&save_text), 7, 7, (size_t)(17753382416546318007UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(17753382416546318012UL), (size_t)(0UL), "save_text|field|0", "float*", (void *)(&field), (size_t)8, 1, 0, 0, "save_text|dimx|0", "i32", (void *)(&dimx), (size_t)4, 0, 0, 0, "save_text|dimy|0", "i32", (void *)(&dimy), (size_t)4, 0, 0, 0, "save_text|ny|0", "i32", (void *)(&ny), (size_t)4, 0, 0, 0, "save_text|nx|0", "i32", (void *)(&nx), (size_t)4, 0, 0, 0, "save_text|filename|0", "i8*", (void *)(&filename), (size_t)8, 1, 0, 0, "save_text|radius|0", "i32", (void *)(&radius), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_0; }
...
# 16 "/Users/jmg3/num-debug/src/examples/cuda/../cpp/lib/common2d.cpp"
 { lbl_2: int x; register_stack_var("save_text|x|0", "i32", (void *)(&x), (size_t)4, 0, 0, 0); if (____chimes_replaying) { switch(get_next_call()) { case(7): { goto call_lbl_7; } default: { chimes_error(); } } } for ( x = (0) ; x < nx; x++) {
...
# 28 "/Users/jmg3/num-debug/src/examples/cuda/../cpp/lib/common2d.cpp"
 const float dx, const float dt) {new_stack((void *)(&init_data), 8, 0, (size_t)(17753382416546318145UL), (size_t)(17753382416546318146UL), (size_t)(17753382416546318147UL), (size_t)(17753382416546318148UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)); if (____chimes_replaying) { switch(get_next_call()) { case(1): { goto call_lbl_1; } default: { chimes_error(); } } }
...
# 39 "/Users/jmg3/num-debug/src/examples/cuda/../cpp/lib/common2d.cpp"
 call_lbl_1: calling((void*)&memset, 1, 0UL, 3, (size_t)(17753382416546318148UL), (size_t)(0UL), (size_t)(0UL)); memset(h_coeff, 0, 20 * sizeof(float));
...
alias_group_changed(15, (size_t)(17753382416546318022UL), (size_t)(17753382416546318023UL), (size_t)(17753382416546318024UL), (size_t)(17753382416546318025UL), (size_t)(17753382416546318026UL), (size_t)(17753382416546318027UL), (size_t)(17753382416546318028UL), (size_t)(17753382416546318029UL), (size_t)(17753382416546318030UL), (size_t)(17753382416546318031UL), (size_t)(17753382416546318032UL), (size_t)(17753382416546318145UL), (size_t)(17753382416546318146UL), (size_t)(17753382416546318147UL), (size_t)(17753382416546318148UL)); rm_stack(false, 0UL); }
...
void usage(char **argv) {new_stack((void *)(&usage), 1, 1, (size_t)(17753382416546318169UL), "usage|argv|0", "i8**", (void *)(&argv), (size_t)8, 1, 0, 0); if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } }
...
alias_group_changed(2, (size_t)(17753382416546318170UL), (size_t)(17753382416546318207UL)); rm_stack(false, 0UL); }
...
void setup_config(config *conf, int argc, char **argv) {new_stack((void *)(&setup_config), 3, 3, (size_t)(17753382416546318329UL), (size_t)(0UL), (size_t)(17753382416546318331UL), "setup_config|conf|0", "%struct._config*", (void *)(&conf), (size_t)8, 1, 0, 0, "setup_config|argc|0", "i32", (void *)(&argc), (size_t)4, 0, 0, 0, "setup_config|argv|0", "i8**", (void *)(&argv), (size_t)8, 1, 0, 0); if (____chimes_replaying) { goto lbl_0; }
# 72 "/Users/jmg3/num-debug/src/examples/cuda/../cpp/lib/common2d.cpp"
 lbl_0: int c; register_stack_var("setup_config|c|0", "i32", (void *)(&c), (size_t)4, 0, 0, 0); if (____chimes_replaying) { switch(get_next_call()) { case(1): { goto call_lbl_1; } case(12): { goto call_lbl_12; } case(21): { goto call_lbl_21; } case(23): { goto call_lbl_23; } default: { chimes_error(); } } } ;
...
# 75 "/Users/jmg3/num-debug/src/examples/cuda/../cpp/lib/common2d.cpp"
 call_lbl_1: calling((void*)&default_config, 1, 0UL, 1, (size_t)(17753382416546318329UL)); default_config(conf);
...
# 77 "/Users/jmg3/num-debug/src/examples/cuda/../cpp/lib/common2d.cpp"
 alias_group_changed(6, (size_t)(17753382416546318208UL), (size_t)(17753382416546318209UL), (size_t)(17753382416546318210UL), (size_t)(17753382416546318211UL), (size_t)(17753382416546318329UL), (size_t)(17753382416546318346UL)); while ((c = getopt(argc, argv, "x:y:z:i:svr:tp:g:w:d")) != -1) {
...
# 79 "/Users/jmg3/num-debug/src/examples/cuda/../cpp/lib/common2d.cpp"
 alias_group_changed(2, (size_t)(17753382416546318211UL), (size_t)(17753382416546318329UL)); case 'x':
...
# 82 "/Users/jmg3/num-debug/src/examples/cuda/../cpp/lib/common2d.cpp"
 alias_group_changed(2, (size_t)(17753382416546318211UL), (size_t)(17753382416546318329UL)); case 'y':
...
# 85 "/Users/jmg3/num-debug/src/examples/cuda/../cpp/lib/common2d.cpp"
 alias_group_changed(2, (size_t)(17753382416546318211UL), (size_t)(17753382416546318329UL)); case 'i':
...
# 96 "/Users/jmg3/num-debug/src/examples/cuda/../cpp/lib/common2d.cpp"
 (conf->nsrcs + 1), 17753382416546318259UL);
...
# 100 "/Users/jmg3/num-debug/src/examples/cuda/../cpp/lib/common2d.cpp"
 alias_group_changed(2, (size_t)(17753382416546318211UL), (size_t)(17753382416546318329UL)); case 'r':
...
# 103 "/Users/jmg3/num-debug/src/examples/cuda/../cpp/lib/common2d.cpp"
 alias_group_changed(2, (size_t)(17753382416546318211UL), (size_t)(17753382416546318329UL)); case 'g':
...
# 106 "/Users/jmg3/num-debug/src/examples/cuda/../cpp/lib/common2d.cpp"
 alias_group_changed(2, (size_t)(17753382416546318211UL), (size_t)(17753382416546318329UL)); case 'w':
...
# 114 "/Users/jmg3/num-debug/src/examples/cuda/../cpp/lib/common2d.cpp"
 alias_group_changed(2, (size_t)(17753382416546318211UL), (size_t)(17753382416546318329UL)); call_lbl_21: calling((void*)&usage, 21, 0UL, 1, (size_t)(17753382416546318331UL)); default:
...
# 120 "/Users/jmg3/num-debug/src/examples/cuda/../cpp/lib/common2d.cpp"
 alias_group_changed(2, (size_t)(17753382416546318211UL), (size_t)(17753382416546318329UL)); call_lbl_23: calling((void*)&getNumCUDADevices, 23, 0UL, 0); conf->ngpus = getNumCUDADevices();
...
alias_group_changed(2, (size_t)(17753382416546318211UL), (size_t)(17753382416546318329UL)); rm_stack(false, 0UL); }


static int module_init() {
    init_module(17753382416546317923UL, 16, 5, 17753382416546317923UL + 235UL, 17753382416546317923UL + 246UL, 17753382416546317923UL + 99UL, 17753382416546317923UL + 222UL, 17753382416546317923UL + 425UL, 17753382416546317923UL + 308UL, 17753382416546317923UL + 418UL, 17753382416546317923UL + 387UL, 17753382416546317923UL + 1UL, 17753382416546317923UL + 84UL, 17753382416546317923UL + 406UL, 17753382416546317923UL + 336UL, 17753382416546317923UL + 247UL, 17753382416546317923UL + 284UL, 17753382416546317923UL + 246UL, 17753382416546317923UL + 241UL, 17753382416546317923UL + 6UL, 17753382416546317923UL + 89UL, 17753382416546317923UL + 102UL, 17753382416546317923UL + 225UL, 17753382416546317923UL + 8UL, 17753382416546317923UL + 27UL, 17753382416546317923UL + 100UL, 17753382416546317923UL + 223UL, 17753382416546317923UL + 101UL, 17753382416546317923UL + 224UL, 17753382416546317923UL + 285UL, 17753382416546317923UL + 406UL, 17753382416546317923UL + 284UL, 17753382416546317923UL + 428UL, 17753382416546317923UL + 287UL, 17753382416546317923UL + 408UL, "__sFILE", 20, (int)__builtin_offsetof(struct __sFILE, _p), (int)__builtin_offsetof(struct __sFILE, _r), (int)__builtin_offsetof(struct __sFILE, _w), (int)__builtin_offsetof(struct __sFILE, _flags), (int)__builtin_offsetof(struct __sFILE, _file), (int)__builtin_offsetof(struct __sFILE, _bf), (int)__builtin_offsetof(struct __sFILE, _lbfsize), (int)__builtin_offsetof(struct __sFILE, _cookie), (int)__builtin_offsetof(struct __sFILE, _close), (int)__builtin_offsetof(struct __sFILE, _read), (int)__builtin_offsetof(struct __sFILE, _seek), (int)__builtin_offsetof(struct __sFILE, _write), (int)__builtin_offsetof(struct __sFILE, _ub), (int)__builtin_offsetof(struct __sFILE, _extra), (int)__builtin_offsetof(struct __sFILE, _ur), (int)__builtin_offsetof(struct __sFILE, _ubuf), (int)__builtin_offsetof(struct __sFILE, _nbuf), (int)__builtin_offsetof(struct __sFILE, _lb), (int)__builtin_offsetof(struct __sFILE, _blksize), (int)__builtin_offsetof(struct __sFILE, _offset), "__sFILEX", 0, "__sbuf", 2, (int)__builtin_offsetof(struct __sbuf, _base), (int)__builtin_offsetof(struct __sbuf, _size), "_config", 11, (int)__builtin_offsetof(struct _config, nx), (int)__builtin_offsetof(struct _config, ny), (int)__builtin_offsetof(struct _config, nsteps), (int)__builtin_offsetof(struct _config, save_text), (int)__builtin_offsetof(struct _config, verbose), (int)__builtin_offsetof(struct _config, radius), (int)__builtin_offsetof(struct _config, ngpus), (int)__builtin_offsetof(struct _config, srcs), (int)__builtin_offsetof(struct _config, nsrcs), (int)__builtin_offsetof(struct _config, progress_width), (int)__builtin_offsetof(struct _config, progress_disabled), "_source", 4, (int)__builtin_offsetof(struct _source, x), (int)__builtin_offsetof(struct _source, y), (int)__builtin_offsetof(struct _source, freq), (int)__builtin_offsetof(struct _source, t));
    return 0;
}
