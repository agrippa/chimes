...
static int module_init() {
    init_module(12059379678030502345UL, 5, 1, 12059379678030502345UL + 245UL, 12059379678030502345UL + 326UL, 12059379678030502345UL + 244UL, 12059379678030502345UL + 326UL, 12059379678030502345UL + 5UL, 12059379678030502345UL + 34UL, 12059379678030502345UL + 4UL, 12059379678030502345UL + 230UL, 12059379678030502345UL + 240UL, 12059379678030502345UL + 326UL, "DomainSt", 8, (int)__builtin_offsetof (struct DomainSt, procGrid), (int)__builtin_offsetof (struct DomainSt, procCoord), (int)__builtin_offsetof (struct DomainSt, globalMin), (int)__builtin_offsetof (struct DomainSt, globalMax), (int)__builtin_offsetof (struct DomainSt, globalExtent), (int)__builtin_offsetof (struct DomainSt, localMin), (int)__builtin_offsetof (struct DomainSt, localMax), (int)__builtin_offsetof (struct DomainSt, localExtent));
    return 0;
}
