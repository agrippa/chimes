...
# 20 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/decomposition.c"
   alias_group_changed(____alias_loc_id_0); (__builtin_expect(!(xproc * yproc * zproc == ({ call_lbl_3: calling((void*)getNRanks, 3, 0UL, 0); (getNRanks)(); }) ), 0) ? __assert_rtn(__func__, "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/decomposition.c", 20, "xproc * yproc * zproc == getNRanks()") : (void)0);
