...
# 336 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/haloExchange.c"
     lbl_0: int *list; if (____must_checkpoint_mkAtomCellList_list_0 != 0) { register_stack_var("mkAtomCellList|list|0", &____must_checkpoint_mkAtomCellList_list_0, "i32*", (void *)(&list), (size_t)8, 1, 0, 0); } if (____chimes_replaying) { goto lbl_1; } list = ((int *)malloc_wrapper(nCells * sizeof(int), 18379826249005485420UL, 0, 0)) ;
...
# 457 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/haloExchange.c"
     lbl_0: int *list; if (____must_checkpoint_mkForceSendCellList_list_0 != 0) { register_stack_var("mkForceSendCellList|list|0", &____must_checkpoint_mkForceSendCellList_list_0, "i32*", (void *)(&list), (size_t)8, 1, 0, 0); } if (____chimes_replaying) { goto lbl_1; } list = ((int *)malloc_wrapper(nCells * sizeof(int), 18379826249005486140UL, 0, 0)) ;
...
# 509 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/haloExchange.c"
     lbl_0: int *list; if (____must_checkpoint_mkForceRecvCellList_list_0 != 0) { register_stack_var("mkForceRecvCellList|list|0", &____must_checkpoint_mkForceRecvCellList_list_0, "i32*", (void *)(&list), (size_t)8, 1, 0, 0); } if (____chimes_replaying) { goto lbl_1; } list = ((int *)malloc_wrapper(nCells * sizeof(int), 18379826249005486337UL, 0, 0)) ;
...
{new_stack((void *)(&sortAtomsInCell), 3, 0, (size_t)(18379826249005486831UL), (size_t)(18379826249005486832UL), (size_t)(0UL)); if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } }
