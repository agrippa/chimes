...
{new_stack((void *)(&destroyHaloExchange), "destroyHaloExchange", &____must_manage_destroyHaloExchange, 1, 0, (size_t)(18379826249005486357UL)); if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } }
...
{new_stack((void *)(&initHaloExchange), "initHaloExchange", &____must_manage_initHaloExchange, 1, 1, (size_t)(18379826249005484771UL), "initHaloExchange|domain|0", &____must_checkpoint_initHaloExchange_domain_0, "%struct.DomainSt*", (void *)(&domain), (size_t)8, 1, 0, 0); if (____chimes_replaying) { goto lbl_0; }
...
{new_stack((void *)(&loadAtomsBuffer), "loadAtomsBuffer", &____must_manage_loadAtomsBuffer, 4, 0, (size_t)(18379826249005485060UL), (size_t)(18379826249005485061UL), (size_t)(0UL), (size_t)(18379826249005485063UL)); if (____chimes_replaying) { goto lbl_0; }
...
{new_stack((void *)(&unloadAtomsBuffer), "unloadAtomsBuffer", &____must_manage_unloadAtomsBuffer, 5, 0, (size_t)(18379826249005485215UL), (size_t)(18379826249005485216UL), (size_t)(0UL), (size_t)(0UL), (size_t)(18379826249005485219UL)); if (____chimes_replaying) { goto lbl_0; }
...
{new_stack((void *)(&destroyAtomsExchange), "destroyAtomsExchange", &____must_manage_destroyAtomsExchange, 1, 0, (size_t)(18379826249005485257UL)); if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } }
...
{new_stack((void *)(&mkForceRecvCellList), "mkForceRecvCellList", &____must_manage_mkForceRecvCellList, 3, 2, (size_t)(18379826249005486339UL), (size_t)(0UL), (size_t)(0UL), "mkForceRecvCellList|boxes|0", &____must_checkpoint_mkForceRecvCellList_boxes_0, "%struct.LinkCellSt*", (void *)(&boxes), (size_t)8, 1, 0, 0, "mkForceRecvCellList|nCells|0", &____must_checkpoint_mkForceRecvCellList_nCells_0, "i32", (void *)(&nCells), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_0; }
...
{new_stack((void *)(&loadForceBuffer), "loadForceBuffer", &____must_manage_loadForceBuffer, 4, 0, (size_t)(18379826249005485755UL), (size_t)(18379826249005485756UL), (size_t)(0UL), (size_t)(18379826249005485758UL)); if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } }
...
{new_stack((void *)(&unloadForceBuffer), "unloadForceBuffer", &____must_manage_unloadForceBuffer, 5, 0, (size_t)(18379826249005485812UL), (size_t)(18379826249005485906UL), (size_t)(0UL), (size_t)(0UL), (size_t)(18379826249005485909UL)); if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } }
...
{new_stack((void *)(&destroyForceExchange), "destroyForceExchange", &____must_manage_destroyForceExchange, 1, 0, (size_t)(18379826249005485947UL)); if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } }
...
{new_stack((void *)(&sortAtomsInCell), "sortAtomsInCell", &____must_manage_sortAtomsInCell, 3, 0, (size_t)(18379826249005486831UL), (size_t)(18379826249005486832UL), (size_t)(0UL)); if (____chimes_replaying) { goto lbl_0; }
...
{new_stack((void *)(&sortAtomsById), "sortAtomsById", &____must_manage_sortAtomsById, 2, 0, (size_t)(18379826249005486881UL), (size_t)(18379826249005486882UL)); if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } }
