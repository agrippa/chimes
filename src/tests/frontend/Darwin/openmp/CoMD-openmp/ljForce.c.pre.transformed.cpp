...
{new_stack((void *)(&ljDestroy), 1, 1, (size_t)(17518077371777717474UL), "ljDestroy|inppot|0", "%struct.BasePotentialSt**", (void *)(&inppot), (size_t)8, 1, 0, 0); if (____chimes_replaying) { goto lbl_0; }
...
# 121 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/ljForce.c"
   alias_group_changed(2, (size_t)(17518077371777717478UL), (size_t)(17518077371777717480UL)); call_lbl_3: calling((void*)&strcpy, 3, 17518077371777717507UL, 2, (size_t)(17518077371777717480UL), (size_t)(17518077371777718002UL)); strcpy(pot->latticeType, "FCC");
...
# 124 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/ljForce.c"
   alias_group_changed(1, (size_t)(17518077371777717480UL)); call_lbl_5: calling((void*)&strcpy, 5, 17518077371777717518UL, 2, (size_t)(17518077371777717480UL), (size_t)(17518077371777718003UL)); strcpy(pot->name, "Cu");
...
# 127 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/ljForce.c"
   alias_group_changed(1, (size_t)(17518077371777717480UL)); rm_stack(true, 17518077371777717480UL); return (BasePotential*) pot;
...
{new_stack((void *)(&ljPrint), 2, 2, (size_t)(17518077371777717976UL), (size_t)(17518077371777717977UL), "ljPrint|file|0", "%struct.__sFILE*", (void *)(&file), (size_t)8, 1, 0, 0, "ljPrint|pot|0", "%struct.BasePotentialSt*", (void *)(&pot), (size_t)8, 1, 0, 0); if (____chimes_replaying) { goto lbl_0; }
...
{new_stack((void *)(&ljForce), 1, 1, (size_t)(17518077371777717714UL), "ljForce|s|0", "%struct.SimFlatSt*", (void *)(&s), (size_t)8, 1, 0, 0); if (____chimes_replaying) { goto lbl_0; }
...
# 155 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/ljForce.c"
     lbl_6: int fSize; register_stack_var("ljForce|fSize|0", "i32", (void *)(&fSize), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_7; } fSize = (s->boxes->nTotalBoxes * 64); { call_lbl_7: unsigned ____chimes_parent_thread0 = entering_omp_parallel(7, 0); ;
...
# 157 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/ljForce.c"
   { register_thread_local_stack_vars(LIBCHIMES_THREAD_NUM(), ____chimes_parent_thread0, true, 0); if (____chimes_replaying) { goto lbl_11; } lbl_11: int ii; register_stack_var("ljForce|ii|0", "i32", (void *)(&ii), (size_t)4, 0, 0, 0); if (____chimes_replaying) { switch(get_next_call()) { case(1): { goto call_lbl_1; } default: { chimes_error(); } } } for ( ii = (0) ; ii<fSize; ++ii)
...
# 163 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/ljForce.c"
     lbl_7: real_t s6; register_stack_var("ljForce|s6|0", "double", (void *)(&s6), (size_t)8, 0, 0, 0); if (____chimes_replaying) { goto lbl_8; } s6 = (sigma * sigma * sigma * sigma * sigma * sigma) ;
...
# 165 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/ljForce.c"
     lbl_8: real_t rCut6; register_stack_var("ljForce|rCut6|0", "double", (void *)(&rCut6), (size_t)8, 0, 0, 0); if (____chimes_replaying) { goto lbl_9; } rCut6 = (s6 / (rCut2 * rCut2 * rCut2)) ;
# 166 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/ljForce.c"
     lbl_9: real_t eShift; register_stack_var("ljForce|eShift|0", "double", (void *)(&eShift), (size_t)8, 0, 0, 0); if (____chimes_replaying) { goto lbl_10; } eShift = (1. * rCut6 * (rCut6 - 1.)) ;
...
# 168 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/ljForce.c"
     lbl_10: int nNbrBoxes; register_stack_var("ljForce|nNbrBoxes|0", "i32", (void *)(&nNbrBoxes), (size_t)4, 0, 0, 0); if (____chimes_replaying) { switch(get_next_call()) { case(7): { goto call_lbl_7; } case(8): { goto call_lbl_8; } default: { chimes_error(); } } } nNbrBoxes = (27); { call_lbl_8: unsigned ____chimes_parent_thread1 = entering_omp_parallel(8, 0); ;
...
# 172 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/ljForce.c"
   { register_thread_local_stack_vars(LIBCHIMES_THREAD_NUM(), ____chimes_parent_thread1, true, 0); if (____chimes_replaying) { goto lbl_12; } lbl_12: int iBox; register_stack_var("ljForce|iBox|0", "i32", (void *)(&iBox), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_13; } for ( iBox = (0) ; iBox<s->boxes->nLocalBoxes; iBox++)
...
# 177 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/ljForce.c"
      { lbl_14: int jTmp; register_stack_var("ljForce|jTmp|0", "i32", (void *)(&jTmp), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_15; } for ( jTmp = (0) ; jTmp<nNbrBoxes; jTmp++)
...
# 179 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/ljForce.c"
           lbl_15: int jBox; register_stack_var("ljForce|jBox|0", "i32", (void *)(&jBox), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_16; } jBox = (s->boxes->nbrBoxes[iBox][jTmp]) ;
...
# 183 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/ljForce.c"
           lbl_16: int nJBox; register_stack_var("ljForce|nJBox|0", "i32", (void *)(&nJBox), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_17; } nJBox = (s->boxes->nAtoms[jBox]) ;
...
# 186 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/ljForce.c"
         { lbl_17: int iOff; register_stack_var("ljForce|iOff|0", "i32", (void *)(&iOff), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_18; } for ( iOff = (64 * iBox) ; iOff<(iBox*64 +nIBox); iOff++)
...
# 190 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/ljForce.c"
            { lbl_18: int jOff; register_stack_var("ljForce|jOff|0", "i32", (void *)(&jOff), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_19; } for ( jOff = (jBox * 64) ; jOff<(jBox*64 +nJBox); jOff++)
...
# 192 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/ljForce.c"
                lbl_19: real3 dr; register_stack_var("ljForce|dr|0", "[3 x double]", (void *)(dr), (size_t)24, 0, 0, 0); if (____chimes_replaying) { goto lbl_20; } ;
# 193 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/ljForce.c"
                 lbl_20: real_t r2; register_stack_var("ljForce|r2|0", "double", (void *)(&r2), (size_t)8, 0, 0, 0); if (____chimes_replaying) { goto lbl_21; } r2 = (0.) ;
# 194 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/ljForce.c"
               { lbl_21: int m; register_stack_var("ljForce|m|0", "i32", (void *)(&m), (size_t)4, 0, 0, 0); if (____chimes_replaying) { goto lbl_22; } for ( m = (0) ; m<3; m++)
...
# 206 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/ljForce.c"
                    lbl_22: real_t r6; register_stack_var("ljForce|r6|0", "double", (void *)(&r6), (size_t)8, 0, 0, 0); if (____chimes_replaying) { goto lbl_23; } r6 = (s6 * (r2 * r2 * r2)) ;
# 207 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/ljForce.c"
                    lbl_23: real_t eLocal; register_stack_var("ljForce|eLocal|0", "double", (void *)(&eLocal), (size_t)8, 0, 0, 0); if (____chimes_replaying) { goto lbl_24; } eLocal = (r6 * (r6 - 1.) - eShift) ;
...
# 212 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/ljForce.c"
                    lbl_24: real_t fr; register_stack_var("ljForce|fr|0", "double", (void *)(&fr), (size_t)8, 0, 0, 0); if (____chimes_replaying) { goto lbl_25; } fr = (-4. * epsilon * r6 * r2 * (12. * r6 - 6.)) ;
# 213 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/ljForce.c"
                  { lbl_25: int m; register_stack_var("ljForce|m|1", "i32", (void *)(&m), (size_t)4, 0, 0, 0); if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } for ( m = (0) ; m<3; m++)
...
static int module_init() {
    init_module(17518077371777717449UL, 14, 11, 17518077371777717449UL + 25UL, 17518077371777717449UL + 11UL, 17518077371777717449UL + 77UL, 17518077371777717449UL + 265UL, 17518077371777717449UL + 472UL, 17518077371777717449UL + 527UL, 17518077371777717449UL + 31UL, 17518077371777717449UL + 567UL, 17518077371777717449UL + 531UL, 17518077371777717449UL + 544UL, 17518077371777717449UL + 29UL, 17518077371777717449UL + 31UL, 17518077371777717449UL + 1UL, 17518077371777717449UL + 25UL, 17518077371777717449UL + 473UL, 17518077371777717449UL + 528UL, 17518077371777717449UL + 2UL, 17518077371777717449UL + 11UL, 17518077371777717449UL + 267UL, 17518077371777717449UL + 269UL, 17518077371777717449UL + 265UL, 17518077371777717449UL + 267UL, 17518077371777717449UL + 474UL, 17518077371777717449UL + 528UL, 17518077371777717449UL + 269UL, 17518077371777717449UL + 247UL, 17518077371777717449UL + 78UL, 17518077371777717449UL + 267UL, "AtomsSt", 8, (int)__builtin_offsetof (struct AtomsSt, nLocal), (int)__builtin_offsetof (struct AtomsSt, nGlobal), (int)__builtin_offsetof (struct AtomsSt, gid), (int)__builtin_offsetof (struct AtomsSt, iSpecies), (int)__builtin_offsetof (struct AtomsSt, r), (int)__builtin_offsetof (struct AtomsSt, p), (int)__builtin_offsetof (struct AtomsSt, f), (int)__builtin_offsetof (struct AtomsSt, U), "BasePotentialSt", 9, (int)__builtin_offsetof (struct BasePotentialSt, cutoff), (int)__builtin_offsetof (struct BasePotentialSt, mass), (int)__builtin_offsetof (struct BasePotentialSt, lat), (int)__builtin_offsetof (struct BasePotentialSt, latticeType), (int)__builtin_offsetof (struct BasePotentialSt, name), (int)__builtin_offsetof (struct BasePotentialSt, atomicNo), (int)__builtin_offsetof (struct BasePotentialSt, force), (int)__builtin_offsetof (struct BasePotentialSt, print), (int)__builtin_offsetof (struct BasePotentialSt, destroy), "DomainSt", 8, (int)__builtin_offsetof (struct DomainSt, procGrid), (int)__builtin_offsetof (struct DomainSt, procCoord), (int)__builtin_offsetof (struct DomainSt, globalMin), (int)__builtin_offsetof (struct DomainSt, globalMax), (int)__builtin_offsetof (struct DomainSt, globalExtent), (int)__builtin_offsetof (struct DomainSt, localMin), (int)__builtin_offsetof (struct DomainSt, localMax), (int)__builtin_offsetof (struct DomainSt, localExtent), "HaloExchangeSt", 6, (int)__builtin_offsetof (struct HaloExchangeSt, nbrRank), (int)__builtin_offsetof (struct HaloExchangeSt, bufCapacity), (int)__builtin_offsetof (struct HaloExchangeSt, loadBuffer), (int)__builtin_offsetof (struct HaloExchangeSt, unloadBuffer), (int)__builtin_offsetof (struct HaloExchangeSt, destroy), (int)__builtin_offsetof (struct HaloExchangeSt, parms), "LinkCellSt", 10, (int)__builtin_offsetof (struct LinkCellSt, gridSize), (int)__builtin_offsetof (struct LinkCellSt, nLocalBoxes), (int)__builtin_offsetof (struct LinkCellSt, nHaloBoxes), (int)__builtin_offsetof (struct LinkCellSt, nTotalBoxes), (int)__builtin_offsetof (struct LinkCellSt, localMin), (int)__builtin_offsetof (struct LinkCellSt, localMax), (int)__builtin_offsetof (struct LinkCellSt, boxSize), (int)__builtin_offsetof (struct LinkCellSt, invBoxSize), (int)__builtin_offsetof (struct LinkCellSt, nAtoms), (int)__builtin_offsetof (struct LinkCellSt, nbrBoxes), "LjPotentialSt", 11, (int)__builtin_offsetof (struct LjPotentialSt, cutoff), (int)__builtin_offsetof (struct LjPotentialSt, mass), (int)__builtin_offsetof (struct LjPotentialSt, lat), (int)__builtin_offsetof (struct LjPotentialSt, latticeType), (int)__builtin_offsetof (struct LjPotentialSt, name), (int)__builtin_offsetof (struct LjPotentialSt, atomicNo), (int)__builtin_offsetof (struct LjPotentialSt, force), (int)__builtin_offsetof (struct LjPotentialSt, print), (int)__builtin_offsetof (struct LjPotentialSt, destroy), (int)__builtin_offsetof (struct LjPotentialSt, sigma), (int)__builtin_offsetof (struct LjPotentialSt, epsilon), "SimFlatSt", 11, (int)__builtin_offsetof (struct SimFlatSt, nSteps), (int)__builtin_offsetof (struct SimFlatSt, printRate), (int)__builtin_offsetof (struct SimFlatSt, dt), (int)__builtin_offsetof (struct SimFlatSt, domain), (int)__builtin_offsetof (struct SimFlatSt, boxes), (int)__builtin_offsetof (struct SimFlatSt, atoms), (int)__builtin_offsetof (struct SimFlatSt, species), (int)__builtin_offsetof (struct SimFlatSt, ePotential), (int)__builtin_offsetof (struct SimFlatSt, eKinetic), (int)__builtin_offsetof (struct SimFlatSt, pot), (int)__builtin_offsetof (struct SimFlatSt, atomExchange), "SpeciesDataSt", 3, (int)__builtin_offsetof (struct SpeciesDataSt, name), (int)__builtin_offsetof (struct SpeciesDataSt, atomicNo), (int)__builtin_offsetof (struct SpeciesDataSt, mass), "__sFILE", 20, (int)__builtin_offsetof (struct __sFILE, _p), (int)__builtin_offsetof (struct __sFILE, _r), (int)__builtin_offsetof (struct __sFILE, _w), (int)__builtin_offsetof (struct __sFILE, _flags), (int)__builtin_offsetof (struct __sFILE, _file), (int)__builtin_offsetof (struct __sFILE, _bf), (int)__builtin_offsetof (struct __sFILE, _lbfsize), (int)__builtin_offsetof (struct __sFILE, _cookie), (int)__builtin_offsetof (struct __sFILE, _close), (int)__builtin_offsetof (struct __sFILE, _read), (int)__builtin_offsetof (struct __sFILE, _seek), (int)__builtin_offsetof (struct __sFILE, _write), (int)__builtin_offsetof (struct __sFILE, _ub), (int)__builtin_offsetof (struct __sFILE, _extra), (int)__builtin_offsetof (struct __sFILE, _ur), (int)__builtin_offsetof (struct __sFILE, _ubuf), (int)__builtin_offsetof (struct __sFILE, _nbuf), (int)__builtin_offsetof (struct __sFILE, _lb), (int)__builtin_offsetof (struct __sFILE, _blksize), (int)__builtin_offsetof (struct __sFILE, _offset), "__sFILEX", 0, "__sbuf", 2, (int)__builtin_offsetof (struct __sbuf, _base), (int)__builtin_offsetof (struct __sbuf, _size));
    return 0;
}
