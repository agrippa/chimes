...
# 212 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/mycommand.c"
   alias_group_changed(____alias_loc_id_0); call_lbl_8: calling((void*)&addArg, 8, 0UL, 7, (size_t)(6351733837270304336UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(6351733837270304104UL), (size_t)(0UL), (size_t)(6351733837270304340UL)); addArg("help", 'h', 0, 'i', &(help), 0, "print this message");
...
# 249 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/mycommand.c"
   rm_stack(false, 0UL, "parseCommandLine", &____must_manage_parseCommandLine, 0); return cmd;
...
# 254 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/mycommand.c"
   alias_group_changed(____alias_loc_id_1); call_lbl_2: calling((void*)&printRank, 2, 0UL, 0); if (!printRank()) {rm_stack(false, 0UL, "printCmdYaml", &____must_manage_printCmdYaml, 0); return;; };
...
rm_stack(false, 0UL, "printCmdYaml", &____must_manage_printCmdYaml, 0); }
