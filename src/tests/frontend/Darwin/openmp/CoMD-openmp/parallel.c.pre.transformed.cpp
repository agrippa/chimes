...
# 107 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/parallel.c"
    ({ call_lbl_3: const void * ____chimes_arg3; size_t ____chimes_arg4; if (!____chimes_replaying) { ____chimes_arg3 = (sendBuf); ____chimes_arg4 = (sendLen); } calling((void*)memcpy, 3, 0UL, 3, (size_t)(2720369932807153940UL), (size_t)(2720369932807153941UL), (size_t)(0UL)); (memcpy)(recvBuf, ____chimes_arg3, ____chimes_arg4); }) ;
