...
{new_stack((void *)(&getTimeString), 1, 1, (size_t)(5761392777509905392UL), "getTimeString|timestring|0", &____must_checkpoint_getTimeString_timestring_0, "i8*", (void *)(&timestring), (size_t)8, 1, 0, 0); if (____chimes_replaying) { goto lbl_0; }
# 31 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/yamlOutput.c"
    lbl_0: time_t rawtime; if (____must_checkpoint_getTimeString_rawtime_0 != 0) { register_stack_var("getTimeString|rawtime|0", &____must_checkpoint_getTimeString_rawtime_0, "i64", (void *)(&rawtime), (size_t)8, 0, 0, 0); } if (____chimes_replaying) { switch(get_next_call()) { case(2): { goto call_lbl_2; } case(3): { goto call_lbl_3; } default: { chimes_error(); } } } ;
...
# 34 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/yamlOutput.c"
    call_lbl_3: calling((void*)&localtime, 3, 5761392777509905367UL, 1, (size_t)(5761392777509905360UL)); timeinfo = localtime(&rawtime);
...
alias_group_changed(1, (size_t)(5761392777509905361UL)); rm_stack(false, 0UL); }
...
# 48 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/yamlOutput.c"
    call_lbl_1: calling((void*)&printRank, 1, 0UL, 0); if (!printRank()) {alias_group_changed(1, (size_t)(5761392777509905247UL)); rm_stack(false, 0UL); return;; };
...
# 54 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/yamlOutput.c"
    struct tm *ptm; call_lbl_5: calling((void*)&localtime, 5, 5761392777509905257UL, 1, (size_t)(5761392777509905246UL)); ptm = (localtime(&rawtime)) ;
# 55 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/yamlOutput.c"
    lbl_2: char sdate[25]; if (____must_checkpoint_yamlBegin_sdate_0 != 0) { register_stack_var("yamlBegin|sdate|0", &____must_checkpoint_yamlBegin_sdate_0, "[25 x i8]", (void *)(sdate), (size_t)25, 0, 0, 0); } if (____chimes_replaying) { switch(get_next_call()) { case(1): { goto call_lbl_1; } case(4): { goto call_lbl_4; } case(5): { goto call_lbl_5; } default: { chimes_error(); } } } ;
...
alias_group_changed(1, (size_t)(5761392777509905247UL)); rm_stack(false, 0UL); }
...
{new_stack((void *)(&yamlAppInfo), 1, 1, (size_t)(5761392777509905349UL), "yamlAppInfo|file|0", &____must_checkpoint_yamlAppInfo_file_0, "%struct.__sFILE*", (void *)(&file), (size_t)8, 1, 0, 0); if (____chimes_replaying) { goto lbl_0; }
...
# 69 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/yamlOutput.c"
   alias_group_changed(1, (size_t)(5761392777509905294UL)); call_lbl_2: calling((void*)&printRank, 2, 0UL, 0); if (!printRank()) {rm_stack(false, 0UL); return;; };
...
# 87 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/yamlOutput.c"
    lbl_0: char timestring[32]; if (____must_checkpoint_yamlAppInfo_timestring_0 != 0) { register_stack_var("yamlAppInfo|timestring|0", &____must_checkpoint_yamlAppInfo_timestring_0, "[32 x i8]", (void *)(timestring), (size_t)32, 0, 0, 0); } if (____chimes_replaying) { switch(get_next_call()) { case(2): { goto call_lbl_2; } case(4): { goto call_lbl_4; } case(18): { goto call_lbl_18; } case(20): { goto call_lbl_20; } case(23): { goto call_lbl_23; } default: { chimes_error(); } } } ;
...
# 91 "/Users/jmg3/num-debug/src/examples/openmp/CoMD/src-openmp/yamlOutput.c"
    call_lbl_23: calling((void*)&fflush, 23, 0UL, 1, (size_t)(5761392777509905349UL)); fflush(file);
...
{new_stack((void *)(&yamlEnd), 0, 0); if (____chimes_replaying) { switch(get_next_call()) { case(1): { goto call_lbl_1; } default: { chimes_error(); } } }
...
{new_stack((void *)(&printSeparator), 1, 0, (size_t)(5761392777509905356UL)); if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } }
