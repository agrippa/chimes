...
void foo() {new_stack(0, 0); if (____chimes_replaying) { switch(get_next_call()) { case(0): { goto call_lbl_0; } default: { exit(42); } } }
     call_lbl_0: calling(0, 0UL, 0); checkpoint();
rm_stack(false, 0UL); }

int main(int argc, char **argv) {init_chimes(); new_stack(2, 2, (size_t)(0UL), (size_t)(29UL), "main|argc|0", "i32", (void *)(&argc), (size_t)4, 0, 0, 0, "main|argv|0", "i8**", (void *)(&argv), (size_t)8, 1, 0, 0); if (____chimes_replaying) { goto lbl_0; }
...
# 13 "/Users/jmg3/num-debug/src/examples/openmp/basic_parallel.cpp"
    ...
    { register_thread_local_stack_vars(LIBCHIMES_THREAD_NUM(), ____chimes_parent_thread, 3, &a, &b, &c); if (____chimes_replaying) { goto lbl_3; }
          lbl_3: int inside; register_stack_var("main|inside|0", "i32", (void *)(&inside), (size_t)4, 0, 0, 0); if (____chimes_replaying) { switch(get_next_call()) { case(0): { goto call_lbl_0; } default: { exit(42); } } } inside = (6);
        alias_group_changed(7, (size_t)(3UL), (size_t)(4UL), (size_t)(5UL), (size_t)(6UL), (size_t)(7UL), (size_t)(8UL), (size_t)(9UL)); printf("hello from %d : %d\n", omp_get_thread_num(), inside);
...
static int module_init() {
    init_module(17008665004289634901UL, 1, 0, 5UL, 29UL);
    return 0;
}
