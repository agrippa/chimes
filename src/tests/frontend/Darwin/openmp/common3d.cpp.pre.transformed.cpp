...
void setup_config(config *conf, int argc, char **argv) {new_stack((void *)(&setup_config), 3, 3, (size_t)(4957368879419144574UL), (size_t)(0UL), (size_t)(4957368879419144576UL), "setup_config|conf|0", "%struct._config*", (void *)(&conf), (size_t)8, 1, 0, 0, "setup_config|argc|0", "i32", (void *)(&argc), (size_t)4, 0, 0, 0, "setup_config|argv|0", "i8**", (void *)(&argv), (size_t)8, 1, 0, 0); if (____chimes_replaying) { goto lbl_0; }
...
# 82 "/Users/jmg3/num-debug/src/examples/openmp/lib/common3d.cpp"
                alias_group_changed(2, (size_t)(4957368879419144448UL), (size_t)(4957368879419144574UL)); conf->nx = atoi(optarg);
...
# 85 "/Users/jmg3/num-debug/src/examples/openmp/lib/common3d.cpp"
                alias_group_changed(2, (size_t)(4957368879419144448UL), (size_t)(4957368879419144574UL)); conf->ny = atoi(optarg);
...
# 88 "/Users/jmg3/num-debug/src/examples/openmp/lib/common3d.cpp"
                alias_group_changed(2, (size_t)(4957368879419144448UL), (size_t)(4957368879419144574UL)); conf->nz = atoi(optarg);
...
# 91 "/Users/jmg3/num-debug/src/examples/openmp/lib/common3d.cpp"
                alias_group_changed(2, (size_t)(4957368879419144448UL), (size_t)(4957368879419144574UL)); conf->nsteps = atoi(optarg);
...
# 97 "/Users/jmg3/num-debug/src/examples/openmp/lib/common3d.cpp"
                alias_group_changed(2, (size_t)(4957368879419144448UL), (size_t)(4957368879419144574UL)); conf->save_text = atoi(optarg);
...
# 106 "/Users/jmg3/num-debug/src/examples/openmp/lib/common3d.cpp"
                alias_group_changed(2, (size_t)(4957368879419144448UL), (size_t)(4957368879419144574UL)); conf->radius = atoi(optarg);
...
# 109 "/Users/jmg3/num-debug/src/examples/openmp/lib/common3d.cpp"
                alias_group_changed(2, (size_t)(4957368879419144448UL), (size_t)(4957368879419144574UL)); conf->ngpus = atoi(optarg);
...
# 112 "/Users/jmg3/num-debug/src/examples/openmp/lib/common3d.cpp"
                alias_group_changed(2, (size_t)(4957368879419144448UL), (size_t)(4957368879419144574UL)); conf->progress_width = atoi(optarg);
...
# 119 "/Users/jmg3/num-debug/src/examples/openmp/lib/common3d.cpp"
            alias_group_changed(2, (size_t)(4957368879419144448UL), (size_t)(4957368879419144574UL)); call_lbl_25: calling((void*)&usage, 25, 0UL, 1, (size_t)(4957368879419144576UL)); default:
...
# 125 "/Users/jmg3/num-debug/src/examples/openmp/lib/common3d.cpp"
        alias_group_changed(2, (size_t)(4957368879419144448UL), (size_t)(4957368879419144574UL)); call_lbl_27: calling((void*)&getNumCUDADevices, 27, 0UL, 0); conf->ngpus = getNumCUDADevices();
