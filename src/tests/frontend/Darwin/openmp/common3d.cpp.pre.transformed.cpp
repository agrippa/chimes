...
# 74 "/Users/jmg3/num-debug/src/examples/openmp/lib/common3d.cpp"
     lbl_0: int c; if (____must_checkpoint_setup_config_c_0 != 0) { register_stack_var("setup_config|c|0", &____must_checkpoint_setup_config_c_0, "i32", (void *)(&c), (size_t)4, 0, 0, 0); } if (____chimes_replaying) { switch(get_next_call()) { case(1): { goto call_lbl_1; } case(16): { goto call_lbl_16; } case(24): { goto call_lbl_24; } case(26): { goto call_lbl_26; } default: { chimes_error(); } } } ;
...
# 119 "/Users/jmg3/num-debug/src/examples/openmp/lib/common3d.cpp"
             call_lbl_24: calling((void*)&usage, 24, 0UL, 1, (size_t)(4957368879419144576UL)); default:
...
# 125 "/Users/jmg3/num-debug/src/examples/openmp/lib/common3d.cpp"
        alias_group_changed(2, (size_t)(4957368879419144448UL), (size_t)(4957368879419144574UL)); call_lbl_26: calling((void*)&getNumCUDADevices, 26, 0UL, 0); conf->ngpus = getNumCUDADevices();
