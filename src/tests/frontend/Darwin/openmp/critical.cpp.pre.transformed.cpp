# 1 "critical.cpp.pre.transformed.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 1 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
...
# 3 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp" 2
...
extern void register_custom_init_handler(const char *obj_name,
        void (*fp)(void *));
# 4 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp" 2
# 4 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
# 5 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
...
# 6 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
     ({ call_lbl_1: if (!____chimes_replaying) { } calling((void*)checkpoint, 1, 0UL, 0); (checkpoint)(); }) ;
# 7 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
rm_stack(false, 0UL, "foo", (int *)0x0, 0, ____chimes_disable0); }
# 8 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
# 9 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
int main(int argc, char **argv) {init_chimes(); const int ____chimes_disable1 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(17419711328753974961UL)) ; if (____chimes_replaying) { switch(get_next_call()) { case(6): { goto call_lbl_6; } default: { chimes_error(); } } } ; ;
# 10 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
     int a; a = (3) ;
# 11 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
     int b; b = (4) ;
# 12 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
     int c; c = (5) ;
# 13 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
     int d; d = (0); { call_lbl_6: unsigned ____chimes_parent_stack_depth0 = get_parent_vars_stack_depth(); unsigned ____chimes_call_stack_depth0 = get_thread_stack_depth(); size_t ____chimes_region_id0; unsigned ____chimes_parent_thread0 = entering_omp_parallel(6, &____chimes_region_id0, 3, &a, &b, &c); ;
# 14 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
# 14 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
# 14 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
#pragma omp parallel firstprivate(a) private(b, c)
# 14 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
# 14 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
# 15 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
    { register_thread_local_stack_vars(LIBCHIMES_THREAD_NUM(), ____chimes_parent_thread0, LIBCHIMES_NUM_THREADS(), ____chimes_parent_stack_depth0, ____chimes_region_id0, 3, &a, &b, &c); ; if (____chimes_replaying) { switch(get_next_call()) { case(4): { goto call_lbl_4; } default: { chimes_error(); } } }
# 16 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
         int inside; inside = (6); bool ____chimes_disable1; ____chimes_disable1 = disable_current_thread(); ;
# 17 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
# 18 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
# 18 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
# 18 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
#pragma omp critical
# 18 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
# 18 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
# 19 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
        {
# 20 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
            d = d + 1;
# 21 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
        } reenable_current_thread(____chimes_disable1);
# 22 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
# 23 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
        printf("hello from %d : %d\n", omp_get_thread_num(), inside);
# 24 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
        alias_group_changed(____alias_loc_id_0); ({ call_lbl_4: if (!____chimes_replaying) { } calling((void*)foo, 4, 0UL, 0); (foo)(); }) ;
# 25 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
    } leaving_omp_parallel(____chimes_call_stack_depth0, ____chimes_region_id0); }
# 26 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
# 27 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
    rm_stack(false, 0UL, "main", (int *)0x0, 0, ____chimes_disable1); return 0;
# 28 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
}


static int module_init() {
    init_module(17419711328753974926UL, 1, 2, 0, 1, 0, 17419711328753974926UL + 5UL, 17419711328753974926UL + 35UL, "main", 1, "foo", "foo", 1, "checkpoint", &____alias_loc_id_0, (unsigned)8, 17419711328753974926UL + 3UL, 17419711328753974926UL + 4UL, 17419711328753974926UL + 5UL, 17419711328753974926UL + 6UL, 17419711328753974926UL + 7UL, 17419711328753974926UL + 8UL, 17419711328753974926UL + 9UL, 17419711328753974926UL + 10UL);
    register_functions(2, "critical.cpp.pre.register.cpp", "foo", &foo, "main", &main);
    return 0;
}
