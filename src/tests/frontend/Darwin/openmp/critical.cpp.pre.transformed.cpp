...
# 13 "/Users/jmg3/num-debug/src/examples/openmp/critical.cpp"
     int d; d = (0); { call_lbl_4: unsigned ____chimes_parent_stack_depth0 = get_parent_vars_stack_depth(); unsigned ____chimes_call_stack_depth0 = get_thread_stack_depth(); size_t ____chimes_region_id0; unsigned ____chimes_parent_thread0 = entering_omp_parallel(4, &____chimes_region_id0, 3, &a, &b, &c); ;
...
static int module_init() {
    init_module(17419711328753974926UL, 1, 2, 0, 1, 0, 0, 0, 0, &____alias_loc_id_0, (unsigned)8, (17419711328753974926UL + 3UL), (17419711328753974926UL + 4UL), (17419711328753974926UL + 5UL), (17419711328753974926UL + 6UL), (17419711328753974926UL + 7UL), (17419711328753974926UL + 8UL), (17419711328753974926UL + 9UL), (17419711328753974926UL + 10UL), (17419711328753974926UL + 5UL), (17419711328753974926UL + 35UL), "main", 1, "foo", "foo", 1, "checkpoint");
    register_functions(2, "critical.cpp.pre.extern_ptrs.cpp", "main", &main, "foo", &foo);
    return 0;
}
