...
# 2 "/Users/jmg3/num-debug/src/examples/openmp/./critical.cpp" 2
...
int main_resumable(int argc, char **argv) {const int ____chimes_did_disable1 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(14349445141712074438UL)) ; if (____chimes_replaying) { switch(get_next_call()) { case(4): { goto call_lbl_4; } default: { chimes_error(); } } } ; ;
...
# 13 "/Users/jmg3/num-debug/src/examples/openmp/./critical.cpp"
     int d; d = (0); { call_lbl_4: void *____chimes_parent_ctx1 = get_thread_ctx(); unsigned ____chimes_parent_stack_depth0 = get_parent_vars_stack_depth(); unsigned ____chimes_call_stack_depth0 = get_thread_stack_depth(); size_t ____chimes_region_id0; unsigned ____chimes_parent_thread0 = entering_omp_parallel(4, &____chimes_region_id0, 3, &a, &b, &c); ;
...
int main_quick(int argc, char **argv) {const int ____chimes_did_disable1 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(14349445141712074438UL)) ; ; ;
# 10 "/Users/jmg3/num-debug/src/examples/openmp/./critical.cpp"
     int a; a = (3) ;
# 11 "/Users/jmg3/num-debug/src/examples/openmp/./critical.cpp"
     int b; b = (4) ;
...
static int module_init() {
    init_module(14349445141712074403UL, 1, 2, 0, 1, 0, 0, 0, 0, 0, 0,
                           &____alias_loc_id_0, (unsigned)8, (unsigned)0, (14349445141712074403UL + 3UL), (14349445141712074403UL + 4UL), (14349445141712074403UL + 5UL), (14349445141712074403UL + 6UL), (14349445141712074403UL + 7UL), (14349445141712074403UL + 8UL), (14349445141712074403UL + 9UL), (14349445141712074403UL + 10UL),
                             (14349445141712074403UL + 5UL), (14349445141712074403UL + 35UL),
                             "main", "main", 1, "foo",
