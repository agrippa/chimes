...
int main(int argc, char **argv) {init_chimes(); const int ____chimes_disable0 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(383979529920101897UL)) ; if (____chimes_replaying) { switch(get_next_call()) { case(4): { goto call_lbl_4; } default: { chimes_error(); } } } ; ;
...
static int module_init() {
    ...
    register_functions(1, "for_parallel.cpp.pre.register.cpp", "main", &main);
    return 0;
}
