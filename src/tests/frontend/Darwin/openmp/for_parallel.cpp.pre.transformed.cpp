...
int main(int argc, char **argv) {init_chimes(); new_stack((void *)(&main), "main", (int *)0x0, 2, 0, (size_t)(0UL), (size_t)(383979529920101897UL)); if (____chimes_replaying) { switch(get_next_call()) { case(7): { goto call_lbl_7; } case(5): { goto call_lbl_5; } default: { chimes_error(); } } }
...
# 10 "/Users/jmg3/num-debug/src/examples/openmp/for_parallel.cpp"
    for (int i = 0; i < 10; i++) {if (____chimes_first_iter0) { register_thread_local_stack_vars(LIBCHIMES_THREAD_NUM(), ____chimes_parent_thread0, LIBCHIMES_NUM_THREADS(), true, true, false, ____chimes_parent_stack_depth0, ____chimes_region_id0, 3, &a, &b, &c); ____chimes_first_iter0 = 0; } if (____chimes_replaying) { chimes_error(); }
...
static int module_init() {
    init_module(383979529920101858UL, 1, 1, 0, 0, 383979529920101858UL + 3UL, 383979529920101858UL + 39UL, "main", 1, "checkpoint");
    return 0;
}
