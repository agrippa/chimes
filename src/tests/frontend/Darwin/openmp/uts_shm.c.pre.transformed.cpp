...
# 456 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
    ({ calling_npm(1, 0, 5826008423592871139UL, 5826008423592869290UL); ss_error_npm("ss_init: unable to allocate space for stealstack"); });
...
# 479 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  if (s->top >= s->stackSize) {({ calling_npm(1, 0, 5826008423592871141UL, 5826008423592869290UL); ss_error_npm("ss_push: overflow"); }); };
# 481 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  if (debug & 1) { char *____chimes_unroll_var_1; call_lbl_1: ____chimes_unroll_var_1 = ( ({ uint8 * ____chimes_arg4; if (!____chimes_replaying) { ____chimes_arg4 = (c->state.state); } calling((void*)rng_showstate, 1, 5826008423592869418UL, 0, 2, (size_t)(5826008423592869475UL), (size_t)(5826008423592871114UL)); (rng_showstate)(____chimes_arg4, debug_str); }) ) ; printf("ss_push: Thread %d, posn %d: node %s [%d]\n", omp_get_thread_num(), s->top, ____chimes_unroll_var_1, c->height); };
# 484 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
   call_lbl_3: ({ void * ____chimes_arg6; unsigned long ____chimes_arg8; if (!____chimes_replaying) { ____chimes_arg6 = (&(s->stack[s->top])); ____chimes_arg8 = (sizeof(Node)); } calling((void*)memcpy, 3, 0UL, 0, 3, (size_t)(5826008423592869436UL), (size_t)(5826008423592869475UL), (size_t)(0UL)); (memcpy)(____chimes_arg6, c, ____chimes_arg8); }) ;
...
# 494 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  if (s->top <= s->local) {({ calling_npm(1, 0, 5826008423592871143UL, 5826008423592869290UL); ss_error_npm("ss_top: empty local stack"); }); };
# 496 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  r = &(s->stack[(s->top) - 1]);
# 497 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  if (debug & 1) { char *____chimes_unroll_var_2; call_lbl_1: ____chimes_unroll_var_2 = ( ({ uint8 * ____chimes_arg9; if (!____chimes_replaying) { ____chimes_arg9 = (r->state.state); } calling((void*)rng_showstate, 1, 5826008423592869537UL, 0, 2, (size_t)(5826008423592869525UL), (size_t)(5826008423592871114UL)); (rng_showstate)(____chimes_arg9, debug_str); }) ) ; printf("ss_top: Thread %d, posn %d: node %s [%d] nchild = %d\n", omp_get_thread_num(), s->top - 1, ____chimes_unroll_var_2, r->height, r->numChildren); };
...
# 507 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  if (s->top <= s->local) {({ calling_npm(1, 0, 5826008423592871143UL, 5826008423592869290UL); ss_error_npm("ss_pop: empty local stack"); }); };
...
# 511 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  if (debug & 1) { char *____chimes_unroll_var_3; call_lbl_1: ____chimes_unroll_var_3 = ( ({ uint8 * ____chimes_arg11; if (!____chimes_replaying) { ____chimes_arg11 = (r->state.state); } calling((void*)rng_showstate, 1, 5826008423592869595UL, 0, 2, (size_t)(5826008423592869583UL), (size_t)(5826008423592871114UL)); (rng_showstate)(____chimes_arg11, debug_str); }) ) ; printf("ss_pop: Thread %d, posn %d: node %s [%d] nchild = %d\n", omp_get_thread_num(), s->top, ____chimes_unroll_var_3, r->height, r->numChildren); };
...
# 520 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  if (s->top <= s->local) {({ calling_npm(1, 0, 5826008423592871147UL, 5826008423592869290UL); ss_error_npm("ss_topPosn: empty local stack"); }); };
...
# 532 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
   call_lbl_1: ({ omp_lock_t * ____chimes_arg13; if (!____chimes_replaying) { ____chimes_arg13 = (s->stackLock); } calling((void*)omp_set_lock, 1, 0UL, ____alias_loc_id_9, 1, (size_t)(5826008423592869651UL)); (omp_set_lock)(____chimes_arg13); }) ;
# 533 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  if (s->top - s->local >= k) {{ s->local += k; s->workAvail += k; s->nRelease++; }; } else {({ calling_npm(1, 0, 5826008423592871142UL, 5826008423592869290UL); ss_error_npm("ss_release:  do not have k vals to release"); }); } ;
# 540 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
   call_lbl_2: ({ omp_lock_t * ____chimes_arg14; if (!____chimes_replaying) { ____chimes_arg14 = (s->stackLock); } calling((void*)omp_unset_lock, 2, 0UL, ____alias_loc_id_10, 1, (size_t)(5826008423592869651UL)); (omp_unset_lock)(____chimes_arg14); }) ;
...
# 548 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
   call_lbl_1: ({ omp_lock_t * ____chimes_arg15; if (!____chimes_replaying) { ____chimes_arg15 = (s->stackLock); } calling((void*)omp_set_lock, 1, 0UL, ____alias_loc_id_11, 1, (size_t)(5826008423592869700UL)); (omp_set_lock)(____chimes_arg15); }) ;
...
# 555 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
   call_lbl_2: ({ omp_lock_t * ____chimes_arg16; if (!____chimes_replaying) { ____chimes_arg16 = (s->stackLock); } calling((void*)omp_unset_lock, 2, 0UL, ____alias_loc_id_12, 1, (size_t)(5826008423592869700UL)); (omp_unset_lock)(____chimes_arg16); }) ;
...
# 567 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  if (s->sharedStart != s->top) {({ calling_npm(1, 0, 5826008423592871134UL, 5826008423592869290UL); ss_error_npm("ss_steal: thief attempts to steal onto non-empty stack"); }); };
# 569 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
# 570 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  if (s->top + k >= s->stackSize) {({ calling_npm(1, 0, 5826008423592871150UL, 5826008423592869290UL); ss_error_npm("ss_steal: steal will overflow thief's stack"); }); };
...
# 577 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
   call_lbl_2: ({ omp_lock_t * ____chimes_arg17; if (!____chimes_replaying) { ____chimes_arg17 = (stealStack[victim]->stackLock); } calling((void*)omp_set_lock, 2, 0UL, ____alias_loc_id_13, 1, (size_t)(5826008423592869965UL)); (omp_set_lock)(____chimes_arg17); }) ;
...
# 591 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  if (victimLocal - victimShared != victimWorkAvail) {({ calling_npm(1, 0, 5826008423592871153UL, 5826008423592869290UL); ss_error_npm("ss_steal: stealStack invariant violated"); }); };
...
# 608 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
   call_lbl_4: ({ omp_lock_t * ____chimes_arg18; if (!____chimes_replaying) { ____chimes_arg18 = (stealStack[victim]->stackLock); } calling((void*)omp_unset_lock, 4, 0UL, ____alias_loc_id_14, 1, (size_t)(5826008423592869965UL)); (omp_unset_lock)(____chimes_arg18); }) ;
...
# 621 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
     call_lbl_6: ({ void * ____chimes_arg19; unsigned long ____chimes_arg21; if (!____chimes_replaying) { ____chimes_arg19 = (&(s->stack[s->top])); ____chimes_arg21 = (k * sizeof(Node)); } calling((void*)memcpy, 6, 0UL, 0, 3, (size_t)(5826008423592869938UL), (size_t)(5826008423592869965UL), (size_t)(0UL)); (memcpy)(____chimes_arg19, victimSharedStart, ____chimes_arg21); }) ;
...
# 629 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
             call_lbl_7: ____chimes_unroll_var_4 = ( ({ uint8 * ____chimes_arg22; if (!____chimes_replaying) { ____chimes_arg22 = (r->state.state); } calling((void*)rng_showstate, 7, 5826008423592869946UL, 0, 2, (size_t)(5826008423592869938UL), (size_t)(5826008423592871114UL)); (rng_showstate)(____chimes_arg22, debug_str); }) ) ; printf("ss_steal:  Thread %2d posn %d (steal #%d) receives %s [%d] from thread %d posn %d (%p)\n",
...
# 687 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  if (state < 0 || state >= 5) {({ calling_npm(1, 0, 5826008423592871158UL, 5826008423592869290UL); ss_error_npm("ss_setState: thread state out of range"); }); };
...
void genChildren_npm(Node * parent, Node * child, StealStack * ss);void releaseNodes_npm(StealStack *ss);
...
# 965 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
        ____chimes_unroll_var_5 = (({ calling_npm(2, 0, 5826008423592870313UL, 5826008423592869630UL, 5826008423592871147UL, 5826008423592869290UL); ss_topPosn_npm(ss); })) ; call_lbl_3: ____chimes_unroll_var_6 = ( ({ uint8 * ____chimes_arg28; if (!____chimes_replaying) { ____chimes_arg28 = (parent->state.state); } calling((void*)rng_showstate, 3, 5826008423592870243UL, 0, 2, (size_t)(5826008423592870311UL), (size_t)(5826008423592871114UL)); (rng_showstate)(____chimes_arg28, debug_str); }) ) ; printf("Gen:  Thread %d, posn %2d: node %s [%d] has %2d children\n",
...
# 986 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
         call_lbl_5: ({ uint8 * ____chimes_arg30; uint8 * ____chimes_arg31; if (!____chimes_replaying) { ____chimes_arg30 = (parent->state.state); ____chimes_arg31 = (child->state.state); } calling((void*)rng_spawn, 5, 0UL, ____alias_loc_id_23, 3, (size_t)(5826008423592870311UL), (size_t)(5826008423592870312UL), (size_t)(0UL)); (rng_spawn)(____chimes_arg30, ____chimes_arg31, i); }) ;
...
# 1098 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
    if (({ calling_npm(1, 0, 5826008423592870352UL, 5826008423592869642UL); ss_localDepth_npm(ss); }) > 2 * chunkSize) {
...
# 1105 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
        ({ calling_npm(0, 0); cbarrier_cancel_npm(); });
...
# 1131 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  ({ calling_npm(1, 0, 5826008423592870506UL, 5826008423592870182UL); initNode_npm(&child); });
...
# 1136 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
       localDepth = (({ calling_npm(1, 0, 5826008423592870608UL, 5826008423592869642UL); ss_localDepth_npm(ss); })) ;
...
# 300 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  ind += sprintf(strBuf+ind, "Execution strategy:  ");
# 301 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  if (1) {{ int ____chimes_unroll_var_0 = omp_get_num_threads(); ind += sprintf(strBuf + ind, "Parallel search using %d threads\n", ____chimes_unroll_var_0); if (doSteal) { ind += sprintf(strBuf + ind, "   Load balance by work stealing, chunk size = %d nodes\n", chunkSize); ind += sprintf(strBuf + ind, "  CBarrier Interval: %d\n", cbint); ind += sprintf(strBuf + ind, "   Polling Interval: %d\n", pollint); } else ind += sprintf(strBuf + ind, "   No load balancing.\n"); }; } else {ind += sprintf(strBuf + ind, "Iterative sequential search\n"); } ;
# 313 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
# 314 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  return ind;
# 315 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
...
# 481 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  if (debug & 1) { char * ____chimes_unroll_var_1 = rng_showstate(c->state.state, debug_str); printf("ss_push: Thread %d, posn %d: node %s [%d]\n", omp_get_thread_num(), s->top, ____chimes_unroll_var_1, c->height); };
# 484 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
...
# 496 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  r = &(s->stack[(s->top) - 1]);
# 497 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  if (debug & 1) { char * ____chimes_unroll_var_2 = rng_showstate(r->state.state, debug_str); printf("ss_top: Thread %d, posn %d: node %s [%d] nchild = %d\n", omp_get_thread_num(), s->top - 1, ____chimes_unroll_var_2, r->height, r->numChildren); };
# 501 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  return r;
# 502 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
}
...
# 510 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  r = &(s->stack[s->top]);
# 511 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  if (debug & 1) { char * ____chimes_unroll_var_3 = rng_showstate(r->state.state, debug_str); printf("ss_pop: Thread %d, posn %d: node %s [%d] nchild = %d\n", omp_get_thread_num(), s->top, ____chimes_unroll_var_3, r->height, r->numChildren); };
# 515 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
}
...
# 629 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
         char * ____chimes_unroll_var_4 = rng_showstate(r->state.state, debug_str); printf("ss_steal:  Thread %2d posn %d (steal #%d) receives %s [%d] from thread %d posn %d (%p)\n",
# 630 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
               omp_get_thread_num(), s->top + i, s->nSteal,
# 631 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
               ____chimes_unroll_var_4,
...
# 964 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  if (debug & 2) {
# 965 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
     int ____chimes_unroll_var_5 = ss_topPosn_npm(ss); char * ____chimes_unroll_var_6 = rng_showstate(parent->state.state, debug_str); printf("Gen:  Thread %d, posn %2d: node %s [%d] has %2d children\n",
# 966 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
           omp_get_thread_num(), ____chimes_unroll_var_5,
# 967 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
           ____chimes_unroll_var_6,
...
# 1273 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
# 1274 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  uts_showStats(nthreads, chunkSize, elapsedSecs, tnodes, tleaves, mheight);
# 1275 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
# 1276 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  if (verbose > 1) {
# 1277 "/Users/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
