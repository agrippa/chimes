...
# 16 "/home/jmg3/num-debug/src/examples/cpp/./custom_init_example.cpp"
       f = ((foo *) ({ void *____chimes_tmp_ptr = malloc(sizeof(foo)); malloc_helper(____chimes_tmp_ptr, sizeof(foo), 1944833083709766364UL, 0, 1, (int)sizeof(struct _foo), 0); ____chimes_tmp_ptr; })) ;
