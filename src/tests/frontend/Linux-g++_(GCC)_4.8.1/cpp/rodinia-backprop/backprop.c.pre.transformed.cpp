...
# 403 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/backprop.c"
  mem = (char *) ({ void *____chimes_tmp_ptr = malloc((unsigned int)((n1 + 1) * (n2 + 1) * sizeof(float))); ; malloc_helper(____chimes_tmp_ptr, (unsigned) ((n1+1) * (n2+1) * sizeof(float)), 18030399740950322161UL, 0, 0); ____chimes_tmp_ptr; }) ;
...
# 413 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/backprop.c"
   ({ free_helper(mem, 18030399740950322161UL);free(mem); }) ;
...
# 417 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/backprop.c"
  mem = (char *) ({ void *____chimes_tmp_ptr = malloc((unsigned int)((n2 + 1) * (n3 + 1) * sizeof(float))); ; malloc_helper(____chimes_tmp_ptr, (unsigned) ((n2+1) * (n3+1) * sizeof(float)), 18030399740950322161UL, 0, 0); ____chimes_tmp_ptr; }) ;
...
# 455 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/backprop.c"
  mem = (char *) ({ void *____chimes_tmp_ptr = malloc((unsigned int)((n1 + 1) * (n2 + 1) * sizeof(float))); ; malloc_helper(____chimes_tmp_ptr, (unsigned) ((n1+1) * (n2+1) * sizeof(float)), 18030399740950322471UL, 0, 0); ____chimes_tmp_ptr; }) ;
...
# 463 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/backprop.c"
   ({ free_helper(mem, 18030399740950322471UL);free(mem); }) ;
...
# 468 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/backprop.c"
  mem = (char *) ({ void *____chimes_tmp_ptr = malloc((unsigned int)((n2 + 1) * (n3 + 1) * sizeof(float))); ; malloc_helper(____chimes_tmp_ptr, (unsigned) ((n2+1) * (n3+1) * sizeof(float)), 18030399740950322471UL, 0, 0); ____chimes_tmp_ptr; }) ;
