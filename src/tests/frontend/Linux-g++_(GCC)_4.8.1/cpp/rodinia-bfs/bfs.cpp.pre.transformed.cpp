...
{const int ____chimes_did_disable3 = new_stack((void *)(&BFSGraph), "BFSGraph", (int *)0, 2, 0, (size_t)(0UL), (size_t)(6277575452893475596UL)) ; int count_iters;
# 57 "/gpfs-biou/jmg3/rodinia_3.0/openmp/bfs/bfs.cpp"
bool stop;
# 57 "/gpfs-biou/jmg3/rodinia_3.0/openmp/bfs/bfs.cpp"
int k;
...
# 85 "/gpfs-biou/jmg3/rodinia_3.0/openmp/bfs/bfs.cpp"
    h_graph_nodes = ((Node*) ({ void *____chimes_tmp_ptr = malloc((sizeof(Node) * no_of_nodes) + sizeof(void *)); malloc_helper(____chimes_tmp_ptr, sizeof(Node)*no_of_nodes, 6277575452893475578UL, 0, 1, (int)sizeof(struct Node), 0); (____chimes_tmp_ptr ? (void *)(((unsigned char *)____chimes_tmp_ptr) + sizeof(void *)) : ____chimes_tmp_ptr); })) ;
# 86 "/gpfs-biou/jmg3/rodinia_3.0/openmp/bfs/bfs.cpp"
    h_graph_mask = ((bool*) ({ void *____chimes_tmp_ptr = malloc((sizeof(bool) * no_of_nodes) + sizeof(void *)); malloc_helper(____chimes_tmp_ptr, sizeof(bool)*no_of_nodes, 6277575452893475584UL, 0, 0); (____chimes_tmp_ptr ? (void *)(((unsigned char *)____chimes_tmp_ptr) + sizeof(void *)) : ____chimes_tmp_ptr); })) ;
# 87 "/gpfs-biou/jmg3/rodinia_3.0/openmp/bfs/bfs.cpp"
    h_updating_graph_mask = ((bool*) ({ void *____chimes_tmp_ptr = malloc((sizeof(bool) * no_of_nodes) + sizeof(void *)); malloc_helper(____chimes_tmp_ptr, sizeof(bool)*no_of_nodes, 6277575452893475586UL, 0, 0); (____chimes_tmp_ptr ? (void *)(((unsigned char *)____chimes_tmp_ptr) + sizeof(void *)) : ____chimes_tmp_ptr); })) ;
# 88 "/gpfs-biou/jmg3/rodinia_3.0/openmp/bfs/bfs.cpp"
    h_graph_visited = ((bool*) ({ void *____chimes_tmp_ptr = malloc((sizeof(bool) * no_of_nodes) + sizeof(void *)); malloc_helper(____chimes_tmp_ptr, sizeof(bool)*no_of_nodes, 6277575452893475588UL, 0, 0); (____chimes_tmp_ptr ? (void *)(((unsigned char *)____chimes_tmp_ptr) + sizeof(void *)) : ____chimes_tmp_ptr); })) ;
...
# 113 "/gpfs-biou/jmg3/rodinia_3.0/openmp/bfs/bfs.cpp"
    h_graph_edges = ((int*) ({ void *____chimes_tmp_ptr = malloc((sizeof(int) * edge_list_size) + sizeof(void *)); malloc_helper(____chimes_tmp_ptr, sizeof(int)*edge_list_size, 6277575452893475581UL, 0, 0); (____chimes_tmp_ptr ? (void *)(((unsigned char *)____chimes_tmp_ptr) + sizeof(void *)) : ____chimes_tmp_ptr); })) ;
...
# 126 "/gpfs-biou/jmg3/rodinia_3.0/openmp/bfs/bfs.cpp"
    h_cost = ((int*) ({ void *____chimes_tmp_ptr = malloc((sizeof(int) * no_of_nodes) + sizeof(void *)); malloc_helper(____chimes_tmp_ptr, sizeof(int)*no_of_nodes, 6277575452893475590UL, 0, 0); (____chimes_tmp_ptr ? (void *)(((unsigned char *)____chimes_tmp_ptr) + sizeof(void *)) : ____chimes_tmp_ptr); })) ;
...
#pragma omp parallel for private(tid, i, id)
...
# 193 "/gpfs-biou/jmg3/rodinia_3.0/openmp/bfs/bfs.cpp"
  ({ free_helper((((unsigned char *)h_graph_nodes) - sizeof(void *)), 6277575452893475578UL);free((((unsigned char *)h_graph_nodes) - sizeof(void *))); }) ;
# 194 "/gpfs-biou/jmg3/rodinia_3.0/openmp/bfs/bfs.cpp"
  ({ free_helper((((unsigned char *)h_graph_edges) - sizeof(void *)), 6277575452893475581UL);free((((unsigned char *)h_graph_edges) - sizeof(void *))); }) ;
# 195 "/gpfs-biou/jmg3/rodinia_3.0/openmp/bfs/bfs.cpp"
  ({ free_helper((((unsigned char *)h_graph_mask) - sizeof(void *)), 6277575452893475584UL);free((((unsigned char *)h_graph_mask) - sizeof(void *))); }) ;
# 196 "/gpfs-biou/jmg3/rodinia_3.0/openmp/bfs/bfs.cpp"
  ({ free_helper((((unsigned char *)h_updating_graph_mask) - sizeof(void *)), 6277575452893475586UL);free((((unsigned char *)h_updating_graph_mask) - sizeof(void *))); }) ;
# 197 "/gpfs-biou/jmg3/rodinia_3.0/openmp/bfs/bfs.cpp"
  ({ free_helper((((unsigned char *)h_graph_visited) - sizeof(void *)), 6277575452893475588UL);free((((unsigned char *)h_graph_visited) - sizeof(void *))); }) ;
# 198 "/gpfs-biou/jmg3/rodinia_3.0/openmp/bfs/bfs.cpp"
  ({ free_helper((((unsigned char *)h_cost) - sizeof(void *)), 6277575452893475590UL);free((((unsigned char *)h_cost) - sizeof(void *))); }) ;
...
double start_time;
# 57 "/gpfs-biou/jmg3/rodinia_3.0/openmp/bfs/bfs.cpp"
 register_stack_vars(10, "BFSGraph|count_iters|0", (int *)0x0, "i32", (void *)(&count_iters), (size_t)4, 0, 0, 0, "BFSGraph|stop|0", (int *)0x0, "i8", (void *)(&stop), (size_t)1, 0, 0, 0, "BFSGraph|k|0", (int *)0x0, "i32", (void *)(&k), (size_t)4, 0, 0, 0, "BFSGraph|h_cost|0", (int *)0x0, "i32*", (void *)(&h_cost), (size_t)8, 1, 0, 0, "BFSGraph|h_graph_edges|0", (int *)0x0, "i32*", (void *)(&h_graph_edges), (size_t)8, 1, 0, 0, "BFSGraph|h_graph_visited|0", (int *)0x0, "i8*", (void *)(&h_graph_visited), (size_t)8, 1, 0, 0, "BFSGraph|h_updating_graph_mask|0", (int *)0x0, "i8*", (void *)(&h_updating_graph_mask), (size_t)8, 1, 0, 0, "BFSGraph|h_graph_mask|0", (int *)0x0, "i8*", (void *)(&h_graph_mask), (size_t)8, 1, 0, 0, "BFSGraph|h_graph_nodes|0", (int *)0x0, "%struct.Node*", (void *)(&h_graph_nodes), (size_t)8, 1, 0, 0, "BFSGraph|start_time|0", (int *)0x0, "double", (void *)(&start_time), (size_t)8, 0, 0, 0); ; ;
# 58 "/gpfs-biou/jmg3/rodinia_3.0/openmp/bfs/bfs.cpp"
    char *input_f; ;
# 59 "/gpfs-biou/jmg3/rodinia_3.0/openmp/bfs/bfs.cpp"
 int num_omp_threads; ;
...
static int module_init() {
    init_module(6277575452893475151UL, 13, 4, 0, 6, 2, 0, 2, 3, 0, 5,
                           ...
                           &____alias_loc_id_5, (unsigned)9, (unsigned)0, (unsigned)0, (6277575452893475151UL + 32UL), (6277575452893475151UL + 62UL), (6277575452893475151UL + 63UL), (6277575452893475151UL + 64UL), (6277575452893475151UL + 65UL), (6277575452893475151UL + 66UL), (6277575452893475151UL + 85UL), (6277575452893475151UL + 86UL), (6277575452893475151UL + 458UL),
                            "seconds", 0, "_Z7secondsv", "_Z11seconds_npmv", 0, 0, 0UL, 1, "gettimeofday", 2, (6277575452893475151UL + 1UL), (6277575452893475151UL + 2UL), 0UL,
                            "Usage", 0, "_Z5UsageiPPc", "_Z9Usage_npmiPPc", 0, 2, 0UL, (6277575452893475151UL + 39UL), 0UL, 1, "fprintf", 3, (6277575452893475151UL + 32UL), (6277575452893475151UL + 460UL), (6277575452893475151UL + 35UL), 0UL,
                           "seconds", &(____chimes_does_checkpoint_seconds_npm),
                           "Usage", &(____chimes_does_checkpoint_Usage_npm),
                             (6277575452893475151UL + 458UL), (6277575452893475151UL + 32UL),
                             ...
                             (6277575452893475151UL + 445UL), (6277575452893475151UL + 106UL),
                             (6277575452893475151UL + 77UL), (6277575452893475151UL + 430UL),
                             (6277575452893475151UL + 63UL), (6277575452893475151UL + 445UL),
                             (6277575452893475151UL + 64UL), (6277575452893475151UL + 106UL),
                             (6277575452893475151UL + 71UL), (6277575452893475151UL + 437UL),
                             (6277575452893475151UL + 70UL), (6277575452893475151UL + 435UL),
                             (6277575452893475151UL + 68UL), (6277575452893475151UL + 427UL),
                             (6277575452893475151UL + 69UL), (6277575452893475151UL + 433UL),
                             (6277575452893475151UL + 79UL), (6277575452893475151UL + 439UL),
        ...
        "seconds", 0UL, (int)0,
        "Usage", 0UL, (int)2, 0UL, 6277575452893475596UL,
        "seconds", 0UL, (int)0);
    ...
    register_global_var("global|fp", "%struct._IO_FILE*", (void *)(&fp), 8, 1, 0, (6277575452893475151UL + 458UL), 0);
    return 0;
}
