# 1 "facetrain.c.pre.transformed.cpp"
# 1 "<command-line>"
...
static int ____chimes_does_checkpoint_backprop_face_npm = 1;
...
static int ____chimes_does_checkpoint_load_npm = 1;

static int ____must_checkpoint_backprop_face_net_0 = 2;
static int ____must_checkpoint_backprop_face_out_err_0 = 2;
static int ____must_checkpoint_backprop_face_start_0 = 2;
static int ____must_checkpoint_backprop_face_end_0 = 2;

static int ____must_manage_seconds = 2;
static int ____must_manage_setup = 2;
static int ____must_manage_backprop_face = 2;
...
# 1 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
...
# 2 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c" 2
...
# 3 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c" 2
...
# 4 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c" 2
...
BPNN *bpnn_read(char *);
# 5 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c" 2
...
# 6 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c" 2
...
# 7 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c" 2
# 7 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
# 8 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
extern char *strcpy();
# 9 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
extern void exit();
# 10 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
# 11 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
int layer_size = 0;
# 12 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
# 13 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
extern void load(BPNN *net);
# 14 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
extern void bpnn_train_kernel(BPNN *net, float *eo, float *eh);
# 15 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
# 16 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
# 17 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
double seconds_npm();
...
# 18 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
     struct timeval tp; ;
# 19 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
     struct timezone tzp; ;
# 20 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
     int i; i = (gettimeofday(&tp, &tzp)) ;
# 21 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
...
# 22 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
rm_stack(false, 0UL, "seconds", &____must_manage_seconds, ____alias_loc_id_4, ____chimes_did_disable0, false); }
# 23 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
# 24 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
...
# 25 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
...
# 26 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
   ;
# 27 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
  int i; ;
# 28 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
   float hid_err; ;
# 29 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
# 30 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
      call_lbl_0: start = (({ calling_npm("seconds", 0); seconds_npm(); })) ;
# 31 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
# 32 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
   call_lbl_1: net = ({ calling((void*)bpnn_create, 1, ____alias_loc_id_3, 12415807971304850424UL, 3, (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)); (bpnn_create)(layer_size, 16, 1); }) ;
# 33 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
  printf("Input layer size : %d\n", layer_size);
# 34 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
# 35 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
   call_lbl_2: ({ calling((void*)load, 2, ____alias_loc_id_2, 0UL, 1, (size_t)(12415807971304850424UL)); (load)(net); }) ;
# 36 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
# 37 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
  printf("Starting training kernel\n");
# 38 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
   call_lbl_3: ({ calling((void*)bpnn_train_kernel, 3, ____alias_loc_id_1, 0UL, 3, (size_t)(12415807971304850424UL), (size_t)(12415807971304850412UL), (size_t)(12415807971304850413UL)); (bpnn_train_kernel)(net, &out_err, &hid_err); }) ;
# 39 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
      call_lbl_4: end = (({ calling_npm("seconds", 0); seconds_npm(); })) ;
# 40 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
   call_lbl_5: ({ calling((void*)bpnn_free, 5, ____alias_loc_id_0, 0UL, 1, (size_t)(12415807971304850424UL)); (bpnn_free)(net); }) ;
# 41 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
# 42 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
  printf("Training done, execution took %f s\n", end - start);
# 43 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
rm_stack(false, 0UL, "backprop_face", &____must_manage_backprop_face, 0, ____chimes_did_disable1, false); }
# 44 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
# 45 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
...
# 46 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
{const int ____chimes_did_disable2 = new_stack((void *)(&setup), "setup", &____must_manage_setup, 2, 0, (size_t)(0UL), (size_t)(12415807971304850482UL)) ; if (____chimes_replaying) { switch(get_next_call()) { case(0): { goto call_lbl_0; } case(1): { goto call_lbl_1; } default: { chimes_error(); } } } ; ;
# 47 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
  if(argc!=2){
# 48 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
  fprintf(stderr, "usage: backprop <num of input elements>\n");
# 49 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
  exit(0);
# 50 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
  }
# 51 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
# 52 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
  layer_size = atoi(argv[1]);
# 53 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
# 54 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
  int seed; ;
# 55 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
# 56 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
  seed = 7;
# 57 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
   call_lbl_0: ({ calling((void*)bpnn_initialize, 0, 0, 0UL, 1, (size_t)(0UL)); (bpnn_initialize)(seed); }) ;
# 58 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
   call_lbl_1: ({ calling((void*)backprop_face, 1, 0, 0UL, 0); (backprop_face)(); }) ;
# 59 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
# 60 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
  exit(0);
# 61 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
...
# 46 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
{const int ____chimes_did_disable2 = new_stack((void *)(&setup), "setup", &____must_manage_setup, 2, 0, (size_t)(0UL), (size_t)(12415807971304850482UL)) ; ; ;
# 47 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
  if(argc!=2){
# 48 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
  fprintf(stderr, "usage: backprop <num of input elements>\n");
...
static int module_init() {
    init_module(12415807971304850384UL, 4, 3, 4, 5, 3, 5, 8, 2, 0, 3,
                           &____alias_loc_id_0, (unsigned)1, (unsigned)0, (unsigned)1, (12415807971304850384UL + 31UL), "bpnn_free", (unsigned)1, (12415807971304850384UL + 40UL),
                           &____alias_loc_id_1, (unsigned)0, (unsigned)0, (unsigned)1, "bpnn_train_kernel", (unsigned)3, (12415807971304850384UL + 28UL), (12415807971304850384UL + 29UL), (12415807971304850384UL + 40UL),
                           &____alias_loc_id_2, (unsigned)1, (unsigned)0, (unsigned)1, (12415807971304850384UL + 26UL), "load", (unsigned)1, (12415807971304850384UL + 40UL),
                           &____alias_loc_id_3, (unsigned)1, (unsigned)0, (unsigned)1, (12415807971304850384UL + 30UL), "bpnn_create", (unsigned)1, (12415807971304850384UL + 40UL),
                           &____alias_loc_id_4, (unsigned)3, (unsigned)0, (unsigned)0, (12415807971304850384UL + 1UL), (12415807971304850384UL + 3UL), (12415807971304850384UL + 4UL),
                            "seconds", 0, "_Z7secondsv", "_Z11seconds_npmv", 0, 0, 0UL, 1, "gettimeofday", 2, (12415807971304850384UL + 1UL), (12415807971304850384UL + 2UL), 0UL,
                            "setup", 0, "_Z5setupiPPc", "_Z9setup_npmiPPc", 0, 2, 0UL, (12415807971304850384UL + 98UL), 0UL, 6, "fprintf", 2, (12415807971304850384UL + 79UL), (12415807971304850384UL + 109UL), 0UL, "exit", 1, 0UL, 0UL, "atoi", 1, (12415807971304850384UL + 85UL), 0UL, "bpnn_initialize", 1, 0UL, 0UL, "backprop_face", 0, 0UL, "exit", 1, 0UL, 0UL,
                            "backprop_face", 0, "_Z13backprop_facev", "_Z17backprop_face_npmv", 4, &____alias_loc_id_0, &____alias_loc_id_1, &____alias_loc_id_2, &____alias_loc_id_3, 0, 0UL, 9, "seconds", 0, 0UL, "bpnn_create", 3, 0UL, 0UL, 0UL, (12415807971304850384UL + 40UL), "printf", 2, (12415807971304850384UL + 105UL), 0UL, 0UL, "load", 1, (12415807971304850384UL + 40UL), 0UL, "printf", 1, (12415807971304850384UL + 106UL), 0UL, "bpnn_train_kernel", 3, (12415807971304850384UL + 40UL), (12415807971304850384UL + 28UL), (12415807971304850384UL + 29UL), 0UL, "seconds", 0, 0UL, "bpnn_free", 1, (12415807971304850384UL + 40UL), 0UL, "printf", 2, (12415807971304850384UL + 107UL), 0UL, 0UL,
                               ...
                               "bpnn_train_kernel", (void **)&(____chimes_extern_func_bpnn_train_kernel),
                               "load", (void **)&(____chimes_extern_func_load),
                           "seconds", &(____chimes_does_checkpoint_seconds_npm),
                           "setup", &(____chimes_does_checkpoint_setup_npm),
                           "backprop_face", &(____chimes_does_checkpoint_backprop_face_npm),
                           ...
                           "load", &(____chimes_does_checkpoint_load_npm),
                             (12415807971304850384UL + 98UL), (12415807971304850384UL + 85UL),
                             (12415807971304850384UL + 26UL), (12415807971304850384UL + 40UL),
                             (12415807971304850384UL + 108UL), (12415807971304850384UL + 79UL),
                             (12415807971304850384UL + 70UL), (12415807971304850384UL + 98UL),
                     ...
                     "timezone", 64UL, 2, "int", (int)__builtin_offsetof (struct timezone, tz_minuteswest), "int", (int)__builtin_offsetof (struct timezone, tz_dsttime),
                             ...
                             "setup", "_Z5setupiPPc", 0, 2, "bpnn_initialize", "backprop_face",
                             "backprop_face", "_Z13backprop_facev", 0, 6, "seconds", "bpnn_create", "load", "bpnn_train_kernel", "seconds", "bpnn_free",
                        ...
                        "backprop_face|end|0", 1, "bpnn_free",
        "seconds", 0UL, (int)0,
        "seconds", 0UL, (int)0);
    register_global_var("global|layer_size", "i32", (void *)(&layer_size), 4, 0, 0, 0UL, 0);
    return 0;
}
