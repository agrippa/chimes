# 1 "imagenet.c.pre.transformed.cpp"
# 1 "<command-line>"
...
# 1 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c"
...
# 3 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c" 2
...
# 4 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c" 2
...
BPNN *bpnn_read(char *);
# 5 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c" 2
# 5 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c"
# 6 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c"
extern int layer_size;
# 7 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c"
# 8 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c"
void load_npm(BPNN *net);
void load_quick(BPNN *net); void load(BPNN *net);
void load_resumable(BPNN *net)
# 9 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c"
{const int ____chimes_did_disable0 = new_stack((void *)(&load), "load", &____must_manage_load, 1, 0, (size_t)(7369176591518032173UL)) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
# 10 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c"
  float *units; ;
# 11 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c"
  int nr; int nc; int imgsize; int i; int j; int k; ;
# 12 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c"
# 13 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c"
  nr = layer_size;
# 14 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c"
# 15 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c"
  imgsize = nr * nc;
# 16 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c"
  units = net->input_units;
# 17 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c"
# 18 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c"
  k = 1;
# 19 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c"
  for (i = 0; i < nr; i++) {
# 20 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c"
   units[k] = (float) rand()/2147483647 ;
# 21 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c"
   k++;
# 22 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c"
    }
# 23 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c"
rm_stack(false, 0UL, "load", &____must_manage_load, ____alias_loc_id_0, ____chimes_did_disable0, false); }
# 8 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c"
void load_quick(BPNN *net)
# 9 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c"
{const int ____chimes_did_disable0 = new_stack((void *)(&load), "load", &____must_manage_load, 1, 0, (size_t)(7369176591518032173UL)) ; ; ;
# 10 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c"
  float *units; ;
# 11 "/gpfs-biou/jmg3/rodinia_3.0/openmp/backprop/imagenet.c"
  int nr; int nc; int imgsize; int i; int j; int k; ;
...
static int module_init() {
    init_module(7369176591518032121UL, 3, 1, 0, 1, 1, 0, 1, 0, 0, 1,
                           &____alias_loc_id_0, (unsigned)7, (unsigned)0, (unsigned)0, (7369176591518032121UL + 1UL), (7369176591518032121UL + 2UL), (7369176591518032121UL + 3UL), (7369176591518032121UL + 5UL), (7369176591518032121UL + 6UL), (7369176591518032121UL + 8UL), (7369176591518032121UL + 26UL),
                            "load", 0, "_Z4loadP4BPNN", "_Z8load_npmP4BPNN", 0, 1, (7369176591518032121UL + 52UL), 0UL, 1, "rand", 0, 0UL,
                           "load", &(____chimes_does_checkpoint_load_npm),
                             (7369176591518032121UL + 1UL), (7369176591518032121UL + 52UL),
