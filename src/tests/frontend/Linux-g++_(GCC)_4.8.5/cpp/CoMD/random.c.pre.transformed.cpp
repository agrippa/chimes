...
# 1 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
...
# 1 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
# 1 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
# 2 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
# 3 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
# 4 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
# 5 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
# 6 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
...
# 8 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c" 2
...
# 9 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.h" 2
...
# 9 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c" 2
# 9 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
...
# 11 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c" 2
# 22 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
# 22 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
...
# 23 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
{const int ____chimes_did_disable0 = new_stack((void *)(&gasdev), "gasdev", &____must_manage_gasdev, 1, 0, (size_t)(6522342444046979271UL)) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
# 24 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
   real_t rsq; real_t v1; real_t v2; ;
# 25 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
   do
# 26 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
   {
# 27 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
       call_lbl_0: v1 = 2.0*({ calling_npm("lcg61", 0); lcg61_npm(seed); })-1.0;
# 28 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
       call_lbl_1: v2 = 2.0*({ calling_npm("lcg61", 0); lcg61_npm(seed); })-1.0;
# 29 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
      rsq = v1*v1+v2*v2;
# 30 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
   } while (rsq >= 1.0 || rsq == 0.0);
# 31 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
# 32 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
...
# 33 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
rm_stack(false, 0UL, "gasdev", &____must_manage_gasdev, ____alias_loc_id_0, ____chimes_did_disable0, false); }
# 42 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
# 42 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
double lcg61_resumable(uint64_t* seed)
# 43 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
{const int ____chimes_did_disable1 = new_stack((void *)(&lcg61), "lcg61", &____must_manage_lcg61, 1, 0, (size_t)(6522342444046979334UL)) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
# 44 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
    static double convertToDouble; convertToDouble = (1.0/2305843009213693951ULL) ;
# 45 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
# 46 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
   *seed *= 437799614237992725ULL;
# 47 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
   *seed %= 2305843009213693951ULL;
# 48 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
# 49 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
...
# 50 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
rm_stack(false, 0UL, "lcg61", &____must_manage_lcg61, ____alias_loc_id_1, ____chimes_did_disable1, false); }
# 66 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
# 66 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
...
# 67 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
...
# 68 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
    uint32_t s1; s1 = (id * 2654435761UL) ;
# 69 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
    uint32_t s2; s2 = ((id+callSite) * 2654435761UL) ;
# 70 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
# 71 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
      iSeed = ((0x100000000ULL * s1) + s2) ;
# 72 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
   { unsigned int jj; for ( jj = (0) ;jj<10; ++jj) { call_lbl_0: ({ calling_npm("lcg61", 0); lcg61_npm(&iSeed); }); } };
# 74 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
# 75 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
...
# 76 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
...
# 23 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
{const int ____chimes_did_disable0 = new_stack((void *)(&gasdev), "gasdev", &____must_manage_gasdev, 1, 0, (size_t)(6522342444046979271UL)) ; ; ;
# 24 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
   real_t rsq; real_t v1; real_t v2; ;
# 25 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
   do
...
# 43 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
{const int ____chimes_did_disable1 = new_stack((void *)(&lcg61), "lcg61", &____must_manage_lcg61, 1, 0, (size_t)(6522342444046979334UL)) ; ; ;
# 44 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
    static double convertToDouble; convertToDouble = (1.0/2305843009213693951ULL) ;
# 45 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
# 46 "/scratch/jmg3/chimes/src/examples/cpp/CoMD/src-mpi/random.c"
...
static int module_init() {
    init_module(6522342444046979259UL, 2, 3, 1, 3, 3, 0, 3, 3, 0, 0,
                           &____alias_loc_id_0, (unsigned)5, (unsigned)0, (unsigned)0, (6522342444046979259UL + 1UL), (6522342444046979259UL + 2UL), (6522342444046979259UL + 3UL), (6522342444046979259UL + 4UL), (6522342444046979259UL + 5UL),
                           &____alias_loc_id_1, (unsigned)3, (unsigned)0, (unsigned)0, (6522342444046979259UL + 54UL), (6522342444046979259UL + 55UL), (6522342444046979259UL + 75UL),
                           &____alias_loc_id_2, (unsigned)7, (unsigned)0, (unsigned)0, (6522342444046979259UL + 78UL), (6522342444046979259UL + 79UL), (6522342444046979259UL + 80UL), (6522342444046979259UL + 81UL), (6522342444046979259UL + 82UL), (6522342444046979259UL + 83UL), (6522342444046979259UL + 84UL),
                            "gasdev", 0, "_Z6gasdevPm", "_Z10gasdev_npmPm", 0, 1, (6522342444046979259UL + 12UL), 0UL, 4, "lcg61", 1, (6522342444046979259UL + 12UL), 0UL, "lcg61", 1, (6522342444046979259UL + 12UL), 0UL, "log", 1, 0UL, 0UL, "sqrt", 1, 0UL, 0UL,
                            "lcg61", 0, "_Z5lcg61Pm", "_Z9lcg61_npmPm", 0, 1, (6522342444046979259UL + 75UL), 0UL, 0,
                            "mkSeed", 0, "_Z6mkSeedjj", "_Z10mkSeed_npmjj", 0, 2, 0UL, 0UL, 0UL, 1, "lcg61", 1, (6522342444046979259UL + 82UL), 0UL,
                           ...
                           "mkSeed", &(____chimes_does_checkpoint_mkSeed_npm),
                             (6522342444046979259UL + 1UL), (6522342444046979259UL + 12UL),
                             (6522342444046979259UL + 54UL), (6522342444046979259UL + 75UL),
                             "gasdev", "_Z6gasdevPm", 0, 2, "lcg61", "lcg61",
                             "lcg61", "_Z5lcg61Pm", 0, 0,
                             "mkSeed", "_Z6mkSeedjj", 0, 1, "lcg61",
                        "mkSeed|iSeed|0", 1, "mkSeed",
        "lcg61", 0UL, (int)1, 6522342444046979271UL,
        "lcg61", 0UL, (int)1, 6522342444046979271UL,
        "lcg61", 0UL, (int)1, 6522342444046979341UL);
    return 0;
}
