...
# 1 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
...
# 1 "<command-line>" 2
# 1 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 34 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
...
# 35 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp" 2
...
# 36 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp" 2
...
# 37 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp" 2
...
# 38 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp" 2
...
# 39 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp" 2
...
# 40 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp" 2
...
# 41 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp" 2
...
# 42 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp" 2
# 42 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 43 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
...
# 45 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp" 2
# 45 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 46 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 47 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 48 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 49 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 50 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 51 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 52 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
...
# 53 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
        float *c_coeff, int nx, int ny, int nz, int dimx, int dimy, int dimz,
# 54 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
        int radius) {const int ____chimes_did_disable0 = new_stack((void *)(&fwd), "fwd", &____must_manage_fwd, 11, 0, (size_t)(9834377018900107519UL), (size_t)(9834377018900107520UL), (size_t)(9834377018900107521UL), (size_t)(9834377018900107522UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
# 55 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 56 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
    { int z; for ( z = (0) ; z < nz; z++) {
# 57 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
        { int y; for ( y = (0) ; y < ny; y++) {
# 58 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
            { int x; for ( x = (0) ; x < nx; x++) {
# 59 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
                 int this_offset; this_offset = ((((radius) + (z)) * (dimy) * (dimx) + ((radius) + (y)) * (dimx) + ((radius) + (x)))) ;
# 60 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
                 float temp; temp = (2.0f * curr[this_offset] - next[this_offset]) ;
# 61 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
                 float div; div = (c_coeff[0] * curr[this_offset]) ;
# 62 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
                { int d; for ( d = (1) ; d <= radius; d++) {
# 63 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
                     int z_pos_offset; z_pos_offset = ((((radius) + (z + d)) * (dimy) * (dimx) + ((radius) + (y)) * (dimx) + ((radius) + (x)))) ;
# 65 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
                     int z_neg_offset; z_neg_offset = ((((radius) + (z - d)) * (dimy) * (dimx) + ((radius) + (y)) * (dimx) + ((radius) + (x)))) ;
# 67 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
                     int y_pos_offset; y_pos_offset = ((((radius) + (z)) * (dimy) * (dimx) + ((radius) + (y + d)) * (dimx) + ((radius) + (x)))) ;
# 69 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
                     int y_neg_offset; y_neg_offset = ((((radius) + (z)) * (dimy) * (dimx) + ((radius) + (y - d)) * (dimx) + ((radius) + (x)))) ;
# 71 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
                     int x_pos_offset; x_pos_offset = ((((radius) + (z)) * (dimy) * (dimx) + ((radius) + (y)) * (dimx) + ((radius) + (x + d)))) ;
# 73 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
                     int x_neg_offset; x_neg_offset = ((((radius) + (z)) * (dimy) * (dimx) + ((radius) + (y)) * (dimx) + ((radius) + (x - d)))) ;
# 75 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
                    div += c_coeff[d] * (curr[z_pos_offset] +
# 76 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
                            curr[z_neg_offset] + curr[y_pos_offset] +
# 77 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
                            curr[y_neg_offset] + curr[x_pos_offset] +
# 78 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
                            curr[x_neg_offset]);
# 79 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
                } }
# 80 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
                next[this_offset] = temp + div * vsq[this_offset];
# 81 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
            } }
# 82 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
        } }
# 83 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
    } }
# 84 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
rm_stack(false, 0UL, "fwd", &____must_manage_fwd, ____alias_loc_id_10, ____chimes_did_disable0, false); }
# 85 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 86 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
...
int main_resumable( int argc, char *argv[] ) {const int ____chimes_did_disable1 = new_stack((void *)(&main), "main", (int *)0, 2, 2, (size_t)(0UL), (size_t)(9834377018900107165UL), "main|argc|0", &____must_checkpoint_main_argc_0, "i32", (void *)(&argc), (size_t)4, 0, 0, 0, "main|argv|0", &____must_checkpoint_main_argv_0, "i8**", (void *)(&argv), (size_t)8, 1, 0, 0) ; double elapsed_s;
# 86 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
int step;
# 86 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
float **srcs;
...
# 87 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
      ;
# 88 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 89 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
...
# 90 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 91 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
     call_lbl_1: (____chimes_does_checkpoint_setup_config_npm ? ( ({ calling((void*)setup_config, 1, ____alias_loc_id_2, 0UL, 3, (size_t)(9834377018900106789UL), (size_t)(0UL), (size_t)(9834377018900107165UL)); (setup_config)(&conf, argc, argv); }) ) : (({ calling_npm("setup_config", ____alias_loc_id_2); (*____chimes_extern_func_setup_config)(&conf, argc, argv); })));
# 92 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
...
# 93 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 94 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
       dx = (20.f) ;
# 95 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
       dt = (0.002f) ;
# 96 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 97 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 98 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
       dimx = (conf.nx + 2*conf.radius) ;
# 99 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
       dimy = (conf.ny + 2*conf.radius) ;
# 100 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
       dimz = (conf.nz + 2*conf.radius) ;
# 101 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
     size_t nbytes; nbytes = (dimx * dimy * dimz * sizeof(float)) ;
# 102 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 103 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
    if (conf.verbose) {
# 104 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
        printf("x = %zu, y = %zu, z = %zu\n", dimx, dimy, dimz);
# 105 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
        printf("nsteps = %d\n", conf.nsteps);
# 106 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
        printf("radius = %d\n", conf.radius);
# 107 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
    }
# 108 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 109 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
       c_coeff = ((float *) ({ void *____chimes_tmp_ptr = malloc((sizeof(float) * 20) + sizeof(void *)); malloc_helper(____chimes_tmp_ptr, sizeof(float) * 20, 9834377018900107037UL, 0, 0); (____chimes_tmp_ptr ? (void *)(((unsigned char *)____chimes_tmp_ptr) + sizeof(void *)) : ____chimes_tmp_ptr); })) ;
# 110 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
       curr = ((float *) ({ void *____chimes_tmp_ptr = malloc((nbytes) + sizeof(void *)); malloc_helper(____chimes_tmp_ptr, nbytes, 9834377018900107034UL, 0, 0); (____chimes_tmp_ptr ? (void *)(((unsigned char *)____chimes_tmp_ptr) + sizeof(void *)) : ____chimes_tmp_ptr); })) ;
# 111 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
       next = ((float *) ({ void *____chimes_tmp_ptr = malloc((nbytes) + sizeof(void *)); malloc_helper(____chimes_tmp_ptr, nbytes, 9834377018900107034UL, 0, 0); (____chimes_tmp_ptr ? (void *)(((unsigned char *)____chimes_tmp_ptr) + sizeof(void *)) : ____chimes_tmp_ptr); })) ;
# 112 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
       vsq = ((float *) ({ void *____chimes_tmp_ptr = malloc((nbytes) + sizeof(void *)); malloc_helper(____chimes_tmp_ptr, nbytes, 9834377018900107036UL, 0, 0); (____chimes_tmp_ptr ? (void *)(((unsigned char *)____chimes_tmp_ptr) + sizeof(void *)) : ____chimes_tmp_ptr); })) ;
# 113 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
    if (curr == __null || next == __null || vsq == __null) {
# 114 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
        fprintf(stderr, "Allocations failed\n");
# 115 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
...
# 116 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
    }
# 117 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 118 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
     call_lbl_3: (____chimes_does_checkpoint_config_sources_npm ? ( ({ source ** ____chimes_arg6; int * ____chimes_arg7; int ____chimes_arg8; int ____chimes_arg9; int ____chimes_arg10; if (!____chimes_replaying) { ____chimes_arg6 = (&conf.srcs); ____chimes_arg7 = (&conf.nsrcs); ____chimes_arg8 = (conf.nx); ____chimes_arg9 = (conf.ny); ____chimes_arg10 = (conf.nsteps); } calling((void*)config_sources, 3, ____alias_loc_id_8, 0UL, 5, (size_t)(9834377018900106789UL), (size_t)(9834377018900106789UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)); (config_sources)(____chimes_arg6, ____chimes_arg7, ____chimes_arg8, ____chimes_arg9, ____chimes_arg10); }) ) : (({ calling_npm("config_sources", ____alias_loc_id_8); (*____chimes_extern_func_config_sources)(&conf.srcs, &conf.nsrcs, conf.nx, conf.ny, conf.nsteps); })));
# 119 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
        call_lbl_4: srcs = ((____chimes_does_checkpoint_sample_sources_npm ? ( ({ source * ____chimes_arg11; int ____chimes_arg12; int ____chimes_arg13; if (!____chimes_replaying) { ____chimes_arg11 = (conf.srcs); ____chimes_arg12 = (conf.nsrcs); ____chimes_arg13 = (conf.nsteps); } calling((void*)sample_sources, 4, ____alias_loc_id_6, 9834377018900107144UL, 4, (size_t)(9834377018900106970UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)); (sample_sources)(____chimes_arg11, ____chimes_arg12, ____chimes_arg13, dt); }) ) : (({ calling_npm("sample_sources", ____alias_loc_id_6); (*____chimes_extern_func_sample_sources)(conf.srcs, conf.nsrcs, conf.nsteps, dt); })))) ;
# 120 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 121 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
     call_lbl_5: (____chimes_does_checkpoint_init_data_npm ? ( ({ calling((void*)init_data, 5, ____alias_loc_id_5, 0UL, 9, (size_t)(9834377018900107034UL), (size_t)(9834377018900107034UL), (size_t)(9834377018900107036UL), (size_t)(9834377018900107037UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)); (init_data)(curr, next, vsq, c_coeff, dimx, dimy, dimz, dx, dt); }) ) : (({ calling_npm("init_data", ____alias_loc_id_5); (*____chimes_extern_func_init_data)(curr, next, vsq, c_coeff, dimx, dimy, dimz, dx, dt); })));
# 122 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 123 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
    { for ( step = (0) ; step < conf.nsteps; step++) {
# 124 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
        { int src; for ( src = (0) ; src < conf.nsrcs; src++) {
# 125 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
            if (conf.srcs[src].t > step) {continue; };
# 126 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
             int src_offset; src_offset = ((((conf.radius) + (0)) * (dimy) * (dimx) + ((conf.radius) + (conf.srcs[src].y)) * (dimx) + ((conf.radius) + (conf.srcs[src].x)))) ;
# 128 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
            curr[src_offset] = srcs[src][step];
# 129 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
        } }
# 130 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 131 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
         call_lbl_6: ({ calling_npm("fwd", 0); fwd_npm(next, curr, vsq, c_coeff, conf.nx, conf.ny, conf.nz, dimx, dimy, dimz, conf.radius); });
# 133 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 134 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
         float *tmp; tmp = (next) ;
# 135 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
        next = curr;
# 136 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
        curr = tmp;
# 137 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 138 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 139 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
         call_lbl_7: checkpoint_transformed(7, ____alias_loc_id_7);
# 140 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 141 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 142 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
...
# 143 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
    } }
# 144 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
...
# 145 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 146 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
...
# 147 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 148 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
     float point_rate; point_rate = ((float)conf.nx * conf.ny / (elapsed_s / conf.nsteps)) ;
# 149 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
    fprintf(stderr, "iso_r4_2x:   %8.10f s total, %8.10f s/step, %8.2f Mcells/s/step\n",
# 150 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
            elapsed_s, elapsed_s / conf.nsteps, point_rate / 1000000.f);
# 151 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 152 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
    if (conf.save_text != -1) {
# 153 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
         call_lbl_11: (____chimes_does_checkpoint_save_layer_text_npm ? ( ({ int ____chimes_arg26; int ____chimes_arg29; int ____chimes_arg30; int ____chimes_arg32; if (!____chimes_replaying) { ____chimes_arg26 = (conf.save_text); ____chimes_arg29 = (conf.ny); ____chimes_arg30 = (conf.nx); ____chimes_arg32 = (conf.radius); } calling((void*)save_layer_text, 11, ____alias_loc_id_1, 0UL, 8, (size_t)(9834377018900107034UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(9834377018900107546UL), (size_t)(0UL)); (save_layer_text)(curr, ____chimes_arg26, dimx, dimy, ____chimes_arg29, ____chimes_arg30, "snap.text", ____chimes_arg32); }) ) : (({ calling_npm("save_layer_text", ____alias_loc_id_1); (*____chimes_extern_func_save_layer_text)(curr, conf.save_text, dimx, dimy, conf.ny, conf.nx, "snap.text", conf.radius); })));
# 155 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
    }
# 156 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 157 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
     ({ free_helper((((unsigned char *)c_coeff) - sizeof(void *)), 9834377018900107037UL);free((((unsigned char *)c_coeff) - sizeof(void *))); }) ;
# 158 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
     ({ free_helper((((unsigned char *)curr) - sizeof(void *)), 9834377018900107034UL);free((((unsigned char *)curr) - sizeof(void *))); }) ;
# 159 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
     ({ free_helper((((unsigned char *)next) - sizeof(void *)), 9834377018900107034UL);free((((unsigned char *)next) - sizeof(void *))); }) ;
# 160 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
     ({ free_helper((((unsigned char *)vsq) - sizeof(void *)), 9834377018900107036UL);free((((unsigned char *)vsq) - sizeof(void *))); }) ;
# 161 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
    { int i; for ( i = (0) ; i < conf.nsrcs; i++) {
# 162 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
         ({ free_helper((((unsigned char *)srcs[i]) - sizeof(void *)), 9834377018900107146UL);free((((unsigned char *)srcs[i]) - sizeof(void *))); }) ;
# 163 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
    } }
# 164 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
     ({ free_helper((((unsigned char *)srcs) - sizeof(void *)), 9834377018900107144UL);free((((unsigned char *)srcs) - sizeof(void *))); }) ;
# 165 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 166 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
...
# 167 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
...
# 53 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
        float *c_coeff, int nx, int ny, int nz, int dimx, int dimy, int dimz,
# 54 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
        int radius) {const int ____chimes_did_disable0 = new_stack((void *)(&fwd), "fwd", &____must_manage_fwd, 11, 0, (size_t)(9834377018900107519UL), (size_t)(9834377018900107520UL), (size_t)(9834377018900107521UL), (size_t)(9834377018900107522UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)) ; ; ;
# 55 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 56 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
    { int z; for ( z = (0) ; z < nz; z++) {
# 57 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
...
# 117 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 118 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
     call_lbl_3: (____chimes_does_checkpoint_config_sources_npm ? ( ({ calling((void*)config_sources, 3, ____alias_loc_id_8, 0UL, 5, (size_t)(9834377018900106789UL), (size_t)(9834377018900106789UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)); (config_sources)(&conf.srcs, &conf.nsrcs, conf.nx, conf.ny, conf.nsteps); }) ) : (({ calling_npm("config_sources", ____alias_loc_id_8); (*____chimes_extern_func_config_sources)(&conf.srcs, &conf.nsrcs, conf.nx, conf.ny, conf.nsteps); })));
# 119 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
        call_lbl_4: srcs = ((____chimes_does_checkpoint_sample_sources_npm ? ( ({ calling((void*)sample_sources, 4, ____alias_loc_id_6, 9834377018900107144UL, 4, (size_t)(9834377018900106970UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)); (sample_sources)(conf.srcs, conf.nsrcs, conf.nsteps, dt); }) ) : (({ calling_npm("sample_sources", ____alias_loc_id_6); (*____chimes_extern_func_sample_sources)(conf.srcs, conf.nsrcs, conf.nsteps, dt); })))) ;
# 120 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 121 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
     call_lbl_5: (____chimes_does_checkpoint_init_data_npm ? ( ({ calling((void*)init_data, 5, ____alias_loc_id_5, 0UL, 9, (size_t)(9834377018900107034UL), (size_t)(9834377018900107034UL), (size_t)(9834377018900107036UL), (size_t)(9834377018900107037UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)); (init_data)(curr, next, vsq, c_coeff, dimx, dimy, dimz, dx, dt); }) ) : (({ calling_npm("init_data", ____alias_loc_id_5); (*____chimes_extern_func_init_data)(curr, next, vsq, c_coeff, dimx, dimy, dimz, dx, dt); })));
# 122 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
...
# 152 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
    if (conf.save_text != -1) {
# 153 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
         call_lbl_11: (____chimes_does_checkpoint_save_layer_text_npm ? ( ({ calling((void*)save_layer_text, 11, ____alias_loc_id_1, 0UL, 8, (size_t)(9834377018900107034UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(9834377018900107546UL), (size_t)(0UL)); (save_layer_text)(curr, conf.save_text, dimx, dimy, conf.ny, conf.nx, "snap.text", conf.radius); }) ) : (({ calling_npm("save_layer_text", ____alias_loc_id_1); (*____chimes_extern_func_save_layer_text)(curr, conf.save_text, dimx, dimy, conf.ny, conf.nx, "snap.text", conf.radius); })));
# 155 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
    }
# 156 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
# 157 "/scratch/jmg3/chimes/src/examples/cpp/./iso3d.cpp"
...
static int module_init() {
    init_module(9834377018900106785UL, 14, 2, 6, 11, 1, 9, 10, 1, 10, 2,
                           &____alias_loc_id_0, (unsigned)1, (unsigned)0, (unsigned)0, (9834377018900106785UL + 22UL),
                           &____alias_loc_id_1, (unsigned)1, (unsigned)0, (unsigned)1, (9834377018900106785UL + 23UL), "save_layer_text", (unsigned)2, (9834377018900106785UL + 249UL), (9834377018900106785UL + 761UL),
                           &____alias_loc_id_2, (unsigned)1, (unsigned)0, (unsigned)1, (9834377018900106785UL + 5UL), "setup_config", (unsigned)2, (9834377018900106785UL + 4UL), (9834377018900106785UL + 380UL),
                           &____alias_loc_id_3, (unsigned)1, (unsigned)0, (unsigned)0, (9834377018900106785UL + 18UL),
                           &____alias_loc_id_4, (unsigned)3, (unsigned)0, (unsigned)0, (9834377018900106785UL + 1UL), (9834377018900106785UL + 2UL), (9834377018900106785UL + 3UL),
                           &____alias_loc_id_5, (unsigned)1, (unsigned)0, (unsigned)1, (9834377018900106785UL + 17UL), "init_data", (unsigned)3, (9834377018900106785UL + 249UL), (9834377018900106785UL + 251UL), (9834377018900106785UL + 252UL),
                           &____alias_loc_id_6, (unsigned)0, (unsigned)0, (unsigned)1, "sample_sources", (unsigned)2, (9834377018900106785UL + 185UL), (9834377018900106785UL + 359UL),
                           &____alias_loc_id_7, (unsigned)7, (unsigned)0, (unsigned)0, (9834377018900106785UL + 13UL), (9834377018900106785UL + 14UL), (9834377018900106785UL + 18UL), (9834377018900106785UL + 19UL), (9834377018900106785UL + 20UL), (9834377018900106785UL + 21UL), (9834377018900106785UL + 249UL),
                           &____alias_loc_id_8, (unsigned)0, (unsigned)0, (unsigned)1, "config_sources", (unsigned)1, (9834377018900106785UL + 4UL),
                           &____alias_loc_id_9, (unsigned)15, (unsigned)0, (unsigned)0, (9834377018900106785UL + 1UL), (9834377018900106785UL + 6UL), (9834377018900106785UL + 7UL), (9834377018900106785UL + 8UL), (9834377018900106785UL + 9UL), (9834377018900106785UL + 10UL), (9834377018900106785UL + 11UL), (9834377018900106785UL + 12UL), (9834377018900106785UL + 13UL), (9834377018900106785UL + 14UL), (9834377018900106785UL + 15UL), (9834377018900106785UL + 16UL), (9834377018900106785UL + 23UL), (9834377018900106785UL + 24UL), (9834377018900106785UL + 25UL),
                            &____alias_loc_id_10, (unsigned)25, (unsigned)0, (unsigned)0, (9834377018900106785UL + 411UL), (9834377018900106785UL + 412UL), (9834377018900106785UL + 413UL), (9834377018900106785UL + 414UL), (9834377018900106785UL + 415UL), (9834377018900106785UL + 416UL), (9834377018900106785UL + 417UL), (9834377018900106785UL + 418UL), (9834377018900106785UL + 419UL), (9834377018900106785UL + 420UL), (9834377018900106785UL + 421UL), (9834377018900106785UL + 422UL), (9834377018900106785UL + 423UL), (9834377018900106785UL + 424UL), (9834377018900106785UL + 425UL), (9834377018900106785UL + 426UL), (9834377018900106785UL + 427UL), (9834377018900106785UL + 428UL), (9834377018900106785UL + 429UL), (9834377018900106785UL + 430UL), (9834377018900106785UL + 431UL), (9834377018900106785UL + 432UL), (9834377018900106785UL + 433UL), (9834377018900106785UL + 434UL), (9834377018900106785UL + 734UL),
                            "fwd", 1, (void *)(&fwd_npm), (void *)__null, 0, 11, (9834377018900106785UL + 734UL), (9834377018900106785UL + 735UL), (9834377018900106785UL + 736UL), (9834377018900106785UL + 737UL), 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0,
                           ...
                           "update_progress", &(____chimes_does_checkpoint_update_progress_npm),
                             (9834377018900106785UL + 13UL), (9834377018900106785UL + 249UL),
                             (9834377018900106785UL + 12UL), (9834377018900106785UL + 252UL),
                             (9834377018900106785UL + 15UL), (9834377018900106785UL + 251UL),
                             (9834377018900106785UL + 14UL), (9834377018900106785UL + 249UL),
                             (9834377018900106785UL + 17UL), (9834377018900106785UL + 359UL),
                             (9834377018900106785UL + 758UL), (9834377018900106785UL + 307UL),
                             (9834377018900106785UL + 414UL), (9834377018900106785UL + 737UL),
                             (9834377018900106785UL + 3UL), (9834377018900106785UL + 380UL),
                             (9834377018900106785UL + 4UL), (9834377018900106785UL + 185UL),
                             (9834377018900106785UL + 412UL), (9834377018900106785UL + 735UL),
                             (9834377018900106785UL + 413UL), (9834377018900106785UL + 736UL),
                             (9834377018900106785UL + 411UL), (9834377018900106785UL + 734UL),
                             (9834377018900106785UL + 359UL), (9834377018900106785UL + 361UL),
                             (9834377018900106785UL + 21UL), (9834377018900106785UL + 249UL),
        ...
        "fwd", 0UL, (int)11, 9834377018900107034UL, 9834377018900107034UL, 9834377018900107036UL, 9834377018900107037UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL,
        "seconds", 0UL, (int)0,
        "setup_config", 0UL, (int)3, 9834377018900106789UL, 0UL, 9834377018900107165UL,
        "init_progress", 0UL, (int)3, 0UL, 0UL, 0UL,
        "config_sources", 0UL, (int)5, 9834377018900106789UL, 9834377018900106789UL, 0UL, 0UL, 0UL,
        "sample_sources", 9834377018900107144UL, (int)4, 9834377018900106970UL, 0UL, 0UL, 0UL,
        "init_data", 0UL, (int)9, 9834377018900107034UL, 9834377018900107034UL, 9834377018900107036UL, 9834377018900107037UL, 0UL, 0UL, 0UL, 0UL, 0UL,
        "update_progress", 0UL, (int)1, 0UL,
        "seconds", 0UL, (int)0,
        "finish_progress", 0UL, (int)0,
        "save_layer_text", 0UL, (int)8, 9834377018900107034UL, 0UL, 0UL, 0UL, 0UL, 0UL, 9834377018900107546UL, 0UL);
    return 0;
}
