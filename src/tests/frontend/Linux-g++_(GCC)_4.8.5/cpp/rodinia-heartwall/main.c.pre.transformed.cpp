...
# 144 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
      call_lbl_4: (____chimes_does_checkpoint_AVI_print_error_npm ? ( ({ char * ____chimes_arg2; if (!____chimes_replaying) { ____chimes_arg2 = ((char *)"Error with AVI_open_input_file"); } calling((void*)AVI_print_error, 4, ____alias_loc_id_0, 0UL, 1, (size_t)(762051829673680282UL)); (AVI_print_error)(____chimes_arg2); }) ) : (({ calling_npm("AVI_print_error", ____alias_loc_id_0); (*____chimes_extern_func_AVI_print_error)((char *) "Error with AVI_open_input_file"); })));
...
# 577 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
    call_lbl_48: (____chimes_does_checkpoint_kernel_npm ? ( ({ public_struct ____chimes_arg15; private_struct ____chimes_arg16; if (!____chimes_replaying) { ____chimes_arg15 = (pub); ____chimes_arg16 = (priv[i]); } calling((void*)kernel, 48, ____alias_loc_id_6, 0UL, 2, (size_t)(762051829673678596UL), (size_t)(762051829673678597UL)); (kernel)(____chimes_arg15, ____chimes_arg16); }) ) : (({ calling_npm("kernel", ____alias_loc_id_6); (*____chimes_extern_func_kernel)(pub, priv[i]); })));
...
# 598 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
     call_lbl_54: checkpoint_transformed(54, ____alias_loc_id_2);
...
# 143 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
 if (d_frames == __null) {
# 144 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
      call_lbl_4: (____chimes_does_checkpoint_AVI_print_error_npm ? ( ({ calling((void*)AVI_print_error, 4, ____alias_loc_id_0, 0UL, 1, (size_t)(762051829673680282UL)); (AVI_print_error)((char *)"Error with AVI_open_input_file"); }) ) : (({ calling_npm("AVI_print_error", ____alias_loc_id_0); (*____chimes_extern_func_AVI_print_error)((char *) "Error with AVI_open_input_file"); })));
# 145 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
      int ____chimes_ret_var_1; ; ____chimes_ret_var_1 = (-1); rm_stack(false, 0UL, "main", (int *)0x0, ____alias_loc_id_13, ____chimes_did_disable2, false); return ____chimes_ret_var_1; ;
# 146 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
 }
...
# 576 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
  for(i=0; i<pub.allPoints; i++){
# 577 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
    call_lbl_48: (____chimes_does_checkpoint_kernel_npm ? ( ({ calling((void*)kernel, 48, ____alias_loc_id_6, 0UL, 2, (size_t)(762051829673678596UL), (size_t)(762051829673678597UL)); (kernel)(pub, priv[i]); }) ) : (({ calling_npm("kernel", ____alias_loc_id_6); (*____chimes_extern_func_kernel)(pub, priv[i]); })));
# 579 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
  }
# 580 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
# 581 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
