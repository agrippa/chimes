...
# 233 "/scratch/jmg3/rodinia_3.0/openmp/hotspot/hotspot_openmp.cpp"
 temp = (double *) calloc_wrapper (grid_rows * grid_cols, sizeof(double), 10021604361511767237UL, 0, 0);
# 234 "/scratch/jmg3/rodinia_3.0/openmp/hotspot/hotspot_openmp.cpp"
 power = (double *) calloc_wrapper (grid_rows * grid_cols, sizeof(double), 10021604361511767244UL, 0, 0);
# 235 "/scratch/jmg3/rodinia_3.0/openmp/hotspot/hotspot_openmp.cpp"
 result = (double *) calloc_wrapper (grid_rows * grid_cols, sizeof(double), 10021604361511767251UL, 0, 0);
...
# 248 "/scratch/jmg3/rodinia_3.0/openmp/hotspot/hotspot_openmp.cpp"
  call_lbl_9: ({ calling((void*)compute_tran_temp, 9, ____alias_loc_id_1, 0UL, 6, (size_t)(10021604361511767251UL), (size_t)(0UL), (size_t)(10021604361511767237UL), (size_t)(10021604361511767244UL), (size_t)(0UL), (size_t)(0UL)); (compute_tran_temp)(result, sim_time, temp, power, grid_rows, grid_cols); }) ;
...
# 264 "/scratch/jmg3/rodinia_3.0/openmp/hotspot/hotspot_openmp.cpp"
 free_wrapper(temp, 10021604361511767237UL);
# 265 "/scratch/jmg3/rodinia_3.0/openmp/hotspot/hotspot_openmp.cpp"
 free_wrapper(power, 10021604361511767244UL);
...
# 247 "/scratch/jmg3/rodinia_3.0/openmp/hotspot/hotspot_openmp.cpp"
 printf("Start computing the transient temperature\n");
# 248 "/scratch/jmg3/rodinia_3.0/openmp/hotspot/hotspot_openmp.cpp"
  call_lbl_9: ({ calling((void*)compute_tran_temp, 9, ____alias_loc_id_1, 0UL, 6, (size_t)(10021604361511767251UL), (size_t)(0UL), (size_t)(10021604361511767237UL), (size_t)(10021604361511767244UL), (size_t)(0UL), (size_t)(0UL)); compute_tran_temp_quick(result, sim_time, temp, power, grid_rows, grid_cols); }) ;
# 249 "/scratch/jmg3/rodinia_3.0/openmp/hotspot/hotspot_openmp.cpp"
 printf("Ending simulation\n");
# 250 "/scratch/jmg3/rodinia_3.0/openmp/hotspot/hotspot_openmp.cpp"
# 251 "/scratch/jmg3/rodinia_3.0/openmp/hotspot/hotspot_openmp.cpp"
