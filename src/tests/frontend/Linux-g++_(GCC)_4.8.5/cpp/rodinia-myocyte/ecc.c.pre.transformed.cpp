...
# 11 "/scratch/jmg3/rodinia_3.0/openmp/myocyte/ecc.c"
    float *finavalu){const int ____chimes_did_disable0 = new_stack((void *)(&ecc), "ecc", &____must_manage_ecc, 6, 0, (size_t)(0UL), (size_t)(17020714764657570938UL), (size_t)(0UL), (size_t)(17020714764657570940UL), (size_t)(0UL), (size_t)(17020714764657570942UL)) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
...
# 10 "/scratch/jmg3/rodinia_3.0/openmp/myocyte/ecc.c"
    int parameter_offset,
# 11 "/scratch/jmg3/rodinia_3.0/openmp/myocyte/ecc.c"
    float *finavalu){const int ____chimes_did_disable0 = new_stack((void *)(&ecc), "ecc", &____must_manage_ecc, 6, 0, (size_t)(0UL), (size_t)(17020714764657570938UL), (size_t)(0UL), (size_t)(17020714764657570940UL), (size_t)(0UL), (size_t)(17020714764657570942UL)) ; ; ;
# 12 "/scratch/jmg3/rodinia_3.0/openmp/myocyte/ecc.c"
# 13 "/scratch/jmg3/rodinia_3.0/openmp/myocyte/ecc.c"
# 14 "/scratch/jmg3/rodinia_3.0/openmp/myocyte/ecc.c"
# 15 "/scratch/jmg3/rodinia_3.0/openmp/myocyte/ecc.c"
