...
# 1 "/scratch/jmg3/Benchmarks/rodinia_poly_3.0/openmp/myocyte/timer.c"
...
# 2 "/scratch/jmg3/Benchmarks/rodinia_poly_3.0/openmp/myocyte/timer.c" 2
...
# 3 "/scratch/jmg3/Benchmarks/rodinia_poly_3.0/openmp/myocyte/timer.c" 2
...
# 4 "/scratch/jmg3/Benchmarks/rodinia_poly_3.0/openmp/myocyte/timer.c" 2
# 4 "/scratch/jmg3/Benchmarks/rodinia_poly_3.0/openmp/myocyte/timer.c"
# 5 "/scratch/jmg3/Benchmarks/rodinia_poly_3.0/openmp/myocyte/timer.c"
# 6 "/scratch/jmg3/Benchmarks/rodinia_poly_3.0/openmp/myocyte/timer.c"
# 7 "/scratch/jmg3/Benchmarks/rodinia_poly_3.0/openmp/myocyte/timer.c"
...
# 8 "/scratch/jmg3/Benchmarks/rodinia_poly_3.0/openmp/myocyte/timer.c"
  struct timeval tv; ;
# 9 "/scratch/jmg3/Benchmarks/rodinia_poly_3.0/openmp/myocyte/timer.c"
 gettimeofday(&tv, __null);
# 10 "/scratch/jmg3/Benchmarks/rodinia_poly_3.0/openmp/myocyte/timer.c"
...
# 11 "/scratch/jmg3/Benchmarks/rodinia_poly_3.0/openmp/myocyte/timer.c"
...
static int module_init() {
    init_module(3720432013949371716UL, 0, 1, 0, 1, 1, 0, 1, 0, 0, 1,
                           &____alias_loc_id_0, (unsigned)2, (unsigned)0, (unsigned)0, (3720432013949371716UL + 1UL), (3720432013949371716UL + 2UL),
                            "get_time", 0, "_Z8get_timev", "_Z12get_time_npmv", 0, 0, 0UL, 1, "gettimeofday", 2, (3720432013949371716UL + 1UL), (3720432013949371716UL + 19UL), 0UL,
