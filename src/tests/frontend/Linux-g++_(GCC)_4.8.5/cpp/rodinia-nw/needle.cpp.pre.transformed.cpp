...
{const int ____chimes_did_disable4 = new_stack((void *)(&usage), "usage", &____must_manage_usage, 2, 0, (size_t)(0UL), (size_t)(322747555189994395UL)) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
...
{const int ____chimes_did_disable5 = new_stack((void *)(&runTest), "runTest", (int *)0, 2, 0, (size_t)(0UL), (size_t)(322747555189994372UL)) ; int *referrence;
# 104 "/scratch/jmg3/rodinia_3.0/openmp/nw/needle.cpp"
int *output_itemsets;
# 104 "/scratch/jmg3/rodinia_3.0/openmp/nw/needle.cpp"
int *input_itemsets;
...
int max_cols;
# 104 "/scratch/jmg3/rodinia_3.0/openmp/nw/needle.cpp"
 register_stack_vars(5, "runTest|referrence|0", (int *)0x0, "i32*", (void *)(&referrence), (size_t)8, 1, 0, 0, "runTest|output_itemsets|0", (int *)0x0, "i32*", (void *)(&output_itemsets), (size_t)8, 1, 0, 0, "runTest|input_itemsets|0", (int *)0x0, "i32*", (void *)(&input_itemsets), (size_t)8, 1, 0, 0, "runTest|penalty|0", (int *)0x0, "i32", (void *)(&penalty), (size_t)4, 0, 0, 0, "runTest|max_cols|0", (int *)0x0, "i32", (void *)(&max_cols), (size_t)4, 0, 0, 0); if (____chimes_replaying) { switch(get_next_call()) { case(15): { goto call_lbl_15; } case(17): { goto call_lbl_17; } default: { chimes_error(); } } } ; ;
...
# 127 "/scratch/jmg3/rodinia_3.0/openmp/nw/needle.cpp"
 referrence = (int *)malloc_wrapper( max_rows * max_cols * sizeof(int), 322747555189994246UL, 0, 0 );
# 128 "/scratch/jmg3/rodinia_3.0/openmp/nw/needle.cpp"
    input_itemsets = (int *)malloc_wrapper( max_rows * max_cols * sizeof(int), 322747555189994241UL, 0, 0 );
# 129 "/scratch/jmg3/rodinia_3.0/openmp/nw/needle.cpp"
 output_itemsets = (int *)malloc_wrapper( max_rows * max_cols * sizeof(int), 322747555189994367UL, 0, 0 );
...
# 184 "/scratch/jmg3/rodinia_3.0/openmp/nw/needle.cpp"
     call_lbl_15: checkpoint_transformed(15, ____alias_loc_id_2);
...
# 270 "/scratch/jmg3/rodinia_3.0/openmp/nw/needle.cpp"
 free_wrapper(referrence, 322747555189994246UL);
# 271 "/scratch/jmg3/rodinia_3.0/openmp/nw/needle.cpp"
 free_wrapper(input_itemsets, 322747555189994241UL);
# 272 "/scratch/jmg3/rodinia_3.0/openmp/nw/needle.cpp"
 free_wrapper(output_itemsets, 322747555189994367UL);
...
# 91 "/scratch/jmg3/rodinia_3.0/openmp/nw/needle.cpp"
{const int ____chimes_did_disable4 = new_stack((void *)(&usage), "usage", &____must_manage_usage, 2, 0, (size_t)(0UL), (size_t)(322747555189994395UL)) ; ; ;
# 92 "/scratch/jmg3/rodinia_3.0/openmp/nw/needle.cpp"
 fprintf(stderr, "Usage: %s <max_rows/max_cols> <penalty> <num_threads>\n", argv[0]);
# 93 "/scratch/jmg3/rodinia_3.0/openmp/nw/needle.cpp"
 fprintf(stderr, "\t<dimension>      - x and y dimensions\n");
...
static int module_init() {
    init_module(322747555189993815UL, 9, 6, 3, 7, 4, 0, 4, 5, 0, 2,
                           ...
                           &____alias_loc_id_6, (unsigned)2, (unsigned)0, (unsigned)0, (322747555189993815UL + 91UL), (322747555189993815UL + 92UL),
                            ...
                            "gettime", 0, "_Z7gettimev", "_Z11gettime_npmv", 0, 0, 0UL, 1, "gettimeofday", 2, (322747555189993815UL + 71UL), (322747555189993815UL + 600UL), 0UL,
                            "maximum", 0, "_Z7maximumiii", "_Z11maximum_npmiii", 0, 3, 0UL, 0UL, 0UL, 0UL, 0,
                            "usage", 0, "_Z5usageiPPc", "_Z9usage_npmiPPc", 0, 2, 0UL, (322747555189993815UL + 580UL), 0UL, 5, "fprintf", 3, (322747555189993815UL + 565UL), (322747555189993815UL + 591UL), (322747555189993815UL + 568UL), 0UL, "fprintf", 2, (322747555189993815UL + 565UL), (322747555189993815UL + 592UL), 0UL, "fprintf", 2, (322747555189993815UL + 565UL), (322747555189993815UL + 593UL), 0UL, "fprintf", 2, (322747555189993815UL + 565UL), (322747555189993815UL + 594UL), 0UL, "exit", 1, 0UL, 0UL,
                           ...
                           "usage", &(____chimes_does_checkpoint_usage_npm),
                             (322747555189993815UL + 590UL), (322747555189993815UL + 565UL),
                             (322747555189993815UL + 580UL), (322747555189993815UL + 568UL),
                             (322747555189993815UL + 560UL), (322747555189993815UL + 580UL),
                             (322747555189993815UL + 557UL), (322747555189993815UL + 164UL),
                             (322747555189993815UL + 89UL), (322747555189993815UL + 116UL),
                             (322747555189993815UL + 124UL), (322747555189993815UL + 426UL),
                             (322747555189993815UL + 125UL), (322747555189993815UL + 552UL),
                             (322747555189993815UL + 126UL), (322747555189993815UL + 431UL),
                             (322747555189993815UL + 118UL), (322747555189993815UL + 557UL),
        ...
        "seconds", 0UL, (int)0,
        "seconds", 0UL, (int)0,
        "usage", 0UL, (int)2, 0UL, 322747555189994372UL,
