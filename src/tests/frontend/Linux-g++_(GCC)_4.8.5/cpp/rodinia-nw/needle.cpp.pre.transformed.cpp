...
# 189 "/scratch/jmg3/rodinia_3.0/openmp/nw/needle.cpp"
 { lbl_0: int i; register_stack_var("runTest|i|5", (int *)0x0, "i32", (void *)(&i), (size_t)4, 0, 0, 0); if (____chimes_replaying) { switch(get_next_call()) { case(15): { goto call_lbl_15; } case(17): { goto call_lbl_17; } default: { chimes_error(); } } } for( i = (max_cols - 4) ; i >= 0 ; i--){
