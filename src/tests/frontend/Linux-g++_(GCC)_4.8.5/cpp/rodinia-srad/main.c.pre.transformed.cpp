...
# 238 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
 image_ori = (float*) ({ void *____chimes_tmp_ptr = malloc(sizeof(float) * image_ori_elem); ; malloc_helper(____chimes_tmp_ptr, sizeof(float) * image_ori_elem, 7677405821689735764UL, 0, 0); ____chimes_tmp_ptr; }) ;
...
# 257 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
 image = (float*) ({ void *____chimes_tmp_ptr = malloc(sizeof(float) * Ne); ; malloc_helper(____chimes_tmp_ptr, sizeof(float) * Ne, 7677405821689735673UL, 0, 0); ____chimes_tmp_ptr; }) ;
...
# 282 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
    iN = (int *) ({ void *____chimes_tmp_ptr = malloc(sizeof(int *) * Nr); ; malloc_helper(____chimes_tmp_ptr, sizeof(int*)*Nr, 7677405821689735602UL, 0, 0); ____chimes_tmp_ptr; }) ;
# 283 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
    iS = (int *) ({ void *____chimes_tmp_ptr = malloc(sizeof(int *) * Nr); ; malloc_helper(____chimes_tmp_ptr, sizeof(int*)*Nr, 7677405821689735609UL, 0, 0); ____chimes_tmp_ptr; }) ;
# 284 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
    jW = (int *) ({ void *____chimes_tmp_ptr = malloc(sizeof(int *) * Nc); ; malloc_helper(____chimes_tmp_ptr, sizeof(int*)*Nc, 7677405821689735704UL, 0, 0); ____chimes_tmp_ptr; }) ;
# 285 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
    jE = (int *) ({ void *____chimes_tmp_ptr = malloc(sizeof(int *) * Nc); ; malloc_helper(____chimes_tmp_ptr, sizeof(int*)*Nc, 7677405821689735703UL, 0, 0); ____chimes_tmp_ptr; }) ;
...
# 288 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
 dN = (float*) ({ void *____chimes_tmp_ptr = malloc(sizeof(float) * Ne); ; malloc_helper(____chimes_tmp_ptr, sizeof(float)*Ne, 7677405821689735705UL, 0, 0); ____chimes_tmp_ptr; }) ;
# 289 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
    dS = (float*) ({ void *____chimes_tmp_ptr = malloc(sizeof(float) * Ne); ; malloc_helper(____chimes_tmp_ptr, sizeof(float)*Ne, 7677405821689735706UL, 0, 0); ____chimes_tmp_ptr; }) ;
# 290 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
    dW = (float*) ({ void *____chimes_tmp_ptr = malloc(sizeof(float) * Ne); ; malloc_helper(____chimes_tmp_ptr, sizeof(float)*Ne, 7677405821689735707UL, 0, 0); ____chimes_tmp_ptr; }) ;
# 291 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
    dE = (float*) ({ void *____chimes_tmp_ptr = malloc(sizeof(float) * Ne); ; malloc_helper(____chimes_tmp_ptr, sizeof(float)*Ne, 7677405821689735708UL, 0, 0); ____chimes_tmp_ptr; }) ;
...
# 294 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
    c = (float*) ({ void *____chimes_tmp_ptr = malloc(sizeof(float) * Ne); ; malloc_helper(____chimes_tmp_ptr, sizeof(float)*Ne, 7677405821689735715UL, 0, 0); ____chimes_tmp_ptr; }) ;
...
# 374 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
  ({ free(image_ori); free_helper(image_ori, 7677405821689735764UL); }) ;
# 375 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
  ({ free(image); free_helper(image, 7677405821689735673UL); }) ;
# 376 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
# 377 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
     ({ free(iN); free_helper(iN, 7677405821689735602UL); }) ; ({ free(iS); free_helper(iS, 7677405821689735609UL); }) ; ({ free(jW); free_helper(jW, 7677405821689735704UL); }) ; ({ free(jE); free_helper(jE, 7677405821689735703UL); }) ;
# 378 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
     ({ free(dN); free_helper(dN, 7677405821689735705UL); }) ; ({ free(dS); free_helper(dS, 7677405821689735706UL); }) ; ({ free(dW); free_helper(dW, 7677405821689735707UL); }) ; ({ free(dE); free_helper(dE, 7677405821689735708UL); }) ;
# 379 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
     ({ free(c); free_helper(c, 7677405821689735715UL); }) ;
