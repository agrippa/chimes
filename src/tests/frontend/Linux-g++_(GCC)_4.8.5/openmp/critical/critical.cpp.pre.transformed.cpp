...
# 1 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
...
# 2 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp" 2
...
# 3 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp" 2
...
# 4 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp" 2
# 4 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
# 5 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
...
# 6 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
     call_lbl_0: checkpoint_transformed(0, 0);
# 7 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
rm_stack(false, 0UL, "foo", (int *)0x0, 0, ____chimes_did_disable0, false); }
# 8 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
# 9 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
int main_quick(int argc, char **argv); int main(int argc, char **argv);
int main_resumable(int argc, char **argv) {const int ____chimes_did_disable1 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(1471647340114156853UL)) ; if (____chimes_replaying) { switch(get_next_call()) { case(1): { goto call_lbl_1; } default: { chimes_error(); } } } ; ;
# 10 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
     int a; a = (3) ;
# 11 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
     int b; b = (4) ;
# 12 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
     int c; c = (5) ;
# 13 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
     int d; d = (0) ;
# 14 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
# 14 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
# 14 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
...
# 14 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
# 14 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
# 15 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
...
# 16 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
         int inside; inside = (6) ;
# 17 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
# 18 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
# 18 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
# 18 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
...
# 18 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
# 18 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
# 19 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
        { {
# 20 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
            d = d + 1;
# 21 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
         } } reenable_current_thread(____chimes_disable1);
# 22 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
# 23 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
        printf("hello from %d : %d\n", omp_get_thread_num(), inside);
# 24 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
         call_lbl_0: ({ calling((void*)foo, 0, ____alias_loc_id_0, 0UL, 0); (foo)(); }) ;
# 25 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
     } thread_leaving(); } } leaving_omp_parallel(____chimes_call_stack_depth0, ____chimes_region_id0, 0); }
# 26 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
# 27 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
...
# 28 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
...
# 9 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
int main_quick(int argc, char **argv) {const int ____chimes_did_disable1 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(1471647340114156853UL)) ; ; ;
# 10 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
     int a; a = (3) ;
# 11 "/scratch/jmg3/chimes/src/examples/openmp/./critical.cpp"
     int b; b = (4) ;
...
static int module_init() {
    init_module(1471647340114156814UL, 1, 2, 0, 2, 0, 0, 0, 0, 0, 0,
                           &____alias_loc_id_0, (unsigned)8, (unsigned)0, (unsigned)0, (1471647340114156814UL + 3UL), (1471647340114156814UL + 4UL), (1471647340114156814UL + 5UL), (1471647340114156814UL + 6UL), (1471647340114156814UL + 7UL), (1471647340114156814UL + 8UL), (1471647340114156814UL + 9UL), (1471647340114156814UL + 10UL),
                           &____alias_loc_id_1, (unsigned)1, (unsigned)0, (unsigned)0, (1471647340114156814UL + 11UL),
                             (1471647340114156814UL + 5UL), (1471647340114156814UL + 39UL),
                             "main", "main", 0, 1, "foo",
