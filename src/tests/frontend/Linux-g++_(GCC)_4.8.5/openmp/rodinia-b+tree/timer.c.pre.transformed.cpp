...
# 1 "/scratch/jmg3/rodinia_3.0/openmp/b+tree/util/timer/timer.c"
...
# 1 "/scratch/jmg3/rodinia_3.0/openmp/b+tree/util/timer/timer.c"
# 1 "/scratch/jmg3/rodinia_3.0/openmp/b+tree/util/timer/timer.c"
# 2 "/scratch/jmg3/rodinia_3.0/openmp/b+tree/util/timer/timer.c"
extern "C" {
# 13 "/scratch/jmg3/rodinia_3.0/openmp/b+tree/util/timer/timer.c"
...
# 14 "/scratch/jmg3/rodinia_3.0/openmp/b+tree/util/timer/timer.c" 2
...
# 15 "/scratch/jmg3/rodinia_3.0/openmp/b+tree/util/timer/timer.c" 2
# 25 "/scratch/jmg3/rodinia_3.0/openmp/b+tree/util/timer/timer.c"
# 25 "/scratch/jmg3/rodinia_3.0/openmp/b+tree/util/timer/timer.c"
...
# 26 "/scratch/jmg3/rodinia_3.0/openmp/b+tree/util/timer/timer.c"
  struct timeval tv; ;
# 27 "/scratch/jmg3/rodinia_3.0/openmp/b+tree/util/timer/timer.c"
 gettimeofday(&tv, __null);
# 28 "/scratch/jmg3/rodinia_3.0/openmp/b+tree/util/timer/timer.c"
...
# 29 "/scratch/jmg3/rodinia_3.0/openmp/b+tree/util/timer/timer.c"
rm_stack(false, 0UL, "get_time", &____must_manage_get_time, ____alias_loc_id_0, ____chimes_did_disable0, false); }
# 30 "/scratch/jmg3/rodinia_3.0/openmp/b+tree/util/timer/timer.c"
# 31 "/scratch/jmg3/rodinia_3.0/openmp/b+tree/util/timer/timer.c"
# 32 "/scratch/jmg3/rodinia_3.0/openmp/b+tree/util/timer/timer.c"
# 33 "/scratch/jmg3/rodinia_3.0/openmp/b+tree/util/timer/timer.c"
# 34 "/scratch/jmg3/rodinia_3.0/openmp/b+tree/util/timer/timer.c"
# 35 "/scratch/jmg3/rodinia_3.0/openmp/b+tree/util/timer/timer.c"
# 36 "/scratch/jmg3/rodinia_3.0/openmp/b+tree/util/timer/timer.c"
}
# 25 "/scratch/jmg3/rodinia_3.0/openmp/b+tree/util/timer/timer.c"
...
static int module_init() {
    init_module(5216248019188325936UL, 0, 1, 0, 1, 1, 0, 1, 0, 0, 1,
                           &____alias_loc_id_0, (unsigned)2, (unsigned)0, (unsigned)0, (5216248019188325936UL + 1UL), (5216248019188325936UL + 2UL),
                            "get_time", 0, "get_time", "get_time_npm", 0, 0, 0UL, 1, "gettimeofday", 2, (5216248019188325936UL + 1UL), (5216248019188325936UL + 19UL), 0UL,
