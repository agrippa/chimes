...
# 397 "/scratch/jmg3/rodinia_3.0/openmp/backprop/backprop.c"
  mem = (char *) ({ void *____chimes_tmp_ptr = malloc((unsigned int)((n1 + 1) * (n2 + 1) * sizeof(float))); ; malloc_helper(____chimes_tmp_ptr, (unsigned) ((n1+1) * (n2+1) * sizeof(float)), 12828305900417645833UL, 0, 0); ____chimes_tmp_ptr; }) ;
...
# 407 "/scratch/jmg3/rodinia_3.0/openmp/backprop/backprop.c"
   ({ free(mem); free_helper(mem, 12828305900417645833UL); }) ;
...
# 411 "/scratch/jmg3/rodinia_3.0/openmp/backprop/backprop.c"
  mem = (char *) ({ void *____chimes_tmp_ptr = malloc((unsigned int)((n2 + 1) * (n3 + 1) * sizeof(float))); ; malloc_helper(____chimes_tmp_ptr, (unsigned) ((n2+1) * (n3+1) * sizeof(float)), 12828305900417645833UL, 0, 0); ____chimes_tmp_ptr; }) ;
...
{const int ____chimes_did_disable19 = new_stack((void *)(&bpnn_read), "bpnn_read", &____must_manage_bpnn_read, 1, 0, (size_t)(12828305900417646299UL)) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
...
# 449 "/scratch/jmg3/rodinia_3.0/openmp/backprop/backprop.c"
  mem = (char *) ({ void *____chimes_tmp_ptr = malloc((unsigned int)((n1 + 1) * (n2 + 1) * sizeof(float))); ; malloc_helper(____chimes_tmp_ptr, (unsigned) ((n1+1) * (n2+1) * sizeof(float)), 12828305900417646143UL, 0, 0); ____chimes_tmp_ptr; }) ;
...
# 457 "/scratch/jmg3/rodinia_3.0/openmp/backprop/backprop.c"
   ({ free(mem); free_helper(mem, 12828305900417646143UL); }) ;
...
# 462 "/scratch/jmg3/rodinia_3.0/openmp/backprop/backprop.c"
  mem = (char *) ({ void *____chimes_tmp_ptr = malloc((unsigned int)((n2 + 1) * (n3 + 1) * sizeof(float))); ; malloc_helper(____chimes_tmp_ptr, (unsigned) ((n2+1) * (n3+1) * sizeof(float)), 12828305900417646143UL, 0, 0); ____chimes_tmp_ptr; }) ;
...
# 429 "/scratch/jmg3/rodinia_3.0/openmp/backprop/backprop.c"
{const int ____chimes_did_disable19 = new_stack((void *)(&bpnn_read), "bpnn_read", &____must_manage_bpnn_read, 1, 0, (size_t)(12828305900417646299UL)) ; ; ;
# 430 "/scratch/jmg3/rodinia_3.0/openmp/backprop/backprop.c"
  char *mem; ;
# 431 "/scratch/jmg3/rodinia_3.0/openmp/backprop/backprop.c"
  BPNN *new_mem; ;
