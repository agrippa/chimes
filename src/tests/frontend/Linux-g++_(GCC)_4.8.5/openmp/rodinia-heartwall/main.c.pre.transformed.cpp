...
# 142 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
     call_lbl_3: d_frames = ((avi_t *)(____chimes_does_checkpoint_AVI_open_input_file_npm ? ( ({ calling((void*)AVI_open_input_file, 3, ____alias_loc_id_3, 762051829673680011UL, 2, (size_t)(762051829673680001UL), (size_t)(0UL)); (AVI_open_input_file)(video_file_name, 1); }) ) : (({ calling_npm("AVI_open_input_file", ____alias_loc_id_3); (*____chimes_extern_func_AVI_open_input_file)(video_file_name, 1); })))) ;
# 143 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
 if (d_frames == __null) {
# 144 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
      call_lbl_4: (____chimes_does_checkpoint_AVI_print_error_npm ? ( ({ char * ____chimes_arg2; if (!____chimes_replaying) { ____chimes_arg2 = ((char *)"Error with AVI_open_input_file"); } calling((void*)AVI_print_error, 4, ____alias_loc_id_0, 0UL, 1, (size_t)(762051829673680285UL)); (AVI_print_error)(____chimes_arg2); }) ) : (({ calling_npm("AVI_print_error", ____alias_loc_id_0); (*____chimes_extern_func_AVI_print_error)((char *) "Error with AVI_open_input_file"); })));
...
# 149 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
 alias_group_changed(____alias_loc_id_9); call_lbl_7: pub.frames = (____chimes_does_checkpoint_AVI_video_frames_npm ? ( ({ calling((void*)AVI_video_frames, 7, ____alias_loc_id_9, 0UL, 1, (size_t)(762051829673680011UL)); (AVI_video_frames)(d_frames); }) ) : (({ calling_npm("AVI_video_frames", ____alias_loc_id_9); (*____chimes_extern_func_AVI_video_frames)(d_frames); })));
# 150 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
  call_lbl_8: pub.frame_rows = (____chimes_does_checkpoint_AVI_video_height_npm ? ( ({ calling((void*)AVI_video_height, 8, ____alias_loc_id_7, 0UL, 1, (size_t)(762051829673680011UL)); (AVI_video_height)(d_frames); }) ) : (({ calling_npm("AVI_video_height", ____alias_loc_id_7); (*____chimes_extern_func_AVI_video_height)(d_frames); })));
# 151 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
  call_lbl_9: pub.frame_cols = (____chimes_does_checkpoint_AVI_video_width_npm ? ( ({ calling((void*)AVI_video_width, 9, ____alias_loc_id_4, 0UL, 1, (size_t)(762051829673680011UL)); (AVI_video_width)(d_frames); }) ) : (({ calling_npm("AVI_video_width", ____alias_loc_id_4); (*____chimes_extern_func_AVI_video_width)(d_frames); })));
...
# 155 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
     call_lbl_10: (____chimes_does_checkpoint_AVI_close_npm ? ( ({ calling((void*)AVI_close, 10, ____alias_loc_id_1, 0UL, 1, (size_t)(762051829673680011UL)); (AVI_close)(d_frames); }) ) : (({ calling_npm("AVI_close", ____alias_loc_id_1); (*____chimes_extern_func_AVI_close)(d_frames); })));
...
# 189 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
 pub.d_endoRow = (int *)malloc_wrapper(pub.d_endo_mem, 762051829673679220UL, 0, 0);
...
# 210 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
 pub.d_endoCol = (int *)malloc_wrapper(pub.d_endo_mem, 762051829673679220UL, 0, 0);
...
# 231 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
 pub.d_tEndoRowLoc = (int *)malloc_wrapper(pub.d_endo_mem * pub.frames, 762051829673679220UL, 0, 0);
# 232 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
 pub.d_tEndoColLoc = (int *)malloc_wrapper(pub.d_endo_mem * pub.frames, 762051829673679220UL, 0, 0);
...
# 240 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
 pub.d_epiRow = (int *)malloc_wrapper(pub.d_epi_mem, 762051829673679220UL, 0, 0);
...
# 272 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
 pub.d_epiCol = (int *)malloc_wrapper(pub.d_epi_mem, 762051829673679220UL, 0, 0);
...
# 304 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
 pub.d_tEpiRowLoc = (int *)malloc_wrapper(pub.d_epi_mem * pub.frames, 762051829673679220UL, 0, 0);
# 305 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
 pub.d_tEpiColLoc = (int *)malloc_wrapper(pub.d_epi_mem * pub.frames, 762051829673679220UL, 0, 0);
...
# 327 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
  priv[i].in_partial_sum = (float *)malloc_wrapper(sizeof(float) * 2*pub.tSize+1, 762051829673679220UL, 0, 0);
# 328 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
  priv[i].in_sqr_partial_sum = (float *)malloc_wrapper(sizeof(float) * 2*pub.tSize+1, 762051829673679220UL, 0, 0);
# 329 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
  priv[i].par_max_val = (float *)malloc_wrapper(sizeof(float) * (2*pub.tSize+2*pub.sSize+1), 762051829673679220UL, 0, 0);
# 330 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
  priv[i].par_max_coo = (int *)malloc_wrapper(sizeof(int) * (2*pub.tSize+2*pub.sSize+1), 762051829673679220UL, 0, 0);
...
# 343 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
  priv[i].d_in2 = (float *)malloc_wrapper(pub.in2_mem, 762051829673679220UL, 0, 0);
# 344 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
  priv[i].d_in2_sqr = (float *)malloc_wrapper(pub.in2_mem, 762051829673679220UL, 0, 0);
...
# 357 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
  priv[i].d_in_mod = (float *)malloc_wrapper(pub.in_mod_mem, 762051829673679220UL, 0, 0);
# 358 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
  priv[i].d_in_sqr = (float *)malloc_wrapper(pub.in_mod_mem, 762051829673679220UL, 0, 0);
...
# 365 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
 pub.d_endoT = (float *)malloc_wrapper(pub.in_mod_mem * pub.endoPoints, 762051829673679220UL, 0, 0);
# 366 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
 pub.d_epiT = (float *)malloc_wrapper(pub.in_mod_mem * pub.epiPoints, 762051829673679220UL, 0, 0);
...
# 404 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
  priv[i].d_conv = (float *)malloc_wrapper(pub.conv_mem, 762051829673679220UL, 0, 0);
...
# 426 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
  priv[i].d_in2_pad = (float *)malloc_wrapper(pub.in2_pad_mem, 762051829673679220UL, 0, 0);
...
# 450 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
  priv[i].d_in2_sub = (float *)malloc_wrapper(pub.in2_sub_mem, 762051829673679220UL, 0, 0);
...
# 471 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
  priv[i].d_in2_sub2_sqr = (float *)malloc_wrapper(pub.in2_sub2_sqr_mem, 762051829673679220UL, 0, 0);
...
# 506 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
  priv[i].d_tMask = (float *)malloc_wrapper(pub.tMask_mem, 762051829673679220UL, 0, 0);
...
# 536 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
  priv[i].d_mask_conv = (float *)malloc_wrapper(pub.mask_conv_mem, 762051829673679220UL, 0, 0);
...
# 577 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
    call_lbl_49: (____chimes_does_checkpoint_kernel_npm ? ( ({ public_struct ____chimes_arg15; private_struct ____chimes_arg16; if (!____chimes_replaying) { ____chimes_arg15 = (pub); ____chimes_arg16 = (priv[i]); } calling((void*)kernel, 49, ____alias_loc_id_6, 0UL, 2, (size_t)(762051829673678596UL), (size_t)(762051829673678597UL)); (kernel)(____chimes_arg15, ____chimes_arg16); }) ) : (({ calling_npm("kernel", ____alias_loc_id_6); (*____chimes_extern_func_kernel)(pub, priv[i]); })));
...
# 587 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
  free_wrapper(pub.d_frame, 762051829673679220UL);
...
# 640 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
 free_wrapper(pub.d_endoRow, 762051829673679220UL);
...
# 659 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
  free_wrapper(priv[i].in_partial_sum, 762051829673679220UL);
...
# 143 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
 if (d_frames == __null) {
# 144 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
      call_lbl_4: (____chimes_does_checkpoint_AVI_print_error_npm ? ( ({ calling((void*)AVI_print_error, 4, ____alias_loc_id_0, 0UL, 1, (size_t)(762051829673680285UL)); (AVI_print_error)((char *)"Error with AVI_open_input_file"); }) ) : (({ calling_npm("AVI_print_error", ____alias_loc_id_0); (*____chimes_extern_func_AVI_print_error)((char *) "Error with AVI_open_input_file"); })));
# 145 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
      int ____chimes_ret_var_1; ; ____chimes_ret_var_1 = (-1); rm_stack(false, 0UL, "main", (int *)0x0, ____alias_loc_id_13, ____chimes_did_disable2, false); return ____chimes_ret_var_1; ;
# 146 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
 }
...
# 576 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
  for(i=0; i<pub.allPoints; i++){ { if (____chimes_first_iter0) { register_thread_local_stack_vars(LIBCHIMES_THREAD_NUM(), ____chimes_parent_thread0, ____chimes_parent_ctx1, LIBCHIMES_NUM_THREADS(), ____chimes_parent_stack_depth0, ____chimes_region_id0, 0); ____chimes_first_iter0 = 0; } {
# 577 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
    call_lbl_49: (____chimes_does_checkpoint_kernel_npm ? ( ({ calling((void*)kernel, 49, ____alias_loc_id_6, 0UL, 2, (size_t)(762051829673678596UL), (size_t)(762051829673678597UL)); (kernel)(pub, priv[i]); }) ) : (({ calling_npm("kernel", ____alias_loc_id_6); (*____chimes_extern_func_kernel)(pub, priv[i]); })));
# 579 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
   } } } leaving_omp_parallel(____chimes_call_stack_depth0, ____chimes_region_id0, 1); reenable_current_thread(____chimes_disable0); }
# 580 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
# 581 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/main.c"
