...
# 235 "/scratch/jmg3/rodinia_3.0/openmp/hotspot/hotspot_openmp.cpp"
 temp = (double *) ({ void *____chimes_tmp_ptr = calloc((grid_rows * grid_cols) + ((sizeof(void *) + sizeof(double) - 1) / sizeof(double)), sizeof(double)); ; calloc_helper(____chimes_tmp_ptr, grid_rows * grid_cols, sizeof(double), 10021604361511767245UL, 0, 0); (____chimes_tmp_ptr ? (void *)(((unsigned char *)____chimes_tmp_ptr) + sizeof(void *)) : ____chimes_tmp_ptr); }) ;
# 236 "/scratch/jmg3/rodinia_3.0/openmp/hotspot/hotspot_openmp.cpp"
 power = (double *) ({ void *____chimes_tmp_ptr = calloc((grid_rows * grid_cols) + ((sizeof(void *) + sizeof(double) - 1) / sizeof(double)), sizeof(double)); ; calloc_helper(____chimes_tmp_ptr, grid_rows * grid_cols, sizeof(double), 10021604361511767252UL, 0, 0); (____chimes_tmp_ptr ? (void *)(((unsigned char *)____chimes_tmp_ptr) + sizeof(void *)) : ____chimes_tmp_ptr); }) ;
# 237 "/scratch/jmg3/rodinia_3.0/openmp/hotspot/hotspot_openmp.cpp"
 result = (double *) ({ void *____chimes_tmp_ptr = calloc((grid_rows * grid_cols) + ((sizeof(void *) + sizeof(double) - 1) / sizeof(double)), sizeof(double)); ; calloc_helper(____chimes_tmp_ptr, grid_rows * grid_cols, sizeof(double), 10021604361511767259UL, 0, 0); (____chimes_tmp_ptr ? (void *)(((unsigned char *)____chimes_tmp_ptr) + sizeof(void *)) : ____chimes_tmp_ptr); }) ;
...
# 248 "/scratch/jmg3/rodinia_3.0/openmp/hotspot/hotspot_openmp.cpp"
  call_lbl_6: ({ calling((void*)compute_tran_temp, 6, ____alias_loc_id_1, 0UL, 6, (size_t)(10021604361511767259UL), (size_t)(0UL), (size_t)(10021604361511767245UL), (size_t)(10021604361511767252UL), (size_t)(0UL), (size_t)(0UL)); (compute_tran_temp)(result, sim_time, temp, power, grid_rows, grid_cols); }) ;
...
# 264 "/scratch/jmg3/rodinia_3.0/openmp/hotspot/hotspot_openmp.cpp"
  ({ free_helper((((unsigned char *)temp) - sizeof(void *)), 10021604361511767245UL);free((((unsigned char *)temp) - sizeof(void *))); }) ;
# 265 "/scratch/jmg3/rodinia_3.0/openmp/hotspot/hotspot_openmp.cpp"
  ({ free_helper((((unsigned char *)power) - sizeof(void *)), 10021604361511767252UL);free((((unsigned char *)power) - sizeof(void *))); }) ;
...
# 247 "/scratch/jmg3/rodinia_3.0/openmp/hotspot/hotspot_openmp.cpp"
 printf("Start computing the transient temperature\n");
# 248 "/scratch/jmg3/rodinia_3.0/openmp/hotspot/hotspot_openmp.cpp"
  call_lbl_6: ({ calling((void*)compute_tran_temp, 6, ____alias_loc_id_1, 0UL, 6, (size_t)(10021604361511767259UL), (size_t)(0UL), (size_t)(10021604361511767245UL), (size_t)(10021604361511767252UL), (size_t)(0UL), (size_t)(0UL)); compute_tran_temp_quick(result, sim_time, temp, power, grid_rows, grid_cols); }) ;
# 249 "/scratch/jmg3/rodinia_3.0/openmp/hotspot/hotspot_openmp.cpp"
 printf("Ending simulation\n");
# 250 "/scratch/jmg3/rodinia_3.0/openmp/hotspot/hotspot_openmp.cpp"
# 251 "/scratch/jmg3/rodinia_3.0/openmp/hotspot/hotspot_openmp.cpp"
...
static int module_init() {
    init_module(10021604361511766085UL, 20, 7, 3, 7, 5, 0, 5, 11, 0, 4,
                           ...
                           "read_input", &(____chimes_does_checkpoint_read_input_npm),
                             ...
                             (10021604361511766085UL + 1092UL), (10021604361511766085UL + 1160UL),
                             ...
                             (10021604361511766085UL + 1093UL), (10021604361511766085UL + 1167UL),
                             (10021604361511766085UL + 28UL), (10021604361511766085UL + 841UL),
                             (10021604361511766085UL + 1096UL), (10021604361511766085UL + 1126UL),
                             (10021604361511766085UL + 1241UL), (10021604361511766085UL + 967UL),
                             (10021604361511766085UL + 1084UL), (10021604361511766085UL + 1066UL),
                             (10021604361511766085UL + 1095UL), (10021604361511766085UL + 1126UL),
                             (10021604361511766085UL + 1094UL), (10021604361511766085UL + 1174UL),
                             (10021604361511766085UL + 1230UL), (10021604361511766085UL + 1126UL),
        ...
        "read_input", 0UL, (int)4, 10021604361511767245UL, 0UL, 0UL, 10021604361511767211UL,
        "read_input", 0UL, (int)4, 10021604361511767252UL, 0UL, 0UL, 10021604361511767211UL,
        "seconds", 0UL, (int)0);
