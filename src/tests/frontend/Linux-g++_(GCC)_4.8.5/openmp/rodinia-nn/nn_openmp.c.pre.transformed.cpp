...
# 22 "/scratch/jmg3/rodinia_3.0/openmp/nn/nn_openmp.c"
# 23 "/scratch/jmg3/rodinia_3.0/openmp/nn/nn_openmp.c"
double seconds_npm();
...
# 24 "/scratch/jmg3/rodinia_3.0/openmp/nn/nn_openmp.c"
      ;
# 25 "/scratch/jmg3/rodinia_3.0/openmp/nn/nn_openmp.c"
     struct timezone tzp; ;
# 26 "/scratch/jmg3/rodinia_3.0/openmp/nn/nn_openmp.c"
     int i; i = (gettimeofday(&tp, &tzp)) ;
# 27 "/scratch/jmg3/rodinia_3.0/openmp/nn/nn_openmp.c"
...
# 64 "/scratch/jmg3/rodinia_3.0/openmp/nn/nn_openmp.c"
 neighbors = (struct neighbor *)malloc_wrapper(k*sizeof(struct neighbor), 9808122005516792380UL, 0, 1, (int)sizeof(struct neighbor), 0);
...
# 86 "/scratch/jmg3/rodinia_3.0/openmp/nn/nn_openmp.c"
            sandbox = (char *)realloc_wrapper(sandbox, (nrecords + 1) * 49, 9808122005516792060UL, 0, 0);
...
# 104 "/scratch/jmg3/rodinia_3.0/openmp/nn/nn_openmp.c"
 z = (float *) malloc_wrapper(1000 * sizeof(float), 9808122005516792176UL, 0, 0);
...
# 113 "/scratch/jmg3/rodinia_3.0/openmp/nn/nn_openmp.c"
# 113 "/scratch/jmg3/rodinia_3.0/openmp/nn/nn_openmp.c"
{ call_lbl_33: bool ____chimes_disable0 = disable_current_thread(); void *____chimes_parent_ctx1 = get_thread_ctx(); unsigned ____chimes_parent_stack_depth0 = get_parent_vars_stack_depth(); unsigned ____chimes_call_stack_depth0 = get_thread_stack_depth(); size_t ____chimes_region_id0; unsigned ____chimes_parent_thread0 = entering_omp_parallel(33, &____chimes_region_id0, 4, &i, &rec_iter, &tmp_lat, &tmp_long); int ____chimes_first_iter0 = 1;
# 113 "/scratch/jmg3/rodinia_3.0/openmp/nn/nn_openmp.c"
...
# 143 "/scratch/jmg3/rodinia_3.0/openmp/nn/nn_openmp.c"
# 144 "/scratch/jmg3/rodinia_3.0/openmp/nn/nn_openmp.c"
     double end_time; end_time = (({ calling_npm("seconds", 0); seconds_npm(); })) ;
# 145 "/scratch/jmg3/rodinia_3.0/openmp/nn/nn_openmp.c"
    printf("execution took %f s\n", end_time - start_time);
# 146 "/scratch/jmg3/rodinia_3.0/openmp/nn/nn_openmp.c"
# 147 "/scratch/jmg3/rodinia_3.0/openmp/nn/nn_openmp.c"
 fprintf(stderr, "The %d nearest neighbors are:\n", k);
# 148 "/scratch/jmg3/rodinia_3.0/openmp/nn/nn_openmp.c"
 for( j = 0 ; j < k ; j++ ) {
# 149 "/scratch/jmg3/rodinia_3.0/openmp/nn/nn_openmp.c"
  if (!(neighbors[j].dist == 10000)) {fprintf(stderr, "%s --> %f\n", neighbors[j].entry, neighbors[j].dist); };
# 151 "/scratch/jmg3/rodinia_3.0/openmp/nn/nn_openmp.c"
 }
# 152 "/scratch/jmg3/rodinia_3.0/openmp/nn/nn_openmp.c"
# 153 "/scratch/jmg3/rodinia_3.0/openmp/nn/nn_openmp.c"
# 154 "/scratch/jmg3/rodinia_3.0/openmp/nn/nn_openmp.c"
...
# 155 "/scratch/jmg3/rodinia_3.0/openmp/nn/nn_openmp.c"
...
static int module_init() {
    init_module(9808122005516791887UL, 9, 2, 3, 3, 1, 0, 1, 2, 0, 5,
