...
# 260 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
# 260 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
{ call_lbl_62: bool ____chimes_disable0 = disable_current_thread(); void *____chimes_parent_ctx1 = get_thread_ctx(); unsigned ____chimes_parent_stack_depth0 = get_parent_vars_stack_depth(); unsigned ____chimes_call_stack_depth0 = get_thread_stack_depth(); size_t ____chimes_region_id0; unsigned ____chimes_parent_thread0 = entering_omp_parallel(62, &____chimes_region_id0, 9, &G2, &Jc, &L, &den, &i, &j, &k, &num, &qsqr); int ____chimes_first_iter0 = 1;
# 260 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
...
# 302 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
# 302 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
{ call_lbl_63: bool ____chimes_disable1 = disable_current_thread(); void *____chimes_parent_ctx2 = get_thread_ctx(); unsigned ____chimes_parent_stack_depth1 = get_parent_vars_stack_depth(); unsigned ____chimes_call_stack_depth1 = get_thread_stack_depth(); size_t ____chimes_region_id1; unsigned ____chimes_parent_thread1 = entering_omp_parallel(63, &____chimes_region_id1, 8, &D, &cE, &cN, &cS, &cW, &i, &j, &k); int ____chimes_first_iter1 = 1;
# 302 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
...
# 351 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
  call_lbl_34: (____chimes_does_checkpoint_write_graphics_npm ? ( ({ char * ____chimes_arg12; if (!____chimes_replaying) { ____chimes_arg12 = ("image_out.pgm"); } calling((void*)write_graphics, 34, ____alias_loc_id_3, 0UL, 6, (size_t)(7677405821689735867UL), (size_t)(7677405821689735127UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)); (write_graphics)(____chimes_arg12, image, Nr, Nc, 1, 255); }) ) : (({ calling_npm("write_graphics", ____alias_loc_id_3); (*____chimes_extern_func_write_graphics)("image_out.pgm", image, Nr, Nc, 1, 255); })));
...
# 350 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
# 351 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
  call_lbl_34: (____chimes_does_checkpoint_write_graphics_npm ? ( ({ calling((void*)write_graphics, 34, ____alias_loc_id_3, 0UL, 6, (size_t)(7677405821689735867UL), (size_t)(7677405821689735127UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)); (write_graphics)("image_out.pgm", image, Nr, Nc, 1, 255); }) ) : (({ calling_npm("write_graphics", ____alias_loc_id_3); (*____chimes_extern_func_write_graphics)("image_out.pgm", image, Nr, Nc, 1, 255); })));
# 357 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
# 358 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
  call_lbl_35: time9 = (____chimes_does_checkpoint_get_time_npm ? ( ({ calling((void*)get_time, 35, 0, 0UL, 0); (get_time)(); }) ) : (({ calling_npm("get_time", 0); (*____chimes_extern_func_get_time)(); })));
# 359 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
