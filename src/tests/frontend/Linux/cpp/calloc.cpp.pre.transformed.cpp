...
int main_resumable(int argc, char **argv) {const int ____chimes_did_disable0 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(13121925483205301738UL)) ; int *alloc;
...
# 4 "/home/jmg3/num-debug/src/examples/cpp/calloc.cpp"
       alloc = ((int *)calloc_wrapper(10, sizeof(int), 13121925483205301723UL, 0, 0)) ;
...
int main_quick(int argc, char **argv) {const int ____chimes_did_disable0 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(13121925483205301738UL)) ; int *alloc;
...
static int module_init() {
    init_module(13121925483205301712UL, 2, 1, 0, 2, 0, 0, 0, 0, 0, 0,
                           &____alias_loc_id_0, (unsigned)4, (unsigned)0, (13121925483205301712UL + 1UL), (13121925483205301712UL + 2UL), (13121925483205301712UL + 3UL), (13121925483205301712UL + 4UL),
                           &____alias_loc_id_1, (unsigned)1, (unsigned)0, (13121925483205301712UL + 11UL),
                             (13121925483205301712UL + 3UL), (13121925483205301712UL + 26UL),
                             (13121925483205301712UL + 4UL), (13121925483205301712UL + 11UL),
                             "main", 1, "checkpoint");
