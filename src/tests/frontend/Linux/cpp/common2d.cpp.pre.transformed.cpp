...
# 28 "/home/jmg3/num-debug/src/examples/cpp/lib/common2d.cpp"
                const float dx, const float dt) {const int ____chimes_did_disable1 = new_stack((void *)(&init_data), "init_data", &____must_manage_init_data, 8, 0, (size_t)(14525082970080978529UL), (size_t)(14525082970080978530UL), (size_t)(14525082970080978531UL), (size_t)(14525082970080978532UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
...
void usage_resumable(char **argv) {const int ____chimes_did_disable2 = new_stack((void *)(&usage), "usage", &____must_manage_usage, 1, 0, (size_t)(14525082970080978553UL)) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
...
void default_config_resumable(config *conf) {const int ____chimes_did_disable3 = new_stack((void *)(&default_config), "default_config", &____must_manage_default_config, 1, 0, (size_t)(14525082970080978591UL)) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
...
# 8 "/home/jmg3/num-debug/src/examples/cpp/lib/common2d.cpp"
        const int ny, const int nx, const char *filename, int radius) {const int ____chimes_did_disable0 = new_stack((void *)(&save_text), "save_text", &____must_manage_save_text, 7, 0, (size_t)(14525082970080978391UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(14525082970080978396UL), (size_t)(0UL)) ; ; ;
# 9 "/home/jmg3/num-debug/src/examples/cpp/lib/common2d.cpp"
     FILE *fp; fp = (fopen(filename, "wb")) ;
# 10 "/home/jmg3/num-debug/src/examples/cpp/lib/common2d.cpp"
    if (fp == __null) {
...
# 27 "/home/jmg3/num-debug/src/examples/cpp/lib/common2d.cpp"
                float *h_coeff, const int dimx, const int dimy,
# 28 "/home/jmg3/num-debug/src/examples/cpp/lib/common2d.cpp"
                const float dx, const float dt) {const int ____chimes_did_disable1 = new_stack((void *)(&init_data), "init_data", &____must_manage_init_data, 8, 0, (size_t)(14525082970080978529UL), (size_t)(14525082970080978530UL), (size_t)(14525082970080978531UL), (size_t)(14525082970080978532UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)) ; ; ;
# 29 "/home/jmg3/num-debug/src/examples/cpp/lib/common2d.cpp"
# 30 "/home/jmg3/num-debug/src/examples/cpp/lib/common2d.cpp"
    { size_t i; for ( i = (0) ; i < dimx * dimy; i++) {
# 31 "/home/jmg3/num-debug/src/examples/cpp/lib/common2d.cpp"
...
void usage_quick(char **argv) {const int ____chimes_did_disable2 = new_stack((void *)(&usage), "usage", &____must_manage_usage, 1, 0, (size_t)(14525082970080978553UL)) ; ; ;
# 49 "/home/jmg3/num-debug/src/examples/cpp/lib/common2d.cpp"
    fprintf(stderr, "usage: %s [-v] [-x nx] [-y ny] [-i iters] "
# 50 "/home/jmg3/num-debug/src/examples/cpp/lib/common2d.cpp"
            "[-t text] [-p x,y,f] [-r radius] [-g ngpus] [-w progress_width]\n",
...
void default_config_quick(config *conf) {const int ____chimes_did_disable3 = new_stack((void *)(&default_config), "default_config", &____must_manage_default_config, 1, 0, (size_t)(14525082970080978591UL)) ; ; ;
# 56 "/home/jmg3/num-debug/src/examples/cpp/lib/common2d.cpp"
    conf->nx = 2 * 256;
# 57 "/home/jmg3/num-debug/src/examples/cpp/lib/common2d.cpp"
    conf->ny = 2 * 256;
...
static int module_init() {
    init_module(14525082970080978307UL, 16, 5, 4, 7, 5, 2, 7, 2, 0, 4,
                           ...
                           &____alias_loc_id_3, (unsigned)15, (unsigned)0, (14525082970080978307UL + 99UL), (14525082970080978307UL + 100UL), (14525082970080978307UL + 101UL), (14525082970080978307UL + 102UL), (14525082970080978307UL + 103UL), (14525082970080978307UL + 104UL), (14525082970080978307UL + 105UL), (14525082970080978307UL + 106UL), (14525082970080978307UL + 107UL), (14525082970080978307UL + 108UL), (14525082970080978307UL + 109UL), (14525082970080978307UL + 222UL), (14525082970080978307UL + 223UL), (14525082970080978307UL + 224UL), (14525082970080978307UL + 225UL),
                           &____alias_loc_id_4, (unsigned)1, (unsigned)0, (14525082970080978307UL + 235UL),
                           &____alias_loc_id_5, (unsigned)2, (unsigned)0, (14525082970080978307UL + 247UL), (14525082970080978307UL + 284UL),
                           &____alias_loc_id_6, (unsigned)6, (unsigned)3, (14525082970080978307UL + 285UL), (14525082970080978307UL + 286UL), (14525082970080978307UL + 287UL), (14525082970080978307UL + 288UL), (14525082970080978307UL + 406UL), (14525082970080978307UL + 423UL), "usage", (unsigned)1, (14525082970080978307UL + 408UL), "parse_source", (unsigned)2, (14525082970080978307UL + 308UL), (14525082970080978307UL + 336UL), "default_config", (unsigned)1, (14525082970080978307UL + 406UL),
                            "save_text", (void *)(&save_text_npm), (void *)__null, 0, 7, (14525082970080978307UL + 84UL), 0UL, 0UL, 0UL, 0UL, (14525082970080978307UL + 89UL), 0UL, 0UL, 6, "fopen", 2, (14525082970080978307UL + 89UL), (14525082970080978307UL + 417UL), (14525082970080978307UL + 27UL), "fprintf", 3, (14525082970080978307UL + 387UL), (14525082970080978307UL + 419UL), (14525082970080978307UL + 89UL), 0UL, "exit", 1, 0UL, 0UL, "fprintf", 5, (14525082970080978307UL + 27UL), (14525082970080978307UL + 420UL), 0UL, 0UL, 0UL, 0UL, "fprintf", 2, (14525082970080978307UL + 27UL), (14525082970080978307UL + 421UL), 0UL, "fclose", 1, (14525082970080978307UL + 27UL), 0UL,
                            "init_data", (void *)(&init_data_npm), (void *)__null, 0, 8, (14525082970080978307UL + 222UL), (14525082970080978307UL + 223UL), (14525082970080978307UL + 224UL), (14525082970080978307UL + 225UL), 0UL, 0UL, 0UL, 0UL, 0UL, 1, "memset", 3, (14525082970080978307UL + 225UL), 0UL, 0UL, 0UL,
                            "usage", (void *)(&usage_npm), (void *)__null, 0, 1, (14525082970080978307UL + 246UL), 0UL, 2, "fprintf", 3, (14525082970080978307UL + 387UL), (14525082970080978307UL + 422UL), (14525082970080978307UL + 241UL), 0UL, "exit", 1, 0UL, 0UL,
                            "default_config", (void *)(&default_config_npm), (void *)__null, 0, 1, (14525082970080978307UL + 284UL), 0UL, 0,
                            "setup_config", (void *)(&setup_config_npm), (void *)__null, 2, &____alias_loc_id_0, &____alias_loc_id_1, 3, (14525082970080978307UL + 406UL), 0UL, (14525082970080978307UL + 408UL), 0UL, 13, "default_config", 1, (14525082970080978307UL + 406UL), 0UL, "getopt", 3, 0UL, (14525082970080978307UL + 408UL), (14525082970080978307UL + 424UL), 0UL, "atoi", 1, (14525082970080978307UL + 308UL), 0UL, "atoi", 1, (14525082970080978307UL + 308UL), 0UL, "atoi", 1, (14525082970080978307UL + 308UL), 0UL, "realloc", 2, (14525082970080978307UL + 336UL), 0UL, (14525082970080978307UL + 336UL), "parse_source", 2, (14525082970080978307UL + 308UL), (14525082970080978307UL + 336UL), 0UL, "atoi", 1, (14525082970080978307UL + 308UL), 0UL, "atoi", 1, (14525082970080978307UL + 308UL), 0UL, "atoi", 1, (14525082970080978307UL + 308UL), 0UL, "fprintf", 3, (14525082970080978307UL + 387UL), (14525082970080978307UL + 419UL), 0UL, 0UL, "usage", 1, (14525082970080978307UL + 408UL), 0UL, "getNumCUDADevices", 0, 0UL,
                           ...
                           "parse_source", &(____chimes_does_checkpoint_parse_source_npm),
                             (14525082970080978307UL + 235UL), (14525082970080978307UL + 246UL),
                             (14525082970080978307UL + 99UL), (14525082970080978307UL + 222UL),
                             (14525082970080978307UL + 425UL), (14525082970080978307UL + 308UL),
                             (14525082970080978307UL + 418UL), (14525082970080978307UL + 387UL),
                             (14525082970080978307UL + 1UL), (14525082970080978307UL + 84UL),
                             (14525082970080978307UL + 406UL), (14525082970080978307UL + 336UL),
                             (14525082970080978307UL + 247UL), (14525082970080978307UL + 284UL),
                             (14525082970080978307UL + 246UL), (14525082970080978307UL + 241UL),
                             (14525082970080978307UL + 6UL), (14525082970080978307UL + 89UL),
                             (14525082970080978307UL + 102UL), (14525082970080978307UL + 225UL),
                             (14525082970080978307UL + 8UL), (14525082970080978307UL + 27UL),
                             (14525082970080978307UL + 100UL), (14525082970080978307UL + 223UL),
                             (14525082970080978307UL + 101UL), (14525082970080978307UL + 224UL),
                             (14525082970080978307UL + 285UL), (14525082970080978307UL + 406UL),
                             (14525082970080978307UL + 284UL), (14525082970080978307UL + 428UL),
                             (14525082970080978307UL + 287UL), (14525082970080978307UL + 408UL),
