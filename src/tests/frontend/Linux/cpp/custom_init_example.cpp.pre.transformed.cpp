...
extern void register_custom_init_handler(const char *obj_name,
        void (*fp)(void *));
# 2 "/home/jmg3/num-debug/src/examples/cpp/custom_init_example.cpp" 2
...
# 3 "/home/jmg3/num-debug/src/examples/cpp/custom_init_example.cpp" 2
# 3 "/home/jmg3/num-debug/src/examples/cpp/custom_init_example.cpp"
# 4 "/home/jmg3/num-debug/src/examples/cpp/custom_init_example.cpp"
typedef struct _foo {
# 5 "/home/jmg3/num-debug/src/examples/cpp/custom_init_example.cpp"
    int a;
# 6 "/home/jmg3/num-debug/src/examples/cpp/custom_init_example.cpp"
} foo;
# 7 "/home/jmg3/num-debug/src/examples/cpp/custom_init_example.cpp"
# 8 "/home/jmg3/num-debug/src/examples/cpp/custom_init_example.cpp"
void handler_npm(void *ptr);
void handler_quick(void *ptr); void handler(void *ptr);
void handler_resumable(void *ptr) {const int ____chimes_did_disable0 = new_stack((void *)(&handler), "handler", &____must_manage_handler, 1, 0, (size_t)(18396799246570390404UL)) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
# 9 "/home/jmg3/num-debug/src/examples/cpp/custom_init_example.cpp"
     foo *f_ptr; f_ptr = ((foo *)ptr) ;
# 10 "/home/jmg3/num-debug/src/examples/cpp/custom_init_example.cpp"
    f_ptr->a = 42;
# 11 "/home/jmg3/num-debug/src/examples/cpp/custom_init_example.cpp"
...
int main_resumable(int argc, char **argv) {const int ____chimes_did_disable1 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(18396799246570390437UL)) ; foo *f;
...
# 16 "/home/jmg3/num-debug/src/examples/cpp/custom_init_example.cpp"
       f = ((foo *)malloc_wrapper(sizeof(foo), 18396799246570390418UL, 0, 1, (int)sizeof(struct _foo), 0)) ;
...
# 19 "/home/jmg3/num-debug/src/examples/cpp/custom_init_example.cpp"
     call_lbl_2: checkpoint_transformed(2, ____alias_loc_id_0);
# 20 "/home/jmg3/num-debug/src/examples/cpp/custom_init_example.cpp"
    wait_for_checkpoint();
# 21 "/home/jmg3/num-debug/src/examples/cpp/custom_init_example.cpp"
...
void handler_quick(void *ptr) {const int ____chimes_did_disable0 = new_stack((void *)(&handler), "handler", &____must_manage_handler, 1, 0, (size_t)(18396799246570390404UL)) ; ; ;
# 9 "/home/jmg3/num-debug/src/examples/cpp/custom_init_example.cpp"
     foo *f_ptr; f_ptr = ((foo *)ptr) ;
# 10 "/home/jmg3/num-debug/src/examples/cpp/custom_init_example.cpp"
    f_ptr->a = 42;
...
int main_quick(int argc, char **argv) {const int ____chimes_did_disable1 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(18396799246570390437UL)) ; foo *f;
...
static int module_init() {
    init_module(18396799246570390391UL, 4, 2, 0, 2, 1, 0, 1, 0, 0, 1,
                           &____alias_loc_id_0, (unsigned)5, (unsigned)0, (18396799246570390391UL + 16UL), (18396799246570390391UL + 17UL), (18396799246570390391UL + 18UL), (18396799246570390391UL + 19UL), (18396799246570390391UL + 27UL),
                           &____alias_loc_id_1, (unsigned)3, (unsigned)0, (18396799246570390391UL + 1UL), (18396799246570390391UL + 2UL), (18396799246570390391UL + 13UL),
                            "handler", (void *)(&handler_npm), (void *)__null, 0, 1, (18396799246570390391UL + 13UL), 0UL, 0,
                           "handler", &(____chimes_does_checkpoint_handler_npm),
                             (18396799246570390391UL + 1UL), (18396799246570390391UL + 13UL),
                             (18396799246570390391UL + 18UL), (18396799246570390391UL + 46UL),
