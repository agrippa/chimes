...
int main_resumable(int argc, char **argv) {const int ____chimes_did_disable1 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(12566680130669687643UL)) ; int b;
...
# 11 "/home/jmg3/num-debug/src/examples/cpp/func_ptr.cpp"
        call_lbl_1: b = (((int (*)(int))(translate_fptr((void *)(*fptr), 1, 0UL, 0, 1, 0UL)))(6)) ;
...
int main_quick(int argc, char **argv) {const int ____chimes_did_disable1 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(12566680130669687643UL)) ; int b;
...
static int module_init() {
    init_module(12566680130669687615UL, 2, 2, 0, 3, 1, 0, 1, 0,
                           &____alias_loc_id_0, (unsigned)4, (unsigned)0, (12566680130669687615UL + 10UL), (12566680130669687615UL + 11UL), (12566680130669687615UL + 12UL), (12566680130669687615UL + 29UL),
                           &____alias_loc_id_1, (unsigned)1, (unsigned)0, (12566680130669687615UL + 13UL),
                           &____alias_loc_id_2, (unsigned)1, (unsigned)0, (12566680130669687615UL + 1UL),
                            "foo", (void *)(&foo_npm), (void *)(foo), 0, 1, 0UL, 0UL, 0,
                           "foo", &(____chimes_does_checkpoint_foo_npm),
                             (12566680130669687615UL + 12UL), (12566680130669687615UL + 28UL),
                             (12566680130669687615UL + 29UL), (12566680130669687615UL + 30UL),
                             "main", 1, "checkpoint",
                             "foo", 0);
