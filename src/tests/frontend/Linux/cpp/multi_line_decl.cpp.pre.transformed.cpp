...
int main_resumable(int argc, char **argv) {const int ____chimes_did_disable1 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(15843130262758070597UL)) ; int *ptr;
int a;
...
# 11 "/home/jmg3/num-debug/src/examples/cpp/multi_line_decl.cpp"
       ptr = ((int *)malloc_wrapper(100, 15843130262758070583UL, 0, 0)) ;
...
int main_quick(int argc, char **argv) {const int ____chimes_did_disable1 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(15843130262758070597UL)) ; int *ptr;
int a;
