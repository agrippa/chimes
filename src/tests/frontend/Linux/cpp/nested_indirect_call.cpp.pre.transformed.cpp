...
int main_resumable(int argc, char **argv) {const int ____chimes_did_disable2 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(9917402930177748410UL)) ; int a;
...
# 14 "/home/jmg3/num-debug/src/examples/cpp/nested_indirect_call.cpp"
      int ____chimes_unroll_var_0; ____chimes_unroll_var_0 = (({ calling_npm("bar", 0UL, 0, 1, 0UL); bar_npm(a); })) ; a = ({ calling_npm("foo", 0UL, 0, 1, 0UL); foo_npm(3 + ____chimes_unroll_var_0); });
...
int main_quick(int argc, char **argv) {const int ____chimes_did_disable2 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(9917402930177748410UL)) ; int a;
...
static int module_init() {
    init_module(9917402930177748369UL, 1, 3, 0, 3, 2, 0, 2, 0,
                           &____alias_loc_id_0, (unsigned)5, (unsigned)0, (9917402930177748369UL + 17UL), (9917402930177748369UL + 18UL), (9917402930177748369UL + 19UL), (9917402930177748369UL + 20UL), (9917402930177748369UL + 21UL),
                           &____alias_loc_id_1, (unsigned)1, (unsigned)0, (9917402930177748369UL + 1UL),
                           &____alias_loc_id_2, (unsigned)1, (unsigned)0, (9917402930177748369UL + 10UL),
                           ...
                           "bar", &(____chimes_does_checkpoint_bar_npm),
                             (9917402930177748369UL + 19UL), (9917402930177748369UL + 41UL),
