...
# 6 "/scratch/jmg3/rodinia_3.0/openmp/backprop/facetrain.c"
...
{const int ____chimes_did_disable1 = new_stack((void *)(&setup), "setup", &____must_manage_setup, 2, 0, (size_t)(0UL), (size_t)(3513164141371984952UL)) ; if (____chimes_replaying) { switch(get_next_call()) { case(4): { goto call_lbl_4; } case(5): { goto call_lbl_5; } default: { chimes_error(); } } } ; ;
...
static int module_init() {
    init_module(3513164141371984888UL, 4, 2, 2, 4, 2, 5, 7, 0, 0, 1,
                           ...
                           "load", &(____chimes_does_checkpoint_load_npm),
                             (3513164141371984888UL + 1UL), (3513164141371984888UL + 10UL),
