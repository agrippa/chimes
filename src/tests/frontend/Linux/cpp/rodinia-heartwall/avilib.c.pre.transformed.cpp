...
# 361 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
   if(nhb<=2048 -4) long2str(AVI_header+nhb,movi_len); nhb += 4;
...
# 367 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
   if(nhb<=2048 -4) long2str(AVI_header+nhb,0); nhb += 4;
...
# 383 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
   if(nhb<=2048 -4) long2str(AVI_header+nhb,56); nhb += 4;
# 384 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
   if(nhb<=2048 -4) long2str(AVI_header+nhb,ms_per_frame); nhb += 4;
...
# 393 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
   if(nhb<=2048 -4) long2str(AVI_header+nhb,flag); nhb += 4;
...
# 397 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
   if(nhb<=2048 -4) long2str(AVI_header+nhb,AVI->anum+1); nhb += 4;
...
# 400 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
   if(nhb<=2048 -4) long2str(AVI_header+nhb,AVI->width); nhb += 4;
# 401 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
   if(nhb<=2048 -4) long2str(AVI_header+nhb,AVI->height); nhb += 4;
...
# 425 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
   if(nhb<=2048 -4) long2str(AVI_header+nhb,1000000); nhb += 4;
# 426 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
   if(nhb<=2048 -4) long2str(AVI_header+nhb,frate); nhb += 4;
...
# 430 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
   if(nhb<=2048 -4) long2str(AVI_header+nhb,-1); nhb += 4;
...
# 440 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
   if(nhb<=2048 -4) long2str(AVI_header+nhb,40); nhb += 4;
...
# 447 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
   if(nhb<=2048 -4) long2str(AVI_header+nhb,AVI->width*AVI->height*3); nhb += 4;
...
# 485 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
       if(nhb<=2048 -4) long2str(AVI_header+nhb,sampsize/4); nhb += 4;
# 486 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
       if(nhb<=2048 -4) long2str(AVI_header+nhb,1000*AVI->track[j].mp3rate/8); nhb += 4;
# 487 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
       if(nhb<=2048 -4) long2str(AVI_header+nhb,0); nhb += 4;
# 488 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
       if(nhb<=2048 -4) long2str(AVI_header+nhb,4*AVI->track[j].audio_bytes/sampsize); nhb += 4;
...
# 503 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
       if(nhb<=2048 -4) long2str(AVI_header+nhb,16); nhb += 4;
...
# 506 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
       if(nhb<=2048 -4) long2str(AVI_header+nhb,AVI->track[j].a_rate); nhb += 4;
...
# 541 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
   if(nhb<=2048 -4) long2str(AVI_header+nhb,njunk); nhb += 4;
...
# 563 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
        avi_write(AVI->fdes,(char *)AVI_header,2048)!=2048 ||
...
# 629 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
   if(nhb<=2048 -4) long2str(AVI_header+nhb,AVI->pos - 8); nhb += 4;
...
# 662 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
   if(nhb<=2048 -4) long2str(AVI_header+nhb,AVI->video_frames); nhb += 4;
...
# 807 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
   if(nhb<=2048 -4) long2str(AVI_header+nhb,info_len); nhb += 4;
...
# 819 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
   if(nhb<=2048 -4) long2str(AVI_header+nhb,64); nhb += 4;
...
# 1148 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
   if( avi_read(AVI->fdes,data,12) != 12 ) { AVI_close(AVI); AVI_errno = 3; return 0; }
...
# 1151 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
       strncasecmp(data+8,"AVI ",4) !=0 ) { AVI_close(AVI); AVI_errno = 9; return 0; }
...
# 1168 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
         if( avi_read(AVI->fdes,data,4) != 4 ) { AVI_close(AVI); AVI_errno = 3; return 0; }
...
# 1174 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
            if(hdrl_data==0) { AVI_close(AVI); AVI_errno = 8; return 0; };
...
# 1180 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
            if( avi_read(AVI->fdes,(char *)hdrl_data,n) != n ) { AVI_close(AVI); AVI_errno = 3; return 0; }
...
# 1197 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
         if(AVI->idx==0) { AVI_close(AVI); AVI_errno = 8; return 0; }
# 1198 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
         if(avi_read(AVI->fdes, (char *) AVI->idx, n) != n ) { AVI_close(AVI); AVI_errno = 3; return 0; }
...
# 1204 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
   if(!hdrl_data ) { AVI_close(AVI); AVI_errno = 10; return 0; }
# 1205 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
   if(!AVI->movi_start) { AVI_close(AVI); AVI_errno = 11; return 0; }
...
# 1308 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
   if(!vids_strh_seen || !vids_strf_seen) { AVI_close(AVI); AVI_errno = 12; return 0; }
...
# 1345 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
      if(i>=AVI->n_idx) { AVI_close(AVI); AVI_errno = 12; return 0; }
...
# 1351 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
      if(avi_read(AVI->fdes,data,8)!=8) { AVI_close(AVI); AVI_errno = 3; return 0; }
...
# 1422 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
   if(AVI->video_frames==0) { AVI_close(AVI); AVI_errno = 12; return 0; };
...
# 1424 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
   if(AVI->video_index==0) { AVI_close(AVI); AVI_errno = 8; return 0; };
...
# 1429 "/scratch/jmg3/rodinia_3.0/openmp/heartwall/AVI/avilib.c"
    if(AVI->track[j].audio_index==0) { AVI_close(AVI); AVI_errno = 8; return 0; };
...
static int module_init() {
    init_module(17693923975991247311UL, 91, 57, 98, 117, 0, 0, 0, 0, 0, 4,
                           &____alias_loc_id_0, (unsigned)3, (unsigned)1, (17693923975991247311UL + 2UL), (17693923975991247311UL + 3UL), (17693923975991247311UL + 5UL), "open", (unsigned)1, (17693923975991247311UL + 99UL),
                           &____alias_loc_id_1, (unsigned)3, (unsigned)2, (17693923975991247311UL + 4UL), (17693923975991247311UL + 6UL), (17693923975991247311UL + 14UL), "open", (unsigned)1, (17693923975991247311UL + 99UL), "avi_write", (unsigned)1, (17693923975991247311UL + 6UL),
                           &____alias_loc_id_2, (unsigned)1, (unsigned)1, (17693923975991247311UL + 4UL), "avi_write", (unsigned)1, (17693923975991247311UL + 6UL),
                           &____alias_loc_id_3, (unsigned)5, (unsigned)1, (17693923975991247311UL + 112UL), (17693923975991247311UL + 113UL), (17693923975991247311UL + 114UL), (17693923975991247311UL + 115UL), (17693923975991247311UL + 116UL), "write", (unsigned)1, (17693923975991247311UL + 158UL),
                           &____alias_loc_id_4, (unsigned)6, (unsigned)1, (17693923975991247311UL + 161UL), (17693923975991247311UL + 162UL), (17693923975991247311UL + 163UL), (17693923975991247311UL + 164UL), (17693923975991247311UL + 165UL), (17693923975991247311UL + 219UL), "strncmp", (unsigned)2, (17693923975991247311UL + 223UL), (17693923975991247311UL + 6702UL),
                           &____alias_loc_id_5, (unsigned)1, (unsigned)1, (17693923975991247311UL + 219UL), "avi_update_header", (unsigned)1, (17693923975991247311UL + 219UL),
                           &____alias_loc_id_6, (unsigned)13, (unsigned)2, (17693923975991247311UL + 233UL), (17693923975991247311UL + 234UL), (17693923975991247311UL + 235UL), (17693923975991247311UL + 236UL), (17693923975991247311UL + 237UL), (17693923975991247311UL + 238UL), (17693923975991247311UL + 239UL), (17693923975991247311UL + 240UL), (17693923975991247311UL + 241UL), (17693923975991247311UL + 242UL), (17693923975991247311UL + 243UL), (17693923975991247311UL + 244UL), (17693923975991247311UL + 245UL), "long2str", (unsigned)1, (17693923975991247311UL + 244UL), "avi_sampsize", (unsigned)1, (17693923975991247311UL + 1549UL),
                           &____alias_loc_id_7, (unsigned)7, (unsigned)1, (17693923975991247311UL + 1550UL), (17693923975991247311UL + 1551UL), (17693923975991247311UL + 1552UL), (17693923975991247311UL + 1553UL), (17693923975991247311UL + 1554UL), (17693923975991247311UL + 1555UL), (17693923975991247311UL + 1651UL), "avi_update_header", (unsigned)1, (17693923975991247311UL + 1651UL),
                           &____alias_loc_id_8, (unsigned)5, (unsigned)1, (17693923975991247311UL + 1739UL), (17693923975991247311UL + 1740UL), (17693923975991247311UL + 1741UL), (17693923975991247311UL + 1742UL), (17693923975991247311UL + 1743UL), "avi_write_data", (unsigned)2, (17693923975991247311UL + 1791UL), (17693923975991247311UL + 1792UL),
                            &____alias_loc_id_18, (unsigned)4, (unsigned)1, (17693923975991247311UL + 14UL), (17693923975991247311UL + 3840UL), (17693923975991247311UL + 3841UL), (17693923975991247311UL + 3842UL), "open", (unsigned)1, (17693923975991247311UL + 3892UL),
                            &____alias_loc_id_19, (unsigned)1, (unsigned)1, (17693923975991247311UL + 14UL), "avi_parse_input_file", (unsigned)1, (17693923975991247311UL + 14UL),
                            &____alias_loc_id_20, (unsigned)9, (unsigned)1, (17693923975991247311UL + 3895UL), (17693923975991247311UL + 3896UL), (17693923975991247311UL + 3903UL), (17693923975991247311UL + 3904UL), (17693923975991247311UL + 3910UL), (17693923975991247311UL + 3911UL), (17693923975991247311UL + 3912UL), (17693923975991247311UL + 3913UL), (17693923975991247311UL + 3914UL), "avi_read", (unsigned)1, (17693923975991247311UL + 3915UL),
                            &____alias_loc_id_21, (unsigned)1, (unsigned)1, (17693923975991247311UL + 3902UL), "avi_read", (unsigned)1, (17693923975991247311UL + 3915UL),
                            &____alias_loc_id_22, (unsigned)9, (unsigned)5, (17693923975991247311UL + 3897UL), (17693923975991247311UL + 3899UL), (17693923975991247311UL + 3900UL), (17693923975991247311UL + 3909UL), (17693923975991247311UL + 3910UL), (17693923975991247311UL + 3911UL), (17693923975991247311UL + 3912UL), (17693923975991247311UL + 3914UL), (17693923975991247311UL + 5081UL), "strncasecmp", (unsigned)2, (17693923975991247311UL + 4161UL), (17693923975991247311UL + 6705UL), "str2ulong", (unsigned)1, (17693923975991247311UL + 4161UL), "str2ushort", (unsigned)1, (17693923975991247311UL + 4161UL), "avi_sampsize", (unsigned)1, (17693923975991247311UL + 5081UL), "AVI_close", (unsigned)1, (17693923975991247311UL + 5081UL),
                            &____alias_loc_id_23, (unsigned)9, (unsigned)5, (17693923975991247311UL + 3897UL), (17693923975991247311UL + 3899UL), (17693923975991247311UL + 3900UL), (17693923975991247311UL + 3909UL), (17693923975991247311UL + 3910UL), (17693923975991247311UL + 3911UL), (17693923975991247311UL + 3912UL), (17693923975991247311UL + 3914UL), (17693923975991247311UL + 5081UL), "strncasecmp", (unsigned)2, (17693923975991247311UL + 4161UL), (17693923975991247311UL + 6705UL), "str2ulong", (unsigned)1, (17693923975991247311UL + 4161UL), "str2ushort", (unsigned)1, (17693923975991247311UL + 4161UL), "avi_sampsize", (unsigned)1, (17693923975991247311UL + 5081UL), "AVI_close", (unsigned)1, (17693923975991247311UL + 5081UL),
                            &____alias_loc_id_24, (unsigned)9, (unsigned)5, (17693923975991247311UL + 3897UL), (17693923975991247311UL + 3899UL), (17693923975991247311UL + 3900UL), (17693923975991247311UL + 3909UL), (17693923975991247311UL + 3910UL), (17693923975991247311UL + 3911UL), (17693923975991247311UL + 3912UL), (17693923975991247311UL + 3914UL), (17693923975991247311UL + 5081UL), "strncasecmp", (unsigned)2, (17693923975991247311UL + 4161UL), (17693923975991247311UL + 6705UL), "str2ulong", (unsigned)1, (17693923975991247311UL + 4161UL), "str2ushort", (unsigned)1, (17693923975991247311UL + 4161UL), "avi_sampsize", (unsigned)1, (17693923975991247311UL + 5081UL), "AVI_close", (unsigned)1, (17693923975991247311UL + 5081UL),
                            &____alias_loc_id_25, (unsigned)1, (unsigned)2, (17693923975991247311UL + 3898UL), "strncasecmp", (unsigned)2, (17693923975991247311UL + 4161UL), (17693923975991247311UL + 6705UL), "str2ulong", (unsigned)1, (17693923975991247311UL + 4161UL),
                            &____alias_loc_id_26, (unsigned)1, (unsigned)1, (17693923975991247311UL + 3897UL), "strncasecmp", (unsigned)2, (17693923975991247311UL + 4161UL), (17693923975991247311UL + 6705UL),
                            &____alias_loc_id_27, (unsigned)11, (unsigned)3, (17693923975991247311UL + 3897UL), (17693923975991247311UL + 3901UL), (17693923975991247311UL + 3905UL), (17693923975991247311UL + 3906UL), (17693923975991247311UL + 3907UL), (17693923975991247311UL + 3908UL), (17693923975991247311UL + 3909UL), (17693923975991247311UL + 3916UL), (17693923975991247311UL + 3917UL), (17693923975991247311UL + 4631UL), (17693923975991247311UL + 5081UL), "strncasecmp", (unsigned)2, (17693923975991247311UL + 4631UL), (17693923975991247311UL + 5081UL), "str2ulong", (unsigned)1, (17693923975991247311UL + 4631UL), "AVI_close", (unsigned)1, (17693923975991247311UL + 5081UL),
                            &____alias_loc_id_28, (unsigned)11, (unsigned)3, (17693923975991247311UL + 3897UL), (17693923975991247311UL + 3901UL), (17693923975991247311UL + 3905UL), (17693923975991247311UL + 3906UL), (17693923975991247311UL + 3907UL), (17693923975991247311UL + 3908UL), (17693923975991247311UL + 3909UL), (17693923975991247311UL + 3916UL), (17693923975991247311UL + 3917UL), (17693923975991247311UL + 4631UL), (17693923975991247311UL + 5081UL), "strncasecmp", (unsigned)2, (17693923975991247311UL + 4631UL), (17693923975991247311UL + 5081UL), "str2ulong", (unsigned)1, (17693923975991247311UL + 4631UL), "AVI_close", (unsigned)1, (17693923975991247311UL + 5081UL),
                            &____alias_loc_id_29, (unsigned)11, (unsigned)3, (17693923975991247311UL + 3897UL), (17693923975991247311UL + 3901UL), (17693923975991247311UL + 3905UL), (17693923975991247311UL + 3906UL), (17693923975991247311UL + 3907UL), (17693923975991247311UL + 3908UL), (17693923975991247311UL + 3909UL), (17693923975991247311UL + 3916UL), (17693923975991247311UL + 3917UL), (17693923975991247311UL + 4631UL), (17693923975991247311UL + 5081UL), "strncasecmp", (unsigned)2, (17693923975991247311UL + 4631UL), (17693923975991247311UL + 5081UL), "str2ulong", (unsigned)1, (17693923975991247311UL + 4631UL), "AVI_close", (unsigned)1, (17693923975991247311UL + 5081UL),
                            &____alias_loc_id_30, (unsigned)11, (unsigned)3, (17693923975991247311UL + 3897UL), (17693923975991247311UL + 3901UL), (17693923975991247311UL + 3905UL), (17693923975991247311UL + 3906UL), (17693923975991247311UL + 3907UL), (17693923975991247311UL + 3908UL), (17693923975991247311UL + 3909UL), (17693923975991247311UL + 3916UL), (17693923975991247311UL + 3917UL), (17693923975991247311UL + 4631UL), (17693923975991247311UL + 5081UL), "strncasecmp", (unsigned)2, (17693923975991247311UL + 4631UL), (17693923975991247311UL + 5081UL), "str2ulong", (unsigned)1, (17693923975991247311UL + 4631UL), "AVI_close", (unsigned)1, (17693923975991247311UL + 5081UL),
                            &____alias_loc_id_31, (unsigned)11, (unsigned)3, (17693923975991247311UL + 3897UL), (17693923975991247311UL + 3901UL), (17693923975991247311UL + 3905UL), (17693923975991247311UL + 3906UL), (17693923975991247311UL + 3907UL), (17693923975991247311UL + 3908UL), (17693923975991247311UL + 3909UL), (17693923975991247311UL + 3916UL), (17693923975991247311UL + 3917UL), (17693923975991247311UL + 4631UL), (17693923975991247311UL + 5081UL), "strncasecmp", (unsigned)2, (17693923975991247311UL + 4631UL), (17693923975991247311UL + 5081UL), "str2ulong", (unsigned)1, (17693923975991247311UL + 4631UL), "AVI_close", (unsigned)1, (17693923975991247311UL + 5081UL),
                            &____alias_loc_id_32, (unsigned)11, (unsigned)3, (17693923975991247311UL + 3897UL), (17693923975991247311UL + 3901UL), (17693923975991247311UL + 3905UL), (17693923975991247311UL + 3906UL), (17693923975991247311UL + 3907UL), (17693923975991247311UL + 3908UL), (17693923975991247311UL + 3909UL), (17693923975991247311UL + 3916UL), (17693923975991247311UL + 3917UL), (17693923975991247311UL + 4631UL), (17693923975991247311UL + 5081UL), "strncasecmp", (unsigned)2, (17693923975991247311UL + 4631UL), (17693923975991247311UL + 5081UL), "str2ulong", (unsigned)1, (17693923975991247311UL + 4631UL), "AVI_close", (unsigned)1, (17693923975991247311UL + 5081UL),
                            &____alias_loc_id_33, (unsigned)11, (unsigned)3, (17693923975991247311UL + 3897UL), (17693923975991247311UL + 3901UL), (17693923975991247311UL + 3905UL), (17693923975991247311UL + 3906UL), (17693923975991247311UL + 3907UL), (17693923975991247311UL + 3908UL), (17693923975991247311UL + 3909UL), (17693923975991247311UL + 3916UL), (17693923975991247311UL + 3917UL), (17693923975991247311UL + 4631UL), (17693923975991247311UL + 5081UL), "strncasecmp", (unsigned)2, (17693923975991247311UL + 4631UL), (17693923975991247311UL + 5081UL), "str2ulong", (unsigned)1, (17693923975991247311UL + 4631UL), "AVI_close", (unsigned)1, (17693923975991247311UL + 5081UL),
                            &____alias_loc_id_34, (unsigned)11, (unsigned)3, (17693923975991247311UL + 3897UL), (17693923975991247311UL + 3901UL), (17693923975991247311UL + 3905UL), (17693923975991247311UL + 3906UL), (17693923975991247311UL + 3907UL), (17693923975991247311UL + 3908UL), (17693923975991247311UL + 3909UL), (17693923975991247311UL + 3916UL), (17693923975991247311UL + 3917UL), (17693923975991247311UL + 4631UL), (17693923975991247311UL + 5081UL), "strncasecmp", (unsigned)2, (17693923975991247311UL + 4631UL), (17693923975991247311UL + 5081UL), "str2ulong", (unsigned)1, (17693923975991247311UL + 4631UL), "AVI_close", (unsigned)1, (17693923975991247311UL + 5081UL),
                            &____alias_loc_id_35, (unsigned)11, (unsigned)3, (17693923975991247311UL + 3897UL), (17693923975991247311UL + 3901UL), (17693923975991247311UL + 3905UL), (17693923975991247311UL + 3906UL), (17693923975991247311UL + 3907UL), (17693923975991247311UL + 3908UL), (17693923975991247311UL + 3909UL), (17693923975991247311UL + 3916UL), (17693923975991247311UL + 3917UL), (17693923975991247311UL + 4631UL), (17693923975991247311UL + 5081UL), "strncasecmp", (unsigned)2, (17693923975991247311UL + 4631UL), (17693923975991247311UL + 5081UL), "str2ulong", (unsigned)1, (17693923975991247311UL + 4631UL), "AVI_close", (unsigned)1, (17693923975991247311UL + 5081UL),
                            &____alias_loc_id_36, (unsigned)11, (unsigned)3, (17693923975991247311UL + 3897UL), (17693923975991247311UL + 3901UL), (17693923975991247311UL + 3905UL), (17693923975991247311UL + 3906UL), (17693923975991247311UL + 3907UL), (17693923975991247311UL + 3908UL), (17693923975991247311UL + 3909UL), (17693923975991247311UL + 3916UL), (17693923975991247311UL + 3917UL), (17693923975991247311UL + 4631UL), (17693923975991247311UL + 5081UL), "strncasecmp", (unsigned)2, (17693923975991247311UL + 4631UL), (17693923975991247311UL + 5081UL), "str2ulong", (unsigned)1, (17693923975991247311UL + 4631UL), "AVI_close", (unsigned)1, (17693923975991247311UL + 5081UL),
                            &____alias_loc_id_37, (unsigned)1, (unsigned)1, (17693923975991247311UL + 5081UL), "avi_read", (unsigned)1, (17693923975991247311UL + 3915UL),
                            &____alias_loc_id_38, (unsigned)3, (unsigned)2, (17693923975991247311UL + 3905UL), (17693923975991247311UL + 3906UL), (17693923975991247311UL + 3909UL), "strncasecmp", (unsigned)2, (17693923975991247311UL + 4631UL), (17693923975991247311UL + 5081UL), "AVI_close", (unsigned)1, (17693923975991247311UL + 5081UL),
                            &____alias_loc_id_39, (unsigned)5, (unsigned)2, (17693923975991247311UL + 3905UL), (17693923975991247311UL + 3906UL), (17693923975991247311UL + 3908UL), (17693923975991247311UL + 3909UL), (17693923975991247311UL + 4631UL), "strncasecmp", (unsigned)2, (17693923975991247311UL + 4631UL), (17693923975991247311UL + 5081UL), "str2ulong", (unsigned)1, (17693923975991247311UL + 4631UL),
                            &____alias_loc_id_40, (unsigned)1, (unsigned)2, (17693923975991247311UL + 3898UL), "strncasecmp", (unsigned)2, (17693923975991247311UL + 3915UL), (17693923975991247311UL + 6705UL), "str2ulong", (unsigned)1, (17693923975991247311UL + 3915UL),
                            &____alias_loc_id_41, (unsigned)1, (unsigned)2, (17693923975991247311UL + 3898UL), "strncasecmp", (unsigned)2, (17693923975991247311UL + 3915UL), (17693923975991247311UL + 6705UL), "str2ulong", (unsigned)1, (17693923975991247311UL + 3915UL),
                            &____alias_loc_id_42, (unsigned)1, (unsigned)1, (17693923975991247311UL + 3898UL), "strncasecmp", (unsigned)2, (17693923975991247311UL + 3915UL), (17693923975991247311UL + 6705UL),
                            &____alias_loc_id_43, (unsigned)2, (unsigned)1, (17693923975991247311UL + 3902UL), (17693923975991247311UL + 3904UL), "AVI_close", (unsigned)1, (17693923975991247311UL + 5081UL),
                            &____alias_loc_id_44, (unsigned)2, (unsigned)1, (17693923975991247311UL + 3902UL), (17693923975991247311UL + 3904UL), "AVI_close", (unsigned)1, (17693923975991247311UL + 5081UL),
                            &____alias_loc_id_45, (unsigned)1, (unsigned)1, (17693923975991247311UL + 3903UL), "avi_read", (unsigned)1, (17693923975991247311UL + 4161UL),
                            &____alias_loc_id_46, (unsigned)1, (unsigned)0, (17693923975991247311UL + 5081UL),
                            &____alias_loc_id_47, (unsigned)1, (unsigned)2, (17693923975991247311UL + 5081UL), "avi_read", (unsigned)1, (17693923975991247311UL + 4631UL), "AVI_close", (unsigned)1, (17693923975991247311UL + 5081UL),
                            &____alias_loc_id_48, (unsigned)1, (unsigned)2, (17693923975991247311UL + 5081UL), "avi_read", (unsigned)1, (17693923975991247311UL + 4631UL), "AVI_close", (unsigned)1, (17693923975991247311UL + 5081UL),
                            &____alias_loc_id_49, (unsigned)4, (unsigned)1, (17693923975991247311UL + 14UL), (17693923975991247311UL + 5326UL), (17693923975991247311UL + 5327UL), (17693923975991247311UL + 5328UL), "avi_parse_input_file", (unsigned)1, (17693923975991247311UL + 14UL),
                            &____alias_loc_id_50, (unsigned)5, (unsigned)1, (17693923975991247311UL + 5369UL), (17693923975991247311UL + 5370UL), (17693923975991247311UL + 5371UL), (17693923975991247311UL + 5372UL), (17693923975991247311UL + 5373UL), "read", (unsigned)1, (17693923975991247311UL + 5415UL),
                            &____alias_loc_id_51, (unsigned)1, (unsigned)0, (17693923975991247311UL + 5799UL),
                            &____alias_loc_id_52, (unsigned)5, (unsigned)0, (17693923975991247311UL + 5896UL), (17693923975991247311UL + 5897UL), (17693923975991247311UL + 5898UL), (17693923975991247311UL + 5899UL), (17693923975991247311UL + 6000UL),
                            &____alias_loc_id_53, (unsigned)8, (unsigned)0, (17693923975991247311UL + 6127UL), (17693923975991247311UL + 6128UL), (17693923975991247311UL + 6129UL), (17693923975991247311UL + 6130UL), (17693923975991247311UL + 6131UL), (17693923975991247311UL + 6132UL), (17693923975991247311UL + 6133UL), (17693923975991247311UL + 6340UL),
                            &____alias_loc_id_54, (unsigned)6, (unsigned)1, (17693923975991247311UL + 6344UL), (17693923975991247311UL + 6345UL), (17693923975991247311UL + 6346UL), (17693923975991247311UL + 6347UL), (17693923975991247311UL + 6348UL), (17693923975991247311UL + 6349UL), "avi_read", (unsigned)1, (17693923975991247311UL + 6351UL),
                            &____alias_loc_id_55, (unsigned)1, (unsigned)2, (17693923975991247311UL + 6350UL), "strncasecmp", (unsigned)2, (17693923975991247311UL + 6351UL), (17693923975991247311UL + 6510UL), "str2ulong", (unsigned)1, (17693923975991247311UL + 6351UL),
                            &____alias_loc_id_56, (unsigned)2, (unsigned)1, (17693923975991247311UL + 6510UL), (17693923975991247311UL + 6515UL), "avi_read", (unsigned)1, (17693923975991247311UL + 6511UL),
                            &____alias_loc_id_57, (unsigned)2, (unsigned)1, (17693923975991247311UL + 6510UL), (17693923975991247311UL + 6515UL), "avi_read", (unsigned)1, (17693923975991247311UL + 6511UL),
                            &____alias_loc_id_58, (unsigned)1, (unsigned)1, (17693923975991247311UL + 6515UL), "avi_read", (unsigned)1, (17693923975991247311UL + 6513UL),
                            &____alias_loc_id_59, (unsigned)1, (unsigned)1, (17693923975991247311UL + 6515UL), "avi_read", (unsigned)1, (17693923975991247311UL + 6513UL),
                            &____alias_loc_id_60, (unsigned)1, (unsigned)0, (17693923975991247311UL + 6566UL),
                            &____alias_loc_id_61, (unsigned)4, (unsigned)2, (17693923975991247311UL + 6624UL), (17693923975991247311UL + 6625UL), (17693923975991247311UL + 6626UL), (17693923975991247311UL + 6627UL), "long2str", (unsigned)1, (17693923975991247311UL + 6628UL), "avi_write", (unsigned)1, (17693923975991247311UL + 6628UL),
                            &____alias_loc_id_62, (unsigned)7, (unsigned)2, (17693923975991247311UL + 1UL), (17693923975991247311UL + 2UL), (17693923975991247311UL + 3UL), (17693923975991247311UL + 4UL), (17693923975991247311UL + 5UL), (17693923975991247311UL + 14UL), (17693923975991247311UL + 6701UL), "open", (unsigned)1, (17693923975991247311UL + 99UL), "avi_write", (unsigned)1, (17693923975991247311UL + 6UL),
                            &____alias_loc_id_63, (unsigned)6, (unsigned)1, (17693923975991247311UL + 111UL), (17693923975991247311UL + 112UL), (17693923975991247311UL + 113UL), (17693923975991247311UL + 114UL), (17693923975991247311UL + 115UL), (17693923975991247311UL + 116UL), "write", (unsigned)1, (17693923975991247311UL + 158UL),
                            &____alias_loc_id_64, (unsigned)5, (unsigned)0, (17693923975991247311UL + 161UL), (17693923975991247311UL + 162UL), (17693923975991247311UL + 163UL), (17693923975991247311UL + 164UL), (17693923975991247311UL + 165UL),
(unsigned)1, (unsigned)0, (17693923975991247311UL + 5420UL),
                            &____alias_loc_id_86, (unsigned)1, (unsigned)0, (17693923975991247311UL + 5436UL),
                            &____alias_loc_id_87, (unsigned)1, (unsigned)0, (17693923975991247311UL + 5444UL),
                            &____alias_loc_id_88, (unsigned)1, (unsigned)0, (17693923975991247311UL + 5453UL),
                            &____alias_loc_id_89, (unsigned)1, (unsigned)0, (17693923975991247311UL + 5462UL),
                            &____alias_loc_id_90, (unsigned)1, (unsigned)0, (17693923975991247311UL + 5470UL),
                            &____alias_loc_id_91, (unsigned)1, (unsigned)0, (17693923975991247311UL + 5478UL),
                            &____alias_loc_id_92, (unsigned)1, (unsigned)0, (17693923975991247311UL + 5486UL),
                            &____alias_loc_id_93, (unsigned)1, (unsigned)0, (17693923975991247311UL + 5494UL),
                            &____alias_loc_id_94, (unsigned)1, (unsigned)0, (17693923975991247311UL + 5509UL),
                            &____alias_loc_id_95, (unsigned)1, (unsigned)0, (17693923975991247311UL + 5523UL),
                            &____alias_loc_id_96, (unsigned)1, (unsigned)0, (17693923975991247311UL + 5538UL),
                            &____alias_loc_id_97, (unsigned)1, (unsigned)0, (17693923975991247311UL + 5553UL),
                            &____alias_loc_id_98, (unsigned)1, (unsigned)0, (17693923975991247311UL + 5567UL),
                            &____alias_loc_id_99, (unsigned)1, (unsigned)0, (17693923975991247311UL + 5581UL),
                             &____alias_loc_id_100, (unsigned)1, (unsigned)0, (17693923975991247311UL + 5595UL),
                             &____alias_loc_id_101, (unsigned)1, (unsigned)0, (17693923975991247311UL + 5609UL),
                             &____alias_loc_id_102, (unsigned)1, (unsigned)0, (17693923975991247311UL + 5623UL),
                             &____alias_loc_id_103, (unsigned)1, (unsigned)0, (17693923975991247311UL + 5631UL),
                             &____alias_loc_id_104, (unsigned)4, (unsigned)0, (17693923975991247311UL + 5639UL), (17693923975991247311UL + 5640UL), (17693923975991247311UL + 5641UL), (17693923975991247311UL + 6701UL),
                             &____alias_loc_id_105, (unsigned)4, (unsigned)0, (17693923975991247311UL + 5686UL), (17693923975991247311UL + 5687UL), (17693923975991247311UL + 5688UL), (17693923975991247311UL + 6701UL),
                             &____alias_loc_id_106, (unsigned)4, (unsigned)0, (17693923975991247311UL + 5751UL), (17693923975991247311UL + 5752UL), (17693923975991247311UL + 5753UL), (17693923975991247311UL + 6701UL),
                             &____alias_loc_id_107, (unsigned)4, (unsigned)0, (17693923975991247311UL + 5798UL), (17693923975991247311UL + 5799UL), (17693923975991247311UL + 5825UL), (17693923975991247311UL + 6701UL),
                             &____alias_loc_id_108, (unsigned)5, (unsigned)0, (17693923975991247311UL + 5826UL), (17693923975991247311UL + 5827UL), (17693923975991247311UL + 5828UL), (17693923975991247311UL + 5862UL), (17693923975991247311UL + 6701UL),
                             &____alias_loc_id_109, (unsigned)5, (unsigned)0, (17693923975991247311UL + 5864UL), (17693923975991247311UL + 5865UL), (17693923975991247311UL + 5866UL), (17693923975991247311UL + 5893UL), (17693923975991247311UL + 6701UL),
                             &____alias_loc_id_110, (unsigned)6, (unsigned)1, (17693923975991247311UL + 5895UL), (17693923975991247311UL + 5896UL), (17693923975991247311UL + 5897UL), (17693923975991247311UL + 5898UL), (17693923975991247311UL + 5998UL), (17693923975991247311UL + 6701UL), "avi_read", (unsigned)1, (17693923975991247311UL + 5999UL),
                             &____alias_loc_id_111, (unsigned)8, (unsigned)0, (17693923975991247311UL + 6001UL), (17693923975991247311UL + 6002UL), (17693923975991247311UL + 6003UL), (17693923975991247311UL + 6004UL), (17693923975991247311UL + 6005UL), (17693923975991247311UL + 6006UL), (17693923975991247311UL + 6124UL), (17693923975991247311UL + 6701UL),
                             &____alias_loc_id_112, (unsigned)8, (unsigned)1, (17693923975991247311UL + 6126UL), (17693923975991247311UL + 6127UL), (17693923975991247311UL + 6128UL), (17693923975991247311UL + 6129UL), (17693923975991247311UL + 6130UL), (17693923975991247311UL + 6132UL), (17693923975991247311UL + 6340UL), (17693923975991247311UL + 6701UL), "avi_read", (unsigned)1, (17693923975991247311UL + 6341UL),
                             &____alias_loc_id_113, (unsigned)7, (unsigned)2, (17693923975991247311UL + 6343UL), (17693923975991247311UL + 6344UL), (17693923975991247311UL + 6345UL), (17693923975991247311UL + 6346UL), (17693923975991247311UL + 6347UL), (17693923975991247311UL + 6348UL), (17693923975991247311UL + 6349UL), "strncasecmp", (unsigned)3, (17693923975991247311UL + 6351UL), (17693923975991247311UL + 6510UL), (17693923975991247311UL + 6705UL), "avi_read", (unsigned)3, (17693923975991247311UL + 6351UL), (17693923975991247311UL + 6511UL), (17693923975991247311UL + 6513UL),
                             &____alias_loc_id_114, (unsigned)2, (unsigned)0, (17693923975991247311UL + 6516UL), (17693923975991247311UL + 6517UL),
                             &____alias_loc_id_115, (unsigned)2, (unsigned)0, (17693923975991247311UL + 6565UL), (17693923975991247311UL + 6566UL),
                             &____alias_loc_id_116, (unsigned)3, (unsigned)1, (17693923975991247311UL + 6623UL), (17693923975991247311UL + 6692UL), (17693923975991247311UL + 6701UL), "avi_write", (unsigned)1, (17693923975991247311UL + 6694UL),
                     ...
                     "video_index_entry", 3, "long unsigned int", (int)__builtin_offsetof (video_index_entry, key), "long unsigned int", (int)__builtin_offsetof (video_index_entry, pos), "long unsigned int", (int)__builtin_offsetof (video_index_entry, len),
                             ...
                             "avi_write", "_Z9avi_writeiPcm", 1, "write",
                             ...
                             "AVI_close", "AVI_close", 2, "avi_close_output_file", "close",
                             ...
                             "AVI_open_output_file", "AVI_open_output_file", 3, "open", "avi_write", "close",
                             "AVI_audio_size", "AVI_audio_size", 0,
                             "avi_add_chunk", "_Z13avi_add_chunkP5avi_tPhS1_i", 4, "long2str", "avi_write", "avi_write", "lseek",
                             "AVI_audio_chunks", "AVI_audio_chunks", 0,
                             "AVI_set_audio_bitrate", "AVI_set_audio_bitrate", 0,
                             "AVI_read_frame", "AVI_read_frame", 2, "lseek", "avi_read",
                             "AVI_append_audio", "AVI_append_audio", 8, "str2ulong", "str2ulong", "long2str", "lseek", "long2str", "avi_write", "lseek", "avi_write",
                             ...
                             "AVI_read_audio", "AVI_read_audio", 2, "lseek", "avi_read",
                             "AVI_audio_format", "AVI_audio_format", 0,
                             "avi_update_header", "avi_update_header", 67, "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "avi_sampsize", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "long2str", "lseek", "avi_write", "lseek",
                             "AVI_set_audio_position", "AVI_set_audio_position", 0,
                             "avi_read", "_Z8avi_readiPcm", 1, "read",
                             ...
                             "AVI_set_video", "AVI_set_video", 2, "strncmp", "avi_update_header",
                             ...
                             "AVI_strerror", "AVI_strerror", 2, "__errno_location", "strerror",
                             ...
                             "AVI_open_input_file", "AVI_open_input_file", 2, "open", "avi_parse_input_file",
