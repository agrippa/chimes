...
int main_resumable(int argc, char **argv) {const int ____chimes_did_disable0 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(6519850416441441940UL)) ; int *tmp;
int *next;
int *curr;
int niters;
int N;
...
# 11 "/home/jmg3/num-debug/src/examples/cpp/simple_stencil.cpp"
       curr = ((int *)malloc_wrapper(N * sizeof(int), 6519850416441441816UL, 0, 0)) ;
# 12 "/home/jmg3/num-debug/src/examples/cpp/simple_stencil.cpp"
       next = ((int *)malloc_wrapper(N * sizeof(int), 6519850416441441816UL, 0, 0)) ;
...
# 35 "/home/jmg3/num-debug/src/examples/cpp/simple_stencil.cpp"
    free_wrapper(curr, 6519850416441441816UL);
# 36 "/home/jmg3/num-debug/src/examples/cpp/simple_stencil.cpp"
    free_wrapper(next, 6519850416441441816UL);
...
int main_quick(int argc, char **argv) {const int ____chimes_did_disable0 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(6519850416441441940UL)) ; int *tmp;
int *next;
int *curr;
int niters;
int N;
...
static int module_init() {
    init_module(6519850416441441789UL, 5, 1, 0, 2, 0, 0, 0, 0, 0, 2,
                           &____alias_loc_id_0, (unsigned)11, (unsigned)0, (6519850416441441789UL + 1UL), (6519850416441441789UL + 2UL), (6519850416441441789UL + 3UL), (6519850416441441789UL + 4UL), (6519850416441441789UL + 5UL), (6519850416441441789UL + 6UL), (6519850416441441789UL + 7UL), (6519850416441441789UL + 8UL), (6519850416441441789UL + 9UL), (6519850416441441789UL + 10UL), (6519850416441441789UL + 27UL),
                           &____alias_loc_id_1, (unsigned)11, (unsigned)0, (6519850416441441789UL + 1UL), (6519850416441441789UL + 2UL), (6519850416441441789UL + 3UL), (6519850416441441789UL + 4UL), (6519850416441441789UL + 5UL), (6519850416441441789UL + 6UL), (6519850416441441789UL + 7UL), (6519850416441441789UL + 8UL), (6519850416441441789UL + 9UL), (6519850416441441789UL + 11UL), (6519850416441441789UL + 27UL),
                             (6519850416441441789UL + 9UL), (6519850416441441789UL + 27UL),
                             (6519850416441441789UL + 8UL), (6519850416441441789UL + 27UL),
                             (6519850416441441789UL + 3UL), (6519850416441441789UL + 151UL),
                             (6519850416441441789UL + 11UL), (6519850416441441789UL + 129UL),
                             (6519850416441441789UL + 10UL), (6519850416441441789UL + 27UL),
