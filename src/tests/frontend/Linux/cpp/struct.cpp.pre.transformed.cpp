...
int main_resumable(int argc, char **argv) {const int ____chimes_did_disable0 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(12380541257055300216UL)) ; foo *test2;
foo test;
...
# 17 "/home/jmg3/num-debug/src/examples/cpp/struct.cpp"
       test2 = ((foo *)malloc_wrapper(sizeof(foo) * 3, 12380541257055300204UL, 0, 1, (int)sizeof(struct _foo), 2, (int)__builtin_offsetof(struct _foo, b), (int)__builtin_offsetof(struct _foo, c))) ;
...
int main_quick(int argc, char **argv) {const int ____chimes_did_disable0 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(12380541257055300216UL)) ; foo *test2;
foo test;
...
static int module_init() {
    init_module(12380541257055300151UL, 4, 1, 0, 1, 0, 0, 0, 0, 0, 1,
                           &____alias_loc_id_0, (unsigned)6, (unsigned)0, (12380541257055300151UL + 1UL), (12380541257055300151UL + 2UL), (12380541257055300151UL + 3UL), (12380541257055300151UL + 4UL), (12380541257055300151UL + 5UL), (12380541257055300151UL + 53UL),
                             (12380541257055300151UL + 75UL), (12380541257055300151UL + 26UL),
                             (12380541257055300151UL + 3UL), (12380541257055300151UL + 65UL),
                             (12380541257055300151UL + 5UL), (12380541257055300151UL + 53UL),
                             (12380541257055300151UL + 4UL), (12380541257055300151UL + 38UL),
