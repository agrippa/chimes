...
int main_resumable(int argc, char **argv) {const int ____chimes_did_disable1 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(6301118551054036081UL)) ; if (____chimes_replaying) { switch(get_next_call()) { case(4): { goto call_lbl_4; } default: { chimes_error(); } } } ; ;
...
int main_quick(int argc, char **argv) {const int ____chimes_did_disable1 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(6301118551054036081UL)) ; ; ;
# 10 "/home/jmg3/num-debug/src/examples/openmp/barrier.cpp"
     int a; a = (3) ;
# 11 "/home/jmg3/num-debug/src/examples/openmp/barrier.cpp"
     int b; b = (4) ;
...
static int module_init() {
    init_module(6301118551054036049UL, 1, 2, 0, 1, 0, 0, 0, 0, 0, 0,
                           &____alias_loc_id_0, (unsigned)8, (unsigned)0, (6301118551054036049UL + 3UL), (6301118551054036049UL + 4UL), (6301118551054036049UL + 5UL), (6301118551054036049UL + 6UL), (6301118551054036049UL + 7UL), (6301118551054036049UL + 8UL), (6301118551054036049UL + 9UL), (6301118551054036049UL + 10UL),
                             (6301118551054036049UL + 5UL), (6301118551054036049UL + 32UL),
                             "main", 1, "foo",
                             "foo", 1, "checkpoint");
