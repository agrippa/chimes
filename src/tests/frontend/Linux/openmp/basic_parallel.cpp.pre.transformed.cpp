...
int main_resumable(int argc, char **argv) {const int ____chimes_did_disable1 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(17929019557700912541UL)) ; if (____chimes_replaying) { switch(get_next_call()) { case(4): { goto call_lbl_4; } default: { chimes_error(); } } } ; ;
...
int main_quick(int argc, char **argv) {const int ____chimes_did_disable1 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(17929019557700912541UL)) ; ; ;
# 10 "/home/jmg3/num-debug/src/examples/openmp/basic_parallel.cpp"
     int a; a = (3) ;
# 11 "/home/jmg3/num-debug/src/examples/openmp/basic_parallel.cpp"
     int b; b = (4) ;
