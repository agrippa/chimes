...
# 29 "/home/jmg3/num-debug/src/examples/openmp/./lib/common3d.cpp"
                const float dx, const float dt) {const int ____chimes_did_disable1 = new_stack((void *)(&init_data), "init_data", &____must_manage_init_data, 9, 0, (size_t)(75241783173009578UL), (size_t)(75241783173009579UL), (size_t)(75241783173009580UL), (size_t)(75241783173009581UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
...
void usage_resumable(char **argv) {const int ____chimes_did_disable2 = new_stack((void *)(&usage), "usage", &____must_manage_usage, 1, 0, (size_t)(75241783173009603UL)) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
...
void default_config_resumable(config *conf) {const int ____chimes_did_disable3 = new_stack((void *)(&default_config), "default_config", &____must_manage_default_config, 1, 0, (size_t)(75241783173009644UL)) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
...
# 101 "/home/jmg3/num-debug/src/examples/openmp/./lib/common3d.cpp"
                        (conf->nsrcs + 1), 75241783173009704UL, 0, 1, (int)sizeof(struct _source), 0);
# 102 "/home/jmg3/num-debug/src/examples/openmp/./lib/common3d.cpp"
                 call_lbl_8: ({ source * ____chimes_arg1; if (!____chimes_replaying) { ____chimes_arg1 = (conf->srcs + conf->nsrcs); } calling((void*)parse_source, 8, ____alias_loc_id_0, 0UL, 2, (size_t)(75241783173009668UL), (size_t)(75241783173009704UL)); (parse_source)(optarg, ____chimes_arg1); }) ;
...
# 28 "/home/jmg3/num-debug/src/examples/openmp/./lib/common3d.cpp"
                const int dimx, const int dimy, const int dimz,
# 29 "/home/jmg3/num-debug/src/examples/openmp/./lib/common3d.cpp"
                const float dx, const float dt) {const int ____chimes_did_disable1 = new_stack((void *)(&init_data), "init_data", &____must_manage_init_data, 9, 0, (size_t)(75241783173009578UL), (size_t)(75241783173009579UL), (size_t)(75241783173009580UL), (size_t)(75241783173009581UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)) ; ; ;
# 30 "/home/jmg3/num-debug/src/examples/openmp/./lib/common3d.cpp"
# 31 "/home/jmg3/num-debug/src/examples/openmp/./lib/common3d.cpp"
    { size_t i; for ( i = (0) ; i < dimx * dimy * dimz; i++) {
# 32 "/home/jmg3/num-debug/src/examples/openmp/./lib/common3d.cpp"
...
# 101 "/home/jmg3/num-debug/src/examples/openmp/./lib/common3d.cpp"
                        (conf->nsrcs + 1), 75241783173009704UL, 0, 1, (int)sizeof(struct _source), 0);
# 102 "/home/jmg3/num-debug/src/examples/openmp/./lib/common3d.cpp"
                 call_lbl_8: ({ calling((void*)parse_source, 8, ____alias_loc_id_0, 0UL, 2, (size_t)(75241783173009668UL), (size_t)(75241783173009704UL)); (parse_source)(optarg, conf->srcs + conf->nsrcs); }) ;
# 103 "/home/jmg3/num-debug/src/examples/openmp/./lib/common3d.cpp"
                conf->nsrcs++;
# 104 "/home/jmg3/num-debug/src/examples/openmp/./lib/common3d.cpp"
                break;
...
static int module_init() {
    init_module(75241783173009337UL, 16, 5, 4, 6, 5, 2, 7, 2, 0, 4,
                           ...
                           &____alias_loc_id_5, (unsigned)6, (unsigned)0, (unsigned)0, (75241783173009337UL + 308UL), (75241783173009337UL + 309UL), (75241783173009337UL + 310UL), (75241783173009337UL + 311UL), (75241783173009337UL + 437UL), (75241783173009337UL + 454UL),
                            ...
                            "default_config", (void *)(&default_config_npm), (void *)__null, 0, 1, (75241783173009337UL + 307UL), 0UL, 0,
                            "setup_config", (void *)(&setup_config_npm), (void *)__null, 2, &____alias_loc_id_0, &____alias_loc_id_1, 3, (75241783173009337UL + 437UL), 0UL, (75241783173009337UL + 439UL), 0UL, 15, "default_config", 1, (75241783173009337UL + 437UL), 0UL, "getopt", 3, 0UL, (75241783173009337UL + 439UL), (75241783173009337UL + 455UL), 0UL, "atoi", 1, (75241783173009337UL + 331UL), 0UL, "atoi", 1, (75241783173009337UL + 331UL), 0UL, "atoi", 1, (75241783173009337UL + 331UL), 0UL, "atoi", 1, (75241783173009337UL + 331UL), 0UL, "atoi", 1, (75241783173009337UL + 331UL), 0UL, "realloc", 2, (75241783173009337UL + 367UL), 0UL, (75241783173009337UL + 367UL), "parse_source", 2, (75241783173009337UL + 331UL), (75241783173009337UL + 367UL), 0UL, "atoi", 1, (75241783173009337UL + 331UL), 0UL, "atoi", 1, (75241783173009337UL + 331UL), 0UL, "atoi", 1, (75241783173009337UL + 331UL), 0UL, "fprintf", 3, (75241783173009337UL + 418UL), (75241783173009337UL + 450UL), 0UL, 0UL, "usage", 1, (75241783173009337UL + 439UL), 0UL, "getNumCUDADevices", 0, 0UL,
                           ...
                           "parse_source", &(____chimes_does_checkpoint_parse_source_npm),
                             (75241783173009337UL + 308UL), (75241783173009337UL + 437UL),
                             (75241783173009337UL + 449UL), (75241783173009337UL + 418UL),
                             (75241783173009337UL + 7UL), (75241783173009337UL + 101UL),
                             (75241783173009337UL + 310UL), (75241783173009337UL + 439UL),
                             (75241783173009337UL + 456UL), (75241783173009337UL + 331UL),
                             (75241783173009337UL + 307UL), (75241783173009337UL + 459UL),
                             (75241783173009337UL + 1UL), (75241783173009337UL + 95UL),
                             (75241783173009337UL + 114UL), (75241783173009337UL + 244UL),
                             (75241783173009337UL + 111UL), (75241783173009337UL + 241UL),
                             (75241783173009337UL + 266UL), (75241783173009337UL + 261UL),
                             (75241783173009337UL + 113UL), (75241783173009337UL + 243UL),
                             (75241783173009337UL + 112UL), (75241783173009337UL + 242UL),
        ...
        "default_config", 0UL, (int)1, 75241783173009774UL,
        "usage", 0UL, (int)1, 75241783173009776UL);
    return 0;
}
