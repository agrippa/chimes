...
# 251 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
        q0sqr = varROI / (meanROI*meanROI); { call_lbl_61: ; bool ____chimes_disable0 = disable_current_thread(); void *____chimes_parent_ctx1 = get_thread_ctx(); unsigned ____chimes_parent_stack_depth0 = get_parent_vars_stack_depth(); unsigned ____chimes_call_stack_depth0 = get_thread_stack_depth(); size_t ____chimes_region_id0; unsigned ____chimes_parent_thread0 = entering_omp_parallel(61, &____chimes_region_id0, 9, &G2, &Jc, &L, &den, &i, &j, &k, &num, &qsqr); int ____chimes_first_iter0 = 1; ;
...
# 293 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
        } } leaving_omp_parallel(____chimes_call_stack_depth0, ____chimes_region_id0, 1); reenable_current_thread(____chimes_disable0); } ; { call_lbl_62: ; bool ____chimes_disable1 = disable_current_thread(); void *____chimes_parent_ctx2 = get_thread_ctx(); unsigned ____chimes_parent_stack_depth1 = get_parent_vars_stack_depth(); unsigned ____chimes_call_stack_depth1 = get_thread_stack_depth(); size_t ____chimes_region_id1; unsigned ____chimes_parent_thread1 = entering_omp_parallel(62, &____chimes_region_id1, 8, &D, &cE, &cN, &cS, &cW, &i, &j, &k); int ____chimes_first_iter1 = 1;
