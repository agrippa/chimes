...
# 258 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
# 258 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
{ call_lbl_63: bool ____chimes_disable0 = disable_current_thread(); void *____chimes_parent_ctx1 = get_thread_ctx(); unsigned ____chimes_parent_stack_depth0 = get_parent_vars_stack_depth(); unsigned ____chimes_call_stack_depth0 = get_thread_stack_depth(); size_t ____chimes_region_id0; unsigned ____chimes_parent_thread0 = entering_omp_parallel(63, &____chimes_region_id0, 9, &G2, &Jc, &L, &den, &i, &j, &k, &num, &qsqr); int ____chimes_first_iter0 = 1;
# 258 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
...
# 300 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
# 300 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
{ call_lbl_64: bool ____chimes_disable1 = disable_current_thread(); void *____chimes_parent_ctx2 = get_thread_ctx(); unsigned ____chimes_parent_stack_depth1 = get_parent_vars_stack_depth(); unsigned ____chimes_call_stack_depth1 = get_thread_stack_depth(); size_t ____chimes_region_id1; unsigned ____chimes_parent_thread1 = entering_omp_parallel(64, &____chimes_region_id1, 8, &D, &cE, &cN, &cS, &cW, &i, &j, &k); int ____chimes_first_iter1 = 1;
# 300 "/scratch/jmg3/rodinia_3.0/openmp/srad/srad_v1/main.c"
