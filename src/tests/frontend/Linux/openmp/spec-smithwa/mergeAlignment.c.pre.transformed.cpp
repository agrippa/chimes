...
# 51 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
CSTR_T *mergeAlignment_npm(BSTR_T *B, int maxReports, int minSeparation);static int (*____chimes_extern_func_abs)(int) = abs;static double (*____chimes_extern_func_getSeconds)(void) = getSeconds;static int (*____chimes_extern_func_gridInfo)(int *, int *, int *, int *) = gridInfo;static void (*____chimes_extern_func_qSort_both)(long long *, int *, const long long *, int) = qSort_both;
...
# 89 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
  if ( (P = (BSTR_T*)malloc_wrapper(sizeof(BSTR_T), 10402924002521285989UL, 0, 1, (int)sizeof(struct bstr), 8, (int)__builtin_offsetof(struct bstr, bestScores), (int)__builtin_offsetof(struct bstr, numReports), (int)__builtin_offsetof(struct bstr, bestStartsI), (int)__builtin_offsetof(struct bstr, bestStartsJ), (int)__builtin_offsetof(struct bstr, bestEndsI), (int)__builtin_offsetof(struct bstr, bestEndsJ), (int)__builtin_offsetof(struct bstr, bestSeqsI), (int)__builtin_offsetof(struct bstr, bestSeqsJ))) == __null ) {
...
# 94 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
  if ( (P->numReports = (int*)malloc_wrapper(maxThreads*sizeof(int), 10402924002521285991UL, 0, 0)) == __null ) {
...
# 99 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
  if ( (P->bestScores = (long long**)malloc_wrapper(maxThreads*sizeof(long long*), 10402924002521285991UL, 1, 0))
...
# 105 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
  if ( (P->bestStartsI = (int**)malloc_wrapper(maxThreads*sizeof(int*), 10402924002521285991UL, 1, 0)) == __null ) {
...
# 110 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
  if ( (P->bestStartsJ = (int**)malloc_wrapper(maxThreads*sizeof(int*), 10402924002521285991UL, 1, 0)) == __null ) {
...
# 115 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
  if ( (P->bestEndsI = (int**)malloc_wrapper(maxThreads*sizeof(int*), 10402924002521285991UL, 1, 0)) == __null ) {
...
# 120 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
  if ( (P->bestEndsJ = (int**)malloc_wrapper(maxThreads*sizeof(int*), 10402924002521285991UL, 1, 0)) == __null ) {
...
# 126 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
 (unsigned char***)malloc_wrapper(maxThreads*sizeof(unsigned char**), 10402924002521285991UL, 1, 0))
...
# 148 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
  if ( ( reqack = (int*) malloc_wrapper( maxThreads * sizeof(int), 10402924002521285552UL, 0, 0 ) ) == __null ) {
...
# 154 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
  }; { call_lbl_160: void *____chimes_parent_ctx1 = get_thread_ctx(); unsigned ____chimes_parent_stack_depth0 = get_parent_vars_stack_depth(); unsigned ____chimes_call_stack_depth0 = get_thread_stack_depth(); size_t ____chimes_region_id0; unsigned ____chimes_parent_thread0 = entering_omp_parallel(160, &____chimes_region_id0, 32, &beginTime, &consumer, &count, &endTime, &flag, &i, &index, &indexB, &iter, &j, &length, &mask, &maxReports, &minSeparation, &myCol, &myRow, &npCol, &npRow, &numReports, &numThreads, &producer, &scores, &sequences, &tempEndsI, &tempEndsJ, &tempScores, &tempSeqsI, &tempSeqsJ, &tempStartsI, &tempStartsJ, &threadNum, &totalReports);
...
# 172 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
     call_lbl_31: ({ calling((void*)gridInfo, 31, ____alias_loc_id_3, 0UL, 4, (size_t)(10402924002521284825UL), (size_t)(10402924002521284826UL), (size_t)(10402924002521284823UL), (size_t)(10402924002521284824UL)); (gridInfo)(&npRow, &npCol, &myRow, &myCol); }) ;
...
# 196 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
   (long long*)malloc_wrapper((2*maxReports+1)*sizeof(long long), 10402924002521287188UL, 0, 0))
...
# 207 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
   (int*)malloc_wrapper((2*maxReports+1)*sizeof(int), 10402924002521287188UL, 0, 0)) == __null ) {
...
# 247 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
   (unsigned char**)malloc_wrapper((2*maxReports+1)*sizeof(unsigned char*), 10402924002521287188UL, 1, 0))
...
# 295 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
     (unsigned char**)malloc_wrapper((2*maxReports+1)*sizeof(unsigned char*), 10402924002521286349UL, 1, 0))
...
# 305 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
      if ( (scores = (long long*)malloc_wrapper((2*maxReports+1)*sizeof(long long), 10402924002521286021UL, 0, 0))
...
# 315 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
      if ( (index = (int*)malloc_wrapper((2*maxReports+1)*sizeof(int), 10402924002521286012UL, 0, 0)) == __null ) {
...
# 343 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
     call_lbl_63: beginTime = ({ calling((void*)getSeconds, 63, ____alias_loc_id_1, 0UL, 0); (getSeconds)(); }) ;
...
# 403 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
     (unsigned char*)malloc_wrapper(length * sizeof(unsigned char), 10402924002521287190UL, 0, 0))
...
# 567 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
     alias_group_changed(____alias_loc_id_4); call_lbl_79: call_lbl_80: call_lbl_81: call_lbl_82: call_lbl_83: call_lbl_84: call_lbl_85: call_lbl_86: if ( ( ( ( ({ int ____chimes_arg4; if (!____chimes_replaying) { ____chimes_arg4 = (tempStartsI[j] - P->bestStartsI[producer][i]); } calling((void*)abs, 79, ____alias_loc_id_4, 0UL, 1, (size_t)(0UL)); (abs)(____chimes_arg4); }) > ({ int ____chimes_arg5; if (!____chimes_replaying) { ____chimes_arg5 = (tempStartsJ[j] - P->bestStartsJ[producer][i]); } calling((void*)abs, 80, ____alias_loc_id_4, 0UL, 1, (size_t)(0UL)); (abs)(____chimes_arg5); }) ) ? ({ int ____chimes_arg6; if (!____chimes_replaying) { ____chimes_arg6 = (tempStartsI[j] - P->bestStartsI[producer][i]); } calling((void*)abs, 81, ____alias_loc_id_4, 0UL, 1, (size_t)(0UL)); (abs)(____chimes_arg6); }) : ({ int ____chimes_arg7; if (!____chimes_replaying) { ____chimes_arg7 = (tempStartsJ[j] - P->bestStartsJ[producer][i]); } calling((void*)abs, 82, ____alias_loc_id_4, 0UL, 1, (size_t)(0UL)); (abs)(____chimes_arg7); }) )
...
# 570 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
   ( ( ( ({ int ____chimes_arg8; if (!____chimes_replaying) { ____chimes_arg8 = (tempEndsI[j] - P->bestEndsI[producer][i]); } calling((void*)abs, 83, 0, 0UL, 1, (size_t)(0UL)); (abs)(____chimes_arg8); }) > ({ int ____chimes_arg9; if (!____chimes_replaying) { ____chimes_arg9 = (tempEndsJ[j] - P->bestEndsJ[producer][i]); } calling((void*)abs, 84, 0, 0UL, 1, (size_t)(0UL)); (abs)(____chimes_arg9); }) ) ? ({ int ____chimes_arg10; if (!____chimes_replaying) { ____chimes_arg10 = (tempEndsI[j] - P->bestEndsI[producer][i]); } calling((void*)abs, 85, 0, 0UL, 1, (size_t)(0UL)); (abs)(____chimes_arg10); }) : ({ int ____chimes_arg11; if (!____chimes_replaying) { ____chimes_arg11 = (tempEndsJ[j] - P->bestEndsJ[producer][i]); } calling((void*)abs, 86, 0, 0UL, 1, (size_t)(0UL)); (abs)(____chimes_arg11); }) )
...
# 590 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
       free_wrapper(P->bestSeqsI[producer][i], 10402924002521287190UL);
...
# 594 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
       free_wrapper(P->bestSeqsJ[producer][i], 10402924002521287190UL);
...
# 849 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
  call_lbl_90: ({ calling((void*)qSort_both, 90, ____alias_loc_id_2, 0UL, 4, (size_t)(10402924002521286021UL), (size_t)(10402924002521286012UL), (size_t)(10402924002521287188UL), (size_t)(0UL)); (qSort_both)(scores, index, tempScores, totalReports); }) ;
...
# 901 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
     free_wrapper(tempSeqsI[ index[i] ], 10402924002521287190UL);
...
# 905 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
     free_wrapper(tempSeqsJ[ index[i] ], 10402924002521287190UL);
...
# 1183 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
     call_lbl_93: endTime = ({ calling((void*)getSeconds, 93, ____alias_loc_id_0, 0UL, 0); (getSeconds)(); }) ;
...
# 1199 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
      if ( (C = (CSTR_T*)malloc_wrapper(sizeof(CSTR_T), 10402924002521287324UL, 0, 1, (int)sizeof(struct cstr), 7, (int)__builtin_offsetof(struct cstr, finalScores), (int)__builtin_offsetof(struct cstr, finalStartsI), (int)__builtin_offsetof(struct cstr, finalStartsJ), (int)__builtin_offsetof(struct cstr, finalEndsI), (int)__builtin_offsetof(struct cstr, finalEndsJ), (int)__builtin_offsetof(struct cstr, finalSeqsI), (int)__builtin_offsetof(struct cstr, finalSeqsJ))) == __null ) {
...
# 1215 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
     (long long*)malloc_wrapper((numReports+1)*sizeof(long long), 10402924002521287188UL, 0, 0)) == __null ) {
...
# 1224 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
     (int*)malloc_wrapper((numReports+1)*sizeof(int), 10402924002521287188UL, 0, 0)) == __null) {
...
# 1260 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
    (unsigned char**)malloc_wrapper((numReports+1)*sizeof(unsigned char*), 10402924002521287188UL, 1, 0))
...
# 1305 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
 free_wrapper(tempSeqsI[i], 10402924002521287190UL);
...
# 1328 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
 free_wrapper(tempSeqsJ[i], 10402924002521287190UL);
...
# 1336 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
      free_wrapper(tempScores, 10402924002521287188UL);
...
# 1340 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
      free_wrapper(tempStartsI, 10402924002521287188UL);
...
# 1344 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
      free_wrapper(tempStartsJ, 10402924002521287188UL);
...
# 1348 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
      free_wrapper(tempEndsI, 10402924002521287188UL);
...
# 1352 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
      free_wrapper(tempEndsJ, 10402924002521287188UL);
...
# 1371 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
      free_wrapper(tempSeqsI, 10402924002521287188UL);
...
# 1388 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
      free_wrapper(tempSeqsJ, 10402924002521287188UL);
...
# 1436 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
  rm_stack(true, 10402924002521287324UL, "mergeAlignment", &____must_manage_mergeAlignment, ____alias_loc_id_5, ____chimes_did_disable0); return (C);
...
CSTR_T *freeC_resumable(CSTR_T *C) {const int ____chimes_did_disable1 = new_stack((void *)(&freeC), "freeC", &____must_manage_freeC, 1, 0, (size_t)(10402924002521287280UL)) ; if (____chimes_replaying) { switch(get_next_call()) { default: { chimes_error(); } } } ; ;
...
# 1447 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
      free_wrapper(C->finalScores, 10402924002521287188UL);
...
# 1451 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
      free_wrapper(C->finalStartsI, 10402924002521287188UL);
...
# 1455 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
      free_wrapper(C->finalStartsJ, 10402924002521287188UL);
...
# 1459 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
      free_wrapper(C->finalEndsI, 10402924002521287188UL);
...
# 1463 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
      free_wrapper(C->finalEndsJ, 10402924002521287188UL);
...
# 1469 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
   free_wrapper(C->finalSeqsI[i], 10402924002521287190UL);
...
# 1473 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
      free_wrapper(C->finalSeqsI, 10402924002521287188UL);
...
# 1479 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
   free_wrapper(C->finalSeqsJ[i], 10402924002521287190UL);
...
# 1483 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
      free_wrapper(C->finalSeqsJ, 10402924002521287188UL);
...
# 1486 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
    free_wrapper(C, 10402924002521287280UL);
...
# 1488 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
  rm_stack(true, 10402924002521287324UL, "freeC", &____must_manage_freeC, ____alias_loc_id_6, ____chimes_did_disable1); return (__null);
...
# 566 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
   for (j = 1; j <= numReports; j++) {
# 567 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
     alias_group_changed(____alias_loc_id_4); call_lbl_79: call_lbl_80: call_lbl_81: call_lbl_82: call_lbl_83: call_lbl_84: call_lbl_85: call_lbl_86: if ( ( ( ( ({ calling((void*)abs, 79, ____alias_loc_id_4, 0UL, 1, (size_t)(0UL)); (abs)(tempStartsI[j] - P->bestStartsI[producer][i]); }) > ({ calling((void*)abs, 80, ____alias_loc_id_4, 0UL, 1, (size_t)(0UL)); (abs)(tempStartsJ[j] - P->bestStartsJ[producer][i]); }) ) ? ({ calling((void*)abs, 81, ____alias_loc_id_4, 0UL, 1, (size_t)(0UL)); (abs)(tempStartsI[j] - P->bestStartsI[producer][i]); }) : ({ calling((void*)abs, 82, ____alias_loc_id_4, 0UL, 1, (size_t)(0UL)); (abs)(tempStartsJ[j] - P->bestStartsJ[producer][i]); }) )
# 568 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
# 569 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
     < minSeparation ) ||
# 570 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
   ( ( ( ({ calling((void*)abs, 83, 0, 0UL, 1, (size_t)(0UL)); (abs)(tempEndsI[j] - P->bestEndsI[producer][i]); }) > ({ calling((void*)abs, 84, 0, 0UL, 1, (size_t)(0UL)); (abs)(tempEndsJ[j] - P->bestEndsJ[producer][i]); }) ) ? ({ calling((void*)abs, 85, 0, 0UL, 1, (size_t)(0UL)); (abs)(tempEndsI[j] - P->bestEndsI[producer][i]); }) : ({ calling((void*)abs, 86, 0, 0UL, 1, (size_t)(0UL)); (abs)(tempEndsJ[j] - P->bestEndsJ[producer][i]); }) )
# 571 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
# 572 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
     < minSeparation ) ) {
# 573 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
...
CSTR_T *freeC_quick(CSTR_T *C) {const int ____chimes_did_disable1 = new_stack((void *)(&freeC), "freeC", &____must_manage_freeC, 1, 0, (size_t)(10402924002521287280UL)) ; ; ;
# 1442 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
# 1443 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
  int i; ;
# 1444 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
...
# 566 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
   for (j = 1; j <= numReports; j++) {
# 567 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
     if ( ( ( ((*____chimes_extern_func_abs)(tempStartsI[j] - P->bestStartsI[producer][i]) > (*____chimes_extern_func_abs)(tempStartsJ[j] - P->bestStartsJ[producer][i])) ? (*____chimes_extern_func_abs)(tempStartsI[j] - P->bestStartsI[producer][i]) : (*____chimes_extern_func_abs)(tempStartsJ[j] - P->bestStartsJ[producer][i]) )
# 568 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
# 569 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
     < minSeparation ) ||
# 570 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
   ( ( ((*____chimes_extern_func_abs)(tempEndsI[j] - P->bestEndsI[producer][i]) > (*____chimes_extern_func_abs)(tempEndsJ[j] - P->bestEndsJ[producer][i])) ? (*____chimes_extern_func_abs)(tempEndsI[j] - P->bestEndsI[producer][i]) : (*____chimes_extern_func_abs)(tempEndsJ[j] - P->bestEndsJ[producer][i]) )
# 571 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
# 572 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
     < minSeparation ) ) {
# 573 "/scratch/jmg3/spec/benchspec/OMP2012/372.smithwa/src/mergeAlignment.c"
...
static int module_init() {
    init_module(10402924002521284791UL, 24, 2, 30, 7, 2, 4, 6, 0, 0, 2,
                           &____alias_loc_id_0, (unsigned)15, (unsigned)0, (unsigned)0, (10402924002521284791UL + 6UL), (10402924002521284791UL + 20UL), (10402924002521284791UL + 22UL), (10402924002521284791UL + 23UL), (10402924002521284791UL + 24UL), (10402924002521284791UL + 25UL), (10402924002521284791UL + 28UL), (10402924002521284791UL + 31UL), (10402924002521284791UL + 36UL), (10402924002521284791UL + 761UL), (10402924002521284791UL + 1200UL), (10402924002521284791UL + 1230UL), (10402924002521284791UL + 1558UL), (10402924002521284791UL + 2397UL), (10402924002521284791UL + 2399UL),
                           &____alias_loc_id_1, (unsigned)14, (unsigned)0, (unsigned)0, (10402924002521284791UL + 4UL), (10402924002521284791UL + 5UL), (10402924002521284791UL + 8UL), (10402924002521284791UL + 11UL), (10402924002521284791UL + 12UL), (10402924002521284791UL + 13UL), (10402924002521284791UL + 14UL), (10402924002521284791UL + 15UL), (10402924002521284791UL + 16UL), (10402924002521284791UL + 17UL), (10402924002521284791UL + 20UL), (10402924002521284791UL + 30UL), (10402924002521284791UL + 1200UL), (10402924002521284791UL + 2397UL),
                           &____alias_loc_id_2, (unsigned)6, (unsigned)0, (unsigned)1, (10402924002521284791UL + 20UL), (10402924002521284791UL + 21UL), (10402924002521284791UL + 26UL), (10402924002521284791UL + 27UL), (10402924002521284791UL + 761UL), (10402924002521284791UL + 2397UL), "qSort_both", (unsigned)3, (10402924002521284791UL + 1221UL), (10402924002521284791UL + 1230UL), (10402924002521284791UL + 2397UL),
                           &____alias_loc_id_3, (unsigned)17, (unsigned)0, (unsigned)1, (10402924002521284791UL + 1UL), (10402924002521284791UL + 2UL), (10402924002521284791UL + 3UL), (10402924002521284791UL + 4UL), (10402924002521284791UL + 10UL), (10402924002521284791UL + 11UL), (10402924002521284791UL + 12UL), (10402924002521284791UL + 13UL), (10402924002521284791UL + 14UL), (10402924002521284791UL + 15UL), (10402924002521284791UL + 16UL), (10402924002521284791UL + 19UL), (10402924002521284791UL + 20UL), (10402924002521284791UL + 38UL), (10402924002521284791UL + 39UL), (10402924002521284791UL + 761UL), (10402924002521284791UL + 1198UL), "gridInfo", (unsigned)4, (10402924002521284791UL + 32UL), (10402924002521284791UL + 33UL), (10402924002521284791UL + 34UL), (10402924002521284791UL + 35UL),
                           &____alias_loc_id_4, (unsigned)2, (unsigned)0, (unsigned)0, (10402924002521284791UL + 21UL), (10402924002521284791UL + 27UL),
                           &____alias_loc_id_5, (unsigned)15, (unsigned)0, (unsigned)0, (10402924002521284791UL + 4UL), (10402924002521284791UL + 11UL), (10402924002521284791UL + 12UL), (10402924002521284791UL + 13UL), (10402924002521284791UL + 14UL), (10402924002521284791UL + 15UL), (10402924002521284791UL + 16UL), (10402924002521284791UL + 19UL), (10402924002521284791UL + 20UL), (10402924002521284791UL + 28UL), (10402924002521284791UL + 29UL), (10402924002521284791UL + 37UL), (10402924002521284791UL + 2397UL), (10402924002521284791UL + 2399UL), (10402924002521284791UL + 2533UL),
                           &____alias_loc_id_6, (unsigned)4, (unsigned)0, (unsigned)0, (10402924002521284791UL + 2302UL), (10402924002521284791UL + 2303UL), (10402924002521284791UL + 2397UL), (10402924002521284791UL + 2489UL),
                            "mergeAlignment", (void *)(&mergeAlignment_npm), (void *)__null, 5, &____alias_loc_id_0, &____alias_loc_id_1, &____alias_loc_id_2, &____alias_loc_id_3, &____alias_loc_id_4, 3, (10402924002521284791UL + 2281UL), 0UL, 0UL, (10402924002521284791UL + 2533UL), 157, "malloc", 1, 0UL, (10402924002521284791UL + 1198UL), "printf", 1, (10402924002521284791UL + 2490UL), 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 1200UL), "printf", 1, (10402924002521284791UL + 2491UL), 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 1200UL), "printf", 1, (10402924002521284791UL + 2491UL), 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 1200UL), "printf", 1, (10402924002521284791UL + 2493UL), 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 1200UL), "printf", 1, (10402924002521284791UL + 2493UL), 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 1200UL), "printf", 1, (10402924002521284791UL + 2495UL), 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 1200UL), "printf", 1, (10402924002521284791UL + 2495UL), 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 1200UL), "printf", 1, (10402924002521284791UL + 2495UL), 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 1200UL), "printf", 1, (10402924002521284791UL + 2495UL), 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 761UL), "printf", 1, (10402924002521284791UL + 2499UL), 0UL, "exit", 1, 0UL, 0UL, "gridInfo", 4, (10402924002521284791UL + 34UL), (10402924002521284791UL + 35UL), (10402924002521284791UL + 32UL), (10402924002521284791UL + 33UL), 0UL, "omp_get_thread_num", 0, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 2397UL), "printf", 2, (10402924002521284791UL + 2500UL), 0UL, 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 2397UL), "printf", 2, (10402924002521284791UL + 2501UL), 0UL, 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 2397UL), "printf", 2, (10402924002521284791UL + 2501UL), 0UL, 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 2397UL), "printf", 2, (10402924002521284791UL + 2503UL), 0UL, 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 2397UL), "printf", 2, (10402924002521284791UL + 2503UL), 0UL, 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 2397UL), "printf", 2, (10402924002521284791UL + 2503UL), 0UL, 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 2397UL), "printf", 2, (10402924002521284791UL + 2503UL), 0UL, 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 1558UL), "printf", 2, (10402924002521284791UL + 2503UL), 0UL, 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 1230UL), "printf", 2, (10402924002521284791UL + 2508UL), 0UL, 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 1221UL), "printf", 2, (10402924002521284791UL + 2509UL), 0UL, 0UL, "exit", 1, 0UL, 0UL, "getSeconds", 0, 0UL, "strlen", 1, (10402924002521284791UL + 591UL), 0UL, "printf", 4, (10402924002521284791UL + 2510UL), 0UL, 0UL, 0UL, 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 2399UL), "printf", 3, (10402924002521284791UL + 2510UL), 0UL, 0UL, 0UL, "exit", 1, 0UL, 0UL, "strcpy", 2, (10402924002521284791UL + 2399UL), (10402924002521284791UL + 591UL), (10402924002521284791UL + 2399UL), "strlen", 1, (10402924002521284791UL + 591UL), 0UL, "printf", 4, (10402924002521284791UL + 2510UL), 0UL, 0UL, 0UL, 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 2399UL), "printf", 3, (10402924002521284791UL + 2510UL), 0UL, 0UL, 0UL, "exit", 1, 0UL, 0UL, "strcpy", 2, (10402924002521284791UL + 2399UL), (10402924002521284791UL + 591UL), (10402924002521284791UL + 2399UL), "abs", 1, 0UL, 0UL, "abs", 1, 0UL, 0UL, "abs", 1, 0UL, 0UL, "abs", 1, 0UL, 0UL, "abs", 1, 0UL, 0UL, "abs", 1, 0UL, 0UL, "abs", 1, 0UL, 0UL, "abs", 1, 0UL, 0UL, "free", 1, (10402924002521284791UL + 2399UL), 0UL, "free", 1, (10402924002521284791UL + 2399UL), 0UL, "printf", 4, (10402924002521284791UL + 2514UL), 0UL, 0UL, 0UL, 0UL, "qSort_both", 4, (10402924002521284791UL + 1230UL), (10402924002521284791UL + 1221UL), (10402924002521284791UL + 2397UL), 0UL, 0UL, "free", 1, (10402924002521284791UL + 2399UL), 0UL, "free", 1, (10402924002521284791UL + 2399UL), 0UL, "getSeconds", 0, 0UL, "printf", 2, (10402924002521284791UL + 2515UL), 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 2533UL), "printf", 1, (10402924002521284791UL + 2490UL), 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 2397UL), "printf", 1, (10402924002521284791UL + 2493UL), 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 2397UL), "printf", 1, (10402924002521284791UL + 2518UL), 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 2397UL), "printf", 1, (10402924002521284791UL + 2518UL), 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 2397UL), "printf", 1, (10402924002521284791UL + 2491UL), 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 2397UL), "printf", 1, (10402924002521284791UL + 2491UL), 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 2397UL), "printf", 1, (10402924002521284791UL + 2491UL), 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 2397UL), "printf", 1, (10402924002521284791UL + 2491UL), 0UL, "exit", 1, 0UL, 0UL, "strlen", 1, (10402924002521284791UL + 2399UL), 0UL, "printf", 4, (10402924002521284791UL + 2501UL), 0UL, 0UL, 0UL, 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 2399UL), "printf", 2, (10402924002521284791UL + 2525UL), 0UL, 0UL, "exit", 1, 0UL, 0UL, "strcpy", 2, (10402924002521284791UL + 2399UL), (10402924002521284791UL + 2399UL), (10402924002521284791UL + 2399UL), "free", 1, (10402924002521284791UL + 2399UL), 0UL, "strlen", 1, (10402924002521284791UL + 2399UL), 0UL, "printf", 4, (10402924002521284791UL + 2501UL), 0UL, 0UL, 0UL, 0UL, "exit", 1, 0UL, 0UL, "malloc", 1, 0UL, (10402924002521284791UL + 2399UL), "printf", 2, (10402924002521284791UL + 2525UL), 0UL, 0UL, "exit", 1, 0UL, 0UL, "strcpy", 2, (10402924002521284791UL + 2399UL), (10402924002521284791UL + 2399UL), (10402924002521284791UL + 2399UL), "free", 1, (10402924002521284791UL + 2399UL), 0UL, "free", 1, (10402924002521284791UL + 2397UL), 0UL, "free", 1, (10402924002521284791UL + 2397UL), 0UL, "free", 1, (10402924002521284791UL + 2397UL), 0UL, "free", 1, (10402924002521284791UL + 2397UL), 0UL, "free", 1, (10402924002521284791UL + 2397UL), 0UL, "free", 1, (10402924002521284791UL + 2399UL), 0UL, "free", 1, (10402924002521284791UL + 2397UL), 0UL, "printf", 3, (10402924002521284791UL + 2500UL), 0UL, 0UL, 0UL, "free", 1, (10402924002521284791UL + 2399UL), 0UL, "free", 1, (10402924002521284791UL + 2397UL), 0UL, "printf", 3, (10402924002521284791UL + 2500UL), 0UL, 0UL, 0UL, "free", 1, (10402924002521284791UL + 1558UL), 0UL, "free", 1, (10402924002521284791UL + 1230UL), 0UL, "free", 1, (10402924002521284791UL + 1221UL), 0UL, "free", 1, (10402924002521284791UL + 761UL), 0UL, "free", 1, (10402924002521284791UL + 1200UL), 0UL, "free", 1, (10402924002521284791UL + 1200UL), 0UL, "free", 1, (10402924002521284791UL + 1200UL), 0UL, "free", 1, (10402924002521284791UL + 1200UL), 0UL, "free", 1, (10402924002521284791UL + 1200UL), 0UL, "free", 1, (10402924002521284791UL + 1200UL), 0UL, "free", 1, (10402924002521284791UL + 1200UL), 0UL, "free", 1, (10402924002521284791UL + 1200UL), 0UL, "free", 1, (10402924002521284791UL + 1198UL), 0UL,
                            "freeC", (void *)(&freeC_npm), (void *)__null, 0, 1, (10402924002521284791UL + 2489UL), (10402924002521284791UL + 2533UL), 10, "free", 1, (10402924002521284791UL + 2397UL), 0UL, "free", 1, (10402924002521284791UL + 2397UL), 0UL, "free", 1, (10402924002521284791UL + 2397UL), 0UL, "free", 1, (10402924002521284791UL + 2397UL), 0UL, "free", 1, (10402924002521284791UL + 2397UL), 0UL, "free", 1, (10402924002521284791UL + 2399UL), 0UL, "free", 1, (10402924002521284791UL + 2397UL), 0UL, "free", 1, (10402924002521284791UL + 2399UL), 0UL, "free", 1, (10402924002521284791UL + 2397UL), 0UL, "free", 1, (10402924002521284791UL + 2489UL), 0UL,
                           ...
                           "qSort_both", &(____chimes_does_checkpoint_qSort_both_npm),
                             (10402924002521284791UL + 1200UL), (10402924002521284791UL + 2397UL),
                             (10402924002521284791UL + 1198UL), (10402924002521284791UL + 1200UL),
                             (10402924002521284791UL + 2489UL), (10402924002521284791UL + 2397UL),
                             (10402924002521284791UL + 2302UL), (10402924002521284791UL + 2489UL),
                             (10402924002521284791UL + 1UL), (10402924002521284791UL + 2281UL),
                             (10402924002521284791UL + 5UL), (10402924002521284791UL + 1230UL),
                             (10402924002521284791UL + 4UL), (10402924002521284791UL + 2397UL),
                             (10402924002521284791UL + 509UL), (10402924002521284791UL + 591UL),
                             (10402924002521284791UL + 507UL), (10402924002521284791UL + 509UL),
                             (10402924002521284791UL + 2281UL), (10402924002521284791UL + 507UL),
                             (10402924002521284791UL + 39UL), (10402924002521284791UL + 1198UL),
                             (10402924002521284791UL + 38UL), (10402924002521284791UL + 761UL),
                             (10402924002521284791UL + 11UL), (10402924002521284791UL + 2397UL),
                             (10402924002521284791UL + 13UL), (10402924002521284791UL + 2397UL),
                             (10402924002521284791UL + 12UL), (10402924002521284791UL + 2397UL),
                             (10402924002521284791UL + 15UL), (10402924002521284791UL + 2397UL),
                             (10402924002521284791UL + 14UL), (10402924002521284791UL + 2397UL),
                             (10402924002521284791UL + 17UL), (10402924002521284791UL + 1558UL),
                             (10402924002521284791UL + 16UL), (10402924002521284791UL + 2397UL),
                             (10402924002521284791UL + 19UL), (10402924002521284791UL + 2533UL),
                             (10402924002521284791UL + 1558UL), (10402924002521284791UL + 2399UL),
                             (10402924002521284791UL + 30UL), (10402924002521284791UL + 1221UL),
                             (10402924002521284791UL + 2397UL), (10402924002521284791UL + 2399UL),
                             (10402924002521284791UL + 2533UL), (10402924002521284791UL + 2397UL),
                     ...
                     "cstr", 8, "long long int*", (int)__builtin_offsetof (struct cstr, finalScores), "int", (int)__builtin_offsetof (struct cstr, numReports), "int*", (int)__builtin_offsetof (struct cstr, finalStartsI), "int*", (int)__builtin_offsetof (struct cstr, finalStartsJ), "int*", (int)__builtin_offsetof (struct cstr, finalEndsI), "int*", (int)__builtin_offsetof (struct cstr, finalEndsJ), "unsigned char**", (int)__builtin_offsetof (struct cstr, finalSeqsI), "unsigned char**", (int)__builtin_offsetof (struct cstr, finalSeqsJ),
                             ...
                             "mergeAlignment", "_Z14mergeAlignmentP4bstrii", 12, "gridInfo", "getSeconds", "abs", "abs", "abs", "abs", "abs", "abs", "abs", "abs", "qSort_both", "getSeconds",
                        "mergeAlignment|B|0", 4, "qSort_both", "gridInfo", "getSeconds", "abs",
                        "mergeAlignment|maxReports|0", 4, "qSort_both", "gridInfo", "getSeconds", "abs",
                        "mergeAlignment|minSeparation|0", 4, "qSort_both", "gridInfo", "getSeconds", "abs",
                        "mergeAlignment|tempScores|0", 4, "qSort_both", "gridInfo", "getSeconds", "abs",
                        "mergeAlignment|scores|0", 3, "qSort_both", "getSeconds", "abs",
                        "mergeAlignment|numReports|0", 3, "qSort_both", "getSeconds", "abs",
                        "mergeAlignment|threadNum|0", 3, "qSort_both", "getSeconds", "abs",
                        "mergeAlignment|tempStartsI|0", 4, "qSort_both", "gridInfo", "getSeconds", "abs",
                        "mergeAlignment|tempStartsJ|0", 4, "qSort_both", "gridInfo", "getSeconds", "abs",
                        "mergeAlignment|tempEndsI|0", 4, "qSort_both", "gridInfo", "getSeconds", "abs",
                        "mergeAlignment|tempEndsJ|0", 4, "qSort_both", "gridInfo", "getSeconds", "abs",
                        "mergeAlignment|tempSeqsI|0", 4, "qSort_both", "gridInfo", "getSeconds", "abs",
                        "mergeAlignment|tempSeqsJ|0", 4, "qSort_both", "gridInfo", "getSeconds", "abs",
                        "mergeAlignment|sequences|0", 3, "qSort_both", "getSeconds", "abs",
                        "mergeAlignment|C|0", 4, "qSort_both", "gridInfo", "getSeconds", "abs",
                        "mergeAlignment|i|0", 4, "qSort_both", "gridInfo", "getSeconds", "abs",
                        "mergeAlignment|j|0", 3, "qSort_both", "getSeconds", "abs",
                        "mergeAlignment|iter|0", 3, "qSort_both", "getSeconds", "abs",
                        "mergeAlignment|mask|0", 3, "qSort_both", "getSeconds", "abs",
                        "mergeAlignment|consumer|0", 3, "qSort_both", "getSeconds", "abs",
                        "mergeAlignment|producer|0", 3, "qSort_both", "getSeconds", "abs",
                        "mergeAlignment|totalReports|0", 3, "qSort_both", "getSeconds", "abs",
                        "mergeAlignment|flag|0", 3, "qSort_both", "getSeconds", "abs",
                        "mergeAlignment|length|0", 3, "qSort_both", "getSeconds", "abs",
                        "mergeAlignment|index|0", 3, "qSort_both", "getSeconds", "abs",
                        "mergeAlignment|indexB|0", 3, "qSort_both", "getSeconds", "abs",
                        "mergeAlignment|myRow|0", 1, "mergeAlignment",
                        "mergeAlignment|beginTime|0", 3, "qSort_both", "getSeconds", "abs",
                        "mergeAlignment|reqack|0", 4, "qSort_both", "gridInfo", "getSeconds", "abs",
                        "mergeAlignment|P|0", 4, "qSort_both", "gridInfo", "getSeconds", "abs");
    return 0;
}
