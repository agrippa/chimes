...
void parTreeSearch_resumable(StealStack *ss) {const int ____chimes_did_disable27 = new_stack((void *)(&parTreeSearch), "parTreeSearch", (int *)0, 1, 1, (size_t)(12146000192742678795UL), "parTreeSearch|ss|0", (int *)0, "%struct.stealStack_t*", (void *)(&ss), (size_t)8, 1, 0, 0) ; int victimId;
int goodSteal;
int localDepth;
Node child;
Node *parent;
...
# 1203 "/home/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
...
# 1236 "/home/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
...
# 1313 "/home/jmg3/num-debug/src/examples/openmp/uts/uts_shm.c"
  }
...
int main_resumable(int argc, char *argv[]) {const int ____chimes_did_disable29 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(12146000192742679292UL)) ; StealStack *ss;
double et;
double t2;
double t1;
Node root;
...
void parTreeSearch_quick(StealStack *ss) {const int ____chimes_did_disable27 = new_stack((void *)(&parTreeSearch), "parTreeSearch", (int *)0, 1, 1, (size_t)(12146000192742678795UL), "parTreeSearch|ss|0", (int *)0, "%struct.stealStack_t*", (void *)(&ss), (size_t)8, 1, 0, 0) ; int victimId;
int goodSteal;
int localDepth;
Node child;
Node *parent;
...
int main_quick(int argc, char *argv[]) {const int ____chimes_did_disable29 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(12146000192742679292UL)) ; StealStack *ss;
double et;
double t2;
double t1;
Node root;
...
static int module_init() {
    init_module(12146000192742677280UL, 51, 30, 44, 54, 28, 9, 37, 38, 8, 4,
                           ...
                           "uts_wctime", &(____chimes_does_checkpoint_uts_wctime_npm),
                             ...
                             (12146000192742677280UL + 2026UL), (12146000192742677280UL + 1289UL),
                             (12146000192742677280UL + 1944UL), (12146000192742677280UL + 2012UL),
                             ...
                             (12146000192742677280UL + 2073UL), (12146000192742677280UL + 1432UL),
                             ...
                             (12146000192742677280UL + 1949UL), (12146000192742677280UL + 1307UL),
                             ...
                             (12146000192742677280UL + 14UL), (12146000192742677280UL + 2028UL),
                             ...
                             (12146000192742677280UL + 2022UL), (12146000192742677280UL + 1307UL),
                             (12146000192742677280UL + 299UL), (12146000192742677280UL + 376UL),
                             (12146000192742677280UL + 1410UL), (12146000192742677280UL + 1515UL),
                             (12146000192742677280UL + 297UL), (12146000192742677280UL + 221UL),
                             (12146000192742677280UL + 1412UL), (12146000192742677280UL + 1450UL),
