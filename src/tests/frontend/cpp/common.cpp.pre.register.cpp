...
# 47 "/Users/jmg3/install/llvm-build/Debug+Asserts/bin/../lib/clang/3.5.1/include/stddef.h" 3 4
typedef long int ptrdiff_t;
# 58 "/Users/jmg3/install/llvm-build/Debug+Asserts/bin/../lib/clang/3.5.1/include/stddef.h" 3 4
typedef long unsigned int size_t;
...
# 1 "/Users/jmg3/install/llvm-build/Debug+Asserts/bin/../lib/clang/3.5.1/include/stdint.h" 1 3 4
# 63 "/Users/jmg3/install/llvm-build/Debug+Asserts/bin/../lib/clang/3.5.1/include/stdint.h" 3 4
...
# 64 "/Users/jmg3/install/llvm-build/Debug+Asserts/bin/../lib/clang/3.5.1/include/stdint.h" 2 3 4
...
void ricker_wavelet(float *source, int nsteps, float dt, float freq) {
    new_stack(7724169104006700302UL, 4, 19, (size_t)(2008721800625821080UL), (size_t)(0UL), (size_t)(0UL), (size_t)(0UL), 1387191059008098409UL, 3277977604394879722UL, 4047636378196868974UL, 577070706814357478UL, 4972645299531092553UL, 5827032325616314450UL, 5186300721691170515UL, 3277977604394879722UL, 5997784754333573673UL, 4288610876228433544UL, 6095867792190138415UL, 3433389096703679793UL, 7374354779439216353UL, 2752442294988640373UL, 7503953869617880805UL, 6456531717151425942UL, 8936251819094495589UL, 4995672202021001482UL, 9285280766920217948UL, 2752442294988640373UL, 11007132437992599952UL, 8132302032623108198UL, 11424047330458090375UL, 2008721800625821080UL, 11890416593231187164UL, 8132302032623108198UL, 13982009165439054754UL, 6456531717151425942UL, 14632242022306526605UL, 17386119534690992797UL, 15190893650781371235UL, 9285280766920217948UL, 16334560808348918639UL, 4288610876228433544UL, 16642833800444842057UL, 2685576284420924090UL, 17386119534690992797UL, 16455452247920468155UL); register_stack_var("ricker_wavelet|source|0", "float*", (void *)(&source), 8, 1, 0, 0); register_stack_var("ricker_wavelet|nsteps|0", "i32", (void *)(&nsteps), 4, 0, 0, 0); register_stack_var("ricker_wavelet|dt|0", "float", (void *)(&dt), 4, 0, 0, 0); register_stack_var("ricker_wavelet|freq|0", "float", (void *)(&freq), 4, 0, 0, 0); float shift; lbl_0: register_stack_var("ricker_wavelet|shift|0", "float", (void *)(&shift), 4, 0, 0, 0); if (____numdebug_replaying) { goto lbl_1; } shift = -1.55939996F / freq;

    { int i; lbl_1: register_stack_var("ricker_wavelet|i|0", "i32", (void *)(&i), 4, 0, 0, 0); if (____numdebug_replaying) { goto lbl_2; } for ( i = 0; i < nsteps; alias_group_changed(1, (size_t)(8765741491806222420UL)), i++) { {
         float time; lbl_2: register_stack_var("ricker_wavelet|time|0", "float", (void *)(&time), 4, 0, 0, 0); if (____numdebug_replaying) { goto lbl_3; } time = i * dt + shift;
         float pi_freq_t; lbl_3: register_stack_var("ricker_wavelet|pi_freq_t|0", "float", (void *)(&pi_freq_t), 4, 0, 0, 0); if (____numdebug_replaying) { goto lbl_4; } pi_freq_t = 3.14151692F * freq * time;
         float sqr_pi_freq_t; lbl_4: register_stack_var("ricker_wavelet|sqr_pi_freq_t|0", "float", (void *)(&sqr_pi_freq_t), 4, 0, 0, 0); if (____numdebug_replaying) { goto lbl_5; } lbl_5: if (____numdebug_replaying) { int dst = get_next_call(); switch(dst) { case(0): { goto call_lbl_0; } default: { fprintf(__stderrp, "Unknown label %d at %s:%d\n", dst, "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp", 57); exit(1); } } } sqr_pi_freq_t = pi_freq_t * pi_freq_t;
...
void parse_source(char *optarg, source *out) {
    new_stack(7724169104006700302UL, 2, 19, (size_t)(4288610876228433544UL), (size_t)(4995672202021001482UL), 1387191059008098409UL, 3277977604394879722UL, 4047636378196868974UL, 577070706814357478UL, 4972645299531092553UL, 5827032325616314450UL, 5186300721691170515UL, 3277977604394879722UL, 5997784754333573673UL, 4288610876228433544UL, 6095867792190138415UL, 3433389096703679793UL, 7374354779439216353UL, 2752442294988640373UL, 7503953869617880805UL, 6456531717151425942UL, 8936251819094495589UL, 4995672202021001482UL, 9285280766920217948UL, 2752442294988640373UL, 11007132437992599952UL, 8132302032623108198UL, 11424047330458090375UL, 2008721800625821080UL, 11890416593231187164UL, 8132302032623108198UL, 13982009165439054754UL, 6456531717151425942UL, 14632242022306526605UL, 17386119534690992797UL, 15190893650781371235UL, 9285280766920217948UL, 16334560808348918639UL, 4288610876228433544UL, 16642833800444842057UL, 2685576284420924090UL, 17386119534690992797UL, 16455452247920468155UL); register_stack_var("parse_source|optarg|0", "i8*", (void *)(&optarg), 8, 1, 0, 0); register_stack_var("parse_source|out|0", "%struct._source*", (void *)(&out), 8, 1, 0, 0); char *x_str; lbl_0: register_stack_var("parse_source|x_str|0", "i8*", (void *)(&x_str), 8, 1, 0, 0); if (____numdebug_replaying) { goto lbl_1; } x_str = optarg;
     char *first_comma; lbl_1: register_stack_var("parse_source|first_comma|0", "i8*", (void *)(&first_comma), 8, 1, 0, 0); if (____numdebug_replaying) { goto lbl_2; } call_lbl_0: calling(0, 6456531717151425942UL, 2, (size_t)(4288610876228433544UL), (size_t)(0UL)); first_comma = strchr(x_str, ',');
    if (alias_group_changed(1, (size_t)(7503953869617880805UL)) || first_comma == __null) { {
     ...
     char *y_str; lbl_2: register_stack_var("parse_source|y_str|0", "i8*", (void *)(&y_str), 8, 1, 0, 0); if (____numdebug_replaying) { goto lbl_3; } y_str = first_comma + 1;
     char *second_comma; lbl_3: register_stack_var("parse_source|second_comma|0", "i8*", (void *)(&second_comma), 8, 1, 0, 0); if (____numdebug_replaying) { goto lbl_4; } call_lbl_3: calling(3, 3277977604394879722UL, 2, (size_t)(6456531717151425942UL), (size_t)(0UL)); second_comma = strchr(y_str, ',');
    if (alias_group_changed(1, (size_t)(1387191059008098409UL)) || second_comma == __null) { {
     ...
     char *freq_str; lbl_4: register_stack_var("parse_source|freq_str|0", "i8*", (void *)(&freq_str), 8, 1, 0, 0); if (____numdebug_replaying) { goto lbl_5; } freq_str = second_comma + 1;
     char *third_comma; lbl_5: register_stack_var("parse_source|third_comma|0", "i8*", (void *)(&third_comma), 8, 1, 0, 0); if (____numdebug_replaying) { goto lbl_6; } call_lbl_6: calling(6, 8132302032623108198UL, 2, (size_t)(3277977604394879722UL), (size_t)(0UL)); third_comma = strchr(freq_str, ',');
    if (alias_group_changed(1, (size_t)(11007132437992599952UL)) || third_comma == __null) { {
     ...
     char *time_str; lbl_6: register_stack_var("parse_source|time_str|0", "i8*", (void *)(&time_str), 8, 1, 0, 0); if (____numdebug_replaying) { goto lbl_7; } lbl_7: if (____numdebug_replaying) { int dst = get_next_call(); switch(dst) { case(0): { goto call_lbl_0; } case(1): { goto call_lbl_1; } case(2): { goto call_lbl_2; } case(3): { goto call_lbl_3; } case(4): { goto call_lbl_4; } case(5): { goto call_lbl_5; } case(6): { goto call_lbl_6; } case(7): { goto call_lbl_7; } case(8): { goto call_lbl_8; } case(9): { goto call_lbl_9; } case(10): { goto call_lbl_10; } case(11): { goto call_lbl_11; } case(12): { goto call_lbl_12; } default: { fprintf(__stderrp, "Unknown label %d at %s:%d\n", dst, "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp", 84); exit(1); } } } time_str = third_comma + 1;
    *first_comma = '\0';
    *second_comma = '\0';
    *third_comma = '\0';

    alias_group_changed(4, (size_t)(3277977604394879722UL), (size_t)(6456531717151425942UL), (size_t)(8132302032623108198UL), (size_t)(11890416593231187164UL)); call_lbl_9: calling(9, 0UL, 1, (size_t)(4288610876228433544UL)); out->x = atoi(x_str);
...
void config_sources(source **srcs, int *nsrcs, int nx, int ny, int nsteps) {
    ...
    { int i; lbl_0: register_stack_var("config_sources|i|0", "i32", (void *)(&i), 4, 0, 0, 0); if (____numdebug_replaying) { goto lbl_1; } for ( i = 0; i < *nsrcs; alias_group_changed(1, (size_t)(16182187182034189366UL)), i++) { {
         source *curr; lbl_1: register_stack_var("config_sources|curr|0", "%struct._source*", (void *)(&curr), 8, 1, 0, 0); if (____numdebug_replaying) { goto lbl_2; } lbl_2: if (____numdebug_replaying) { int dst = get_next_call(); switch(dst) { case(0): { goto call_lbl_0; } case(1): { goto call_lbl_1; } case(2): { goto call_lbl_2; } case(3): { goto call_lbl_3; } case(4): { goto call_lbl_4; } case(5): { goto call_lbl_5; } case(6): { goto call_lbl_6; } case(7): { goto call_lbl_7; } default: { fprintf(__stderrp, "Unknown label %d at %s:%d\n", dst, "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp", 111); exit(1); } } } curr = (*srcs) + i;
        ...
        if (curr->y < 0 || curr->y >= ny) { {
             call_lbl_4: calling(4, 0UL, 2, (size_t)(3433389096703679793UL), (size_t)(3128876572329368717UL)); fprintf(__stderrp, "Invalid y value for source\n");
             call_lbl_5: calling(5, 0UL, 1, (size_t)(0UL)); exit(1);
        } }
        if (curr->t < 0 || curr->t >= nsteps) { {
             call_lbl_6: calling(6, 0UL, 2, (size_t)(3433389096703679793UL), (size_t)(3128876572329368717UL)); fprintf(__stderrp, "Invalid t value for source\n");
             call_lbl_7: calling(7, 0UL, 1, (size_t)(0UL)); exit(1);
        } }
    } } }
rm_stack(false, 0UL); }
...
void update_progress(int progress) {
    new_stack(7724169104006700302UL, 1, 19, (size_t)(0UL), 1387191059008098409UL, 3277977604394879722UL, 4047636378196868974UL, 577070706814357478UL, 4972645299531092553UL, 5827032325616314450UL, 5186300721691170515UL, 3277977604394879722UL, 5997784754333573673UL, 4288610876228433544UL, 6095867792190138415UL, 3433389096703679793UL, 7374354779439216353UL, 2752442294988640373UL, 7503953869617880805UL, 6456531717151425942UL, 8936251819094495589UL, 4995672202021001482UL, 9285280766920217948UL, 2752442294988640373UL, 11007132437992599952UL, 8132302032623108198UL, 11424047330458090375UL, 2008721800625821080UL, 11890416593231187164UL, 8132302032623108198UL, 13982009165439054754UL, 6456531717151425942UL, 14632242022306526605UL, 17386119534690992797UL, 15190893650781371235UL, 9285280766920217948UL, 16334560808348918639UL, 4288610876228433544UL, 16642833800444842057UL, 2685576284420924090UL, 17386119534690992797UL, 16455452247920468155UL); register_stack_var("update_progress|progress|0", "i32", (void *)(&progress), 4, 0, 0, 0); int i; lbl_0: register_stack_var("update_progress|i|0", "i32", (void *)(&i), 4, 0, 0, 0); if (____numdebug_replaying) { goto lbl_1; }
    ...
    if (progress_buffer == __null) { {
     ...
     double perc_progress; lbl_1: register_stack_var("update_progress|perc_progress|0", "double", (void *)(&perc_progress), 8, 0, 0, 0); if (____numdebug_replaying) { goto lbl_2; } perc_progress = (double)progress / (double)progress_goal;
     int ticks; lbl_2: register_stack_var("update_progress|ticks|0", "i32", (void *)(&ticks), 4, 0, 0, 0); if (____numdebug_replaying) { goto lbl_3; } lbl_3: if (____numdebug_replaying) { int dst = get_next_call(); switch(dst) { case(0): { goto call_lbl_0; } case(1): { goto call_lbl_1; } case(2): { goto call_lbl_2; } case(3): { goto call_lbl_3; } case(4): { goto call_lbl_4; } case(5): { goto call_lbl_5; } default: { fprintf(__stderrp, "Unknown label %d at %s:%d\n", dst, "/Users/jmg3/num-debug/src/examples/cpp/lib/common.cpp", 194); exit(1); } } } ticks = (int)(perc_progress * progress_length);
    ...
    if (ticks > progress_num_ticks) { {
        for (alias_group_changed(1, (size_t)(1593413819852114407UL)), i = 1; i < 1 + ticks; alias_group_changed(1, (size_t)(1593413819852114407UL)), i++) { {
            progress_buffer[i] = '=';
        } }
