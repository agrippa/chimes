...
# 5 "<command line>" 2
# 1 "<built-in>" 2
# 1 "/Users/jmg3/num-debug/src/examples/cpp/func_with_no_return.cpp" 2
...
int main(int argc, char **argv) {
    init_numdebug(); new_stack(2, (size_t)(0UL), (size_t)(18293662412874621885UL)); call_lbl_0: calling(0, 0UL, 0); haha_this_sux_part_canc();
