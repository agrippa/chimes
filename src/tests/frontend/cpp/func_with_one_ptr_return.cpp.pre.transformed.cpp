...
void *haha_this_sux_part_deux() {
    new_stack(0); lbl_0: int *A; register_stack_var("haha_this_sux_part_deux|A|0", LIBNUMDEBUG_THREAD_NUM(), "i32*", (void *)(&A), 8, 1, 0, 0); if (____numdebug_replaying) { goto lbl_1; } lbl_1: if (____numdebug_replaying) { int dst = get_next_call(); switch(dst) { default: { exit(42); } } } A = ((int *)malloc_wrapper(sizeof(int) * 10, 17562964499866615488UL, 0, 0));
    alias_group_changed(1, (size_t)(2512725157308058073UL)); rm_stack(true, 17562964499866615488UL); return A;
}

int main(int argc, char **argv) {
    init_numdebug(); new_stack(2, (size_t)(0UL), (size_t)(18293662412874621885UL)); register_stack_var("main|argc|0", LIBNUMDEBUG_THREAD_NUM(), "i32", (void *)(&argc), 4, 0, 0, 0); register_stack_var("main|argv|0", LIBNUMDEBUG_THREAD_NUM(), "i8**", (void *)(&argv), 8, 1, 0, 0); alias_group_changed(3, (size_t)(1388457574958923572UL), (size_t)(15018275423251710358UL), (size_t)(17699046973199516026UL)); lbl_0: void *tmp; register_stack_var("main|tmp|0", LIBNUMDEBUG_THREAD_NUM(), "i8*", (void *)(&tmp), 8, 1, 0, 0); if (____numdebug_replaying) { goto lbl_1; } lbl_1: if (____numdebug_replaying) { int dst = get_next_call(); switch(dst) { case(0): { goto call_lbl_0; } case(1): { goto call_lbl_1; } default: { exit(42); } } } call_lbl_0: calling(0, 17472360066938258657UL, 0); tmp = (haha_this_sux_part_deux());
