...
# 5 "<command line>" 2
# 1 "<built-in>" 2
# 1 "/Users/jmg3/num-debug/src/examples/cpp/func_with_only_return.cpp" 2
...
void *haha_this_sux() {
    new_stack(0); rm_stack(true, 14788649179430747748UL); return __null;
}

int main(int argc, char **argv) {
    init_numdebug(); new_stack(2, (size_t)(0UL), (size_t)(18293662412874621885UL)); register_stack_var("main|argc|0", "i32", (void *)(&argc), 4, 0, 0, 0); register_stack_var("main|argv|0", "i8**", (void *)(&argv), 8, 1, 0, 0); lbl_0: void *tmp; register_stack_var("main|tmp|0", "i8*", (void *)(&tmp), 8, 1, 0, 0); if (____numdebug_replaying) { goto lbl_1; } lbl_1: if (____numdebug_replaying) { int dst = get_next_call(); switch(dst) { case(0): { goto call_lbl_0; } case(1): { goto call_lbl_1; } default: { exit(42); } } } call_lbl_0: calling(0, 18019193851472295513UL, 0); tmp = (haha_this_sux());
