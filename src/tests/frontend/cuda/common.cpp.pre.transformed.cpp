...
void ricker_wavelet(float *source, int nsteps, float dt, float freq) {
    ...
    { lbl_1: int i; register_stack_var("ricker_wavelet|i|0", "i32", (void *)(&i), 4, 0, 0, 0); if (____numdebug_replaying) { goto lbl_2; } for ( i = (0); i < nsteps; i++) { {
...
void parse_source(char *optarg, source *out) {
    ...
    if (first_comma == __null) { {
         call_lbl_1: calling(1, 0UL, 2, (size_t)(3433389096703679793UL), (size_t)(13066525898772550973UL)); fprintf(__stderrp, "Improperly formatted argument to -p, must "
                "be x,y,f,t\n");
        alias_group_changed(2, (size_t)(7503953869617880805UL), (size_t)(13982009165439054754UL)); call_lbl_2: calling(2, 0UL, 1, (size_t)(0UL)); exit(1);
    } }
    ...
    alias_group_changed(2, (size_t)(7503953869617880805UL), (size_t)(13982009165439054754UL)); lbl_3: char *second_comma; register_stack_var("parse_source|second_comma|0", "i8*", (void *)(&second_comma), 8, 1, 0, 0); if (____numdebug_replaying) { goto lbl_4; } call_lbl_3: calling(3, 3277977604394879722UL, 2, (size_t)(6456531717151425942UL), (size_t)(0UL)); second_comma = (strchr(y_str, ','));
    if (second_comma == __null) { {
         call_lbl_4: calling(4, 0UL, 2, (size_t)(3433389096703679793UL), (size_t)(13066525898772550973UL)); fprintf(__stderrp, "Improperly formatted argument to -p, must "
                "be x,y,f,t\n");
        alias_group_changed(2, (size_t)(1387191059008098409UL), (size_t)(5186300721691170515UL)); call_lbl_5: calling(5, 0UL, 1, (size_t)(0UL)); exit(1);
    } }
    ...
    alias_group_changed(2, (size_t)(1387191059008098409UL), (size_t)(5186300721691170515UL)); lbl_5: char *third_comma; register_stack_var("parse_source|third_comma|0", "i8*", (void *)(&third_comma), 8, 1, 0, 0); if (____numdebug_replaying) { goto lbl_6; } call_lbl_6: calling(6, 8132302032623108198UL, 2, (size_t)(3277977604394879722UL), (size_t)(0UL)); third_comma = (strchr(freq_str, ','));
    if (third_comma == __null) { {
         call_lbl_7: calling(7, 0UL, 2, (size_t)(3433389096703679793UL), (size_t)(13066525898772550973UL)); fprintf(__stderrp, "Improperly formatted argument to -p, must "
                "be x,y,f,t\n");
        alias_group_changed(5, (size_t)(3277977604394879722UL), (size_t)(6456531717151425942UL), (size_t)(8132302032623108198UL), (size_t)(11007132437992599952UL), (size_t)(11890416593231187164UL)); call_lbl_8: calling(8, 0UL, 1, (size_t)(0UL)); exit(1);
    } }
    ...
    *third_comma = '\0';
    ...
    alias_group_changed(5, (size_t)(3277977604394879722UL), (size_t)(6456531717151425942UL), (size_t)(8132302032623108198UL), (size_t)(11007132437992599952UL), (size_t)(11890416593231187164UL)); call_lbl_9: calling(9, 0UL, 1, (size_t)(4288610876228433544UL)); out->x = atoi(x_str);
...
void config_sources(source **srcs, int *nsrcs, int nx, int ny, int nsteps) {
    ...
    { lbl_0: int i; register_stack_var("config_sources|i|0", "i32", (void *)(&i), 4, 0, 0, 0); if (____numdebug_replaying) { goto lbl_1; } for ( i = (0); i < *nsrcs; i++) { {
        ...
        if (curr->x < 0 || curr->x >= nx) { {
            ...
            alias_group_changed(10, (size_t)(2685576284420924090UL), (size_t)(2752442294988640373UL), (size_t)(6406781234504566915UL), (size_t)(7374354779439216353UL), (size_t)(8522629736461562909UL), (size_t)(9285280766920217948UL), (size_t)(13772703458028244832UL), (size_t)(15190893650781371235UL), (size_t)(16182187182034189366UL), (size_t)(16642833800444842057UL)); call_lbl_3: calling(3, 0UL, 1, (size_t)(0UL)); exit(1);
        } }
        if (curr->y < 0 || curr->y >= ny) { {
            ...
            alias_group_changed(10, (size_t)(2685576284420924090UL), (size_t)(2752442294988640373UL), (size_t)(6406781234504566915UL), (size_t)(7374354779439216353UL), (size_t)(8522629736461562909UL), (size_t)(9285280766920217948UL), (size_t)(13772703458028244832UL), (size_t)(15190893650781371235UL), (size_t)(16182187182034189366UL), (size_t)(16642833800444842057UL)); call_lbl_5: calling(5, 0UL, 1, (size_t)(0UL)); exit(1);
        } }
...
float **sample_sources(source *srcs, int nsrcs, int nsteps, float dt) {
    ...
    if (src_samples == __null) { {
         call_lbl_0: calling(0, 0UL, 2, (size_t)(3433389096703679793UL), (size_t)(1120098738696514263UL)); fprintf(__stderrp, "Allocation failed\n");
        alias_group_changed(7, (size_t)(4972645299531092553UL), (size_t)(7547608872137199987UL), (size_t)(7867438819795547955UL), (size_t)(14632242022306526605UL), (size_t)(17386119534690992797UL), (size_t)(17866036073706292390UL), (size_t)(18281605317195734986UL)); call_lbl_1: calling(1, 0UL, 1, (size_t)(0UL)); exit(1);
    } }

    { lbl_1: int i; register_stack_var("sample_sources|i|0", "i32", (void *)(&i), 4, 0, 0, 0); if (____numdebug_replaying) { goto lbl_2; } lbl_2: if (____numdebug_replaying) { int dst = get_next_call(); switch(dst) { case(0): { goto call_lbl_0; } case(1): { goto call_lbl_1; } case(2): { goto call_lbl_2; } case(3): { goto call_lbl_3; } case(4): { goto call_lbl_4; } default: { exit(42); } } } for ( i = (0); i < nsrcs; i++) { {
        ...
        if (src_samples[i] == __null) { {
            ...
            alias_group_changed(7, (size_t)(4972645299531092553UL), (size_t)(7547608872137199987UL), (size_t)(7867438819795547955UL), (size_t)(14632242022306526605UL), (size_t)(17386119534690992797UL), (size_t)(17866036073706292390UL), (size_t)(18281605317195734986UL)); call_lbl_3: calling(3, 0UL, 1, (size_t)(0UL)); exit(1);
        } }
