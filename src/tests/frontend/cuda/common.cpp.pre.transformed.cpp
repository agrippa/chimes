...
void ricker_wavelet(float *source, int nsteps, float dt, float freq) {
    ...
    { lbl_1: int i; register_stack_var("ricker_wavelet|i|0", "i32", (void *)(&i), 4, 0, 0, 0); if (____numdebug_replaying) { goto lbl_2; } for ( i = (0); i < nsteps; i++) { {
          ...
          lbl_4: float sqr_pi_freq_t; register_stack_var("ricker_wavelet|sqr_pi_freq_t|0", "float", (void *)(&sqr_pi_freq_t), 4, 0, 0, 0); if (____numdebug_replaying) { goto lbl_5; } lbl_5: if (____numdebug_replaying) { int dst = get_next_call(); switch(dst) { default: { exit(42); } } } sqr_pi_freq_t = (pi_freq_t * pi_freq_t);
...
void parse_source(char *optarg, source *out) {
    ...
    alias_group_changed(3, (size_t)(5997784754333573673UL), (size_t)(8936251819094495589UL), (size_t)(16334560808348918639UL)); lbl_1: char *first_comma; register_stack_var("parse_source|first_comma|0", "i8*", (void *)(&first_comma), 8, 1, 0, 0); if (____numdebug_replaying) { goto lbl_2; } first_comma = (strchr(x_str, ','));
    ...
    alias_group_changed(2, (size_t)(7503953869617880805UL), (size_t)(13982009165439054754UL)); lbl_3: char *second_comma; register_stack_var("parse_source|second_comma|0", "i8*", (void *)(&second_comma), 8, 1, 0, 0); if (____numdebug_replaying) { goto lbl_4; } second_comma = (strchr(y_str, ','));
    ...
    alias_group_changed(2, (size_t)(1387191059008098409UL), (size_t)(5186300721691170515UL)); lbl_5: char *third_comma; register_stack_var("parse_source|third_comma|0", "i8*", (void *)(&third_comma), 8, 1, 0, 0); if (____numdebug_replaying) { goto lbl_6; } third_comma = (strchr(freq_str, ','));
    if (third_comma == __null) { {
      ...
      lbl_6: char *time_str; register_stack_var("parse_source|time_str|0", "i8*", (void *)(&time_str), 8, 1, 0, 0); if (____numdebug_replaying) { goto lbl_7; } lbl_7: if (____numdebug_replaying) { int dst = get_next_call(); switch(dst) { default: { exit(42); } } } time_str = (third_comma + 1);
    *first_comma = '\0';
    *second_comma = '\0';
    *third_comma = '\0';
...
void config_sources(source **srcs, int *nsrcs, int nx, int ny, int nsteps) {
    ...
    { lbl_0: int i; register_stack_var("config_sources|i|0", "i32", (void *)(&i), 4, 0, 0, 0); if (____numdebug_replaying) { goto lbl_1; } for ( i = (0); i < *nsrcs; i++) { {
          lbl_1: source *curr; register_stack_var("config_sources|curr|0", "%struct._source*", (void *)(&curr), 8, 1, 0, 0); if (____numdebug_replaying) { goto lbl_2; } lbl_2: if (____numdebug_replaying) { int dst = get_next_call(); switch(dst) { default: { exit(42); } } } curr = ((*srcs) + i);
...
float **sample_sources(source *srcs, int nsrcs, int nsteps, float dt) {
    ...
    { lbl_1: int i; register_stack_var("sample_sources|i|0", "i32", (void *)(&i), 4, 0, 0, 0); if (____numdebug_replaying) { goto lbl_2; } lbl_2: if (____numdebug_replaying) { int dst = get_next_call(); switch(dst) { case(0): { goto call_lbl_0; } default: { exit(42); } } } for ( i = (0); i < nsrcs; i++) { {
...
void init_progress(int length, int goal, int disabled) {
    new_stack(3, (size_t)(0UL), (size_t)(0UL), (size_t)(0UL)); register_stack_var("init_progress|length|0", "i32", (void *)(&length), 4, 0, 0, 0); register_stack_var("init_progress|goal|0", "i32", (void *)(&goal), 4, 0, 0, 0); register_stack_var("init_progress|disabled|0", "i32", (void *)(&disabled), 4, 0, 0, 0); lbl_0: int i; register_stack_var("init_progress|i|0", "i32", (void *)(&i), 4, 0, 0, 0); if (____numdebug_replaying) { goto lbl_1; } lbl_1: if (____numdebug_replaying) { int dst = get_next_call(); switch(dst) { case(0): { goto call_lbl_0; } case(1): { goto call_lbl_1; } default: { exit(42); } } }
...
void update_progress(int progress) {
    ...
    if (progress_buffer == __null) { {
      ...
      lbl_2: int ticks; register_stack_var("update_progress|ticks|0", "i32", (void *)(&ticks), 4, 0, 0, 0); if (____numdebug_replaying) { goto lbl_3; } lbl_3: if (____numdebug_replaying) { int dst = get_next_call(); switch(dst) { default: { exit(42); } } } ticks = ((int)(perc_progress * progress_length));
